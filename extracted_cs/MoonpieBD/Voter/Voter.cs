...
{
    [Info("VoteRewards", "Moonpie", "1.0.0", ResourceId = 752)]
    class Voter : RustPlugin
    {
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            {                
                Rewards = new Dictionary<int, Rewards>
                {
                    {0, new Rewards
                    {
                        Description = "A signal to call in a supply drop",
                        CostToBuy = 1,
                        RPAmount = 0,
                        EcoAmount = 0,                      
                    ...
                    {1, new Rewards
                    {
                        Description = "A small amount of different Metals",
                        CostToBuy = 2,
                        RPAmount = 0,
                        EcoAmount = 0,                       
                        RewardItems = new List<Rewards.RewardItem>
        ...
        Dictionary<string, string> Messages = new Dictionary<string, string>
        {
            ...
            {"noVotes", "Thank you for voting for us but you have not cast anymore votes since the last time you checked - you can vote at www.rust-servers.net"},
