...
{
    [Info("EasyVote", "Exel80", "1.2.1", ResourceId = 2102)]
    ...
    class EasyVote : RustPlugin
    {
        ...
        #region Initializing
        public bool DEBUG = true; // Dev mod
        ...
        [ChatCommand("rewards")]
        void cmdRewards(BasePlayer player, string command, string[] args)
        {
            rewardList(player);
        }
        [ChatCommand("claim")]
