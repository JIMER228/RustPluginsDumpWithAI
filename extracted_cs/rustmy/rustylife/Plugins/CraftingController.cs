...
namespace Oxide.Plugins
{
    ...
    class CraftingController : RustPlugin
    {
        ...
        public bool UseRandomSkinCraft { get; set; }
        ...
        private void LoadConfigValues()
        {
            ...
            UseRandomSkinCraft = GetConfigValue("Options", "Использовать случайный крафт скинов", false);
        ...
        int GetAviableSlots(BasePlayer player)
            =>
            player.inventory.containerMain.availableSlots.Length + player.inventory.containerBelt.availableSlots.Length;
