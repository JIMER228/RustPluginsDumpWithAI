...
namespace Oxide.Plugins
{
    ...
    public class GUIAnnouncements : RustPlugin
    {
        ...
        void CreateMsgGUI(string Msg, string bannerTintColor, string textColor, BasePlayer player = null, bool isWelcomeAnnouncement = false, bool isRestartAnnouncement = false)
        {
