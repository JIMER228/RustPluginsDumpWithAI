...
namespace Oxide.Plugins
{
    ...
    public class CupboardRadius : RustPlugin
    {
        ...
        private void onServerInitialized() {
            ...
            bool reloaded = false;
            foreach (var prevPst in CommunityEntity.ServerInstance.gameObject.GetComponents<MonoBehaviour>()) {
                if (prevPst.GetType().Name == "CupboardRadiusPersistence") {
                    reloaded = true;
                    pst = CommunityEntity.ServerInstance.gameObject.AddComponent<CupboardRadiusPersistence>();
        ...
        private void updateInfluence(uint privlidgePrefabID) {
            ...
            if (ignoreInfluence) {
                ...
                socketBase.socketMods = socketBase.socketMods.Where(mod => mod.FailedPhrase.english != "Вы находитесь в зоне действия другого шкафа!").ToArray();
