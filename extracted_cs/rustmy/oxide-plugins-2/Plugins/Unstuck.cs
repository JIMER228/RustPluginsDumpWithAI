...
namespace Oxide.Plugins
{
    ...
    {
        // Do NOT edit this file, instead edit Unstuck.json in oxide/config and Unstuck.en.json in oxide/lang,
        ...
        void Init()
        {
            ...
            #if RUST
            cmdlib.AddConsoleCommand("global.unstuck", this, "UnstuckConsole");
        ...
        {
            PrintWarning($"Before: {player.transform.position}");
            posTimer.Add(player.UserIDString, timer.Repeat(60f, 0, () =>
            {
                var position = player.transform.position;
                PrintWarning($"After: {position}");
        ...
        {
            var player = players.GetPlayer(arg.GetString(0));
        ...
        {
            if (!input.WasJustPressed(BUTTON.FORWARD)) covalence.Server.Command($"unstuck.adjust {player.UserIDString} up");
            if (!input.WasJustPressed(BUTTON.BACKWARD)) covalence.Server.Command($"unstuck.adjust {player.UserIDString} down");
            if (!input.WasJustPressed(BUTTON.LEFT)) covalence.Server.Command($"unstuck.adjust {player.UserIDString} left");
            if (!input.WasJustPressed(BUTTON.RIGHT)) covalence.Server.Command($"unstuck.adjust {player.UserIDString} right");
        }*/
