...
﻿/*
TODO:
- Add command to add/remove whitelisted IPs
- Add permission to allow player's IPs to be whitelisted on in-game connection
*/
...
namespace Oxide.Plugins
{
    ...
    class LimitRCON : RustPlugin
    {
        ...
        object OnRconConnection(IPEndPoint ip) => IsLocalIp(ip.Address.ToString()) ? null : (!ips.Contains(ip.Address.ToString()) ? (object)true : null);
