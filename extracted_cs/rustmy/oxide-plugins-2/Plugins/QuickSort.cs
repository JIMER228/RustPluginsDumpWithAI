...
namespace Oxide.Plugins
{
    ...
    class QuickSort : RustPlugin
    {
        ...
        void OnLootPlayer(BasePlayer player) => UserInterface(player);

        void OnLootEntity(BasePlayer player) => UserInterface(player);
        ...
        void UserInterface(BasePlayer player)
        {
            ...
            if (uiStyle == "lite") UiLite(player);
            if (uiStyle == "center") UiCenter(player);
            if (uiStyle == "right") UiRight(player);
        }
        ...
        void UiLite(BasePlayer player)
        {
            ...
            elements.Add(new CuiButton
            {
                ...
                Text = { Text = Lang("DepositExisting"), FontSize = 13, Align = TextAnchor.MiddleCenter }
            }, panel);
            elements.Add(new CuiButton
            {
                Button = { Command = "quicksort", Color = "1 0.5 0 0.5" },
                RectTransform = { AnchorMin = "-0.61 -1.545", AnchorMax = "-0.36 -1.435" },
                Text = { Text = Lang("DepositAll"), FontSize = 13, Align = TextAnchor.MiddleCenter }
            }, panel);
            elements.Add(new CuiButton
            {
                Button = { Command = "quicksort.loot", Color = "0 0.7 0 0.5" },
                RectTransform = { AnchorMin = "-0.34 -1.545", AnchorMax = "-0.13 -1.435" },
                Text = { Text = Lang("LootAll"), FontSize = 13, Align = TextAnchor.MiddleCenter }
            }, panel);
