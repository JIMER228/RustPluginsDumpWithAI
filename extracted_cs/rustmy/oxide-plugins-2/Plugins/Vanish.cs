...
- Check if CanBeHurt is covering ALL damage sources
...
namespace Oxide.Plugins
{
    ...
    class Vanish : RustPlugin
    {
        ...
        const string permAllowed = "vanish.allowed";
        ...
        readonly Dictionary<ulong, string> guiInfo = new Dictionary<ulong, string>();
