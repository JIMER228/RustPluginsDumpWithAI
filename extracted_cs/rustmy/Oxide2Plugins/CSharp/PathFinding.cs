...
namespace Oxide.Plugins
{
    ...
    class PathFinding : RustPlugin
    {
        ...
        {
            groundLayer = UnityEngine.LayerMask.GetMask(new string[] { "Terrain", "World", "Construction" });
            blockLayer = UnityEngine.LayerMask.GetMask(new string[] { "World", "Construction", "Tree" });
