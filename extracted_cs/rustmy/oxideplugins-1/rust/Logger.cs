...
namespace Oxide.Plugins
{
    ...
    class Logger : RustPlugin
    {
        ...
        void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["ChatCommand"] = "{0} ({1}) a couru chat commande : {2}",
                ["Connected"] = "{0} ({1}) reliant {2}",
                ["ConsoleCommand"] = "{0} ({1}) a couru la console de commande : {3} {2}",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["ChatCommand"] = "{0} ({1}) побежал чат команды: {2}",
                ["Connected"] = "{0} ({1}) из {2}",
                ["ConsoleCommand"] = "{0} ({1}) побежал команда консоли: {2} {3}",
                ["Disconnected"] = "{0} ({1}) отключен",
                ["Respawned"] = "{0} ({1}) возродится в {2}"
            }, this, "ru");

            // Spanish
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["ChatCommand"] = "{0} ({1}) funcionó el comando chat: {2}",
                ["Connected"] = "{0} ({1}) conectado de {2}",
                ["ConsoleCommand"] = "{0} ({1}) funcionó el comando de consola: {2} {3}",
