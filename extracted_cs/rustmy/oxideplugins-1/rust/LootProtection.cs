...
namespace Oxide.Plugins
{
    ...
    class LootProtection : CovalencePlugin
    {
        ...
        void LoadDefaultMessages()
        {
            ...
            // French
            lang.RegisterMessages(new Dictionary<string, string> { ["LootProtection"] = "{0} a protection de butin activée" }, this, "fr");

            // German
            lang.RegisterMessages(new Dictionary<string, string> { ["LootProtection"] = "{0} hat Beute Schutz aktiviert" }, this, "de");

            // Russian
            lang.RegisterMessages(new Dictionary<string, string> { ["LootProtection"] = "{0} имеет включена защита Лут" }, this, "ru");

            // Spanish
            lang.RegisterMessages(new Dictionary<string, string> { ["LootProtection"] = "{0} tiene botín protección activada" }, this, "es");
        }
