...
{                 
    ...
    public class AutoGrades : RustPlugin
    {
        ...
        void Loaded() {
			...
			lang.RegisterMessages(new Dictionary<string,string>{
				["BGRADE_NOPERM"] = "<color='#DD0000'>Недостаточно прав для использования данной команды.</color>",
				["BGRADE_NORES"] = "<color='#DD0000'>Недостаточно ресурсов для постройки и обновления.</color>",
				["BGRADE_NORES2"] = "<color='#DD0000'>Недостаточно ресурсов для обновления.</color>",
				["BGRADE_HELP"] = "Автоматическое обновление конструкции, использование:",
				["BGRADE_1"] = "<color='#00DD00'>/{0} 1</color> - авто обновление до дерева",
				["BGRADE_2"] = "<color='#00DD00'>/{0} 2</color> - авто обновление до камня",
				["BGRADE_3"] = "<color='#00DD00'>/{0} 3</color> - авто обновление до метала",
				["BGRADE_4"] = "<color='#00DD00'>/{0} 4</color> - авто обновление до бронированого",
				["BGRADE_0"] = "<color='#00DD00'>/{0} 0</color> - отключить авто обновление",
				["BGRADE_CUR"] = "Текущий режим: <color='#DD0000'>{0}</color>",
				["BGRADE_SET"] = "<color='#00DD00'>Вы успешно установили авто обновление до: <color='#DD0000'>{0}</color>.</color>",
				["BGRADE_DIS"] = "<color='#00DD00'>Вы успешно <color='#DD0000'>выключили</color> авто обновление.</color>",
				["BGRADE_INV"] = "<color='#DD0000'>Неверный класс постройки.</color>",
				["Disabled"] = "Отключено",
				["Wood"] = "Дерево",
				["Stone"] = "Камень",
				["Metal"] = "Метал",
