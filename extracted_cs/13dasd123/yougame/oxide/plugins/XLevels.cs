...
namespace Oxide.Plugins
{
    ...
    class XLevels : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            foreach (var i in MQSUTKGKWXESSHQMZBTFNPVRZEJDQJNOOFIHZGAYYRQZT.Award) if (i.Value.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU == String.Empty)
                    ImageLibrary.Call("AddImage", $"https://api.skyplugins.ru/api/getimage/{i.Value.Shortname}/128", i.Value.Shortname + 150);
                else ImageLibrary.Call("AddImage", i.Value.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU, i.Value.Shortname + 151);
            foreach (var i in MQSUTKGKWXESSHQMZBTFNPVRZEJDQJNOOFIHZGAYYRQZT.BPHJKPIBZZWWWEKECFXFMMNBPYJLGQCGDACLNYMEOSGCP) if (i.Value.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU == String.Empty) 
                    ImageLibrary.Call("AddImage", $"https://api.skyplugins.ru/api/getimage/{i.Value.Shortname}/128", i.Value.Shortname + 150);
                else ImageLibrary.Call("AddImage", i.Value.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU, i.Value.Shortname + 151);
            foreach (var i in MQSUTKGKWXESSHQMZBTFNPVRZEJDQJNOOFIHZGAYYRQZT.Coupon) 
                ImageLibrary.Call("AddImage", $"https://api.skyplugins.ru/api/getskin/{i.SkinID}/128", i.SkinID.ToString());
        ...
        private void GBECBQVLVVDZIVUEAMNRGKFHOROYKBWUURDTLTEJAZRBTFUSW(BasePlayer player, int Page = 0)
        {
            ...
            foreach (var inv in KCXWWYFMYEMOZRCKECIYAMKJOKFAHSIGNWYOGEKOALST[player.userID].Skip(Page * 45))
            {
                ...
                YLIGMRYYROGJUESPFTJEIUUUIYLZDPYDFZXOVIMPMQXLEP.Add(new CuiElement
                {
                    ...
                    Components = {
                                                new CuiRawImageComponent {
                                                        Png = (string) ImageLibrary.Call("GetImage", inv.Shortname + (inv.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU == String.Empty ? 150 : 151)), Color = RXYVVGMXHMZFOMOFOUXEATGELGPBKIGSRRMBSXCIHUNOICIC ? "1 1 1 0.4" : "1 1 1 1"
                                                },
                                                new CuiRectTransformComponent {
                ...
                if (!OUZEILXRDRIXPMBNGRIJUDMHBBTCKQSAQCXKXRVIS || OUZEILXRDRIXPMBNGRIJUDMHBBTCKQSAQCXKXRVIS && contains)
                {
                    ...
                    if (contains)
                    {
                        ...
                        YLIGMRYYROGJUESPFTJEIUUUIYLZDPYDFZXOVIMPMQXLEP.Add(new CuiElement
                        {
                            ...
                            Components = {
                                                                new CuiRawImageComponent {
                                                                        Png = (string) ImageLibrary.Call("GetImage", PVQIKHSRNJNPKLISCHRUGNYIGNPRQPWARBNQRTRLKTCIMB.Shortname + (PVQIKHSRNJNPKLISCHRUGNYIGNPRQPWARBNQRTRLKTCIMB.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU == String.Empty ? 150 : 151))
                                                                },
                                                                new CuiRectTransformComponent {
                    ...
                    if (!OUZEILXRDRIXPMBNGRIJUDMHBBTCKQSAQCXKXRVIS || OUZEILXRDRIXPMBNGRIJUDMHBBTCKQSAQCXKXRVIS && contains)
                    {
                        ...
                        if (contains)
                        {
                            ...
                            YLIGMRYYROGJUESPFTJEIUUUIYLZDPYDFZXOVIMPMQXLEP.Add(new CuiElement
                            {
                                ...
                                Components = {
                                                                        new CuiRawImageComponent {
                                                                                Png = (string) ImageLibrary.Call("GetImage", LBFOORXLCWHBXRABYNNXIXSAJPFKNLQVFVEQLAHITQLTJR.Shortname + (LBFOORXLCWHBXRABYNNXIXSAJPFKNLQVFVEQLAHITQLTJR.WEWQPWWLWXLSKOCOEYJYKHAVTNMGIEHMNONHPUSPEPIIU == String.Empty ? 150 : 151)), Color = PHZCLMKVUXHWOVXRPMWVILWQBKKQXSKKAKJVLHFIDYBXXHSF ? "1 1 1 1" : "1 1 1 0.5"
                                                                        },
                                                                        new CuiRectTransformComponent {
                                                                                AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "17.5 17.5", OffsetMax = "-17.5 -17.5"
                                                                        }
        ...
        private void ExchangeInfo(BasePlayer player)
        {
            ...
            foreach (var coupon in MQSUTKGKWXESSHQMZBTFNPVRZEJDQJNOOFIHZGAYYRQZT.Coupon)
            {
                ...
                YLIGMRYYROGJUESPFTJEIUUUIYLZDPYDFZXOVIMPMQXLEP.Add(new CuiElement
                {
                    ...
                    Components = {
                                                new CuiRawImageComponent {
                                                        Png = (string) ImageLibrary.Call("GetImage", coupon.SkinID.ToString())
                                                },
                                                new CuiRectTransformComponent {
