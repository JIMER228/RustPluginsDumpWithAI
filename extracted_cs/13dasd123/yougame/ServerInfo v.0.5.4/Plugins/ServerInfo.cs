...
{
	[Info("ServerInfo", "BRGM (oxide-russia.ru)", "0.5.4", ResourceId = 1317)]
	[Description("Пользовательский интерфейс настраивается пользователем с несколькими вкладками: oxide-russia.ru")]
