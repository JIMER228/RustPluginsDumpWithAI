...
{
    [Info("BetterChatFilterRU", "LaserHydra, jemes. and Slut", "1.2", ResourceId = 2403)]
    ...
    public class BetterChatFilter : CovalencePlugin
    {
        ...
        private int MuteCount = 10;
        private int KickCount = 9999;
        private bool BroadcastKick = false;
        private int TimeToMute = 180;
