...
{
    [Info("WipeBlock", "Hougan / rostov114", "2.0.9")]
    ...
    public class WipeBlock : RustPlugin
    {
        ...
        private class Configuration
        {
            ...
            public class Block 
            {
                [JsonProperty("Сдвиг блокировки в секундах ('1643' - на 1643 секунд вперёд, '-1643' на 1643 секунд назад)")]
        ...
        private string Layer = "UI_1643InstanceBlock";
        private string LayerBlock = "UI_1643Block";
        private string LayerInfoBlock = "UI_1643InfoBlock"; 
        ...
        private void DrawBlockGUI(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0 0.928601643154", AnchorMax = "1.015 0.9998464", OffsetMax = "0 0" }
                }
            });
