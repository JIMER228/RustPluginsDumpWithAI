...
namespace Oxide.Plugins
{
    ...
    class Kits : RustPlugin
    {
        ...
        private void GiveItems(BasePlayer player, Kit kit)
        {
            ...
            {
                GiveItem(player.inventory,BuildItem(kitem.ShortName,kitem.Amount,kitem.SkinID,kitem.Condition,kitem.Weapon,kitem.Content), kitem.Container == "belt" ? player.inventory.containerBelt : kitem.Container == "wear" ? player.inventory.containerWear : player.inventory.containerMain);
            }
        }
