        ...
        private void ExecuteAction(BasePlayer player, string action, string target, float price)
        {
            switch (action.ToLower())
            {
                ...
                case "radiation":
                {
                    ...
                    player.ChatMessage($"Меценат <color=#bbbbbb>{target}</color> заразил вас радиацией <color=#e57373>за {price:F1} руб.</color>");
                ...
                case "drown":
                {
                    ...
                    timer.Repeat(3, 4, () =>
                    {
                        Effect.server.Run("", player.transform.position);
                ...
                case "destroy":
                {
                    ...
                    player.ChatMessage($"Меценат <color=#bbbbbb>{target}</color> разрушил ваши постройки <color=#e57373>за {price:F1} руб.</color>");
                    break;
                }
            }
        }
