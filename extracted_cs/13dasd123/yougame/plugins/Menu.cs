...
namespace Oxide.Plugins
{
    ...
    public class Menu : RustPlugin
    {
        ...
        {
            public string ServerID = "5";
            public string ServerName = "BLOOD RED - MAX2";
            ...
            public static Configuration Generate()
            {
                return new Configuration
                {
                    ...
                    {
                        [0f] = "https://xackuscr.ru/rust/newgreen/0.png",
                        [0.05f] = "https://xackuscr.ru/rust/newgreen/1.png",
                        [0.1f] = "https://xackuscr.ru/rust/newgreen/2.png",
                        [0.15f] = "https://xackuscr.ru/rust/newgreen/3.png",
                        [0.2f] = "https://xackuscr.ru/rust/newgreen/4.png",
                        [0.25f] = "https://xackuscr.ru/rust/newgreen/5.png",
                        [0.3f] = "https://xackuscr.ru/rust/newgreen/6.png",
                        [0.35f] = "https://xackuscr.ru/rust/newgreen/7.png",
                        [0.4f] = "https://xackuscr.ru/rust/newgreen/8.png",
                        [0.45f] = "https://xackuscr.ru/rust/newgreen/9.png",
                        [0.5f] = "https://xackuscr.ru/rust/newgreen/10.png",
                        [0.55f] = "https://xackuscr.ru/rust/newgreen/11.png",
                        [0.6f] = "https://xackuscr.ru/rust/newgreen/12.png",
                        [0.65f] = "https://xackuscr.ru/rust/newgreen/13.png",
                        [0.7f] = "https://xackuscr.ru/rust/newgreen/14.png",
                        [0.75f] = "https://xackuscr.ru/rust/newgreen/15.png",
                        [0.8f] = "https://xackuscr.ru/rust/newgreen/16.png",
                        [0.85f] = "https://xackuscr.ru/rust/newgreen/17.png",
                        [0.9f] = "https://xackuscr.ru/rust/newgreen/18.png",
                        [0.95f] = "https://xackuscr.ru/rust/newgreen/19.png",
                        [1.0f] = "https://xackuscr.ru/rust/newgreen/20.png"
                    }
                };
            }
        }
        ...
        private class MenuPlayer : MonoBehaviour
        {
            ...
            public void UpdateOnline()
            {
                ...
                float imageId = 0f;
                if (!_.plugins.Find("Quest"))
                    imageId = 0f;
                else
                {
                    try
                    {
                        imageId = (float) _.plugins.Find("Quest")?.Call("GetExp", Player);
                    }
                    catch 
                    {
                        imageId = 0f;
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiRawImageComponent { Png = Handler.PrepareImages[imageId.ToString()], Color = "1 1 1 0.9" },
                ...
                { 
                    RectTransform = {AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 20", OffsetMax              = "-14.5 0"},
                    Text          = {Text      = Settings.ServerID, Align       = TextAnchor.LowerRight, Font = "robotocondensed-bold.ttf", FontSize = 16, Color = "1 1 1 0.9" }
                }, Layer + ".Online");
                ...
                if (State == State.Opened)
                {
                    container.Add(new CuiLabel
                    {
                        ...
                        Text          = { Text      = BasePlayer.activePlayerList.ToList().Count.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 15, Align = TextAnchor.MiddleCenter, Color = "0.9 0.1 0.2 1" }
            ...
            public IEnumerator DrawNotification(Notification notification)
            {
                ...
                {
                    FadeOut = 1f,
                    RectTransform = {AnchorMin = "0.1 0.46", AnchorMax        = "4 1", OffsetMax              = "0 0"},
                ...
                {
                    FadeOut = 1f,
                    RectTransform = {AnchorMin = "0.1 0", AnchorMax        = "4 0.46", OffsetMax              = "0 0"},
                ...
                container.Add(new CuiButton
                {
                    RectTransform = {AnchorMin = "0.05 0", AnchorMax = "1 1", OffsetMax = "0 0"},
        ...
        private class MenuHandler : MonoBehaviour
        {
            ...
            public void Awake()
            {
                ...
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/QgN6XJO.png", "NotificationImage");
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/HiEEg07.png", "MenuHeaderImage");
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/QgN6XJO.png", "RaidNotification");
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/egfVi5e.png", "BoarNotification");
