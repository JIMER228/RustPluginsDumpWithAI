...
namespace Oxide.Plugins
{
    ...
    internal class HomeRecycler : RustPlugin
    {
        ...
        {
            if (item.info.itemid == recyclerItemId && item.skin == 1321253094UL)
            {
        ...
        {
            var item = ItemManager.CreateByName(configData.recyclerItemName, 1, 2010734243);
