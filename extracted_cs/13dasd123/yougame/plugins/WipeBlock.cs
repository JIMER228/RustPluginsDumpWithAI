...
namespace Oxide.Plugins
{
    ...
    public class WipeBlock : RustPlugin
    {
        ...
        private string Layer = "UI_18InstanceBlock";
        ...
        {                              
            ...
            { 
                ImageLibrary.Call("AddImage", $"http://185.200.242.130:2007/rust/item/getImage/{check}/128", check, (ulong) 256);  
        ...
        private void DrawBlockGUI(BasePlayer player, string section, int page, bool reopen = false)
        {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
            CuiElementContainer container = new CuiElementContainer();
                ...
                foreach (var check in itemList.Skip(page * 20).Take(20)) 
                {
                    container.Add(new CuiPanel
                    {
                        RectTransform = { AnchorMin = $"{elementId * elemCount} 1", AnchorMax = $"{(elementId + 1) * elemCount} 1", OffsetMin = $"{(elementId == 0 ? "0" : "10")} {topMargin - pHeight}", OffsetMax = $"{(elementId == 3 ? "0" : "-5")} {topMargin}" },
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        Components = 
                        {
                            ...
                            new CuiRectTransformComponent { AnchorMin = "0.5 0", AnchorMax = "0.5 1", OffsetMin = "-40 15", OffsetMax = "40 -15" }
                        }
                    });
