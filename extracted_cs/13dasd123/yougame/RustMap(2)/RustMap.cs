...
namespace Oxide.Plugins
{
    ...
    class RustMap : RustPlugin
	{
		...
		private object OnEntityDeath(BasePlayer player, HitInfo info)
		{
        ...
        void OnEntityDie(BaseCombatEntity entity)
        {
        ...
        void FindStaticMarkers()
        {
            ...
            foreach (var monument in monuments)
            {
				...
				else if (monument.name.Contains("military_tunnel_hapis"))
                {
                    png = "militarytunnel";
                    text = "Туннель";
                }
				...
				else if (monument.name.Contains("Junk"))
                {
                    png = "junkyard";
                    text = "Свалка";
                }
				...
				else if (monument.name.Contains("OilrigAI2"))
                {
                    png = "OilrigAI2";
                    text = "Нефтяная вышка";
                }
				...
				else if (monument.name.Contains("Label (13)"))
                {
                    png = "Outpost";
                    text = "Застава";
                }
        ...
        Dictionary<string, string> images = new Dictionary<string, string>()
		{
			...
			{ "OilrigAI2", "file://" + Interface.Oxide.DataDirectory + Path.DirectorySeparatorChar + "RustMap" + Path.DirectorySeparatorChar + "icons" + Path.DirectorySeparatorChar + "oil_rig.png" },
			{ "OilrigAI", "file://" + Interface.Oxide.DataDirectory + Path.DirectorySeparatorChar + "RustMap" + Path.DirectorySeparatorChar + "icons" + Path.DirectorySeparatorChar + "oil_rig.png" },
			{ "Outpost", "file://" + Interface.Oxide.DataDirectory + Path.DirectorySeparatorChar + "RustMap" + Path.DirectorySeparatorChar + "icons" + Path.DirectorySeparatorChar + "Outpost.png" },
