...
{
    [Info("IQReportSystem", "noname", "1.0.0")]
    class IQReportSystem : RustPlugin
    {
                ...
                case "reported_suspect":
                    {
                        ...
                        VKSendMessage(String.Format(lang.GetMessage("METODS_SEND_REPORT_VK", this), Suspect.displayName, Suspect.UserIDString, ReasonReport));
                        DiscordSendMessage(String.Format(lang.GetMessage("METODS_SEND_REPORT_VK", this), Suspect.displayName, Suspect.UserIDString, ReasonReport));
                        return;
                    }
                ...
                case "moderator_banned":
                    {
                        ...
                        Metods_ModeratorBanned(player, SuspectID, i);
                        return;
                    }
                case "give":
                    {
                ...
                case "remove":
                    {
                        ...
                        DiscordSendMessage(String.Format(lang.GetMessage("CONSOLE_REPORT_REMOVE", this), arg.Args[1], arg.Args[2], ReportInformation[ulong.Parse(arg.Args[1])].ReportCount));
                        return;
                    }             
            }
        }
        ...
        private new void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["UI_ALERT_TITLE"] = "You've been called in for a checkup!",
                ["UI_ALERT_DESCRIPTION"] = "\nYou have reached the maximum number of complaints.\nSo moderation is the server owes you a check! Please provide Discord.\n In case of ignoring this message - you will get a lock!",
                ["UI_ALERT_DESCRIPTION_COMMAND"] = "To provide the data,use the command :\n/discord\next you will contact the moderator",
        ...
        void UI_PlayerInterface(BasePlayer player)
        {
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.01979169 0.07777782", AnchorMax = "0.9786458 0.8694" },
        ...
        void UI_PlayerAlert(BasePlayer suspect)
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 0.2311112", AnchorMax = "1 0.7733" },
        ...
        void UI_ModerationInterface(BasePlayer moderator)
        {
            ...
            foreach (var PList in BasePlayer.activePlayerList)
            {
                ...
                if (InfoData.ReportCount >= config.Setting.MaxReport)
                {
                    ...
                    container.Add(new CuiButton
                    {
                        RectTransform = { AnchorMin = $"{0.004252315 + (x * 0.14)} {0.9163501 - (y * 0.1)}", AnchorMax = $"{0.1385117 + (x * 0.14)} {0.9922839 - (y * 0.1)}" },
        ...
        void UI_ModerationDetalicInfo(BasePlayer moderator, ulong SuspectID)
        {
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.01979169 0.09351294", AnchorMax = "0.9786458 0.3777294" },
                Image = { Color = HexToRustFormat("#0000001B") }
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.1634981 0.8143322", AnchorMax = "0.3025529 0.9153294" },
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.1634981 0.3159608", AnchorMax = "0.4899294 0.4267092" },
        ...
        void DiscordSendMessage(string key, ulong userID = 0, params object[] args)
        {
            ...
            FancyMessage newMessage = new FancyMessage(null, true, new FancyMessage.Embeds[1] { new FancyMessage.Embeds(null, 635133, fields, new Authors("IQReportSystem", "", "https://i.imgur.com/ILk3uJc.png", null), new Footer("", "https://i.imgur.com/ILk3uJc.png", null)) });
