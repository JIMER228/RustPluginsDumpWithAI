...
{
    /* Плагин был разыгран в RUST EDIT PRO https://discord.gg/8CWJadmA5w */  [Info("TPReportSystem", "https://discord.gg/8CWJadmA5w", "1.0.7‌﻿‌​‍‍")]
    class TPReportSystem : RustPlugin
    {
        ...
        void OnServerInitialized() {
            ...
            ImageLibrary.Call("AddImage", "https://imgur.com/b6wyl5i.png", "b6wyl5i");
            ImageLibrary.Call("AddImage", "https://imgur.com/lamC17G.png", "lamC17G");
            ImageLibrary.Call("AddImage", "https://imgur.com/HoGCxnN.png", "HoGCxnN");
            ImageLibrary.Call("AddImage", "https://imgur.com/DA7OETZ.png", "DA7OETZ");
            ...
            if (player != null && args.HasArgs(1))
            {
                ...
                if (args.Args[0] == "check")
                {
                    ...
                    if (db.Enable == false)
                    {
		                ...
		                SendDiscord(config.WebhookNotify, fields, new Authors(player.displayName, "", "", ""), config.Color);
                        SendReply(target, "Вас вызвали на проверку, предоставте свой дискорд /contact 'дискорд'");
                    }
                    else
                    {
                ...
                {
                    if (!permission.UserHasPermission(player.UserIDString, config.Perm)) return;
                    Server.Command($"ban {ulong.Parse(args.Args[1])} {args.Args[2]}");
                }
            }
        }
        #endregion
