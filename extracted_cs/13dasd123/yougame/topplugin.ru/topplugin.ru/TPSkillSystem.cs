...
﻿namespace Oxide.Plugins
{
   ...
   /* Плагин был разыгран в RUST EDIT PRO https://discord.gg/8CWJadmA5w */   [Info("TPSkillSystem", "https://discord.gg/8CWJadmA5w", "1.0.7‌﻿‌​‍‍")]
            ...
            if (ent) {
                foreach (var check in PlayersSkillDataMassiv[entity.OwnerID]) {
                    if (check.Name == "Защитник") {
                        float procent = (float) check.Level * check.PercentIncrement / 100;
