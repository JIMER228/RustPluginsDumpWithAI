...
{
    [Info("IQEconomic", "Forum: https://topplugin.ru Ds: alone_sempai Vk: https://vk.com/rustnastroika", "1.0.5")]
    ...
    public class IQEconomic : RustPlugin
    {
        ...
        /// Plans :
        /// TODO: Убрать создание дата-файла в случае если все функции отключены, лимиты, UI, включена физическая монета
        //  TODO: Добавить кд на обмен
        /// </summary>
        ...
        private class Configuration
        {
            ...
            internal class ExchangerSetting
            {
                ...
                {
                    if (_.orderedListExchanged.Count < 1)
