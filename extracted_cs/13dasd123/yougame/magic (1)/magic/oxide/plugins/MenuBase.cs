...
{
	[Info("MenuBase", "Forum: https://topplugin.ru Ds: alone_sempai Vk: https://vk.com/rustnastroika", "1.0.5")]
	class MenuBase : RustPlugin
	{
			...
			var config = new ConfigData
			{
				BaseSettings = new()
				{
					...
					Sections = new()
					{
						...
						["alertraid"] = new()
						{
							LangKey = "section_alertraid",
							Order = 5,
							Command = "mb.alert.open"
						}
					}
				},
				MainSettings = new()
		...
		private void LoadDefaultMessages()
		{
			...
			lang.RegisterMessages(new Dictionary<string, string>
			{
				...
				["section_case"] = "КЕЙСЫ",
				["section_kits"] = "НАБОРЫ",
				["section_alertraid"] = "ОПОВЕЩЕНИЯ О РЕЙДЕ",
