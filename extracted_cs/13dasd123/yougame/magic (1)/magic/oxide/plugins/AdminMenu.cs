...
{
    [Info("AdminMenu", "Forum: https://topplugin.ru Ds: alone_sempai Vk: https://vk.com/rustnastroika", "1.0.5")]
    class AdminMenu : ChaosPlugin
    {
        ...
        private void CreateGroupMenu(UIUser uiUser, BaseContainer parent)
        {
	        ...
	        if (!Configuration.AlternateUI)
	        {
		        CreateSelectionHeader(uiUser, parent, FormatString("Label.ViewGroups", uiUser.Player, StripPlayerName(uiUser.PermissionTargetName)), m_ListLayout.HasNextPage(uiUser.Page, dst.Count), uiUser.Page > 0, false, true);
        ...
        private void CreatePermissionsMenu(UIUser uiUser, BaseContainer parent)
        {
	        ...
	        else
	        {
		        ...
		        if (!Configuration.AlternateUI)
		        {
			        BaseContainer header = CreateSelectionHeader(uiUser, parent, FormatString("Label.TogglePermission", uiUser.Player, StripPlayerName(uiUser.PermissionTargetName)), m_ListLayout.HasNextPage(uiUser.Page, dst.Count), uiUser.Page > 0, false);
