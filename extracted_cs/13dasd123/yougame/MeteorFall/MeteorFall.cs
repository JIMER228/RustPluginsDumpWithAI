...
namespace Oxide.Plugins
{
    ...
    class MeteorFall : RustPlugin
    {
        ...
        private void StartRainOfFire(Vector3 origin)
        {
            ...
            for (int i = 0; i < 21; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    RustMap?.Call("AddTemporaryMarker", "meteor", false, 0.03f, 0.95f, met.transform, "Метеорит");
                ...
                {
                    posy = i - (i - UnityEngine.Random.Range(0.05f, 0.1f));
                    posx = i - (i - UnityEngine.Random.Range(-0.5f, +0.5f));
                    posz = i - (i - UnityEngine.Random.Range(-05f, +0.5f));
                    pref = prefabOsn[rnd.Next(prefabOsn.Count)];
        ...
        private void CreatePrivateMap(Vector3 pos)
        {
            ...
            MarkerT.markerShopName = "<size=22>Метеорит</size>";
