...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("VoteMap", "https://discord.gg/dNGbxafuJn", "1.1.4")]
    [Description("Let players pick map for the next wipe.")]
    ...
    {   
        ...
        [PluginReference] Plugin ImageLibrary, WipeCountdown;
        ...
        {   
            ...
            int apiCmd = 0;
            if (api) { mainPanel = "imagePanel"; apiCmd = 1;}
        ...
        {   
            ...
            if (api) { mainPanel = "imagePanel"; apiCmd = 1; height[0] = "0.2"; height[1] = "0.85";}
