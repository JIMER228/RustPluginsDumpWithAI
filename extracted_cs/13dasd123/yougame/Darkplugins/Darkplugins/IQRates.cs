...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("IQRates", "https://discord.gg/dNGbxafuJn", "1.5.14")]
    ...
    class IQRates : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {                       
                PrintWarning(LanguageEn ? "Error #35613343" + $"read configuration 'oxide/config/{Name}', create a new configuration!!" : "Ошибка #3561343" + $"чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!!"); //#333
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
        ...
        /// Обновление 1.5.13
        /// - Исправлено когда пропадал аирдроп при вызове через шашку
        /// - Исправлен вызов аирдропа на большом экскаваторе
        /// - Исправлены печки после обновления игры
        /// - Исправлено зацикленное сжигание дерева в печах при их переполнении
        /// - Добавлена возможность детальной настройки рейтинга для карьера (установить рейтинг для определенного предмета во время добычи (по умолчанию берется общиий рейтинг карьера)
        /// - Добавлено API на выдачу бонусного рейтинга для всех категорий - void API_BONUS_RATE_ADDPLAYER(BasePlayer player, Single Rate) - к рейтингу будет прибавлять бонус
