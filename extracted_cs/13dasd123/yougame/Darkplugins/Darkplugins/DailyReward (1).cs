...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("DailyReward", "https://discord.gg/dNGbxafuJn", "1.0.1")]
    ...
    public class DailyReward : RustPlugin
    {
        ...
        private int DefaultMoney = 5;
        [JsonProperty("Максимальное пополнение за раз")]
        private int MaxDeposit = 40;
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            Config["Награда - стартовый баланс за первый день"] = DefaultMoney = GetConfig("Награда - стартовый баланс за первый день", 5);
            Config["Защита от слишком большого пополнения"] = MaxDeposit = GetConfig("Защита от слишком большого пополнения", 40);
