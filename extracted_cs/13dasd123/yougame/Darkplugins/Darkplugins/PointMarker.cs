...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("PointMarker", "https://discord.gg/dNGbxafuJn", "0.0.1")]
    public class PointMarker : RustPlugin
    {
        ...
        {
            [JsonProperty("Интервал обновления, не рекомендуется ставить ниже чем 0.00{DarkPluginsID}")]
