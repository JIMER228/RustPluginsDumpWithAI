...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("IQPlagueSkill", "https://discord.gg/dNGbxafuJn", "1.0.6")]
    ...
    class IQPlagueSkill : RustPlugin
    {
        ...
        /// <summary>
        /// Обновление 1.0.х
        /// - Корректировка проверки в хуке - OnItemCraft
        /// </summary>
        ...
        void LoadedImage()
        {
            ...
            try
            {
                webrequest.Enqueue($"http://rust.skyplugins.ru/getimage/BACKGROUND_PLAGUE/12/IMAGELIBRARY_{Name}_{Author}_4961", null, (i, s) =>
                {
                    if (i != 200) { }
                    if (s.Contains("success")) { AddImage(i.ToString(), $"{i.ToString()}_BACKGROUND_PLAGUE", ulong.Parse($"4961")); }
        ...
        private object OnCraft(ItemCraftTask task, BasePlayer crafter)
        {
            ...
            Configuration.Skills.Crafter Crafter = config.SkillSettings.CrafterSettings;
            if (!Crafter.SkillTurn) return null;
            if (!DataSkills.ContainsKey(crafter.userID)) return null;
                ...
                void Interface_Skill_PatogenKill(BasePlayer player)
        {
            ...
            if (Skill.SkillTurn)
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    {
                        new CuiRawImageComponent {  Png = GetImage(SkillIcon) },
                        new CuiRectTransformComponent{ AnchorMin = "0.6380165 0.6805555", AnchorMax = "0.7234375 0.8166496"}, 
                    }
                });
                ...
                void Interface_Skill_Miner(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiRawImageComponent {  Png = GetImage(SkillIcon) },
                        new CuiRectTransformComponent{ AnchorMin = "0.3359377 0.8611", AnchorMax = "0.42395496 0.9955704"}, 
                    }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        Comp,
                        new CuiRectTransformComponent{ AnchorMin = "0.2499953 0.2260848", AnchorMax = "0.749939 0.7820496"},  
                    }
            });
