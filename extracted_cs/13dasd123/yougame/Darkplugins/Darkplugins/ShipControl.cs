...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("ShipControl", "https://discord.gg/dNGbxafuJn", "0.0.2")]
    [Description("Плагин на контроль корабля. Куплено на whiteplugins.ru")]
