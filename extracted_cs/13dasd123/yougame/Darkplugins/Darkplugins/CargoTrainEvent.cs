...
{
    [Info("CargoTrainEvent", "Sempai#3239", VERSION)]
    ...
    public class CargoTrainEvent : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            SpecialTrain.TrainDriverNetIDToSpecialTrain = new Dictionary<uint, SpecialTrain>();

            SpecialTrain.TrainNetIDToSpecialTrain = new Dictionary<uint, SpecialTrain>();
            SpecialTrain.TrainNetIDToTrainEngine = new Dictionary<uint, TrainEngine>();
            SpecialTrain.WorkcartEntityNetIDToSpecialTrain = new Dictionary<uint, SpecialTrain>();
        ...
        private void OnEntitySpawned(TrainEngine train)
        {
            ...
            SpecialTrain.TrainNetIDToTrainEngine.Add(train.net.ID, train);
        ...
        private void OnCrateHack(HackableLockedCrate crate)
        {
            ...
            if (!SpecialTrain.WorkcartEntityNetIDToSpecialTrain.ContainsKey(crate.net.ID)) return;


            SpecialTrain.WorkcartEntityNetIDToSpecialTrain[crate.net.ID].OnCrateHack(crate);

            Interface.CallHook("OnTrainCrateHack", SpecialTrain.WorkcartEntityNetIDToSpecialTrain[crate.net.ID].Train, crate);
        ...
        {
            if (Instance == null) return null;
            if (!SpecialTrain.TrainDriverNetIDToSpecialTrain.ContainsKey(player.net.ID))
            {
                return null;
            }
        ...
        private object OnTurretTarget(AutoTurret turret, ScientistNPC target)
        {
            ...
            if (SpecialTrain.WorkcartEntityNetIDToSpecialTrain.ContainsKey(target.net.ID))
            {
                return false;
            }
        ...
        private object CanHelicopterTarget(PatrolHelicopterAI heli, BasePlayer target)
        {
            ...
            if (SpecialTrain.TrainDriverNetIDToSpecialTrain.ContainsKey(target.net.ID))
            {
                return false;
            }
        ...
        private object OnNpcTarget(BaseNpc attacker, BasePlayer target)
        {
            ...
            if (SpecialTrain.TrainDriverNetIDToSpecialTrain.ContainsKey(attacker.net.ID))
            {
                return true;
            }
            ...
            bool attackerIsSpecial = SpecialTrain.WorkcartEntityNetIDToSpecialTrain.ContainsKey(attacker.net.ID) || SpecialTrain.TrainDriverNetIDToSpecialTrain.ContainsKey(attacker.net.ID);
            bool targetIsSpecial = SpecialTrain.WorkcartEntityNetIDToSpecialTrain.ContainsKey(target.net.ID) || SpecialTrain.TrainDriverNetIDToSpecialTrain.ContainsKey(target.net.ID);
        ...
        private void OnEntityKill(BaseEntity entity)
        {
            ...
            if (!SpecialTrain.WorkcartEntityNetIDToSpecialTrain.ContainsKey(entity.net.ID)) return;

            //remove the entity from your stuff

            SpecialTrain.WorkcartEntityNetIDToSpecialTrain[entity.net.ID].RemoveWorkcartEntity(entity.net.ID);
        ...
        private void OnEntityKill(TrainEngine train)
        {
            ...
            SpecialTrain.TrainNetIDToTrainEngine.Remove(train.net.ID);


            if (IsTrainSpecial(train.net.ID))
            {
                MakeTrainNormal(train.net.ID);
            }
        ...
        private object OnPlayerDeath(BasePlayer player, HitInfo info)
        {
            ...
            return SpecialTrain.TrainDriverNetIDToSpecialTrain[player.net.ID].OnTrainDriverKilled(info);
        }
        ...
        private object OnEntityTakeDamage(BaseCombatEntity combatEntity, HitInfo info)
        {
            ...
            if (SpecialTrain.WorkcartEntityNetIDToSpecialTrain.ContainsKey(combatEntity.net.ID))
            {
                return SpecialTrain.WorkcartEntityNetIDToSpecialTrain[combatEntity.net.ID].OnTrainEntityTakeDamage(combatEntity, info);
            }

            if (SpecialTrain.TrainDriverNetIDToSpecialTrain.ContainsKey(combatEntity.net.ID))
            {
                return SpecialTrain.TrainDriverNetIDToSpecialTrain[combatEntity.net.ID].OnTrainEntityTakeDamage(combatEntity, info);
            }
        ...
        {
            if (Instance == null) return null;
            if (SpecialTrain.TrainNetIDToSpecialTrain.ContainsKey(train.net.ID))
            {
                return SpecialTrain.TrainNetIDToSpecialTrain[train.net.ID].OnTrainEntityTakeDamage(train, info);
            }
        ...
        private object OnFuelAbstract(EntityFuelSystem fuelSystem, object returnOnSuccess)
        {
            ...
            if (!SpecialTrain.TrainNetIDToSpecialTrain.ContainsKey(fuelSystem.owner.net.ID))
            {
                return null;
            }
            ...
            if (!SpecialTrain.TrainNetIDToSpecialTrain[fuelSystem.owner.net.ID].DriverIsAlive)
            {
                return null;
            }
        ...
        */
        ...
        public class SpecialTrain : MonoBehaviour
        {
            ...
            public static Dictionary<uint, SpecialTrain> TrainDriverNetIDToSpecialTrain;

            //only special trains here
            public static Dictionary<uint, SpecialTrain> TrainNetIDToSpecialTrain;

            //all trains here for fast lookup
            public static Dictionary<uint, TrainEngine> TrainNetIDToTrainEngine;

            public static Dictionary<uint, SpecialTrain> WorkcartEntityNetIDToSpecialTrain;
            ...
            public Dictionary<uint, BaseEntity> WorkcartEntityNetIDToEntity = new Dictionary<uint, BaseEntity>();
            public Dictionary<uint, IOEntity> WorkcartIOEntityNetIDPoweredImmediately = new Dictionary<uint, IOEntity>();
            public Dictionary<uint, IOEntity> WorkcartIOEntityNetIDPoweredOnSelfDestruct = new Dictionary<uint, IOEntity>();
            public Dictionary<uint, CCTV_RC> WorkcartCCTVNetIDToCCTV = new Dictionary<uint, CCTV_RC>();
            ...
            public void Prepare(TrainEngine train)
            {
                ...
                this.TrainDriverNetID = TrainDriver.net.ID;
            ...
            public object OnTrainEntityTakeDamage(BaseCombatEntity entity, HitInfo info)
            {
                ...
                if (_htnPlayer != null)
                {
                    ...
                    bool isDriver = TrainDriverNetIDToSpecialTrain.ContainsKey(entity.net.ID);
                ...
                {
                    if (WorkcartEntityNetIDToEntity.ContainsKey(info.Initiator.net.ID))
                    {
            ...
            */
                ...
                else
                {
                    ...
                    if (_maybeElectricStuff != null)
                    {
                        if (powerImmediately)
                        {
                            ...
                            WorkcartIOEntityNetIDPoweredImmediately.Add(_maybeElectricStuff.net.ID, _maybeElectricStuff);
                        }
                        else
                        {
                            WorkcartIOEntityNetIDPoweredOnSelfDestruct.Add(_maybeElectricStuff.net.ID, _maybeElectricStuff);
                        }
                        ...
                        if (Instance.configData.CamerasAreFunctional)
                        {
                            ...
                            if (maybeCCTV != null)
                            {
                                ...
                                WorkcartCCTVNetIDToCCTV.Add(maybeCCTV.net.ID, maybeCCTV);
                            }
                        }
            ...
            public void CreateWorkcartEntity(WorkcartEntityDefinition definition)
            {
                try
                {
                    ...
                    WorkcartEntityNetIDToSpecialTrain.Add(_newWorkcartEntity.net.ID, this);
                    WorkcartEntityNetIDToEntity.Add(_newWorkcartEntity.net.ID, _newWorkcartEntity);
                }
                catch (Exception e)
                {
            ...
            public void RemoveWorkcartEntity(uint entityNetID)
            {
            ...
            public void PowerIOEntityOn(IOEntity entity)
            {
                ...
                if (WorkcartCCTVNetIDToCCTV.ContainsKey(entity.net.ID))
                {
                    var cctv = WorkcartCCTVNetIDToCCTV[entity.net.ID];
                }
            }
        ...
        private bool IsTrainSpecial(uint trainNetID)
        {
        ...
        private bool MakeTrainNormal(uint trainNetID)
        {
