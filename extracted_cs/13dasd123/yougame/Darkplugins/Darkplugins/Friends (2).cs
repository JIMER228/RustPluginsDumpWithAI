...
{
	/*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("Friends", "https://discord.gg/dNGbxafuJn", "1.0.7")]
	class Friends : RustPlugin
    {
		...
		{
			var message = GetLangMessage(key, player != null ? player.UserIDString : null);
		...
		private bool AreFriends(string playerS, string friendS) => AreFriendsS(playerS, friendS);
