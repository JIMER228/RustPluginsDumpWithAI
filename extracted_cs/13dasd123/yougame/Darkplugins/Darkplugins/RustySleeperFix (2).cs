...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("RustySleeperFix", "https://discord.gg/dNGbxafuJn", "0.21.199")]
    class RustySleeperFix : RustPlugin
    {
        ...
        private void OnPlayerRespawned(BasePlayer player)
        {
            ...
            RaycastHit info;
            if (Physics.Raycast(player.transform.position, Vector3.down, out info, 1.0f))
            {
