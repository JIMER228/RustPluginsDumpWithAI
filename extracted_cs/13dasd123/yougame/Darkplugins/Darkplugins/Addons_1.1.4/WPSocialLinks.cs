...
{
    [Info("WPSocialLinks", "Sempai#3239", "1.1.4")]
    ...
    {   
        ...
        {
            var _wipeCycleUI = CUIClass.CreateOverlay("main", "0 0 0 0.0", "0 0", "0 0", true, 0.0f, $"assets/icons/iconmaterial.mat");
            //TITLE
            CUIClass.CreateText(ref _wipeCycleUI, "text_title", "imagePanel", "1 1 1 1", config.otherSet.topTitleText, 15, "0 0.84", "1 1", TextAnchor.MiddleCenter, $"robotocondensed-bold.ttf", config.otherSet.fontOutlineColor, $"{config.otherSet.fontOutlineThickness} {config.otherSet.fontOutlineThickness}");
            //PANEL 1 
            if (config.panel1.enabled)
            {
                CUIClass.CreatePanel(ref _wipeCycleUI, "div_panel1", "imagePanel", config.panel1.mainColor, _p["p1_Amin"], _p["p1_Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            {
                CUIClass.CreatePanel(ref _wipeCycleUI, "div_panel2", "imagePanel", config.panel2.mainColor, _p["p2_Amin"], _p["p2_Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            {
                CUIClass.CreatePanel(ref _wipeCycleUI, "div_panel3", "imagePanel", config.panel3.mainColor, _p["p3_Amin"], _p["p3_Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            {
                CUIClass.CreatePanel(ref _wipeCycleUI, "div_panel4", "imagePanel", config.panel4.mainColor, _p["p4_Amin"], _p["p4_Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            {
                CUIClass.CreatePanel(ref _wipeCycleUI, "div_panel5", "imagePanel", config.panel5.mainColor, _p["p5_Amin"], _p["p5_Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            {
                CUIClass.CreatePanel(ref _wipeCycleUI, "div_panel6", "imagePanel", config.panel6.mainColor, _p["p6_Amin"], _p["p6_Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            //FOOTER
            CUIClass.CreateText(ref _wipeCycleUI, "text_footer", "imagePanel", "1 1 1 1", config.otherSet.footerText, 15, "0 0.0.5", "1 0.17", TextAnchor.MiddleCenter, $"robotocondensed-bold.ttf", config.otherSet.fontOutlineColor, $"{config.otherSet.fontOutlineThickness} {config.otherSet.fontOutlineThickness}");
            //end
            ...
            public static Configuration CreateConfig()
            {
                ...
                {   
                    ...
                    {   
                        ...
                        footerText = "By following us on social media you can get various rewards.",
