...
{
    [Info("WPWipeCycle", "Sempai#3239", "1.1.4")]
    ...
    {   
        ...
        private void ShowWipeCycle_API(BasePlayer player)
        {
            ...
            //MAP WIPE PANEL 
            CUIClass.CreatePanel(ref _wipeCycleUI, "div_mapwipe", "imagePanel", config.mapWipe.mainColor, _mw["Amin"], _mw["Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            //BP WIPE PANEL
            CUIClass.CreatePanel(ref _wipeCycleUI, "div_bpWipe", "imagePanel", config.bpWipe.mainColor, _bw["Amin"], _bw["Amax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
            ...
            CUIClass.CreatePanel(ref _wipeCycleUI, "div_wipeCountdown", "imagePanel", config.bpWipe.mainColor, _cd["cdAmin"], _cd["cdAmax"], false, 0f, "assets/content/ui/uibackgroundblur.mat");
