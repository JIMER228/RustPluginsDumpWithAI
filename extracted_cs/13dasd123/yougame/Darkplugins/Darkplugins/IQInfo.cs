...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("IQInfo", "https://discord.gg/dNGbxafuJn", "0.0.24")]
    ...
    class IQInfo : RustPlugin
    {
				...
				private void InterfaceCategory(BasePlayer player, Int32 Page = 0, Int32 SelectedIndex = 0)
		{
			...
			container.Add(new CuiPanel
			{
				CursorEnabled = false,
				Image = { Color = "0 0 0 0" },
				RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-515.822262 -267.0150", OffsetMax = "-328.129262 179.3130" } 
	    ...
	    /// <summary>
	    /// - Исправил отрисовку UI-при входе (иногда не отрисовывался задний фон)
	    /// </summary>
        ...
        private void HideTurned(BasePlayer player)
		{
			...
			container.Add(new CuiElement
			{
				...
				Components = {
					...
					new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-411.1 -350.895", OffsetMax = "-395.1 -334.895" }
				}
			});
                ...
                private void InterfaceMenu(BasePlayer player)
		{
			...
			container.Add(new CuiElement
			{
				...
				Components = {
					...
					new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-522 -350", OffsetMax = "-505 -334" }
				}
			});
		...
		private void InterfaceContent(BasePlayer player, Int32 IndexCategory = 0, Int32 Page = 0)
		{
			...
			if (!Lines.UseImage)
			{
				...
				foreach (String TextLine in Lines.TextLines.Take(25))
				{
					...
					new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-397.4260262 {183.13 + (-20 * Line)}", OffsetMax = $"397.434262 {211.01 + (-20 * Line)}" } // 
				}
					});
					Line++;
				}
