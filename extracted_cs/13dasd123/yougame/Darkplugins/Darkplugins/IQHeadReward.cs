...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("IQHeadReward", "https://discord.gg/dNGbxafuJn", "1.0.9")]
    ...
    class IQHeadReward : RustPlugin
    {
        ...
        void ShowPlayerPanel(BasePlayer player, CuiElementContainer container, Int32 Count, HeadTask Heads, String AnchorMin, String AnchorMax)
        {
            ...
            if (Wanted != null)
            {
                container.Add(new CuiElement
                {
                    ...
                    Parent = "AVATAR_TASK",
                    Components = {
                    new CuiTextComponent { Text = $"<b>{Wanted.displayName}</b>", Font = "robotocondensed-regular.ttf", FontSize = 17, Align = TextAnchor.LowerCenter, Color = "0.850980449 0.764706 0.5843138 1" },
                    new CuiOutlineComponent { Color = "0 0 0 0.5", Distance = "1 -1" },
        ...
        void Created_Head_Task(BasePlayer player, Boolean Rehead = false)
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = true,
                Image = { FadeIn = 0.15f, Color = HexToRustFormat("#00000096"), Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 0.008", OffsetMax = "-0.004449 0" }
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = "590.68 -65.3120449", OffsetMax = "0.005 -20.368" }
                }
            });
