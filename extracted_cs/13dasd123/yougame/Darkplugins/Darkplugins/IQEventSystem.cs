...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("IQEventSystem", "https://discord.gg/dNGbxafuJn", "0.0.2")]
    ...
    class IQEventSystem : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {
                PrintWarning("Ошибка #132417" + $"чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!!");
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
        ...
        public void UIEvent(BasePlayer player, int IndexEvent)
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.775641 0", AnchorMax = "1 0.9074417" },
                ...
                private new void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["EVENT_VOTES_BTN"] = "<size=14><b>Сейчас начнется мероприятие!\nЧтобы принять участие,нажмите на эту кнопку</b></size>",
