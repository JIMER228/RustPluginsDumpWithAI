...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("SkyReportSystem", "https://discord.gg/dNGbxafuJn", "1.5.3")]
    ...
    public class SkyReportSystem : RustPlugin
    {
        ...
        protected override void LoadDefaultConfig()
        {
            config = new Configuration()
            {
                ...
                {
                    ["reason_1"] = "3+",
                    ["reason_2"] = "Подозрения в читах",
                    ["reason_3"] = "Макросы",
                    ["reason_4"] = "Реклама в нике",
                    ["reason_5"] = "Спам в чат",
                    ["reason_6"] = "Обман игроков",
                    ["reason_7"] = "Багоюз",
                    ["reason_8"] = "Токсик",
                }
                ...
                if (reason == "")
                {
                    ...
                    foreach (var check in config.Reasonsforcomplaint)
                    {
                        container.Add(new CuiButton
                        {
                            ...
                            Button = { Command = $"SkyReportGo {target.Replace(" ", "").Replace(" ", "").Replace(" ", "")} {check.Key}", Color = "0 0 0 0.7", Close = "buttoncap" + "infotxt2", Material = "assets/content/ui/uibackgroundblur.mat", FadeIn = 0.4f },
