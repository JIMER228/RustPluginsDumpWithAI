...
namespace Oxide.Plugins {
	/*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("LimitedTurrets", "https://discord.gg/dNGbxafuJn", "1.0.1")]
	...
	class LimitedTurrets : RustPlugin {
		...
		public void ShowUIPanel(BasePlayer player) {
			...
			container.Add(new CuiButton
			{
				...
				Button = {Color = "0 0 0 0", Close = "LTUIPanel"},
				Text =
				{
		...
		void CheckTurret(BaseEntity entity) {
			...
			SendReply(player, $"Количество размещенных '{turretTypes[type]}' уменьшилось!\n{(sum <= 0 ? "Больше установить нельзя!" : "Можно установить еще " + sum)}");
		}
