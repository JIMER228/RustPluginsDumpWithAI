...
{
    [Info("HarborEvent", "Sempai#3239", "2.0.7")]
    internal class HarborEvent : RustPlugin
    {
        ...
        private void UpdateConfigValues()
        {
            ...
            if (_config.PluginVersion < new VersionNumber(2, 0, 6))
            {
                ...
                foreach (PresetConfig preset in _config.NpcSmall) foreach (NpcBelt belt in preset.Config.BeltItems) belt.Ammo = string.Empty;
                foreach (PresetConfig preset in _config.NpcLarge) foreach (NpcBelt belt in preset.Config.BeltItems) belt.Ammo = string.Empty;
            }
            _config.PluginVersion = Version;
        ...
        {
            [JsonProperty(En ? "Do you take actions during the loot of a locked crate? [true/false]" : "Выполнять действия при ограблении заблокированного ящика? [true/false]")] public bool IsReinforcement { get; set; }
            [JsonProperty(En ? "A list of commands that are executed in the console ({steamid} - the player who looted the crate)" : "Список команд, которые выполняются в консоли ({steamid} - игрок, который ограбил ящик)")] public HashSet<string> Commands { get; set; }
            [JsonProperty(En ? "Calling a patrol helicopter to a locked crate?" : "Вызывать вертолет к заблокированному ящику? [true/false]")] public bool CallHeli { get; set; }
        }
        ...
        private class PluginConfig
        {
            ...
            [JsonProperty(En ? "Crates setting in Small Harbor" : "Настройка ящиков в Малом Порту")] public HashSet<CrateConfig> DefaultCratesSmall { get; set; }
            [JsonProperty(En ? "Crates setting in Large Harbor" : "Настройка ящиков в Большом Порту")] public HashSet<CrateConfig> DefaultCratesLarge { get; set; }
            ...
            [JsonProperty(En ? "Can Bradley appear in the event zone? [true/false]" : "Должен ли появляться Bradley в зоне ивента? [true/false]")] public bool IsBradley { get; set; }
            ...
            [JsonProperty(En ? "NPCs setting in Small Harbor" : "Настройка NPC в Малом Порту")] public HashSet<PresetConfig> NpcSmall { get; set; }
            [JsonProperty(En ? "NPCs setting in Large Harbor" : "Настройка NPC в Большом Порту")] public HashSet<PresetConfig> NpcLarge { get; set; }
            ...
            [JsonProperty(En ? "The time between the appearance of the ship and its turn to normal (if the ship does not turn to the required position, then it is necessary to increase this parameter) [sec.]" : "Время между появлением корабля и его разворотом в нормальное состояние (если корабль не поворачивается в необходимое положение, то необходимо повысить данный параметр) [sec.]")] public float DelayRotateCargo { get; set; }
            [JsonProperty(En ? "Actions during the loot of a locked crate in a container" : "Действия при ограблении заблокированного ящика в контейнере")] public ReinforcementConfig ReinforcementHackCrateContainer { get; set; }
            [JsonProperty(En ? "Actions during the loot of locked Crates on a ship" : "Действия при ограблении заблокированных ящиков на корабле")] public ReinforcementConfig ReinforcementHackCrateShip { get; set; }
            ...
            public static PluginConfig DefaultConfig()
            {
                return new PluginConfig()
                {
                    ...
                    DefaultCratesSmall = new HashSet<CrateConfig>
                    {
                        new CrateConfig
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_elite.prefab",
                            Position = "(34.027, 14.465, 104.138)",
                            Rotation = "(0, 270, 0)",
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_elite.prefab",
                            Position = "(33.977, 14.465, 107.138)",
                            Rotation = "(0, 270, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        new CrateConfig
                        {
                            ...
                            Position = "(33.989, 15.096, 104.130)",
                            Rotation = "(0, 270, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_normal.prefab",
                            Position = "(33.989, 15.096, 107.130)",
                            Rotation = "(0, 270, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        new CrateConfig
                        {
                            ...
                            Position = "(35.884, 14.443, 104.104)",
                            Rotation = "(0, 180, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                                Max = 1,
                                UseCount = true,
                                Prefabs = new List<PrefabConfig> { new PrefabConfig { Chance = 50.0f, PrefabDefinition = "assets/bundled/prefabs/radtown/dmloot/dm c4.prefab" } }
                            },
                            OwnLootTable = new LootTableConfig
                            {
                                Min = 1,
                        ...
                        new CrateConfig
                        {
                            ...
                            Position = "(35.884, 14.443, 107.105)",
                            Rotation = "(0, 180, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                                Max = 1,
                                UseCount = true,
                                Prefabs = new List<PrefabConfig> { new PrefabConfig { Chance = 50.0f, PrefabDefinition = "assets/bundled/prefabs/radtown/dmloot/dm ammo.prefab" } }
                            },
                            OwnLootTable = new LootTableConfig
                            {
                                Min = 1,
                    ...
                    DefaultCratesLarge = new HashSet<CrateConfig>
                    {
                        new CrateConfig
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_elite.prefab",
                            Position = "(114.944, 17.373, -26.621)",
                            Rotation = "(0, 90, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_elite.prefab",
                            Position = "(114.944, 17.373, -29.621)",
                            Rotation = "(0, 90, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_normal.prefab",
                            Position = "(114.982, 18.004, -26.613)",
                            Rotation = "(0, 90, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/crate_normal.prefab",
                            Position = "(114.982, 18.004, -29.613)",
                            Rotation = "(0, 90, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/dmloot/dm c4.prefab",
                            Position = "(113.087, 17.351, -26.587)",
                            Rotation = "(0, 0, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                        ...
                        {
                            Prefab = "assets/bundled/prefabs/radtown/dmloot/dm ammo.prefab",
                            Position = "(113.087, 17.351, -29.589)",
                            Rotation = "(0, 0, 0)",
                            PrefabLootTable = new PrefabLootTableConfig
                            {
                                Min = 1,
                    ...
                    LeavingShip = false,
                    DelayRotateCargo = 3f,
                    ReinforcementHackCrateContainer = new ReinforcementConfig
                    {
                        IsReinforcement = false,
                        Commands = new HashSet<string>(),
                        CallHeli = false
                    },
                    ReinforcementHackCrateShip = new ReinforcementConfig
                    {
                        IsReinforcement = false,
                        Commands = new HashSet<string>(),
                        CallHeli = false
        ...
        private void OnServerInitialized()
        {
            ...
            {
                if (monument.name.Contains("harbor_1")) StartLocations.Add(new Location { type = 1, pos = monument.transform.position, rot = monument.transform.rotation.eulerAngles });
                else if (monument.name.Contains("harbor_2")) StartLocations.Add(new Location { type = 2, pos = monument.transform.position, rot = monument.transform.rotation.eulerAngles });
            }
        ...
        private void OnEntityDeath(BasePlayer player, HitInfo info)
        {
            ...
            else if (_controller.Players.Contains(player))
            {
        ...
        private void CanHackCrate(BasePlayer player, HackableLockedCrate crate)
        {
            ...
            if (Vector3.Distance(crate.transform.position, _controller.transform.position) < Radius)
            {
        ...
        private void OnCrateHack(HackableLockedCrate crate)
        {
            ...
            if (_startHackCrates.TryGetValue(crateId, out playerId))
            {
                ...
                if (crate == _controller.HackCrate)
                {
                    ...
                    if (_config.ReinforcementHackCrateContainer.IsReinforcement)
                    {
                        foreach (string command in _config.ReinforcementHackCrateContainer.Commands) Server.Command(command.Replace("{steamid}", $"{playerId}"));
                        if (_config.ReinforcementHackCrateContainer.CallHeli)
                        {
                            AlertToAllPlayers("HeliArrive", _config.Prefix);
                            SpawnHelicopter(crate.transform.position);
                        }
                    }
                }
                else
                {
                    if (_config.ReinforcementHackCrateShip.IsReinforcement)
                    {
                        foreach (string command in _config.ReinforcementHackCrateShip.Commands) Server.Command(command.Replace("{steamid}", $"{playerId}"));
                        if (_config.ReinforcementHackCrateShip.CallHeli)
                        {
                            AlertToAllPlayers("HeliArrive", _config.Prefix);
                            SpawnHelicopter(crate.transform.position);
                        }
        ...
        private void Start()
        {
            ...
            {
                Interface.Oxide.CallHook("OnHarborEventStart");
                Subscribes();
                ...
                if (_config.PveMode.Pve && plugins.Exists("PveMode"))
                {
                    ...
                    HashSet<uint> crates = _controller.Crates.Select(x => x.net.ID);
                    crates.Add(_controller.HackCrate.net.ID);
                    PveMode.Call("EventAddPveMode", Name, config, _controller.transform.position, Radius, crates, _controller.Scientists.Select(x => x.net.ID), new HashSet<uint> { _controller.Bradley.net.ID }, new HashSet<ulong>(), null);
                }
        ...
        {
            Unsubscribes();
            if (_config.RemoveBetterNpc && plugins.Exists("BetterNpc")) BetterNpc.Call("CreateController", _controller.Type == 1 ? "Small Harbor" : "Large Harbor");
        ...
        internal class ControllerHarborEvent : FacepunchBehaviour
        {
            ...
            private void Awake()
            {
                ...
                SpawnCargo();
                if (_ins._config.IsBradley) SpawnBradley();
            ...
            {
                TimeToFinish--;
                if (_ins._config.Gui.IsGui) foreach (BasePlayer player in Players) _ins.CreateTabs(player, new Dictionary<string, string> { ["Clock_KpucTaJl"] = GetTimeFormat() });
            ...
            private void SpawnEntities()
            {
                foreach (Prefab prefab in Type == 1 ? _ins.PrefabsHarborSmall : _ins.PrefabsHarborLarge)
                {
                    ...
                    if (entity is DecayEntity && !(entity is SamSite)) (entity as DecayEntity).lifestate = BaseCombatEntity.LifeState.Dead;
            ...
            {
                foreach (CrateConfig crateConfig in Type == 1 ? _ins._config.DefaultCratesSmall : _ins._config.DefaultCratesLarge)
                {
                    Vector3 pos; Quaternion rot;
            ...
            {
                Vector3 pos; Quaternion rot;
                if (Type == 1) GetGlobal(transform, new Vector3(34.941f, 14.440f, 101.856f), new Vector3(0f, 0f, 0f), out pos, out rot);
                else GetGlobal(transform, new Vector3(114.030f, 17.348f, -24.339f), new Vector3(0f, 180f, 0f), out pos, out rot);
                HackCrate = GameManager.server.CreateEntity("assets/prefabs/deployable/chinooklockedcrate/codelockedhackablecrate.prefab", pos, rot) as HackableLockedCrate;
        ...
        private object CanPopulateLoot(LootContainer container)
        {
            ...
            else if (container == _controller.HackCrate)
            {
        ...
        private object OnCustomLootContainer(uint netID)
        {
            ...
            else if (_controller.HackCrate.IsExists() && _controller.HackCrate.net.ID == netID)
            {
        ...
        {
            foreach (CrateConfig crateConfig in _config.DefaultCratesSmall)
            {
                CheckLootTable(crateConfig.OwnLootTable);
                CheckPrefabLootTable(crateConfig.PrefabLootTable);
            }
            foreach (CrateConfig crateConfig in _config.DefaultCratesLarge)
            {
                CheckLootTable(crateConfig.OwnLootTable);
                CheckPrefabLootTable(crateConfig.PrefabLootTable);
            }
        ...
        {
            if (_controller == null) return null;
            if (Vector3.Distance(bradley.transform.position, _controller.transform.position) < Radius) return true;
            else return null;
        }
        ...
        {
            if (_controller == null) return null;
            if (Vector3.Distance(helicopter.transform.position, _controller.transform.position) < Radius) return true;
            else return null;
        }
        #endregion BetterNpc
        ...
        #region Helicopter
        private void SpawnHelicopter(Vector3 pos)
        {
            BaseHelicopter baseHelicopter = GameManager.server.CreateEntity("assets/prefabs/npc/patrol helicopter/patrolhelicopter.prefab", GetSpawnPos(pos)) as BaseHelicopter;
            PatrolHelicopterAI patrolHelicopterAi = baseHelicopter.GetComponent<PatrolHelicopterAI>();
            patrolHelicopterAi.SetInitialDestination(pos);
            baseHelicopter.enableSaving = false;
            baseHelicopter.Spawn();

            baseHelicopter.startHealth = _config.Helicopter.Hp;
            baseHelicopter.InitializeHealth(_config.Helicopter.Hp, _config.Helicopter.Hp);
            BaseHelicopter.weakspot[] weakspots = baseHelicopter.weakspots;
            ...
            baseHelicopter.maxCratesToSpawn = _config.Helicopter.CountCrates;

            patrolHelicopterAi.timeBetweenRockets = _config.Helicopter.TimeBetweenRockets;
            patrolHelicopterAi.leftGun.fireRate = patrolHelicopterAi.rightGun.fireRate = _config.Helicopter.FireRate;
            patrolHelicopterAi.leftGun.burstLength = patrolHelicopterAi.rightGun.burstLength = _config.Helicopter.BurstLength;
            patrolHelicopterAi.leftGun.timeBetweenBursts = patrolHelicopterAi.rightGun.timeBetweenBursts = _config.Helicopter.TimeBetweenBursts;
            patrolHelicopterAi.leftGun.maxTargetRange = patrolHelicopterAi.rightGun.maxTargetRange = _config.Helicopter.MaxTargetRange;
        }
        ...
        private static Vector3 GetSpawnPos(Vector3 pos)
        {
            ...
            {
                new Vector3(-World.Size / 2, 200f, -World.Size / 2),
                new Vector3(World.Size / 2, 200f, World.Size / 2),
                new Vector3(-World.Size / 2, 200f, World.Size / 2),
                new Vector3(World.Size / 2, 200f, -World.Size / 2),
                new Vector3(0f, 200f, World.Size / 2),
                new Vector3(0f, 200f, -World.Size / 2),
                new Vector3(World.Size / 2, 200f, 0f),
                new Vector3(-World.Size / 2, 200f, 0f)
            };
            return positions.Min(x => Vector3.Distance(x, pos));
        }
