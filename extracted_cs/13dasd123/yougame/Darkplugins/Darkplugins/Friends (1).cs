...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("Friends", "https://discord.gg/dNGbxafuJn", "4.0.6")]
    public class Friends : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            AddImage( $"https://rustapi.top/cartinki/givecart.php?token={API_KEY}&image=fsetting.png",$"settingback_friend");
