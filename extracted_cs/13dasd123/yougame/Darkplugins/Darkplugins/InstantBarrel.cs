...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("Instant Barrel", "https://discord.gg/dNGbxafuJn", "1.0.3")]
    ...
    public class InstantBarrel : RustPlugin
    {
        ...
        private void Init() => permission.RegisterPermission(onPermission, this);
