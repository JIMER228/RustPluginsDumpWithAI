...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("ChatSystem", "https://discord.gg/dNGbxafuJn", "2.0.9")]
    [Description("Улучшенная чат-система с интерфейсом! Куплено на whiteplugins.ru")]
