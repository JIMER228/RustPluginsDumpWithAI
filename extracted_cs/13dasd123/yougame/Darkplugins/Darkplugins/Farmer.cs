...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("Farmer", "https://discord.gg/dNGbxafuJn", "1.0.9")]
    ...
    {																			
		...
		private const string MainPanelSizeMin = "-400 -250";
		private const string MainPanelSizeMax = "400 300";
