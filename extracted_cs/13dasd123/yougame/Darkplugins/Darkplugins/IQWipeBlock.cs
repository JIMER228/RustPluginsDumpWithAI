...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("IQWipeBlock", "https://discord.gg/dNGbxafuJn", "1.2.6")]
    ...
    class IQWipeBlock : RustPlugin
    {
        ...
        void UI_Category_More_Popup(BasePlayer player, Configuration.Blocks.BlockElement BlockElement)
        {
            ...
            {
                RectTransform = { AnchorMin = "0.3281249 0.6796", AnchorMax = "0.6927969 0.7268518" }, 
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.2432292 0.06944448", AnchorMax = "0.7546969 0.6583334" }, 
        ...
        {
            WriteData();
            ServerMgr.Instance.StopCoroutine(routineDownloadImage);
                ...
                private void OnServerInitialized()
        {
            ...
            routineDownloadImage = ServerMgr.Instance.StartCoroutine(DownloadImages());
        ...
        void NetworkIDGetSet(UInt64 NetID, Boolean SetOrRemove, BasePlayer player = null)
        {
            ...
            else
            {
                ...
                private Coroutine routineDownloadImage;
        ...
        private void CheckAllUnlock()
        {
            ...
            if (AllTime <= 0)
            {
                ...
                [PluginReference] Plugin IQChat, ImageLibrary, Battles, Duel, Duelist, ArenaTournament, AimTraining, XFarmRoom; // https://umod.org/plugins/duelist
        ...
        void Interface_Button_Panel(BasePlayer player)
        {
            ...
            {
                FadeOut = 0.2f,
                RectTransform = { AnchorMin = $"0.2075757 0.3444443", AnchorMax = $"1 0.6266" }, ///
                Button = { Command = "block", Color = "0 0 0 0" },
            ...
            if (General.UseHidePanelButton)
            {
                ...
                {
                    FadeOut = 0.2f,
                    RectTransform = { AnchorMin = $"0.7 0.06666651", AnchorMax = $"1 0.34888" },  //
        ...
        /// <summary>
        /// Обновление 1.2.6
        /// - Добавлена возможность блокировать MLRS (Просто добавьте ракеты из MLRS в конфигурацию)
        ...
        void HideButtonIsMenu(BasePlayer player)
        {
            ...
            container.Add(new CuiButton 
            {
                RectTransform = { AnchorMin = "0.1557295 0.9037", AnchorMax = "0.8375002 0.9351867" }, ///
