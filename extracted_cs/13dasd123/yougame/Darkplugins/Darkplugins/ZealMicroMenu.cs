...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("ZealMicroMenu", "https://discord.gg/dNGbxafuJn", "1.0.3")]
    class ZealMicroMenu : RustPlugin
    {
        ...
        public List<BasePlayer> OpenMenu = new List<BasePlayer>();
