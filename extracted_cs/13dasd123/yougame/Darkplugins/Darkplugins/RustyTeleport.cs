...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("RustyTeleport", "https://discord.gg/dNGbxafuJn", "1.27.3140")]
    class RustyTeleport : RustPlugin
    {
        #region References
        [PluginReference]
        Plugin Clans;
        ...
        #region Variables
        private RustyTeleportConfig m_Config;
        ...
        private class RustyTeleportConfig
        {
            ...
            public static RustyTeleportConfig Prototype()
            {
                return new RustyTeleportConfig()
                {
                    PluginPrefix = "[RustyTP]",
                    EnableGUI = true,
                    ...
                    {
                        ["rustyteleport.vip"] = new Dictionary<string, Dictionary<string, int>>()
                        {
                        ...
                        ["rustyteleport.admin"] = new Dictionary<string, Dictionary<string, int>>()
                        {
                            ["Settings"] = new Dictionary<string, int>()
                            {
                                ["SaveHomeLimit"]          = 999,
        ...
        {
            m_Config = RustyTeleportConfig.Prototype();
        ...
        protected override void LoadConfig()
        {
            ...
            m_Config = Config.ReadObject<RustyTeleportConfig>();
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>()
            {
                ...
                ["incorrect_command_tp"] = "<color=#ba2c2c>Некорректное использование команды /tp. Ознакомьтесь с документацией плагина на https://whiteplugins.ru</color>",
