...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("StatsSystem", "https://discord.gg/dNGbxafuJn", "1.0.6")]
    class StatsSystem : RustPlugin
    {
        ...
        void StatsUI(BasePlayer player, int page = 0)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Color = "1 1 1 0.1", Close = "MainStats" },
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Color = "1 1 1 0.1", Command = $"stats profile {player.userID} 0" },
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Color = "1 1 1 0.1", Command = DB.Count() > (page + 1) * 10 ? $"stats skip {page + 1}" : "" },
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Color = "1 1 1 0.1", Command = page >= 1 ? $"stats skip {page - 1}" : "" },
            ...
            foreach (var check in items.Skip(page * 10).Take(10))
            {
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = $"0.63 0", AnchorMax = $"0.75 1", OffsetMax = "0 0" },
                ...
                container.Add(new CuiButton
                {
                    ...
                    Button = { Color = "1 1 1 0.1", Command = $"stats profile {check.Key} {z + page * 10}" },
        ...
        void ProfileUI(BasePlayer player, ulong SteamID, int z)
        {
            ...
            foreach (var check in target.Settings)
            {
                ...
                {
                    RectTransform = { AnchorMin = $"0.03 0", AnchorMax = $"1 1", OffsetMax = "0 0" },
                    Text = { Text = $"{check.Key.Replace("Kill", "УБИЙСТВ").Replace("Death", "СМЕРТЕЙ").Replace("Time", "АКТИВНОСТЬ")}", Color = "1 1 1 0.8", Align = TextAnchor.MiddleLeft, FontSize = 12, Font = "robotocondensed-regular.ttf" }
                }, "Count");
