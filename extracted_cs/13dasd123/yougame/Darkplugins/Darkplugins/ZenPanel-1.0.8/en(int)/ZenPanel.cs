...
// Allows installation only on YOURS servers, no more than 3 servers.
// It is forbidden to publish, transfer (including to have a look and best friend), (re) sale, donation,
// sink, loan or rent, loss in cards. 
// The violator will be anathematized, the license will be cancelled, and above him and his servers
// a special ritual of voodoo magic and a black witch is performed, after this the servers are not guaranteed to work!
...
namespace Oxide.Plugins {
	[Info("ZenPanel", "rever", "1.0.8")]
	[Description("Server infopanel")]
	class ZenPanel : RustPlugin {
		...
		public class Configuration {
			[JsonProperty(PropertyName = "Config version (dont change)")]
			public int version;

			[JsonProperty(PropertyName = "Settings command")]
			public string cmdOptions;

			[JsonProperty(PropertyName = "Advices")]
			public ConfigurationAdvice advice;

			[JsonProperty(PropertyName = "Logo")] public ConfigurationLogo logo;

			[JsonProperty(PropertyName = "Hide UI elements")]
			public ConfigurationHide hide;

			[JsonProperty(PropertyName = "Refresh rate")]
		...
		public class ConfigurationEconimc {
			[JsonProperty(PropertyName = "Icon url (256x256)")]
			public string url;

			[JsonProperty(PropertyName = "Show")] public bool allow;
		...
		public class ConfigurationAdvice {
			...
			[JsonProperty(PropertyName = "List")] public List<string> list;
		}
		...
		public class ConfigurationLogo {
			...
			[JsonProperty(PropertyName = "Size X")]
			public int x;

			[JsonProperty(PropertyName = "Size Y")]
			public int y;

			[JsonProperty(PropertyName = "Offset top-right X")]
			public int offsetX;

			[JsonProperty(PropertyName = "Offset top-right Y")]
			public int offsetY;
		}

		public class ConfigurationHide {
			[JsonProperty(PropertyName = "Allow")] public bool allow;

			[JsonProperty(PropertyName = "Only for zenpanel.canhide permission")]
			public bool usePermision;

			[JsonProperty(PropertyName = "Allow hide logo")]
			public bool canHideLogo;
		}

		public class ConfigurationTimers {
			[JsonProperty(PropertyName = "Clock")] public float clock;
			...
			[JsonProperty(PropertyName = "UI")] public float main;
		}
			...
			config = new Configuration {
				...
				advice = new ConfigurationAdvice {
					...
					list = new List<string> {
						"<color=#00ff00>Server advertising!</color>",
						"Also <color=#ff0000>you can use colors</color> :)",
						"Many advices",
						"For example adv. you Facebook group or site"
					}
				},
				...
				economic = new ConfigurationEconimc {
					url = "https://i.imgur.com/Gc1O6E6.png",
					allow = true,
					economics = true,
					serverRewards = true
				}
		...
		private double GetAMin(int cnt) {
			cnt--;
			return 0.8f-cnt*0.08-0.01*cnt;
		}

		private string GetAMax(int cnt) {
			cnt--;
		...
		private void Loaded() {
			...
			if (config.version != 1) {
				PrintError("Invalid config version! Plugin unloaded!");
