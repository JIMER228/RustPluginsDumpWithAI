// ZenPanel от rever. Куплено на сайте https://darkplugins.ru. Спасибо за покупку!
// В случае любых проблем создавайте тикет в разделе "Техническая поддержка" или пишите напрямую автору.
//
// 						!!! ВАЖНАЯ ИНФОРМАЦИЯ !!!
// Разрешается установка только на СВОИ сервера, не более 3х серверов.
...
// Нарушитель будет предан анафеме, лицензия аннулированна, а над ним и его серверами будет
// совершен особый ритуал магии вуду и черное колдунство, после чего работа серверов не гарантируется!
