...
{
    [Info("Convoy", "Sempai#3239", "2.1.5")]
    class Convoy : RustPlugin
    {
        [PluginReference] Plugin NpcSpawn, GUIAnnouncements, DiscordMessages, PveMode, Economics, ServerRewards, IQEconomic;
        ...
        object OnEntityTakeDamage(ScientistNPC entity, HitInfo info)
        {
            ...
            ConvoyVehicle convoyVehicle = convoyVehicles.Where(x => x != null && x.scientists.Contains(entity)).FirstOrDefault();
        ...
        void OnEntityDeath(ModularCar entity, HitInfo info)
        {
            ...
            ConvoyVehicle convoyVehicle = convoyVehicles.Where(x => x != null && x.baseEntity != null && x.baseEntity.net.ID == entity.net.ID).FirstOrDefault();
        ...
        void OnEntityDeath(BasePlayer player, HitInfo info)
        {
            ...
            {
                ConvoyVehicle convoyVehicle = convoyVehicles.FirstOrDefault(x => x != null && x.roamNpc.Contains(player));
                ...
                else if (freeConvoyNpc.Contains(player as ScientistNPC)) EconomyManager.ActionEconomy(info.InitiatorPlayer.userID, "Npc");
            }
        }
        ...
        object CanPopulateLoot(BasePlayer entity, NPCPlayerCorpse corpse)
        {
            ...
            if (entity is ScientistNPC && convoyVehicles.Any(x => x != null && x.scientists.Contains(entity)))
            {
        ...
        void ConsoleStartPersonalCommand(ConsoleSystem.Arg arg)
        {
            ...
            if (arg.Args != null && arg.Args.Count() > 0 && _config.convoys.Any(x => x.name == arg.Args[0])) CreateConvoy(arg.Args[0]);
            CreateConvoy();
        }
        ...
        void UpdateConfig()
        {
            if (_config.version != Version.ToString())
            {
                ...
                if (_config.version == "2.0.0" || _config.version == "2.0.1" || _config.version == "2.0.2" || _config.version == "2.0.3" || _config.version == "2.0.4" || _config.version == "2.0.5" || _config.version == "2.0.6" || _config.version == "2.0.7")
                {
                    foreach (NpcConfig npcConfig in _config.NPC) npcConfig.kit = "";
                }

                if (_config.version == "2.0.0" || _config.version == "2.0.1" || _config.version == "2.0.2" || _config.version == "2.0.3" || _config.version == "2.0.4" || _config.version == "2.0.5" || _config.version == "2.0.6" || _config.version == "2.0.7" || _config.version == "2.0.8" || _config.version == "2.0.9")
                {
        ...
        object ConvoyTakeDamage(BaseEntity entity, HitInfo info)
        {
            ...
            {
                Alert(initiator, GetMessage("Distance", initiator.UserIDString, _config.prefics));
                return true;
            }
        ...
        static class EconomyManager
        {
            ...
            internal static void SendBalance()
            {
                ...
                foreach (KeyValuePair<ulong, double> dic in _playersBalance)
                {
                    ...
                    if (player != null) ins.Alert(player, ins.GetMessage("SendEconomy", player.UserIDString, ins._config.prefics, dic.Value));
                }
            ...
            static void DefineEventWinner()
            {
                ...
                float maxPoint = _playersBalance.Max(x => (float)x.Value);
        ...
        class PluginConfig
        {
            ...
            [JsonProperty(en ? "Enable automatic event holding [true/false]" : "Включить автоматическое проведение ивента [true/false]")] public bool autoEvent { get; set; }
