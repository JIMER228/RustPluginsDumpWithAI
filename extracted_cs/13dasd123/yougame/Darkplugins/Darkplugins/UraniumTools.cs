...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("UraniumTools", "https://discord.gg/dNGbxafuJn", "0.0.2")]
    ...
    class UraniumTools : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {
                PrintWarning("Ошибка #{DarkPluginsID}" + $"чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!!");
                LoadDefaultConfig();
            }
