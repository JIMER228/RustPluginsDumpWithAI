...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("Turrets Extended", "https://discord.gg/dNGbxafuJn", "3.3.2")]
    ...
    public class TurretsExtended : RustPlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["NoAuthChat"] = "<color=#ce422b>У вас нет права на строительство или вы не имеете права на башню!</color>"
            }, this);
        }
