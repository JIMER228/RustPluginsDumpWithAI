...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("CustomTurret", "https://discord.gg/dNGbxafuJn", "1.0.0")]
        ...
        private void DrawUi(BasePlayer player)
        {
            ...
            CuiElementContainer container = new CuiElementContainer
            {
                ...
                },
                {
                    new CuiButton
                    {
                        RectTransform = { AnchorMin = "0 0", AnchorMax = "1{DarkPluginsID} 1{DarkPluginsID}" },
