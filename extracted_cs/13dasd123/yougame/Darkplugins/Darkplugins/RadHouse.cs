...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("RadHouse", "https://discord.gg/dNGbxafuJn", "1.4.1")]
    class RadHouse : RustPlugin
    {
        static RadHouse instance;
        [PluginReference] Plugin RustMap;
        [PluginReference] Plugin Map;
        [PluginReference] Plugin LustyMap,NpcSpawn;
        ...
        public class DataStorage
        {
            public Dictionary<string, Amount>[] Common = new Dictionary<string, Amount>[] {
                new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
                        ShortName="wood", Min=3000, Max=10000
                    }
                    , ["Stone"]=new Amount() {
                        ShortName="stones", Min=5000, Max=9000
                    }
                    , ["Metall"]=new Amount() {
                        ShortName="metal.fragments", Min=1000, Max=5000
                    }
                    , ["Charcoal"]=new Amount() {
                        ShortName="charcoal", Min=2500, Max=10000
                    }
                    , ["Fuel"]=new Amount() {
                        ShortName="lowgradefuel", Min=100, Max=500
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
                        ShortName="wood", Min=5000, Max=15000
                    }
                    , ["Stone"]=new Amount() {
                        ShortName="stones", Min=9000, Max=20000
                    }
                    , ["Metall"]=new Amount() {
                        ShortName="metal.fragments", Min=2500, Max=10000
                    }
                    , ["Charcoal"]=new Amount() {
                        ShortName="charcoal", Min=5000, Max=15000
                    }
                    , ["Fuel"]=new Amount() {
                        ShortName="lowgradefuel", Min=250, Max=900
                    }
                    , ["HQMetall"]=new Amount() {
                        ShortName="metal.refined", Min=50, Max=150
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
                        ShortName="wood", Min=8000, Max=25000
                    }
                    , ["Stone"]=new Amount() {
                        ShortName="stones", Min=15000, Max=32000
                    }
                    , ["Metall"]=new Amount() {
                        ShortName="metal.fragments", Min=5000, Max=15000
                    }
                    , ["Charcoal"]=new Amount() {
                        ShortName="charcoal", Min=7000, Max=23000
                    }
                    , ["Fuel"]=new Amount() {
                        ShortName="lowgradefuel", Min=350, Max=1200
                    }
                    , ["HQMetall"]=new Amount() {
                        ShortName="metal.refined", Min=150, Max=400
                    }
                    , ["Sulfur"]=new Amount() {
                        ShortName="sulfur", Min=1000, Max=3500
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
                        ShortName="wood", Min=15000, Max=35000
                    }
                    , ["Stone"]=new Amount() {
                        ShortName="stones", Min=40000, Max=70000
                    }
                    , ["Metall"]=new Amount() {
                        ShortName="metal.fragments", Min=10000, Max=25000
                    }
                    , ["Charcoal"]=new Amount() {
                        ShortName="charcoal", Min=20000, Max=40000
                    }
                    , ["Fuel"]=new Amount() {
                        ShortName="lowgradefuel", Min=500, Max=1500
                    }
                    , ["HQMetall"]=new Amount() {
                        ShortName="metal.refined", Min=250, Max=600
                    }
                    , ["Sulfur"]=new Amount() {
                        ShortName="sulfur", Min=2500, Max=6000
                    }
                    , ["GunPow"]=new Amount() {
                        ShortName="gunpowder", Min=1000, Max=3000
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
                        ShortName="wood", Min=25000, Max=50000
                    }
                    , ["Stone"]=new Amount() {
                        ShortName="stones", Min=50000, Max=80000
                    }
                    , ["Metall"]=new Amount() {
                        ShortName="metal.fragments", Min=15000, Max=35000
                    }
                    , ["Charcoal"]=new Amount() {
                        ShortName="charcoal", Min=30000, Max=50000
                    }
                    , ["Fuel"]=new Amount() {
                        ShortName="lowgradefuel", Min=750, Max=1750
                    }
                    , ["HQMetall"]=new Amount() {
                        ShortName="metal.refined", Min=350, Max=700
                    }
                    , ["Sulfur"]=new Amount() {
                        ShortName="sulfur", Min=3500, Max=7000
                    }
                    , ["GunPow"]=new Amount() {
                        ShortName="gunpowder", Min=2000, Max=5000
                    }
                    , ["Explosives"]=new Amount() {
                        ShortName="explosives", Min=70, Max=150
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
                        ShortName="wood", Min=35000, Max=70000
                    }
                    , ["Stone"]=new Amount() {
                        ShortName="stones", Min=70000, Max=100000
                    }
                    , ["Metall"]=new Amount() {
                        ShortName="metal.fragments", Min=20000, Max=40000
                    }
                    , ["Charcoal"]=new Amount() {
                        ShortName="charcoal", Min=40000, Max=60000
                    }
                    , ["Fuel"]=new Amount() {
                        ShortName="lowgradefuel", Min=1000, Max=2000
                    }
                    , ["HQMetall"]=new Amount() {
                        ShortName="metal.refined", Min=500, Max=900
                    }
                    , ["Sulfur"]=new Amount() {
                        ShortName="sulfur", Min=5000, Max=10000
                    }
                    , ["GunPow"]=new Amount() {
                        ShortName="gunpowder", Min=4000, Max=7000
                    }
                    , ["Explosives"]=new Amount() {
                        ShortName="explosives", Min=100, Max=250
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["Wood"]=new Amount() {
            ...
            public Dictionary<string, Amount>[] Rare = new Dictionary<string, Amount>[] {
                ...
                , new Dictionary<string, Amount>() {
                    ["GunPow"]=new Amount() {
                        ShortName="gunpowder", Min=500, Max=2000
                    }
                    , ["Explosives"]=new Amount() {
                ...
                , new Dictionary<string, Amount>() {
                    ["Explosives"]=new Amount() {
                        ShortName="explosives", Min=40, Max=100
                    }
                    , ["Thompson"]=new Amount() {
                ...
                , new Dictionary<string, Amount>() {
                    ["AmmoRifle"]=new Amount() {
                        ShortName="ammo.rifle", Min=60, Max=120
                    }
                    , ["Bolt"]=new Amount() {
                        ShortName="rifle.bolt", Min=1, Max=1
                    }
                    ...
                    , ["C4"]=new Amount() {
                        ShortName="explosive.timed", Min=2, Max=4
                    }
                    , ["B4"]=new Amount() {
                        ShortName="explosive.satchel", Min=6, Max=13
                    }
                }
                , new Dictionary<string, Amount>() {
                    ["AmmoRifle"]=new Amount() {
            ...
            public Dictionary<string, float>[] RadiationRadius = new Dictionary<string, float>[] {
                new Dictionary<string, float>() {
                    ["Радиус радиации в первый день"]=10, ["Радиус радиации во второй день"]=12, ["Радиус радиации в третий день"]=14, ["Радиус радиации в четвертый день"]=16, ["Радиус радиации в пятый день"]=18, ["Радиус радиации в шестой день"]=20, ["Радиус радиации в седьмой день"]=20,
                }
            }
            ;
            public Dictionary<string, float>[] RadiationIntensity = new Dictionary<string, float>[] {
                new Dictionary<string, float>() {
                    ["Радиация в первый день"]=10, ["Радиация во второй день"]=15, ["Радиация в третий день"]=20, ["Радиация в четвертый день"]=25, ["Радиация в пятый день"]=30, ["Радиация в шестой день"]=35, ["Радиация в седьмой день"]=40,
                }
            }
            ;
            public DataStorage() { }
        ...
        public static int HealthNPC = 200;
        ...
        private void LoadConfigValues()
        {
            ...
            if (NativeMapRadius > 9) NativeMapRadius = 1.0f;
            ...
            GetConfig("[Стандартная карта]", "Описание маркера", ref NativeTitle);
            ...
            GetConfig("[NPC]", "Какой размер здоровья устанавливать NPC", ref HealthNPC);
        ...
        void CreateRadHouse(bool IsAdminCreate)
        {
            ...
            Server.Broadcast($"{ChatPrefix} Радиактивный дом появился, координаты: {pos}, в квадрате {GetGrid(pos)}\nЕсли никто не успеет авторизоваться за {TimeToRemove} секунд, он пропадет");
        ...
        const string scientist = "assets/rust.ai/agents/npcplayer/humannpc/scientist/scientistnpc_patrol.prefab";
        private ScientistNPC InstantiateEntity(string type, Vector3 position)
        {
        ...
        static JArray wearItems = new JArray{
            new JObject{["ShortName"]= "hoodie",
                ["Amount"]= 1,
                ["SkinID"]= 2187105866},
            new JObject{
                ["ShortName"]= "pants",
        ...
        static JArray beltItems = new JArray{
            new JObject{
        ...
        {
            ["Name"] = "Radhouse Scientist Security",
            ["WearItems"] = wearItems,
            ["BeltItems"] = beltItems,
            ["Health"] = HealthNPC,
            ["RoamRange"] = 30f,
        ...
        void SpawnScientist(Vector3 pos)
        {
            ScientistNPC scientistNpc = (ScientistNPC)NpcSpawn.Call("SpawnNpc", pos, configNpc);
            
            Equip(scientistNpc);
            NPCMonitor npcMonitor = scientistNpc.gameObject.AddComponent<NPCMonitor>();
            npcMonitor.Initialize();
            if (scientistNpc != null)
                BaseEntityList.Add(scientistNpc);
        ...
        public class BotSettings
        {
            ...
            public string Name = "Radhouse Scientist Security";
            public float DamageScale = 1.2f;
            public float Accuracy = 0.4f;
            public float Speed = 7f;
            public float AttackRangeMultiplier = 1f;
            public float RadiusVisBots = 70f;
            ...
            public List<ItemNpc> beltItems = new List<ItemNpc>
            {
                new ItemNpc
                {
                    Shortname = "rifle.lr300",
        ...
        private void SpawnBots(Vector3 pos)
        {
            BotSettings BotPattern = new BotSettings();
            
            
            JArray arrayWear = new JArray();
            foreach (var item in BotPattern.wearItems)
                arrayWear.Add(new JObject { ["ShortName"] = item.Shortname, ["Amount"] = 1, ["SkinID"] = item.SkinID, });
            JArray arrayBelt = new JArray();
            foreach (var item in BotPattern.beltItems)
                arrayBelt.Add(new JObject { ["ShortName"] = item.Shortname, ["Amount"] = 1, ["SkinID"] = item.SkinID, });
            JObject configNpc = new JObject()
            {
                ["Name"] = BotPattern.Name,
                ["WearItems"] = arrayBelt,
                ["BeltItems"] = arrayBelt,
                ["Health"] = BotPattern.Health,
                ["RoamRange"] = BotPattern.RoamRange,
                ["ChaseRange"] = BotPattern.ChaseRange,
                ["DamageScale"] = BotPattern.DamageScale,
                ["AimConeScale"] = BotPattern.Accuracy,
                ["DisableRadio"] = false,
                ["EnableNavMesh"] = false,
                ["Stationary"] = false,
                ["KillInSafeZone"] = false,
            ...
            for (int i = 0; i < AmountNPC; i++)
            {
                ...
                Vector3 SpawnPosBot = RandomCircle(pos,10);
        ...
        public class NPCMonitor : MonoBehaviour
        {
            ...
            private void Awake()
            {
                player = GetComponent<ScientistNPC>();
                homePosition = instance.LootBox.transform.position;
                GeneratePatrolPositions();
            }

            public void Initialize(ulong playerid = 118784)
            {
                InvokeRepeating("UpdatePatrolPosition", 5f, 5f);
                if (instance.LootNPC)
                    player.GetComponent<ScientistNPC>().LootSpawnSlots = new LootContainer.LootSpawnSlot[0];
            }

            public void UpdateTargetPosition()
            {
                if (player == null || player.GetBestTarget() == null) return;
        ...
        private void CreatePrivateMap(Vector3 pos)
        {
            ...
            mapMarker.color1 = ConvertToColor(NativeMapColor);
            mapMarker.alpha = NativeMapAlpha;
            mapMarker.enabled = true;
            vendingMarker.markerShopName = NativeTitle;
            vendingMarker.Spawn();
        ...
        object OnEntityTakeDamage(BaseCombatEntity entity, HitInfo info)
        {
            ...
            if (BaseEntityList != null)
            {
                var targetEntity = BaseEntityList.FirstOrDefault(p => p == entity);
                if (targetEntity != null)
                {
                    if (targetEntity.name.Contains("scientist")) return null;
                    return false;
                }
            }
            return null;
        ...
        object CanLootEntity(BasePlayer player, StorageContainer container)
        {
            ...
            if (BaseEntityList != null)
            {
                BaseEntity box = BaseEntityList.FirstOrDefault(p => p == container);
        ...
        {
            if (RadPosition != Vector3.zero) if (Vector3.Distance(RadPosition, pos) < 20) return true;
            return false;
        }
        ...
        void OnLootEntityEnd(BasePlayer player, BaseCombatEntity entity)
        {
            ...
            if (BaseEntityList != null)
            {
                if (LootBox == entity)
                {
                    if (PlayerAuth.Contains(player.userID) && CanLoot && !NowLooted)
                    {
        ...
        object OnCupboardAuthorize(BuildingPrivlidge privilege, BasePlayer player)
        {
            if (BaseEntityList != null)
            {
                var cup = BaseEntityList.FirstOrDefault(p => p != null && p.net.ID == privilege.net.ID);
                if (cup != null)
                {
                    if (PlayerAuth.Contains(player.userID))
                    {
                    ...
                    if (itemContainer != null)
                    {
                        if (itemContainer.itemList.Count > 0)
                        {
                            ...
                            timer.Destroy(ref mytimer3);
                            return false;
                        }
                        else
                        {
                            SendReply(player, $"{ChatPrefix} Ящик с лутом пуст, дом скоро будет удален.");
                            return false;
                        }
                    }
                }
                ...
                CuiElement RadUI = new CuiElement
                {
                    ...
                    Components = {
                        ...
                        , new CuiRectTransformComponent {
                            AnchorMin=AnchorMinCfg, AnchorMax=AnchorMaxCfg
                        }
                    }
                }
                ;
                CuiElement RadText = new CuiElement
                {
                    ...
                    Components = {
                        new CuiTextComponent {
                            Text=$"{TextGUI} {pos} Квадрат: {GetGrid(pos)}", Align=TextAnchor.MiddleCenter
                        }
                        , new CuiRectTransformComponent {
