...
{
    /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ СКАЧАН С ДИСКОРД СООБЩЕСТВА https://discord.gg/dNGbxafuJn */ [Info("SeedEvent", "https://discord.gg/dNGbxafuJn", "1.1.1")]
    ...
    class SeedEvent : RustPlugin
    {
        ...
        void OnEntityBuilt(Planner plan, GameObject go)
        {
            ...
            var isSeed = go.GetComponent<GrowableEntity>();
