...
namespace Oxide.Plugins
{
    ...
    class BarrenPlus : RustPlugin
    {
        ...
        {
            [JsonProperty(PropertyName = "Частота спавна кучь мусора")]
            public float JunkPileTime = 30;

            [JsonProperty(PropertyName = "Частота спавна затопленных кораблей")]
            public float DiveSiteTime = 45;
            
            [JsonProperty(PropertyName = "Минимальное расстояние между кучами мусора")]
            public int JunkPileRange = 50;

            [JsonProperty(PropertyName = "Минимальное расстояние между затопленными кораблями")]
            public int DiveSiteRange = 50;

            [JsonProperty(PropertyName = "Минимальная глубина")]
            public int BetweenWaterTerrain = 20;

            [JsonProperty(PropertyName = "Максимальная глубина")]
            public int AngleMax = 20;

            [JsonProperty(PropertyName = "Время жизни затопленных кораблей")]
            public int DiveSiteLife = 600;

            [JsonProperty(PropertyName = "Время жизни кучь мусора")]
            public int JunkPileLife = 300;

            [JsonProperty(PropertyName = "Максимальное количество попыток найти местоположение")]
