...
{
    [Info("WelcomeHelp", "Hougan", "0.0.41")]
    public class WelcomeHelp : RustPlugin
    {
        ...
        private class Configs
        {
            ...
            {
                [JsonProperty("Текст заголовка (можно написать название проекта)")]
                ...
                return new Configs
                {
                    Pages = new List<Page>
                    {
						new Page
                        {
                            DisplayName = "Правила",
                            Text =
                                "1. Запрещено использовать флуд и капс в чате!\n" +
                                "2. Запрещено играть в команде более 4-х человек!\n" +
								"3. Запрещена критика деятельности администрации в открытой форме!\n" +
								"4. Запрещена ненормативная лексика и оскорбления других игроков!\n" +
								"5. Запрещено оскорбление проекта в целом!\n" +
								"6. Запрещена реклама сторонних проектов в любой форме\n\n" +
                                "color=#FF4500>Наказание: блокировка от 3 до 365 дней, возможна и пожизненная блокировка.</color>\n\n" +
								"<color=#FF8C00>P.S. Играйте честно и уважайте других игроков!!!</color>\n" +
								"Администрация сервера имеет право в любой момент изменить правила.",
                            Important = true,
                            ReadTime = 10
                        },
                        new Page
                        {
                            DisplayName = "Система сна на спальнике",
                            Text =
                                "У нас новая, уникальная система сна на спальнике. <b>Зачем?</b> - спросите вы. Это помогает вам восстановить здоровье!\n" +
                                "Если вы в доме, у вас нету ничего под рукой, но срочно необходимо восстановить здоровье подойдите к спальник или кровати и нажмите <b>SHIFT+R</b>!\n\n" +
                                "У вас начнётся процесс сна, вы сможете остановить его в любой момент.",
                            Important = false,
                            ReadTime = 10
                        },
                    }
        ...
        protected override void LoadConfig()
        {
            ...
            {
                PrintWarning($"Ошибка чтения конфига, создается новый конфиг!");
                LoadDefaultConfig();
            }
