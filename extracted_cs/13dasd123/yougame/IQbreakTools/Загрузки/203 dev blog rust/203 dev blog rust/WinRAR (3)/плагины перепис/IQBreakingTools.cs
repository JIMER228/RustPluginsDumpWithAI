...
{
    [Info("IQBreakingTools", "Mercury", "0.0.6")]
    ...
    class IQBreakingTools : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {
                PrintWarning("Ошибка #3433" + $"чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!!");
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
        ...
        void OnLoseCondition(Item item, ref float amount)
        {
            ...
            if (!Oxide.Core.ExtensionMethods.IsSteamId(player.UserIDString)) return;
