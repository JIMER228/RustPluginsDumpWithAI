...
{
    [Info("ChatBot", "Oxide Россия - oxide-russia.ru", "1.1.0")]
    [Description("ChatBot")]
    class ChatBot : RustPlugin
    {
		...
		foreach (var Otvet in Chat)
         {	  
			...
			if(exclud){
			ConsoleNetwork.BroadcastToAllClients("chat.add", new object[] { "76561198078082735", $"<size=15>|<color=#03385d>A</color><color=#024879>l</color><color=#025995>i</color><color=#0366ac>e</color><color=#037bcf>n</color><color=008aea>RUST</color>|</size> {Otvet.Return}" });
			Puts($"|<color=#03385d>A</color><color=#024879>l</color><color=#025995>i</color><color=#0366ac>e</color><color=#037bcf>n</color><color=008aea>RUST</color>|: {Otvet.Return}");
			return;
			}
			}
			}
