...
{
    [Info("Duel", "RustPlugin.ru --Fixed be Vlad-00003", "3.3.8")]
    [Description("Automatic Duel with GUI, weapons list, auto-created arenas, save players loot and position")]
    class Duel : RustPlugin
    {
        // Фикс дюпа через backpack
        // Фикс дюпа через трейд
        // Фикс дюпа через /skin и /skinbox
        ...
        static string guiStartAboutToBegin = "Начало чеwрез несколько секунд";
        ...
        void OnEntityDeath(BaseEntity entity, HitInfo hitinfo)
        {
            ...
            {
                var duel = createdTeamDuels[0];
                if (dueller.team == "blue") duel.teamblue.Remove(dueller);
                if (dueller.team == "red") duel.teamred.Remove(dueller);
        ...
        public static void GiveWeapon(BasePlayer player)
        {
            ...
            switch (dueller.weapon)
            {
                case "AK-47":
                    ...
                    GiveAndShowItem(player, 586484018, 25); // шприцы
                    break;
                case "Болт":
