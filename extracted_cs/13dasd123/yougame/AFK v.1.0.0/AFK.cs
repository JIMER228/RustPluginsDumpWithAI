...
{
    [Info("AFK", "A0001", "1.0.0", ResourceId = 1922)]
    [Description("Kicks players that are AFK (away from keyboard) for too long")]

    class AFK : CovalencePlugin
    {
        // НЕ редактируйте этот файл, вместо этого отредактируйте файл AFK.json в oxid / config и AFK.en.json в каталоге ox / lang,
        // или создайте новый языковой файл для другого языка, используя файл 'en' по умолчанию
        ...
        void LoadDefaultMessages()
        {
            ...
            {
                ["KickedForAfk"] = "Вас кикнули за то, что вы были АФК в течение {0} минут",
                //["NoLongerAfk"] = "Вы больше не AFK",
                //["YouWentAfk"] = "Ты в AFK"
            }, this);
        }
