...
{
	/*ПЛАГИН БЫЛ ПОФИКШЕН С ПОМОЩЬЮ ПРОГРАММЫ СКАЧАНОЙ С https://discord.gg/dNGbxafuJn */ [Info("SSkin", "Skuli Dropek", "1.1.2")]
				...
				case "setskin":
					{
						...
						if (entity == null)
						{
							var item = player.inventory.FindItemUID(new ItemId(itemId));
