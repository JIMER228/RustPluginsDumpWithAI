...
namespace Oxide.Plugins
{
    ...
    public class ChatSystem : RustPlugin
    {
        ...
        {	
            if (arg.GetString(0).ToLower().StartsWith("вопрос"))
            {
        ...
        {
			PrintWarning("Благодарим за скачку скачан с форума: serverrust.ru !!!");
            ...
            else
            {
                Settings = new PluginSettings
                {
                    ...
                    {
                        "Благодарим за скачку скачан с форума: serverrust.ru !!!",
                        "Все самые свежие и последние плагины только у нас: serverrust.ru !!!"
                    },
