...
{
    [Info("MagicTools", "server-rust.ru", "1.0.0")]
    ...
    class MagicTools : RustPlugin
    {
        ...
        void cmdAddHits(ConsoleSystem.Arg arg)
        {
            ...
            if (arg.Args.Length != 2 && arg.Args.Length == 0)
            {
                Puts("Вы не правильно ввели команду. Используйте: magictools.addhits STEAMID Кол-ство");
                    return;
            }
