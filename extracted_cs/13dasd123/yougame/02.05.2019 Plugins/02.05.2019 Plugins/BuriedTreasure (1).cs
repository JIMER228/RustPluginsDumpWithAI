...
namespace Oxide.Plugins
{
    ...
    class BuriedTreasure : RustPlugin
    {
        ...
        int ServerRewardsGoldExhcange = 100;
        ...
        private void LoadConfigVariables()
        {
            ...
            CheckCfg("Gold - Player will get this many Server Reward Points when selling 1 gold : ", ref ServerRewardsGoldExhcange);
        ...
        void SellGold(BasePlayer player, Item item = null)
        {
            ...
            if (activeItem != null)
            {
                if (activeItem.skin == 1376561963)
                {
                    ...
                    {
                        ServerRewards?.Call("AddPoints", new object[] { player.userID, ServerRewardsGoldExhcange });
                        SendReply(player, "You Just sold your gold for " + ServerRewardsGoldExhcange.ToString() + " Rewards Points !!!");
                    }
