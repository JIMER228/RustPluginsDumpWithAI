...
{
    [Info("Vehicles Extended", "Lomarine", "1.0.0")] 
      //  Слив плагинов server-rust by Apolo YouGame
    [Description("Плагин для работы с транспортом, разработал - https://vk.com/lomarine")] 
    public class VehiclesExt : RustPlugin
    {
        private const string 
            chinook = "assets/prefabs/npc/ch47/ch47.entity.prefab", 
            sedan = "sassets/content/vehicles/sedan_a/sedan.entity.prefab", 
