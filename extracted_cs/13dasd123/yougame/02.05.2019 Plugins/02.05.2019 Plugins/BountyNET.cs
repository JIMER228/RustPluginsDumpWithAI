...
{
    [Info("BountyNET", "k1lly0u", "0.1.5", ResourceId = 0)]
    ...
    class BountyNET : RustPlugin
    {
      ...
      //  Слив плагинов server-rust by Apolo YouGame
            ...
            if (notify)
                PopupToPlayer(player, msg("reward_claimed", player.userID));
        }
      ...
      //  Слив плагинов server-rust by Apolo YouGame
        ...
        private bool IsTeamMate(ulong playerId, ulong friendId)
        {
            ...
            if (player == null)
                return false;
            return RelationshipManager.Instance.FindTeam(player.currentTeam)?.GetMember(friendId) != null;
        }
