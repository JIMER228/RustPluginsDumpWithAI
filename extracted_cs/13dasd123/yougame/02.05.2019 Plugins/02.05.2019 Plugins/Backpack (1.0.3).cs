...
{
    [Info("Backpack", "Server-rust.ru","1.0.3")]
    public class Backpack : RustPlugin
    {
        ...
        {
            public static readonly List<int> sizes = new List<int>() {10,20,30};
            ...
            public static StorageContainer SpawnContainer (BasePlayer player, int size, bool die)
            {
                ...
                {
                    pos -= new Vector3(1000-Rnd.Next(0, 2000), Rnd.Next(102, 200), 1000-Rnd.Next(0, 2000));
                }
