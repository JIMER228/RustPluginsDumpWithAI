...
{
    [Info("Sputnik", "https://discord.gg/96eJaVaWBv", "1.2.4")]
    class Sputnik : RustPlugin
    {
        ...
        object OnCardSwipe(CardReader cardReader, Keycard keycard, BasePlayer player)
        {
            ...
            if (keyCardItem.info.shortname == ins._config.customCardConfig.shortName && keyCardItem.skin == ins._config.customCardConfig.skinID)
            {
                ...
                else if (keyCardItem.skin != 0)
                {
                    return true;
                }
            }
            else if (sputnikClass != null)
            {
        ...
        {
            if (eventClass == null || player == null || container == null || container.net == null) return null;
            SputnikClass sputnikClass = eventClass.GetSputnikClassFromCrateUid(container.net.ID.Value);
            if (sputnikClass != null)
            {
                if (!sputnikClass.IsSputnikAgressive())
        ...
        object OnEntityTakeDamage(ScientistNPC scientistNPC, HitInfo info)
        {
            ...
            if (eventClass.GetSputnikClassByTurretUid(autoTurret.net.ID.Value) != null) return true;
        ...
        object OnEntityTakeDamage(AutoTurret autoTurret, HitInfo info)
        {
            ...
            if (sputnikClass != null)
            {
                if (info.InitiatorPlayer.IsRealPlayer()) sputnikClass.MakeSputnikAgressive();
            }
            return null;
        }
        ...
        {
            if (eventClass == null || patrolHelicopter == null || patrolHelicopter.net == null) return;
        ...
        {
            if (eventClass == null || !turret.IsExists() || player == null) return null;

            SputnikClass sputnikClass = eventClass.GetSputnikClassByTurretUid(turret.net.ID.Value);
            if (sputnikClass != null)
            {
                if (!player.IsRealPlayer()) return true;
                if (!sputnikClass.IsSputnikAgressive() && !_config.agressiveConfig.turretAgressiveMode) return true;
            }
            return null;
        }
        ...
        {
            if (eventClass == null || heli == null) return null;
            ...
            if (sputnikClass != null)
            {
                ...
                if (!sputnikClass.IsSputnikAgressive() && !_config.agressiveConfig.heliAgressiveMode) return false;
                return null;
            }
        ...
        {
            if (eventClass == null || npc == null || npc.net == null) return null;
            ...
            if (sputnikClass != null)
            {
                if (!sputnikClass.IsSputnikAgressive() && !_config.agressiveConfig.npcAgressiveMode) return false;
            }
            return null;
        }
        ...
        {
            if (eventClass == null || netID == null) return null;
            SputnikClass sputnikClass = eventClass.GetSputnikClassFromCrateUid(netID.Value);
            if (sputnikClass == null) return null;
            string cratePresetName = null;
            if (sputnikClass.lockedCrates.Any(y => y.Key != null && y.Key.net.ID.Value == netID.Value)) cratePresetName = sputnikClass.lockedCrates.FirstOrDefault(y => y.Key != null && y.Key.net.ID.Value == netID.Value).Value;
            else if (sputnikClass.crates.Any(y => y.Key != null && y.Key.net.ID.Value == netID.Value)) cratePresetName = sputnikClass.crates.FirstOrDefault(y => y.Key != null && y.Key.net.ID.Value == netID.Value).Value;
        ...
        object CanEntityTakeDamage(AutoTurret autoTurret, HitInfo hitinfo)
        {
            ...
            if (eventClass.GetSputnikClassByTurretUid(autoTurret.net.ID.Value) != null)
            {
        ...
        object CanEntityTakeDamage(Landmine landmine, HitInfo hitinfo)
        {
            ...
            if (eventClass.GetSputnikClassByMineUid(landmine.net.ID.Value) != null)
            {
                if (hitinfo.InitiatorPlayer == null || !hitinfo.InitiatorPlayer.IsRealPlayer()) return false;
                else return true;
            }
        ...
        object CanEntityTakeDamage(ScientistNPC scientistNPC, HitInfo hitinfo)
        {
            ...
            if (autoTurret == null) return null;
            if (eventClass.GetSputnikClassByTurretUid(autoTurret.net.ID.Value) != null) return false;
            return null;
        }
        ...
        object CanEntityTakeDamage(BasePlayer victim, HitInfo hitinfo)
        {
            ...
            else if (hitinfo.Initiator != null)
            {
                ...
                if (baseTrap != null)
                {
                    if (eventClass.GetSputnikClassByMineUid(baseTrap.net.ID.Value) != null) return true;
                    return null;
                }
            }
            return null;
        ...
        {
            if (eventClass == null || trap == null || !player.IsRealPlayer()) return null;
            if (eventClass.GetSputnikClassByMineUid(trap.net.ID.Value) != null) return true;
            return null;
        }

        object CanEntityBeTargeted(BasePlayer player, BaseEntity turret)
        {
            if (eventClass == null || turret == null || turret.net == null) return null;

            SputnikClass sputnikClass = eventClass.GetSputnikClassByTurretUid(turret.net.ID.Value);
            if (sputnikClass != null)
            {
                if (!player.IsRealPlayer()) return false;
                if (!sputnikClass.IsSputnikAgressive() && !_config.agressiveConfig.turretAgressiveMode) return false;
                else return true;
            }
        ...
        void SpawnPointCommand(BasePlayer player, string command, string[] arg)
        {
            ...
            SputnikDebrisConfig sputnikDebrisConfig = _config.sputnikDebrisConfigs.FirstOrDefault(x => x.presetName == arg[0]);
        ...
        void StartEvent(string presetName = "", BasePlayer activator = null)
        {
            ...
            if (ins._config.mainConfig.enableStartStopLogs)
                PrintLogMessage("EventStart_Log", eventConfig.presetName);
        }
        ...
        void PrintLogMessage(string langKey, params object[] args)
        {
        ...
        class SputnikClass : FacepunchBehaviour
        {
            ...
            void UpdateMapMarker()
            {
                if (vendingMarker != null)
                {
                    ...
                    string text = destroyTime > 0 ? $"{sputnikDebrisConfig.markerConfig.displayName} {ins.GetTimeMessage(null, destroyTime)} " + displayEventOwnerName : $"{sputnikDebrisConfig.markerConfig.displayName} {ins.GetTimeMessage(null, ins.eventClass.eventTime)} " + displayEventOwnerName;
        ...
        class ZoneClass : FacepunchBehaviour
        {
            ...
            void OnDestroy()
            {
                ...
                playersInZone.Clear();
                if (ins._config.supportedPluginsConfig.pveMode.pve && ins.plugins.Exists("PveMode")) ins.PveMode.Call("EventRemovePveMode", sputnikClass.sputnikDebrisConfig.presetName, false);
            }
            ...
            void CreateZone()
            {
                ...
                if (ins._config.supportedPluginsConfig.pveMode.pve)
                {
                    ...
                    foreach (ScientistNPC scientistNPC in sputnikClass.npcs) if (scientistNPC.IsExists()) npcs.Add(scientistNPC.net.ID.Value);
                    foreach (LootContainer lootContainer in sputnikClass.crates.Keys) if (lootContainer.IsExists()) crates.Add(lootContainer.net.ID.Value);
                    foreach (LootContainer lootContainer in sputnikClass.lockedCrates.Keys) if (lootContainer.IsExists()) crates.Add(lootContainer.net.ID.Value);
                    if (sputnikClass.sputnikHeli != null) helies.Add(sputnikClass.sputnikHeli.GetHeliNetId());

                    ins.PveMode.Call("EventAddPveMode", sputnikClass.sputnikDebrisConfig.presetName, config, sputnikClass.gameObject.transform.position, sputnikClass.sputnikDebrisConfig.zoneConfig.radius, crates, npcs, bradleys, helies, new HashSet<ulong>(), null);
                }
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["EventActive"] = "{0} Cet événement est actif maintenant. Pour terminer cet événement (<color=#ce3f27>/sputikstop</color>)!",
        ...
        private class PluginConfig
        {
            ...
            public static PluginConfig DefaultConfig()
            {
                ...
                {
                    version = new VersionNumber(1, 2, 4),
                    prefix = "[Sputnik]",
