...
namespace Oxide.Plugins
{
    ...
    {   
        ...
        {
            PrintWarning("Благодарим за приобритение плагина на сайте Rust-Plugin.ru.\n Если вы приобрели плагин в другом месте - вы теряете все гарантии.");
        }
       ...
       // }
        ...
        void OnDispenserGather(ResourceDispenser dispenser, BaseEntity entity, Item item)
        {
            ...
            if (MoreHQM && dispenser.gatherType == ResourceDispenser.GatherType.Ore)
            {
                ...
                if (!HaveHQM)
                {
                    dispenser.finishBonus.Add(new ItemAmount(ItemManager.FindItemDefinition(-1982036270), 2f));
                }
            }
