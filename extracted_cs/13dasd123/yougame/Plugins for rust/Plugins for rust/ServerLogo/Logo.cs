...
namespace Oxide.Plugins
{
    ...
    class Logo : RustPlugin
    {
        ...
        {
            PrintWarning("Создание файла конфигурации!");
        }
        void Loaded()
        {
            GetConfig("Изображение. Ссылка или название файла в папке data", ref ImageAddress);
            GetConfig("Минимальный отступ", ref Amin);
            GetConfig("Максимальный отступ", ref Amax);
            SaveConfig();
