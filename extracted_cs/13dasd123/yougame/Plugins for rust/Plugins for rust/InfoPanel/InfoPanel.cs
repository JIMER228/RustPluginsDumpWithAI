...
namespace Oxide.Plugins
{
    ...
    public class InfoPanel : RustPlugin
    {
                    ...
                    {"Clock", new PanelConfig
                        {
                            ...
                            Width = 0.2f,
                            Height = 0.95f,
                            BackgroundColor = "152, 152, 152, 0.1",
        ...
        private List<string> Messages = new List<string> { "Вся информация: <color=#ffd479>/info</color>", "Донат-Магазин: slavic_server.gamestores.ru", "Нарушил правила - получил бан.", "По всем вопросам: vk.com/slavic_server" };
