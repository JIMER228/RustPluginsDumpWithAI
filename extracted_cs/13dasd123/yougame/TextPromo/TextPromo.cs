    ...
    public class TextPromo : RustPlugin
    {
        public class ConfigData
        {
            ...
            public static ConfigData GetNewConf()
            {
                ...
                newConfig.nameserver = "HARD-RUST.RU";
                newConfig.promo1 = "wipe (15%)";
                newConfig.promo2 = "global (20 rub)";
                newConfig.count = 10;
                return newConfig;
            }
        }
        ...
        void OnPlayerConnected(BasePlayer player)
        {
            ...
            {
                GivePromo(player);
                SendReply(player, "Вы получили записку с промо!");
                data.Vidal = true;
                SaveData();
            }
        }
