...
{
    /* Плагин был разыгран дискордом https://discord.gg/8CWJadmA5w */ [Info("XMenu", "https://discord.gg/8CWJadmA5w", "1.1.10")]
    class XMenu : RustPlugin
    {
		...
		private void OnServerInitialized()
		{
			...
			"     Author - Monster\n" +
			"     VK - vk.com/idannopol\n" +
			"     Discord - https://discord.gg/8CWJadmA5w\n" +
			"     \n" + 
			"-----------------------------");
		...
		private void GUIAddButtonOpen(BasePlayer player)
		{
			...
			container.Add(new CuiLabel
            {
                ...
                Text = { Text = lang.GetMessage("AddOPEN", this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 8, Color = "1 1 1 0.80" }
            }, ".AddButton_Open");
        ...
        {		
			...
			public static MenuConfig GetNewConfiguration()
            {
                return new MenuConfig
                {
                    ...
                    {
						MenuColor = "1 0.27 0 0.50",
						MenuMaterial = "assets/icons/greyout.mat",
						ButtonColor = "0.21 0.22 0.20 0.75",
					...
					{
						EMenuColor = "1 0.27 0 0.50",
						EMenuMaterial = "assets/icons/greyout.mat",
						EBackgroundColor = "0.21 0.22 0.20 0.75",
		...
		private void GUIAddButton(BasePlayer player)
		{
            ...
            {
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMax = "0 -1" },
                Text = { Text = lang.GetMessage("AddCLOSE", this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.80" }
            }, ".AddButton_Close");
			...
			foreach(var button in config.ButtonAdd)
			{
                ...
                {
                    RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMax = "0 -1" },
                    Text = { FadeIn = fadein, Text = lang.GetMessage(button.Key, this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.80" }
                }, ".AddButton_N");
