...
namespace Oxide.Plugins
{
    ...
    class RatesController : RustPlugin
    {
        ...
        private class AllowedItemsConfig
        {
            ...
            {
                _type = 1,
                Items = new List<string> { "Rotten Apple", "Spoiled Wolf Meat", "Spoiled Chicken", "Spoiled Human Meat"}
            };
        ...
        private class LootController : FacepunchBehaviour
        {
            ...
            private void Awake()
            {
                ...
                _lootContainer.destroyOnEmpty = false;
            }
            ...
            private void Kill()
            {
                _lootContainer.destroyOnEmpty = _destroyOnEmpty;
                Destroy(this);
            }
