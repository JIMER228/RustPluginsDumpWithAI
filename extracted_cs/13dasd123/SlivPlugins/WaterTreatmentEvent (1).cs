...
{
    [Info("WaterTreatmentEvent", "Yac Vaguer", "1.0.0")]
    ...
    public class WaterTreatmentEvent : RustPlugin
    {
        ...
        /** Translations Base64 encoded */
        private const string compressed = "";
        ...
        private class PluginConfig
        {
            ...
            public static PluginConfig DefaultConfig()
            {
                ...
                return new PluginConfig()
                {
                    ...
                    eventEndWarningTime = 300f,
                    cooldownAfterCompletedEvent = 500f,
        ...
        void StartEvent()
        {
            if (started)
            {
                log.Error("The Event is on, you need to stop the event (/wtestop) first before starting a new one");
                return;
            }
        ...
        private void SpawnBasedEntities(string prefab, Vector3[] vectorlist)
        {
            ...
            {
                var position = missionZone.Location.transform.TransformPoint(vec); 
        ...
        {
            VendingMachineMapMarker vendingMarker = (VendingMachineMapMarker)GameManager.server.CreateEntity(prefabPaths["VendingMachineMarker"], missionZone.EventCenter);
        ...
        private void SpawnBradleyAPC()
        {
            ...
            Vector3 pointA = missionZone.Location.transform.TransformPoint(new Vector3(17.03f, 0, -16.32f));
            Vector3 pointB = missionZone.Location.transform.TransformPoint(new Vector3(14.91f, 0, -115.23f));
        ...
        private void SpawnF15()
        {
            ...
            Vector3 startingPosition = new Vector3(-410.53f, 168, 130.09f);
            ...
            jetF15.defaultAltitude = 160f;
            jetF15.Spawn();
            jetF15.Invoke(() => FireRocket(targetPosition), 10f);
        ...
        {
            Vector3 launchPosition = targetPosition * 1f;
            Vector3 direction = (targetPosition - launchPosition).normalized;

            // Create the rocket entity
            MLRSRocket? rocket = GameManager.server.CreateEntity(prefabPaths["MLRS"], launchPosition) as MLRSRocket;
            if (rocket == null)
            {
                return;
            }    
            ...
            if (projectile != null)
            {
                Effect.server.Run(prefabPaths["MLRS"], targetPosition);
                projectile.gravityModifier = 0.01f;
                projectile.InitializeVelocity(direction * 60f);
                log.Debug("Sending MLRS");
            }

            rocket.Spawn();
            log.Debug("Bomb Dropped");
        ...
        {
            var position = missionZone.Location.transform.TransformPoint(new Vector3(-3.5f, 0.5f, -64.5f)); 
        ...
        private void SpawnGuards()
        {
            ...
            foreach (Vector3 pos in guardsPositions)
            {
                ...
                {
                    var position = missionZone.Location.transform.TransformPoint(pos);
        ...
        private static JObject GetNPCSettings(PluginConfig.NpcSettings config)
        {
            ...
            return new JObject
            {
                ...
                ["Kit"] = "", // We will not allow kits for performance propose
        ...
        private class Log
        {
            ...
            private void LogIntoFile(string message, string type)
            {
                ...
                try
                {
                    ...
                    if (type == ERROR_LEVEL || type == WARNING_LEVEL)
                    {
        ...
        {
            private PluginConfig.NotificationConfig pluginConfig;
