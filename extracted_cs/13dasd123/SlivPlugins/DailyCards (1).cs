...
{
    [Info("DailyCards", "EcoSmile", "1.0.3")]
    class DailyCards : RustPlugin
    {
        ...
        void DrawCurrentOpening(BasePlayer player)
        {
            ...
            if (opened <= 0)
            {
                UI.AddText(ref container, "OependCount", "OependCount.2", "0.68 0.63 0.60 1", lg == "ru" ? $"ОТКРЫТИЯ ЗАКОНЧИЛИСЬ, ПРИХОДИТЕ ЗАВТРА" : $"THE OPENINGS ARE OVER, COME BACK TOMORROW", TextAnchor.LowerCenter, 16, "0.5 0", "0.5 0", "-250 -25", "250 -5");
