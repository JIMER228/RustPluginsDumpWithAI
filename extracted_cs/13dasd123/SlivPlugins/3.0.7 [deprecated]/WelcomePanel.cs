...
/* 
    DEPRECATED! 
    - developed in 2021
    - last tested 20/03/2023

    As to this date, version 3.0.7 is fully working and can 
    be used on live servers. To servers trying to squeeze
    every bit of performance on wipe days is recommended to 
    use 3.2.0 version or higher.

    discord.gg/rustplugins
*/

namespace Oxide.Plugins
{
    [Info("WelcomePanel", "David", "3.0.7")]
    ...
    {   
        ...
        private string AvailableAddons()
        {
            ...
            #region API Calls
                ...
                private void OpenAddOn_API(BasePlayer player, string addonName)
                {   
                    if(addonName.ToLower().Contains("kits")) { WPKits.CallHook("ShowKits_Page1_API", player); return;}
                    if(addonName.ToLower().Contains("links")) { WPSocialLinks.CallHook("ShowLinks_API", player); return;}
                    if(addonName.ToLower().Contains("vip")) { WPVipRanks.CallHook("ShowVipRanks_API", player); return;}
                    if(addonName.ToLower().Contains("wipe")) { WPWipeCycle.CallHook("ShowWipeCycle_API", player); return;}
                    if(addonName.ToLower().Contains("votemap")) { VoteMap.CallHook("ContentCui", player, 1, 0, true); return;}
                    if(addonName.ToLower().Contains("shop")) { Shop.CallHook("ShowShop_API", player); return;}
                ...
                int GetLayout_API()
                {
                    return presetData[$"{Name}"].presetNumber;
                }
        ...
        {   
            ...
            if (config.generalSettings.customCommands.Contains(command.ToLower()))
            { 
                int index = config.generalSettings.customCommands.IndexOf(command.ToLower());
                int tab = index + 1;
        ...
        {   
            ...
            string[] offset = {"-680 -360", $"680 360"};     
            string[] anchor = {"0.5 0.5", "0.5 0.5"};   
            
            if (presetData[$"{Name}"].presetNumber == 5 || presetData[$"{Name}"].presetNumber == 2)
            {
                offset = new string[] {"0 0", "0 0"};
                anchor = new string[] {"-0.03 0", "1.03 1"};
            }
        ...
        #region Base
            ...
            //container
                CUIClass.CreatePanel(ref createBase, "offsetContainer", "Overlay", $"{cuiData["offsetContainer"].color}", anchor[0], anchor[1], false, Em(eM, cuiData["offsetContainer"].fade), $"{cuiData["offsetContainer"].material}", "", offset[0], offset[1]);
        ...
        {   
            ...
            if(tabNumber == 1) { btn_Title = config.tab1Settings.btnTitle; bgImage = config.tab1Settings.tabImageUrl; bgImage_Amin = config.tab1Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab1Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 2) { btn_Title = config.tab2Settings.btnTitle; bgImage = config.tab2Settings.tabImageUrl; bgImage_Amin = config.tab2Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab2Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 3) { btn_Title = config.tab3Settings.btnTitle; bgImage = config.tab3Settings.tabImageUrl; bgImage_Amin = config.tab3Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab3Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 4) { btn_Title = config.tab4Settings.btnTitle; bgImage = config.tab4Settings.tabImageUrl; bgImage_Amin = config.tab4Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab4Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 5) { btn_Title = config.tab5Settings.btnTitle; bgImage = config.tab5Settings.tabImageUrl; bgImage_Amin = config.tab5Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab5Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 6) { btn_Title = config.tab6Settings.btnTitle; bgImage = config.tab6Settings.tabImageUrl; bgImage_Amin = config.tab6Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab6Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 7) { btn_Title = config.tab7Settings.btnTitle; bgImage = config.tab7Settings.tabImageUrl; bgImage_Amin = config.tab7Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab7Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 8) { btn_Title = config.tab8Settings.btnTitle; bgImage = config.tab8Settings.tabImageUrl; bgImage_Amin = config.tab8Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab8Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 9) { btn_Title = config.tab9Settings.btnTitle; bgImage = config.tab9Settings.tabImageUrl; bgImage_Amin = config.tab9Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab9Settings.tabImageAnchor[1];
            ...
            if(tabNumber == 10) { btn_Title = config.tab10Settings.btnTitle; bgImage = config.tab10Settings.tabImageUrl; bgImage_Amin = config.tab10Settings.tabImageAnchor[0]; bgImage_Amax = config?.tab10Settings.tabImageAnchor[1];
            ...
            CUIClass.CreatePanel(ref createPage, $"{Name}_content", "offsetContainer", $"{cuiData["contentPanel"].color}", $"{cuiData["contentPanel"].anchorMin}", $"{cuiData["contentPanel"].anchorMax}", false, cuiData["contentPanel"].fade, cuiData["contentPanel"].material);
            

            if (addonName == "" || addonName == "null" || addonName == null) 
            {   
                if (CI("contentPanel")) CUIClass.CreateImage(ref createPage, $"{Name}_content", Img("contentPanel"), "0 0", "1 1", 0f);  
                ...
                { 
                    ...
                    {   
                        ...
                        CUIClass.CreateImage(ref createPage, $"{Name}_content", Img2(tabNumber), bgImage_Amin, bgImage_Amax, 0f);  
                                                                                        
                        CUIClass.CreateText(ref createPage, "contentText", $"{Name}_content", fontColor, $"{R(player, textContent)}", fontSize, "0.01 0.008", "0.99 0.992", textAnchor, fontStyle, fontOutColor, $"{fontOutThic} {fontOutThic}"); 
                    
                        if (CheckPage(tabNumber, indexNext)) 
                        {
                            CUIClass.CreateButton(ref createPage, "nextButton", $"{Name}_content", cuiData["nextButton"].color, "", 7, cuiData["nextButton"].anchorMin, cuiData["nextButton"].anchorMax, $"welcomepanel_open {tabNumber} {indexNext}", "", "1 1 1 1", 0f, TextAnchor.MiddleCenter, $"{config?.buttonSettings.btnFontStyle}", cuiData["nextButton"].material);
                            if (CI("nextButton")) CUIClass.CreateImage(ref createPage, "nextButton", Img("nextButton"), "0 0", "1 1", 0f);  
                        }
                        if (pageNumber != 1) 
                        {
                            CUIClass.CreateButton(ref createPage, "previousButton", $"{Name}_content", cuiData["previousButton"].color, "", 7, cuiData["previousButton"].anchorMin, cuiData["previousButton"].anchorMax, $"welcomepanel_open {tabNumber} {indexPrev}", "", "1 1 1 1", 0f, TextAnchor.MiddleCenter, $"{config?.buttonSettings.btnFontStyle}", cuiData["previousButton"].material);
        ...
        {   
            ...
            if (presetNumber == 1)
            {
                ...
                //main panel
                    ...
                    cuiData["mainPanel"].color = "0 0 0 0.55"; cuiData["mainPanel"].material = "assets/content/ui/uibackgroundblur-ingamemenu.mat"; 
                ...
                //side panel
                    ...
                    cuiData["sidePanel"].color = "0 0 0 0.55"; cuiData["sidePanel"].material = "assets/content/ui/uibackgroundblur-ingamemenu.mat"; 
            ...
            if (presetNumber == 2)
            {
                ...
                //main panel
                    ...
                    cuiData["mainPanel"].color = "0 0 0 0.4"; cuiData["mainPanel"].material = "assets/content/ui/uibackgroundblur-ingamemenu.mat"; 
                    cuiData["mainPanel"].image = ""; cuiData["mainPanel"].fade = 0.5f;
                //side panel
                    cuiData["sidePanel"].anchorMin = "0.02500001 -0.00499999"; cuiData["sidePanel"].anchorMax = "0.22 1.008";
                    cuiData["sidePanel"].color = "0 0 0 0.75"; cuiData["sidePanel"].material = "assets/content/ui/uibackgroundblur-ingamemenu.mat"; 
                    cuiData["sidePanel"].image = ""; cuiData["sidePanel"].fade = 0.5f;
                //title panel
            ...
            if (presetNumber == 5)
            {
                ...
                //side panel
                    cuiData["sidePanel"].anchorMin = "0 0"; cuiData["sidePanel"].anchorMax = "0 0";
                    cuiData["sidePanel"].color = "0 0 0 0.75"; cuiData["sidePanel"].material = "assets/icons/iconmaterial.mat"; 
                    cuiData["sidePanel"].image = ""; cuiData["sidePanel"].fade = 0.5f;
                //title panel
                    cuiData["titlePanel"].anchorMin = "0.178 0.745"; cuiData["titlePanel"].anchorMax = "0.9 0.85";
                    cuiData["titlePanel"].color = "0 0 0 0"; cuiData["titlePanel"].material = "assets/icons/iconmaterial.mat"; 
