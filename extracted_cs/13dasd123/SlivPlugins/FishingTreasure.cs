...
/* 1.0.4
 * Added NewSave option to remove hotspots on map wipe.
 * Added API int AddTempHotspot(Vector3 pos, float distance) - returns the index for the temp hotspot was created.
 * Added API void RemoveTempHotspot(int index) - removes the temp hotspot.
 * Added API ulong GetCasketSkin() - Returns the current skin id for caskets.
 * 
 */

namespace Oxide.Plugins
{
	[Info("FishingTreasure", "imthenewguy", "1.0.4")]
