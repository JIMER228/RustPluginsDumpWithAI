...
{
    [Info("Auto Farm", "Razor", "1.5.5", ResourceId = 34)]
    ...
    public class AutoFarm : RustPlugin
    {
        ...
        private void UpdateConfigValues()
        {
            ...
            if (configData.Version < new VersionNumber(1, 5, 0))
        ...
        class planterBoxBehavior : FacepunchBehaviour
        {
            ...
            public void ForceLightUpdate(GrowableEntity sunEntity)
            {
