...
{
    [Info("DVMenu", "Oxide Россия", "0.0.6")]
    [Description("Панель с приятным и удобным CUI и конфигом.")]
            ...
            public static Configuration GetNewConfiguration()
            {
                return new Configuration
                {
                    SettingPlugin = new SettingsPlugin
                    {
						...
						Bind = "chat.say /info",
						Logo = "https://ic.wampi.ru/2021/07/31/1.png",
                        PNG = "https://ic.wampi.ru/2021/07/31/7lOY4444sov.png",
                    }
                };
            }
        }
