    ...
    class CustomModules : RustPlugin
    {
        ...
        class RemoteModuleClass : ModuleBaseClass
        {
            ...
            void CreateCamera()
            {
                ...
                camera = BuildManager.CreateChildEntity(baseVehicleModule, "assets/prefabs/deployable/cctvcamera/cctv_deployed.prefab", localPosition, localRotation) as CCTV_RC;
            ...
            void CreateBroadcaster()
            {
                ...
                rfBroadcaster = BuildManager.CreateChildEntity(baseVehicleModule, "assets/prefabs/deployable/playerioents/gates/rfbroadcaster/rfbroadcaster.prefab", localPosition, localRotation) as RFBroadcaster;
        ...
        class BoostModuleClass : ModuleBaseClass
        {
            ...
            void SpawnRocketLaunchers()
            {
                foreach (LocationConfig locationConfig in boostModuleConfig.rocketLauncherLocations)
                {
                    ...
                    BaseEntity entity = BuildManager.CreateDecorativeChildEntity(baseVehicleModule, "assets/prefabs/weapons/rocketlauncher/rocket_launcher.entity.prefab", localPosition, localRotation);
            ...
            void TakeFuel()
            {
                baseVehicleModule.Vehicle.GetFuelSystem().pendingFuel = +boostModuleConfig.fuelConsScale;
            }
        ...
        class TurretModuleClass : ModuleBaseClass
        {
            ...
            void SpawnTurrets()
            {
                foreach (LocationConfig locationConfig in turretModuleConfig.turretlocations)
                {
                    ...
                    AutoTurret turret = BuildManager.CreateChildEntity(baseVehicleModule, "assets/prefabs/npc/autoturret/autoturret_deployed.prefab", localPosition, localRotation) as AutoTurret;
                ...
                foreach (var pair in baseModuleConfig.entities)
                {
                    ...
                    else
                    {
                        foreach (LocationConfig locationConfig in pair.Value)
                        {
                            ...
                            BaseEntity entity = BuildManager.CreateDecorativeChildEntity(baseVehicleModule, pair.Key, localPosition, localRotation);
                            attachedEntities.Add(entity);
                        }
                    }
                }
        ...
        static class BuildManager
        {
            ...
            internal static BaseEntity CreateDecorativeChildEntity(BaseEntity parrentEntity, string prefabName, Vector3 localPosition, Vector3 localRotation, ulong skinID = 0)
            {
                BaseEntity entity = GameManager.server.CreateEntity(prefabName, parrentEntity.transform.position);
                if (entity == null)
                    return null;
                ...
                DestroyEntityConponents<Collider>(entity);
        ...
        private class PluginConfig
        {
            ...
            public static PluginConfig DefaultConfig()
            {
                ...
                {
                    version = new VersionNumber(1, 1, 9),
