...
{
    [Info("HarborEvent", "KpucTaJl", "2.2.9")]
    internal class HarborEvent : RustPlugin
    {
        ...
        private object OnButtonPress(PressButton button, BasePlayer player)
        {
            ...
            if (button == Controller.Button && !Controller.Bradley.IsExists())
            {
        ...
        internal HashSet<Prefab> ContainerEntities { get; } = new HashSet<Prefab>
        {
            ...
            new Prefab { Path = "assets/prefabs/deployable/cctvcamera/cctv_deployed.prefab", Pos = new Vector3(0f, 2.4f, 4.5f), Rot = new Vector3(18f, 180f, 0f) }
        };
        ...
        private void Start(BasePlayer player)
        {
            ...
            timer.In(_config.PreStartTime, () =>
            {
                ...
                Interface.Oxide.CallHook("OnHarborEventStart", Controller.transform.position, _config.Radius);
        ...
        internal class ControllerHarborEvent : FacepunchBehaviour
        {
            ...
            private IEnumerator CargoControl()
            {
                ...
                ReturnCranes();
                Cargo.CancelInvoke(Cargo.LeaveHarbor);
            ...
            private static void SetToDefaultCrane(HarborCraneContainerPickup crane)
            {
                ...
                crane.transform.rotation = Quaternion.LookRotation(((pos + crane.startForward * 26f).WithY(pos.y) - pos).normalized, Vector3.up);
