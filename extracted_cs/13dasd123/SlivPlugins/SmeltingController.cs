...
namespace Oxide.Plugins
{
	...
	[Info("SmeltingController", "codefling.com/kasvoton", "1.5.13")]
	...
	public class SmeltingController : RustPlugin
	{
		...
		{
			HarmonyInstance.DEBUG = ConVar.Global.developer > 0;
			_harmony = HarmonyInstance.Create($"{Name}_{Version.Major}_{Version.Minor}_{Version.Patch}");
		}
