...
{
    [Info("WelcomeHelp", "Hougan", "0.0.6")]
	[Description("Куплено на Oxide-Russia.ru")]
    public class WelcomeHelp : RustPlugin
    {
        ...
        private class Configs
        {
            public class Interface
            {
                ...
                public string HeaderText = "OXIDE RUSSIA";
                ...
                public string LeftDownText = "ГРУППА\n" +
                                             "<b>VK.COM/OXIDE-RUSSIA</b>";
                [JsonProperty("Напись в правом нижнем углу")]
                public string RightDownText = "САЙТ\n" +
                                              "<b>OXIDE-RUSSIA.RU</b>";

                [JsonProperty("Надпись на кнопке")]
                public string ButtonText = "ВОЙТИ В ИГРУ";
            }
                ...
                return new Configs
                {
                    Pages = new List<Page>
                    {
                        new Page
                        {
                            ...
                            Text =
                                "У нас новая, уникальная система перепродажи. <b>Зачем?</b> - спросите вы. Это помогает вам сэкономить деньги!\n" +
                                "Если вы не очень богатые, у вас нету лишних денег, но срочно необходимы приватные плагины, купите их на <b>OXIDE RUSSIA</b>!\n\n" +
                                "Вы сэкономите деньги при создании сервера.",
                            Important = true,
                            ReadTime = 10
                        },
                        new Page
                ...
                /*case "switch":
                {
                    ...
                    if (SkipPlayers.Contains(player.userID))
                    {
                        container.Add(new CuiButton
                        {
                            ...
                            Button = { FadeIn = 1f, Color = "0 0 0 0.468", Material = "", Command = "UI_WelcomeHelpHandler switch" },
        ...
        private void UI_DrawInterface(BasePlayer player, bool onJoin = true)
        {
            ...
            else 
            {
                container.Add(new CuiButton
                {
                    ...
                    Button = { Color = "0.968627453468 0.921568632 0.882352948 0.02529412", Material = "", Close = Layer },
