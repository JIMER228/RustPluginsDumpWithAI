...
{
    [Info("PocketDimensions", "Nikedemos", "1.0.8")]
    ...
    public class PocketDimensions : RustPlugin
    {
        ...
        public const string MSG_VIABILITY_MORE_ENTITIES_IN_VOLUME_THAT_BUILDING = nameof(MSG_VIABILITY_MORE_ENTITIES_IN_VOLUME_THAT_BUILDING);
        public const string MSG_VIABILITY_LESS_ENTITIES_IN_VOLUME_THAT_BUILDING = nameof(MSG_VIABILITY_LESS_ENTITIES_IN_VOLUME_THAT_BUILDING);
        ...
        private static Dictionary<string, string> LangMessages = new Dictionary<string, string>
        {
            ...
            [MSG_VIABILITY_MORE_ENTITIES_IN_VOLUME_THAT_BUILDING] = "More entities ({0}) inside volume than found in the building ({1})",
            [MSG_VIABILITY_LESS_ENTITIES_IN_VOLUME_THAT_BUILDING] = "Less entities ({0}) inside volume than found in the building ({1})",
        ...
        public static class ConversionGuiManager
        {
            ...
            public static void PlayerPressConvertButton(BasePlayer player, ulong tcNetID)
            {
                        ...
                        case ConversionCurrencyType.CustomItemAmount:
                            {
                                ...
                                var iterateOver = Facepunch.Pool.GetList<Item>();
                        ...
                        case ConversionCurrencyType.Economics:
                            {
                                ...
                                int checkEconomics = Convert.ToInt32(Instance.Economics.Call("Balance", player.userID));
                ...
                switch (Instance.Configuration.ConversionCostCurrencyUsed)
                {
                    ...
                    case ConversionCurrencyType.Economics:
                        {
                            Instance.Economics.Call("Withdraw", player.userID, (double)amountNeeded);
                        }
                        break;
                }
            }
        ...
        public class DimensionalPocket : DimensionalBehaviour
        {
            ...
            {
                return portal.transform.position - portal.transform.right * 0.4F;
            }
            ...
            public void PlayerUsePortal(BasePlayer player)
            {
                ...
                TeleportPlayerTo(player, PairedBox.transform.position + Vector3.up * 0.33F, (PairedBox.transform.rotation * Vector3.forward).normalized);
            }
            ...
            public Vector3 GetTeleportPosition(bool useProvidedBoxExistingCheck, bool boxExists)
            {
                ...
                return LastKnownBoxPosition == default(Vector3) ? (boxExists ? PairedBox.transform.position : ServerMgr.FindSpawnPoint().pos) : LastKnownBoxPosition;
        ...
        private void CommandList(IPlayer iplayer, string command, string[] args)
        {
            ...
            switch (args[1].ToLower())
            {
                ...
                case CMD_LIST_ARG_TP_TO_BOX:
                    {
                        ...
                        TeleportPlayerTo(player, thisPocket.PairedBox.transform.position);
                ...
                case CMD_LIST_ARG_PLAYER_INFO:
                    {
                        List<ulong> playerIDList = Facepunch.Pool.GetList<ulong>();
                        ...
                        if (maybeTC != null)
                        {
                            ...
                            {
                                for (var i = 0; i < maybeTC.authorizedPlayers.Count; i++)
                                {
                                    var authorisedPlayerID = maybeTC.authorizedPlayers[i].userid;
                        ...
                        if (playerIDList.Count == 0)
                        {
                            ...
                            Facepunch.Pool.FreeList(ref playerIDList);
                            iplayer.Reply(buildResponse.ToString());
                            return;
                        }
        ...
        public class SpawnedPasteRequest
        {
            ...
            public void OnRequestedSpecialPasteFinished(List<BaseEntity> pastedEntities)
            {
                ...
                var steamIDList = Facepunch.Pool.GetList<ulong>();
                ...
                Facepunch.Pool.FreeList(ref steamIDList);
        ...
        public static bool ShellViabilityCheck(BuildingPrivlidge tc, out BuildingBlock middleFoundation, out BuildingBlock theExternalDoorway, out string log, out Vector3 debugPosition, string involvedPlayerUserID = null)
        {
            ...
            int everythingThatMattersInsideOBB = 0;
            ...
            for (var i = 0; i < ReusableVisibilityList.Count; i++)
            {
                asDecayEntity = ReusableVisibilityList[i] as DecayEntity;
                ...
                if (asDecayEntity == null)
                {
                    ...
                    ReusableExtraBaseCombatEntities.Add(asBaseCombat);
                ...
                else
                {
                    ...
                    bool ignoreAxisDistanceCheck = false;
                    ...
                    everythingThatMattersInsideOBB++;
            ...
            if (everythingThatMattersInsideOBB != everythingInBuildingCount)
            {
                //do we have extra entities in vis?
                if (everythingThatMattersInsideOBB > everythingInBuildingCount)
                {
                    log = MSG(MSG_VIABILITY_MORE_ENTITIES_IN_VOLUME_THAT_BUILDING, involvedPlayerUserID, everythingThatMattersInsideOBB, everythingInBuildingCount);
                }
                else
                {
                    log = MSG(MSG_VIABILITY_LESS_ENTITIES_IN_VOLUME_THAT_BUILDING, involvedPlayerUserID, everythingThatMattersInsideOBB, everythingInBuildingCount);
                }
        ...
        public static void ToastPlayer(BasePlayer player, string toast, GameTip.Styles style = GameTip.Styles.Red_Normal)
        {
            if (player == null)
            {
                return;
        ...
        public static void TeleportPlayerTo(BasePlayer player, Vector3 position, Vector3 viewAngles = default(Vector3))
        {
            ...
            {
                player.ClientRPCPlayer(null, player, "ForceViewAnglesTo", viewAngles);
            }
