...
{
    [Info("GasStationEvent", "KpucTaJl", "1.2.5")]
    internal class GasStationEvent : RustPlugin
    {
        ...
        private void Start(BasePlayer player)
        {
            ...
            {
                Puts("GasStationEvent has begun");
                ...
                Interface.Oxide.CallHook("OnGasStationEventStart", Controller.transform.position, _config.Radius);
        ...
        internal class ControllerGasStationEvent : FacepunchBehaviour
        {
            ...
            private void OnDestroy()
            {
                ...
                foreach (ScientistNPC npc in FirstScientists) if (npc.IsExists()) npc.Kill();
                foreach (ScientistNPC npc in SecondScientists) if (npc.IsExists()) npc.Kill();
            ...
            private void UpdateVendingMarker()
            {
                ...
                VendingMachineTime.shopName = GetTimeFormat(TimeToFinish);
            ...
            {
                List<CodeLock> list = Pool.GetList<CodeLock>();
            ...
            internal void FinishPathFirstCar(ControllerFirstCar controller)
            {
                ...
                Effect.server.Run("assets/prefabs/npc/patrol helicopter/damage_effect_debris.prefab", FirstCar.transform.position, Vector3.up, null, true);
        ...
        private void OnCorpsePopulate(ScientistNPC entity, NPCPlayerCorpse corpse)
        {
            ...
            if (Controller.FirstScientists.Contains(entity))
            {
                ...
                {
                    AlertToAllPlayers("KillAllVagos", _config.Prefix);
            ...
            else if (Controller.SecondScientists.Contains(entity))
            {
                ...
                {
                    AlertToAllPlayers("KillAllBallas", _config.Prefix);
        ...
        private void SendBalance()
        {
            ...
            Interface.Oxide.CallHook("OnGasStationEventWinner", winnerId);
