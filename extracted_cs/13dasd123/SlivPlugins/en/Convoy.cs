...
namespace Oxide.Plugins
{
    ...
    class Convoy : RustPlugin
    {
        ...
        {
            if (entity == null || convoyController == null || entity.net == null || entity.net.ID == null)
                return false;
        ...
        {
            if (crate == null || convoyController == null)
                return false;
        ...
        {
            if (patrolHelicopter == null || convoyController == null || patrolHelicopter.net == null || patrolHelicopter.net == null || patrolHelicopter.net.ID == null)
                return false;

            return convoyController.IsConvoyHeli(patrolHelicopter.net.ID.Value);
        }
        #endregion API
        ...
        void OnEntityTakeDamage(BuildingBlock buildingBlock, HitInfo info)
        {
            ...
            {
                if (!convoyController.convoyVehicles.Any(x => x != null && Vector3.Distance(info.PointStart, x.baseEntity.transform.position) < _config.maxDamageDistance * 2))
                    return;
        ...
        void OnEntityDeath(PatrolHelicopter entity, HitInfo info)
        {
            ...
            if (IsConvoyHeli(entity))
                EconomyManager.ActionEconomy(info.InitiatorPlayer.userID, "Heli");
        }
        ...
        void OnLootEntity(BasePlayer player, HackableLockedCrate crate)
        {
            ...
            if (convoyTruck != null)
                convoyController.OnCrateLooted(crate.net.ID.Value);
        }
        ...
        {
            if (convoyController.convoyHeli != null && convoyController.convoyHeli.patrolHelicopterAI == ai)
                return true;
            else
                return null;
        }
        ...
        object CanHelicopterTarget(PatrolHelicopterAI heli, BasePlayer player)
        {
            ...
            if (IsConvoyHeli(heli.helicopterBase))
            {
                if (!player.IsRealPlayer() || player.IsSleeping())
                    return false;
                else if (!_config.isAggressive && !convoyController.IsConvoyStop() && !convoyController.IsAnyCrateHacking())
                    return false;
            }
        ...
        object CanBradleyApcTarget(BradleyAPC apc, BaseEntity entity)
        {
            ...
            if (!_config.isAggressive && !convoyController.IsConvoyStop() && !convoyController.IsAnyCrateHacking())
                return false;
        ...
        {
            if (convoyController == null || npc == null)
                return null;
            else if (NpcManager.IsConvoyNpc(npc) && !convoyController.IsConvoyStop() && !_config.isAggressive)
                return false;
        ...
        {
            if (convoyController == null || container == null)
                return null;
        ...
        {
            if (convoyController == null || !_config.eventZone.isCreateZonePVP || hitinfo == null || !victim.IsRealPlayer())
                return null;

            if (_config.eventZone.isCreateZonePVP && !_config.pveMode.enable && ZoneController.IsPlayerInZone(victim.userID) && hitinfo.InitiatorPlayer.IsRealPlayer() && ZoneController.IsPlayerInZone(hitinfo.InitiatorPlayer.userID))
                return true;
            else
                return null;
        }
        ...
        {
            if (convoyController == null || info == null || entity == null || !info.InitiatorPlayer.IsRealPlayer())
                return null;
            ...
            if (NpcManager.IsConvoyNpc(entity.displayName))
            {
                ...
                if (!convoyController.CanConvoyNpcTakeDamage(info))
                    return false;
        ...
        {
            if (convoyController == null || victim == null || hitinfo == null)
                return null;
            ...
            {
                if (!convoyController.CanConvoyEntityTakeDamage(hitinfo, victim))
                    return false;
        ...
        {
            if (convoyController == null || victim == null || victim.net == null || hitinfo == null || !hitinfo.InitiatorPlayer.IsRealPlayer())
                return null;
        ...
        {
            if (convoyController == null || baseVehicleModule == null || baseVehicleModule.Vehicle == null || baseVehicleModule.Vehicle.net == null || hitinfo == null || !hitinfo.InitiatorPlayer.IsRealPlayer())
                return null;
            ...
            if (convoyVehicle != null && hitinfo.InitiatorPlayer.IsRealPlayer())
            {
                if (!convoyController.CanConvoyEntityTakeDamage(hitinfo, baseVehicleModule.Vehicle))
                    return false;
        ...
        {
            if (convoyController == null || entity == null)
                return null;
        ...
        {
            if (convoyController == null || crate == null || crate.net == null)
                return null;
        ...
        {
            if (convoyController == null || _config.betterNpcConfig.bradleyNpc || bradley == null || bradley.net == null)
                return null;

            if (convoyController.GetConvoyVehicleByEntityNetId(bradley.net.ID.Value) != null)
                return true;
        ...
        {
            if (convoyController == null || _config.betterNpcConfig.heliNpc || helicopter == null)
                return null;
        ...
        sealed class ConvoyController : FacepunchBehaviour
        {
            ...
            internal void OnConvoyAttacked(BasePlayer initiator = null)
            {
                ...
                if (initiator != null && !convoyAttackersIds.Contains(initiator.userID))
                ...
                Invoke(() =>
                {
                    if (ins.convoyController != null)
                    {
                        ZoneController.CreateZone(GetConvoyPosition(), initiator);
            ...
            IEnumerator MarkerUpdateCounter()
            {
                while (ins.convoyController != null)
                {
                    ...
                    if (vendingMarker.IsExists())
                    {
                        ...
                        string text = $"{ins.convoyController.convoySetting.displayName} {NotifyManager.GetTimeMessage(null, ins.convoyController.GetEventTime())} ";
                        if (ins._config.pveMode.showEventOwnerNameOnMap)
                            text += displayEventOwnerName;
                        ...
                        if (ins._config.pveMode.enable)
                            vendingMarker.SetFlag(BaseEntity.Flags.Busy, !ins._config.pveMode.showEventOwnerNameOnMap || eventOwnerName == "");
                    }
