...
namespace Oxide.Plugins
{
    ...
    public class Picklock : RustPlugin
    {
        ...
        public class CrateConfig
        {
            ...
            [JsonProperty("Minimum")] public int MinAmount;
            [JsonProperty("Maximum")] public int MaxAmount;
            [JsonProperty("Chance [0.0-100.0]")] public float Chance;
        }

        private class PluginConfig
        {
            [JsonProperty("Lock Opening Time [sec.]")] public float TimeUnlock;
            [JsonProperty("Lock Opening Probability [%]")] public float ChanceUnlock;
            [JsonProperty("Distance from player to the lock [m]")] public float DistanceUnlock;
            [JsonProperty("Do you want to open the door lock using the picklock? [true/false]")] public bool IsKeyLock;
            [JsonProperty("Do you want to open the code lock using the picklock? [true/false]")] public bool IsCodeLock;
            [JsonProperty("Open only the locks of the Raidable Bases plugin? [true/false]")] public bool OnlyRaidableBases;
            [JsonProperty("Open the door after breaking the lock? [true/false]")] public bool IsOpenDoor;
            [JsonProperty("Setting up of the picklock appearance in crates")] public List<CrateConfig> Crates;
