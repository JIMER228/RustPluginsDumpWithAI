...
{
    [Info("XPSystem", "TopPlugin.ru", "0.0.9")]
    ...
    class XPSystem : RustPlugin
    {
        ...
        { 
			PrintWarning(
			                           ...
			                           "mabe. Если будут какие-то вопросы, писать - Sempai#3239");
	    ...
	    private class Configuration
        {
            ...
            public class GUIShop
			{
				...
				public string FirstText = "ВНУТРИИГРОВОЙ МАГАЗИН <color=#a5e664>https://topplugin.ru/</color>";		
			}
		...
		private readonly List<NetworkableId> crateInfo = new List<NetworkableId>();
