...
{
    [Info("FurnaceSorter", "PsychoTea", "1.3.4")]
    ...
    class FurnaceSorter : RustPlugin
    {
        ...
        private void UpdateFurnace(ItemContainer container, Item item, bool adjustFuel = false, bool sortInputSlots = false)
        {
            ...
            playerInfo.CurrentFurnaceID = targetOven.net.ID.Value;
        ...
        private class PlayerInfo
        {
            ...
            public ulong CurrentFurnaceID { get; set; }
        ...
        {
            public ulong FurnaceID { get; set; }
            ...
            private static Hash<ulong, FurnaceInfo> _furnaceInfos = new Hash<ulong, FurnaceInfo>();

            public FurnaceInfo(BaseOven oven)
            {
                this.FurnaceID = oven.net.ID.Value;
            ...
            public static FurnaceInfo Get(BaseOven oven)
            {
                ...
                if (!_furnaceInfos.TryGetValue(oven.net.ID.Value, out furnaceInfo))
                    furnaceInfo = _furnaceInfos[oven.net.ID.Value] = new FurnaceInfo(oven);

                return furnaceInfo;
            }

            public static FurnaceInfo FindByID(ulong id)
            {
                FurnaceInfo furnaceInfo;
