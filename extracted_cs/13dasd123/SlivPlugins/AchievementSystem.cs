...
{
    [Info("Achievement System", "supreme", "2.6.6")]
    ...
    public class AchievementSystem : RustPlugin
    {
        ...
        private void OnCollectiblePickup(Item item, BasePlayer player)
        {
            ...
            if (item.info.itemid == -858312878)
            {
                data.HempPickedUp++;
                
                var minHemp = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHempsVIP : _config.AchievementsSet.minHemps;
            ...
            if (item.info.itemid == -567909622)
            {
                data.PumpkinPickedUp++;
                
                var minPumpkin = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minPumpkinsVIP : _config.AchievementsSet.minPumpkins;
            ...
            if (item.info.itemid == 1367190888)
            {
                data.CornPickedUp++;
                
                var minCorn = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minCornsVIP : _config.AchievementsSet.minCorns;
            ...
            if (item.info.shortname.Contains("stone"))
            {
                ...
                var minStone = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStonesVIP : _config.AchievementsSet.minStones;
            ...
            if (item.info.shortname.Contains("wood"))
            {
                ...
                var minWood = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWoodVIP : _config.AchievementsSet.minWood;
            ...
            if (item.info.shortname.Contains("metal"))
            {
                ...
                var minMetal = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minMetalsVIP : _config.AchievementsSet.minMetals;
            ...
            if (item.info.shortname.Contains("sulfur"))
            {
                ...
                var minSulfur = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSulfursVIP : _config.AchievementsSet.minSulfurs;
        ...
        {
            if (info.Initiator == null || info.Initiator.ShortPrefabName != "player" || victim == null || !victim.userID.IsSteamId() || !info.InitiatorPlayer.userID.IsSteamId() || victim.IsNpc || info.Initiator.IsNpc)
            {
                return;
            }
            ...
            if (info.isHeadshot)
            {
                ...
                var minHeadShots = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHeadshotsVIP : _config.AchievementsSet.minHeadshots;
        ...
        {
            if (victim == null || info == null || info.Initiator.ShortPrefabName != "player" || !victim.userID.IsSteamId() || victim.IsNpc || info.Initiator.IsNpc || victim == info.InitiatorPlayer)
            {
                return;
            }
        ...
        private void OnEntityDeath(BaseEntity entity, HitInfo info)
        {
            ...
            if (entity.name.Contains("barrel"))
            {
                ...
                var minBarrels = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBarrelsDestroyedVIP : _config.AchievementsSet.minBarrelsDestroyed;
            ...
            if (entity.ShortPrefabName == "boar")
            {
                ...
                var minBoars = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBoarsKillsVIP : _config.AchievementsSet.minBoarsKills;
            ...
            if (entity.ShortPrefabName == "bear")
            {
                ...
                var minBears = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBearsKillsVIP : _config.AchievementsSet.minBearsKills;
            ...
            if (entity.ShortPrefabName == "chicken")
            {
                ...
                var minChickens = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minChickensKillsVIP : _config.AchievementsSet.minChickensKills;
            ...
            if (entity.ShortPrefabName == "stag")
            {
                ...
                var minStags = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStagsKillsVIP : _config.AchievementsSet.minStagsKills;
            ...
            if (entity.ShortPrefabName == "wolf")
            {
                ...
                var minWolves = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWolvesKillsVIP : _config.AchievementsSet.minWolvesKills;
            ...
            if (entity.ShortPrefabName == "bradleyapc")
            {
                ...
                var minBradleys = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBradleysKillsVIP : _config.AchievementsSet.minBradleysKills;
            ...
            if (entity.ShortPrefabName == "patrolhelicopter")
            {
                ...
                var minHelicopters = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minChoppersKillsVIP : _config.AchievementsSet.minChoppersKills;
        ...
        private void OnEntityDeath(BaseCombatEntity entity, HitInfo info)
        {
            ...
            if (player == null || info == null || info.InitiatorPlayer == null || player == info.InitiatorPlayer || info.Initiator.IsNpc || !info.InitiatorPlayer.userID.IsSteamId())
            {
                return;
            }
            ...
            if (player.ShortPrefabName.Contains("scientist"))
            {
                data.ScientistsKilled++;

                var minScientists = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minScientistsKillsVIP : _config.AchievementsSet.minScientistsKills;

                if (_data.PlayerDatas.TryGetValue(player.userID, out PlayerData playerData) && playerData.ScientistsKilled == minScientists)
                {
        ...
        private void OnEntityDeath(ScientistNPC heavy, HitInfo info)
        {
            if (heavy == null || info == null || info.InitiatorPlayer == null || heavy == info.InitiatorPlayer || info.Initiator.IsNpc || !info.InitiatorPlayer.userID.IsSteamId())
            {
                return;
            }
            ...
            if (heavy.name.Contains("heavy"))
            {
                data.HeaviesKilled++;
                
                var minHeavies = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHeaviesKillsVIP : _config.AchievementsSet.minHeaviesKills;
        ...
        private void OnDispenserGather(ResourceDispenser dispenser, BasePlayer player, Item item)
        {
            ...
            if (item.info.shortname == "wood")
            {
                ...
                var minWood = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWoodGatheredVIP : _config.AchievementsSet.minWoodGathered;
            ...
            if (item.info.shortname == "stones")
            {
                ...
                var minStones = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStonesGatheredVIP : _config.AchievementsSet.minStonesGathered;
            ...
            if (item.info.shortname == "metal.ore")
            {
                ...
                var minMetal = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minMetalsGatheredVIP : _config.AchievementsSet.minMetalsGathered;
            ...
            if (item.info.shortname == "sulfur.ore")
            {
                ...
                var minSulfur = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSulfursGatheredVIP : _config.AchievementsSet.minSulfursGathered;
            ...
            if (item.info.shortname == "cloth")
            {
                ...
                var minCloth = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minClothSkinnedVIP : _config.AchievementsSet.minClothSkinned;
            ...
            if (player != null)
            {
                if (mod != null)
                {
                    if (mod.ToString().Contains("ammo"))
                    {
                        ...
                        var minBullets = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBulletsVIP : _config.AchievementsSet.minBullets;
            ...
            if (player != null)
            {
                if (item != null)
                {
                    if (item.name.Contains("explosive.timed") || item.name.Contains("explosive.satchel") || item.name.Contains("grenade.beancan") || item.name.Contains("grenade.f1"))
                    {
                        ...
                        var minExplosives = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minExplosivesVIP : _config.AchievementsSet.minExplosives;
        ...
        private void OnRocketLaunched(BasePlayer player, BaseEntity entity)
        {
            ...
            if (player != null)
            {
                ...
                var minRockets = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minRocketsVIP : _config.AchievementsSet.minRockets;
        ...
        private void ProcessPVPKills(BasePlayer player, BasePlayer victim)
        {
            ...
            if (victim.IsSleeping())
            {
                ...
                var minSleepers = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSleepersKillsVIP : _config.AchievementsSet.minSleepersKills;
            ...
            var minKills = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minPVPKillsVIP : _config.AchievementsSet.minPVPKills;
        ...
        private void AchievementsCheckCommand(BasePlayer player)
        {
            ...
            player.ChatMessage($"<color=#e3e3e3>[<color=#ACFA58>Achievement System</color>] Ваша статистика достижений:\n" +
                               $"Убить игроков: {_data.PlayerDatas[player.userID].PVPKills} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minPVPKillsVIP : _config.AchievementsSet.minPVPKills)}\n" +
                               $"Убить учёных в НПС городе:{_data.PlayerDatas[player.userID].ScientistsKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minScientistsKillsVIP : _config.AchievementsSet.minScientistsKills)}\n" +
                               $"Убить бронированных НПС на нефтевышке: {_data.PlayerDatas[player.userID].HeaviesKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHeaviesKillsVIP : _config.AchievementsSet.minHeaviesKills)}\n" +
                               $"Убить кабанов: {_data.PlayerDatas[player.userID].BoarsKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBoarsKillsVIP : _config.AchievementsSet.minBoarsKills)}\n" +
                               $"Убить медведей: {_data.PlayerDatas[player.userID].BearsKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBearsKillsVIP : _config.AchievementsSet.minBearsKills)}\n" +
                               $"Убить курочек: {_data.PlayerDatas[player.userID].ChickensKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minChickensKillsVIP : _config.AchievementsSet.minChickensKills)}\n" +
                               $"Убить оленей: {_data.PlayerDatas[player.userID].StagsKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStagsKillsVIP : _config.AchievementsSet.minStagsKills)}\n" +
                               $"Убить волков: {_data.PlayerDatas[player.userID].WolvesKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWolvesKillsVIP : _config.AchievementsSet.minWolvesKills)}\n" +
                               $"Взорвать танк: {_data.PlayerDatas[player.userID].BradleyDestroyed} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBradleysKillsVIP : _config.AchievementsSet.minBradleysKills)}\n" +
                               $"Сбить патрульный вертолёт: {_data.PlayerDatas[player.userID].HelicopterDestroyed} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minChoppersKillsVIP : _config.AchievementsSet.minChoppersKills)}\n" +
                               $"Убить слиперов: {_data.PlayerDatas[player.userID].SleepersKilled} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSleepersKillsVIP : _config.AchievementsSet.minSleepersKills)}\n" +
                               $"Убить в голову игроков: {_data.PlayerDatas[player.userID].HeadShots} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHeadshotsVIP : _config.AchievementsSet.minHeadshots)}\n" +
                               $"Уничтожить количество бочек: {_data.PlayerDatas[player.userID].BarrelsDestroyed} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBarrelsDestroyedVIP : _config.AchievementsSet.minBarrelsDestroyed)}\n" +
                               $"Взорвать взрывчатки всё кроме ракет: {_data.PlayerDatas[player.userID].ExplosivesThrown} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minExplosivesVIP : _config.AchievementsSet.minExplosives)}\n" +
                               $"Расстрелять патронов: {_data.PlayerDatas[player.userID].BulletsFired} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBulletsVIP : _config.AchievementsSet.minBullets)}\n" +
                               $"Выпустить ракет: {_data.PlayerDatas[player.userID].RocketsLaunched} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minRocketsVIP : _config.AchievementsSet.minRockets)}\n" +
                               $"Собрать кустов конопли: {_data.PlayerDatas[player.userID].HempPickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHempsVIP : _config.AchievementsSet.minHemps)}\n" +
                               $"Собрать тыквы: {_data.PlayerDatas[player.userID].PumpkinPickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minPumpkinsVIP : _config.AchievementsSet.minPumpkins)}\n" +
                               $"Собрать кукурузы {_data.PlayerDatas[player.userID].CornPickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minCornsVIP : _config.AchievementsSet.minCorns)}\n" +
                               $"Подобрать с земли пней: {_data.PlayerDatas[player.userID].WoodPickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWoodVIP : _config.AchievementsSet.minWood)}\n" +
                               $"Подобрать с земли камня: {_data.PlayerDatas[player.userID].StonePickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStonesVIP : _config.AchievementsSet.minStones)}\n" +
                               $"Подобрать с земли метал руды: {_data.PlayerDatas[player.userID].MetalPickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minMetalsVIP : _config.AchievementsSet.minMetals)}\n" +
                               $"Подобрать с земли серной руды: {_data.PlayerDatas[player.userID].SulfurPickedUp} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSulfursVIP : _config.AchievementsSet.minSulfurs)}\n" +
                               $"Нафармить камня: {_data.PlayerDatas[player.userID].StoneGathered} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStonesGatheredVIP : _config.AchievementsSet.minStonesGathered)}\n" +
                               $"Напилить дерева: {_data.PlayerDatas[player.userID].WoodGathered} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWoodGatheredVIP : _config.AchievementsSet.minWoodGathered)}\n" +
                               $"Нафармить металлической руды: {_data.PlayerDatas[player.userID].MetalGathered} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minMetalsGatheredVIP : _config.AchievementsSet.minMetalsGathered)}\n" +
                               $"Нафармить серной руды: {_data.PlayerDatas[player.userID].SulfurGathered} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSulfursGatheredVIP : _config.AchievementsSet.minSulfursGathered)}\n" +
                               $"Собрать ткани: {_data.PlayerDatas[player.userID].ClothSkinned} / {(HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minClothSkinnedVIP : _config.AchievementsSet.minClothSkinned)}</color>");
        }
        ...
        {
            public Hash<ulong, PlayerData> PlayerDatas = new Hash<ulong, PlayerData>();
        }
        ...
        private class PlayerData
        {
            ...
            public int ScientistsKilled = 0;
            public int HeaviesKilled = 0;
            public int BoarsKilled = 0;
            public int BearsKilled = 0;
            public int ChickensKilled = 0;
            public int StagsKilled = 0;
            public int WolvesKilled = 0;
            public int BradleyDestroyed = 0;
            public int HelicopterDestroyed = 0;
            ...
            public int HempPickedUp = 0;
            public int PumpkinPickedUp = 0;
            public int CornPickedUp = 0;
            public int StonePickedUp = 0;
            public int WoodPickedUp = 0;
            public int MetalPickedUp = 0;
            public int SulfurPickedUp = 0;
            public int StoneGathered = 0;
            public int WoodGathered = 0;
            public int MetalGathered = 0;
            public int SulfurGathered = 0;
            public int ClothSkinned = 0;
            public List<string> AchievementsRedeemed = new List<string>();
            public bool DisplayWood;
            public bool DisplayStone;
            public bool DisplayMetal;
            public bool DisplaySulfur;
            public bool DisplayCloth;
        ...
        private void DestroyAllUi(BasePlayer player) => CuiHelper.DestroyUi(player, UiPanelName);
        ...
        private void DisplayUI(BasePlayer player, string text, string imageName)
        {
            ...
            Ui.Image(container, _plugin.ImageLibrary.Call("GetImage", "AchievementSystemUI").ToString(), imagePos, "#ffffff", 255, 1f, 1f); //Achievement Template
            
            UiPosition logoPos = new UiPosition(0.02f, 0.35f, 0.25f, 0.70f);
            Ui.Image(container, _plugin.ImageLibrary.Call("GetImage", imageName).ToString(), logoPos, "#ffffff", 255f, 1f, 1f); //Achievement Logo
        ...
        private void DisplayAchievements(BasePlayer player)
        {
            ...
            var minWoodGathered = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minWoodGatheredVIP : _config.AchievementsSet.minWoodGathered;
            ...
            var minStonesGathered = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minStonesGatheredVIP : _config.AchievementsSet.minStonesGathered;
            ...
            var minMetalGathered = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minMetalsGatheredVIP : _config.AchievementsSet.minMetalsGathered;
            ...
            var minSulfurGathered = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSulfursGatheredVIP : _config.AchievementsSet.minSulfursGathered;
            ...
            var minScientistsKills = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minScientistsKillsVIP : _config.AchievementsSet.minScientistsKills;
            ...
            var minChoppers = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minChoppersKillsVIP : _config.AchievementsSet.minChoppersKills;
            ...
            if (player != null && args.HasArgs(1))
            {
                switch (args.Args[0].ToLower())
                {
                    ...
                    case "redeem_killer":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].PVPKills >= minKills)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsPVPKillsVIP : _config.RewardSet.rewardsPVPKills;

                            if (_config.AchievementsImg.enableItems)
                            {
                                foreach (var item in items)
                                {
                                    var give = ItemManager.CreateByName(item.Key, item.Value);
                            ...
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsPVPKillsRPVIP : _config.RewardSet.rewardsPVPKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsPVPKillsEconomicsVIP : _config.RewardSet.rewardsPVPKillsEconomics;
                    ...
                    case "redeem_nightmare":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].SleepersKilled >= minSleepers)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSleepersKillsVIP : _config.RewardSet.rewardsSleepersKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSleepersKillsRPVIP : _config.RewardSet.rewardsSleepersKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSleepersKillsEconomicsVIP : _config.RewardSet.rewardsSleepersKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_headhunter":
                    {
                        ...
                        var minHs = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minHeadshotsVIP : _config.AchievementsSet.minHeadshots;

                        if (_data.PlayerDatas[player.userID].HeadShots >= minHs)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHeadshotsVIP : _config.RewardSet.rewardsHeadshots;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHeadshotsRPVIP : _config.RewardSet.rewardsHeadshotsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHeadshotsEconomicsVIP : _config.RewardSet.rewardsHeadshotsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_woodlurker":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].WoodPickedUp >= minWood)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWoodVIP : _config.RewardSet.rewardsWood;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWoodRPVIP : _config.RewardSet.rewardsWoodRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWoodEconomicsVIP : _config.RewardSet.rewardsWoodEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_pies":
                    {
                        ...
                        var minPies = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minPumpkinsVIP : _config.AchievementsSet.minPumpkins;

                        if (_data.PlayerDatas[player.userID].PumpkinPickedUp >= minPies)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsPumpkinsVIP : _config.RewardSet.rewardsPumpkins;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsPumpkinsRPVIP : _config.RewardSet.rewardsPumpkinsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsPumpkinsEconomicsVIP : _config.RewardSet.rewardsPumpkinsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_popcorn":
                    {
                        ...
                        var minPopcorn = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minCornsVIP : _config.AchievementsSet.minCorns;

                        if (_data.PlayerDatas[player.userID].CornPickedUp >= minPopcorn)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsCornsVIP : _config.RewardSet.rewardsCorns;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsCornsRPVIP : _config.RewardSet.rewardsCornsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsCornsEconomicsVIP : _config.RewardSet.rewardsCornsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_cannabis":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].HempPickedUp >= minHemp)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHempsVIP : _config.RewardSet.rewardsHemps;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHempsRPVIP : _config.RewardSet.rewardsHempsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHempsEconomicsVIP : _config.RewardSet.rewardsHempsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_maniac":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].BulletsFired >= minBullets)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBulletsVIP : _config.RewardSet.rewardsBullets;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBulletsRPVIP : _config.RewardSet.rewardsBulletsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBulletsEconomicsVIP : _config.RewardSet.rewardsBulletsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_stoneage":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].StonePickedUp >= minStone)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStonesVIP : _config.RewardSet.rewardsStones;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStonesRPVIP : _config.RewardSet.rewardsStonesRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStonesEconomicsVIP : _config.RewardSet.rewardsStonesEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_metal":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].MetalPickedUp >= minMetal)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsMetalsVIP : _config.RewardSet.rewardsMetals;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsMetalsRPVIP : _config.RewardSet.rewardsMetalsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsMetalsEconomicsVIP : _config.RewardSet.rewardsMetalsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_raider":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].SulfurPickedUp >= minSulfur)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSulfursVIP : _config.RewardSet.rewardsSulfurs;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSulfursRPVIP : _config.RewardSet.rewardsSulfursRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSulfursEconomicsVIP : _config.RewardSet.rewardsSulfursEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_goldenbarrel":
                    {
                        ...
                        var minBarrel = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minBarrelsDestroyedVIP : _config.AchievementsSet.minBarrelsDestroyed;

                        if (_data.PlayerDatas[player.userID].BarrelsDestroyed >= minBarrel)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBarrelsVIP : _config.RewardSet.rewardsBarrels;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBarrelsRPVIP : _config.RewardSet.rewardsBarrelsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBarrelsEconomicsVIP : _config.RewardSet.rewardsBarrelsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_rpg":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].RocketsLaunched >= minRockets)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsRocketsVIP : _config.RewardSet.rewardsRockets;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsRocketsRPVIP : _config.RewardSet.rewardsRocketsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsRocketsEconomicsVIP : _config.RewardSet.rewardsRocketsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_boom":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].ExplosivesThrown >= minExplosives)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsExplosivesVIP : _config.RewardSet.rewardsExplosives;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsExplosivesRPVIP : _config.RewardSet.rewardsExplosivesRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsExplosivesEconomicsVIP : _config.RewardSet.rewardsExplosivesEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_axeman":
                    {
                        ...
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWoodGatheredVIP : _config.RewardSet.rewardsWoodGathered;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWoodGatheredRPVIP : _config.RewardSet.rewardsWoodGatheredRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWoodGatheredEconomicsVIP : _config.RewardSet.rewardsWoodGatheredEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_miner":
                    {
                        ...
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStonesGatheredVIP : _config.RewardSet.rewardsStonesGathered;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStonesGatheredRPVIP : _config.RewardSet.rewardsStonesGatheredRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStonesGatheredEconomicsVIP : _config.RewardSet.rewardsStonesGatheredEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_metalgear":
                    {
                        ...
                        var minMetals = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minMetalsGatheredVIP : _config.AchievementsSet.minMetalsGathered;

                        if (_data.PlayerDatas[player.userID].MetalGathered >= minMetals)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsMetalsGatheredVIP : _config.RewardSet.rewardsMetalsGathered;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsMetalsGatheredRPVIP : _config.RewardSet.rewardsMetalsGatheredRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsMetalsGatheredEconomicsVIP : _config.RewardSet.rewardsMetalsGatheredEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_evilminer":
                    {
                        ...
                        var minSulfurs = HasPermission(player, UsePermissionVIP) ? _config.AchievementsSetVIP.minSulfursGatheredVIP : _config.AchievementsSet.minSulfursGathered;

                        if (_data.PlayerDatas[player.userID].SulfurGathered >= minSulfurs)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSulfursGatheredVIP : _config.RewardSet.rewardsSulfursGathered;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSulfursGatheredRPVIP : _config.RewardSet.rewardsSulfursGatheredRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsSulfursGatheredEconomicsVIP : _config.RewardSet.rewardsSulfursGatheredEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_outsmarted":
                    {
                        ...
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsScientistsKillsVIP : _config.RewardSet.rewardsScientistsKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsScientistsKillsRPVIP : _config.RewardSet.rewardsScientistsKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsScientistsKillsEconomicsVIP : _config.RewardSet.rewardsScientistsKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_juggernaut":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].HeaviesKilled >= minHeavies)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHeaviesKillsVIP : _config.RewardSet.rewardsHeaviesKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHeaviesKillsRPVIP : _config.RewardSet.rewardsHeaviesKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsHeaviesKillsEconomicsVIP : _config.RewardSet.rewardsHeaviesKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_piggy":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].BoarsKilled >= minBoars)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBoarsKillsVIP : _config.RewardSet.rewardsBoarsKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBoarsKillsRPVIP : _config.RewardSet.rewardsBoarsKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBoarsKillsEconomicsVIP : _config.RewardSet.rewardsBoarsKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_pookie":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].BearsKilled >= minBears)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBearsKillsVIP : _config.RewardSet.rewardsBearsKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBearsKillsRPVIP : _config.RewardSet.rewardsBearsKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBearsKillsEconomicsVIP : _config.RewardSet.rewardsBearsKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_chickendinner":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].ChickensKilled >= minChickens)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsChickensKillsVIP : _config.RewardSet.rewardsChickensKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsChickensKillsRPVIP : _config.RewardSet.rewardsChickensKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsChickensKillsEconomicsVIP : _config.RewardSet.rewardsChickensKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_bambi":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].StagsKilled >= minStags)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStagsKillsVIP : _config.RewardSet.rewardsStagsKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStagsKillsRPVIP : _config.RewardSet.rewardsStagsKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsStagsKillsEconomicsVIP : _config.RewardSet.rewardsStagsKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_lonewolf":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].WolvesKilled >= minWolves)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWolvesKillsVIP : _config.RewardSet.rewardsWolvesKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWolvesKillsRPVIP : _config.RewardSet.rewardsWolvesKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsWolvesKillsEconomicsVIP : _config.RewardSet.rewardsWolvesKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_tankhunter":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].BradleyDestroyed >= minBradleys)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBradleysKillsVIP : _config.RewardSet.rewardsBradleysKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBradleysKillsRPVIP : _config.RewardSet.rewardsBradleysKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsBradleysKillsEconomicsVIP : _config.RewardSet.rewardsBradleysKillsEconomics;
                                AddEconomics(player, rp);
                            }
                        }
                    ...
                    case "redeem_chopperhunter":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].HelicopterDestroyed >= minChoppers)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsChoppersKillsVIP : _config.RewardSet.rewardsChoppersKills;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsChoppersKillsRPVIP : _config.RewardSet.rewardsChoppersKillsRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsChoppersKillsEconomicsVIP : _config.RewardSet.rewardsChoppersKillsEconomics;
                                AddEconomics(player, rp);
                            }
                    ...
                    case "redeem_skinner":
                    {
                        ...
                        if (_data.PlayerDatas[player.userID].ClothSkinned >= minCloth)
                        {
                            var items = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsClothSkinnedVIP : _config.RewardSet.rewardsClothSkinned;
                            ...
                            if (_config.AchievementsImg.enableRP)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsClothSkinnedRPVIP : _config.RewardSet.rewardsClothSkinnedRP;
                                AddPoints(player, rp);
                            }
                            
                            if (_config.AchievementsImg.enableEconomics)
                            {
                                var rp = HasPermission(player, UsePermissionVIP) ? _config.RewardSetVIP.rewardsClothSkinnedEconomicsVIP : _config.RewardSet.rewardsClothSkinnedEconomics;
                                AddEconomics(player, rp);
                            }
                        }
