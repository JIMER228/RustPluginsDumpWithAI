    ...
    public class NoEscape : RustPlugin
    {
        ...
        private class PlayerBlockStatus : FacepunchBehaviour
        {
            ...
            public void CreateUI()
            {
                ...
                {
                    RectTransform = { AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-199 79", OffsetMax = "180 84" },
                    Image = { Color = "0.2 0.2 0.2 0.85", Material = "assets/icons/greyout.mat" }
                }, "Hud", "NoEscape");

                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0 0.85", AnchorMax = "1 4" },
                    Text = { Text = $"Рейдблок", Font = "robotocondensed-bold.ttf", Color = "1 1 1 0.9", FontSize = 12, Align = TextAnchor.MiddleLeft }
            ...
            public void UpdateUI()
            {
                ...
                CuiHelper.DestroyUi(Player, "NoEscape" + ".Time");
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiImageComponent { Color = "1.00 0.00 0.16 0.85", Material = "assets/icons/greyout.mat" },
                ...
                {
                    RectTransform = { AnchorMin = "0 0.85", AnchorMax = "1 4" },
                    Text = { Text = $"{ins.GetFormatTime(TimeSpan.FromSeconds(CurrentBlocker.TotalTime - CurrentTime))}", Font = "robotocondensed-bold.ttf", Color = "1 1 1 0.9", FontSize = 12, Align = TextAnchor.MiddleRight }
                }, "NoEscape", "NoEscape" + ".Time");
