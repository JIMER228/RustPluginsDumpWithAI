...
* 1.2.0     :   NPC is now a melee type again (scarecrow)
*           :   Added various Behaviours for melee attack
*           :   Small coding cleanup
    ...
    class WalkingDead : RustPlugin
    {
        ...
        public class Walkers : FacepunchBehaviour
        {
            ...
            private void Awake()
            {
                ...
                InvokeRepeating(Attack, 1.2f, 2.0f);
            ...
            private void Attack()
            {
                BaseEntity entity = npc.Brain.Senses.GetNearestTarget(40);
        ...
        void OnPlayerDeath(BasePlayer player, HitInfo info)
        {
            if (player.userID.IsSteamId())
            {
                ...
                else
                {
                    ...
                    if (zoneIds == null)
                    {
                        if (Debug) Puts($"[Debug] No ZoneId's are listed");
                        return;
                    }
