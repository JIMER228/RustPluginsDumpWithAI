...
{
    [Info("SightsSystem", "RustPluginsSliv", "1.3.0")]
    class SightsSystem : RustPlugin
    {
        ...
        void OnPlayerConnected(BasePlayer player)
        {
            if (!DB.ContainsKey(player.userID))
                DB.Add(player.userID, "https://ir-rust.ir/pic/EJsPEkn.png");
        ...
        {
            "https://ir-rust.ir/pic/O1T5M2S.png",
            "https://ir-rust.ir/pic/udgZFcU.png",
            "https://ir-rust.ir/pic/7zs9aHt.png",
            "https://ir-rust.ir/pic/iCrNfVl.png",
            "https://ir-rust.ir/pic/lBZ2Khj.png",
	        "https://ir-rust.ir/pic/6e22fbf2.png",
	        "https://ir-rust.ir/pic/udgZFcU.png",
	        "https://ir-rust.ir/pic/Untitled-2.png",
	        "https://ir-rust.ir/pic/XCSkVNk.png",
	        "https://ir-rust.ir/pic/mIbPpj3.png",
	        "https://ir-rust.ir/pic/RACMuqg.png",
	        "https://ir-rust.ir/pic/tqtF73m.png",
	        "https://ir-rust.ir/pic/10dbace8c3d8593f.png",
            "https://ir-rust.ir/pic/EJsPEkn.png"
        };
        #endregion
        ...
        void SightsUI(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = $"Choose One For CrossHair", Color = "1 1 1 0.5", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf", FontSize = 24 }
            }, "Layer1");
