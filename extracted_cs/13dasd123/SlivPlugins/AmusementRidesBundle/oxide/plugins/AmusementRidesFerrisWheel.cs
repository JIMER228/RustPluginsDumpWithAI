    ...
    public class AmusementRidesFerrisWheel : AmusementRidesPlugin
    {
        ...
        {            
            ...
            public override object WhenButtonPress(Ride ride, PressButton button, BasePlayer player)
            {
                ...
                {
                    if (ride.structure.entityToSpecialGroup.ContainsKey(button.net.ID.Value))
                    {
                        var specialButtonGroupID = ride.structure.entityToSpecialGroup[button.net.ID.Value];
