...
namespace Oxide.Plugins
{
    ...
    public class AmusementRides : RustPlugin
    {
        ...
        public Dictionary<ulong, Ride> entityToRide = new Dictionary<ulong, Ride>();
        ...
        void OnEntityKill(BaseEntity entity)
        {
            ...
            if (entityToRide.TryGetValue(entity.net.ID.Value, out maybeRide))
            {
        ...
        {
            if (entityToRide.ContainsKey(sign.net.ID.Value))
            {
                //update all signs?!
        ...
        {
            if (entityToRide.ContainsKey(entity.net.ID.Value))
            {
                entityToRide[entity.net.ID.Value].handler.WhenItemDeployed(entityToRide[entity.net.ID.Value], deployer, entity);
            }
        }
        ...
        object OnWireCommon(BasePlayer player, IOEntity entity1, IOEntity entity2)
        {
            ...
            if (entityToRide.ContainsKey(entity1.net.ID.Value))
            {
                result = true;
            }
            else
            {
                if (entityToRide.ContainsKey(entity2.net.ID.Value))
                {
                    result = true;
                }
            }
        ...
        void OnEntityBuilt(Planner plan, GameObject go)
        {
            ...
            if (skinToDefinition.ContainsKey(entity.skinID))
            {
                ...
                if (passedTest)
                {
                    ...
                    rides[newRide].structure.rideVolume.allowedEntities.Add(entity.net.ID.Value, entity);

                    if (theFoundation != null)
                    {
                        rides[newRide].structure.rideVolume.allowedEntities.Add(theFoundation.net.ID.Value, theFoundation);
                    }
        ...
        {
            if (entityToRide.ContainsKey(button.net.ID.Value))
            {
                return entityToRide[button.net.ID.Value].handler.WhenButtonPress(entityToRide[button.net.ID.Value], button, player);
            }
            return null;
        }
        ...
        {
            if (entityToRide.ContainsKey(electricSwitch.net.ID.Value))
            {
                return entityToRide[electricSwitch.net.ID.Value].handler.WhenSwitchToggle(entityToRide[electricSwitch.net.ID.Value], electricSwitch, player);
            }
            return null;
        }
        ...
        object OnStructureUpgrade(BaseCombatEntity entity, BasePlayer player, BuildingGrade.Enum grade)
        {
            ...
            if (entityToRide.ContainsKey(entity.net.ID.Value))
            {
                return entityToRide[entity.net.ID.Value].handler.WhenStructureUpgrade(entityToRide[entity.net.ID.Value], entity, player, grade);
            }
            return null;
        }
        ...
        object OnCupboardAuthorize(BuildingPrivlidge privilege, BasePlayer player)
        {
            ...
            if (entityToRide.ContainsKey(privilege.net.ID.Value))
            {
                return entityToRide[privilege.net.ID.Value].handler.WhenCupboardUpdate(entityToRide[privilege.net.ID.Value], privilege, player);
            }
            else return null;
        }
        ...
        {
            if (entityToRide.ContainsKey(mountable.net.ID.Value))
            {
                return entityToRide[mountable.net.ID.Value].handler.IfMountEntity(entityToRide[mountable.net.ID.Value], player, mountable);
            }
            else return null;
        }
        ...
        object CanDismountEntity(BasePlayer player, BaseMountable mountable)
        {
            ...
            if (!entityToRide.TryGetValue(mountable.net.ID.Value, out ride))
            {
                return null;
            }

            return ride.handler.IfDismountEntity(entityToRide[mountable.net.ID.Value], player, mountable);
        }
        ...
        void OnPlayerInput(BasePlayer player, InputState input)
        {
            ...
            ride.handler.ForceDismountEntity(entityToRide[mountable.net.ID.Value], player, mountable);
        }
        ...
        object CanUseLockedEntity(BasePlayer player, BaseLock baseLock)
        {
            ...
            if (entityToRide.ContainsKey(baseLock.net.ID.Value))
            {
                return entityToRide[baseLock.net.ID.Value].handler.IfUseLockedEntity(entityToRide[baseLock.net.ID.Value], player, baseLock);
            }
            else return null;
        }
        ...
        void OnLootEntity(BasePlayer player, BaseEntity entity)
        {
            ...
            if (entityToRide.ContainsKey(entity.net.ID.Value))
            {
                if (player != null)
                {
                    entityToRide[entity.net.ID.Value].handler.WhenLootEntity(entityToRide[entity.net.ID.Value], player, entity);
                }
            }
        }
        ...
        void OnLootEntityEnd(BasePlayer player, BaseCombatEntity entity)
        {
            ...
            if (entityToRide.ContainsKey(entity.net.ID.Value))
            {
                entityToRide[entity.net.ID.Value].handler.WhenLootEntityEnd(entityToRide[entity.net.ID.Value], player, entity);
            }
        }
        ...
        object CanDemolish(BasePlayer player, BuildingBlock block, BuildingGrade.Enum grade)
        {
            ...
            if (entityToRide.ContainsKey(block.net.ID.Value))
            {
                TellMessage(player, MSG(MSG_CANT_DEMOLISH_RIDE_ENTITY, player.UserIDString), entityToRide[block.net.ID.Value].rideData.nickname);
                return false;
            }
            else return null;
        }
        ...
        object OnStructureRotate(BaseCombatEntity entity, BasePlayer player)
        {
            ...
            if (entityToRide.ContainsKey(entity.net.ID.Value))
            {
                TellMessage(player, MSG(MSG_CANT_ROTATE_RIDE_ENTITY, player.UserIDString), entityToRide[entity.net.ID.Value].rideData.nickname);
                return false;
            }
            else return null;
        }
        ...
        object CanPickupEntity(BasePlayer player, BaseEntity entity)
        {
            ...
            if (entityToRide.ContainsKey(entity.net.ID.Value))
            {
                return entityToRide[entity.net.ID.Value].handler.IfPickupEntity(entityToRide[entity.net.ID.Value], player, entity);
            }
            else return null;
        }
        ...
        {
            input.inputs[inputSlot].connectedTo.entityRef.uid = new NetworkableId(0);
            ...
            output.outputs[outputSlot].connectedTo.entityRef.uid = new NetworkableId(0);
        ...
        public class RideVolume : AmusementBehaviour
        {
            ...
            public Dictionary<ulong, BaseCombatEntity> alienEntities = new Dictionary<ulong, BaseCombatEntity>();
            public Dictionary<ulong, BaseCombatEntity> allowedEntities = new Dictionary<ulong, BaseCombatEntity>();
            ...
            void OnTriggerEnter(Collider col)
            {
                ...
                if (ride.structure.allEntities.ContainsKey(entity.net.ID.Value)) return;
                if (alienEntities.ContainsKey(entity.net.ID.Value)) return;

                if (initialCheckPerformed == false)
                {
                    if (!allowedEntities.ContainsKey(entity.net.ID.Value))
                    {
                        alienEntities.Add(entity.net.ID.Value, entity);
                    }
        ...
        public class RideStructure
        {
            ...
            public Dictionary<ulong, BaseEntity> allEntities = new Dictionary<ulong, BaseEntity>();
            public Dictionary<ulong, StabilityEntity> immobileStabilityEntities = new Dictionary<ulong, StabilityEntity>();
            public Dictionary<ulong, BaseCombatEntity> damagableEntities = new Dictionary<ulong, BaseCombatEntity>();
            ...
            public Dictionary<int, Dictionary<ulong, BaseEntity>> specialGroups = new Dictionary<int, Dictionary<ulong, BaseEntity>>();
            public Dictionary<ulong, int> entityToSpecialGroup = new Dictionary<ulong, int>();

            public Dictionary<ulong, BaseMountable> mountables = new Dictionary<ulong, BaseMountable>();
            ...
            public Splitter SummonSplitterAndAddToCache<T>(IOEntity andThenEngageYourZeroethInputToOutputEntity = null, int outputSlotForThatOutputEntity = 0) where T : IOEntity
            {
                ...
                ride.structure.allEntities.Add(newIOCompo.net.ID.Value, newIOCompo);
                Instance.entityToRide.Add(newIOCompo.net.ID.Value, ride);
            ...
            public virtual DroppedItem AttachNewItemToPivot(int itemID, DroppedItem parentPivot, Vector3 position, Vector3 rotation, ulong skin, bool special, int specialGroup)
            {
                ...
                Instance.entityToRide.Add(newItem.net.ID.Value, ride);

                allEntities.Add(newItem.net.ID.Value, newItem);
                ...
                if (special)
                {
                    ...
                    {
                        specialGroups.Add(specialGroup, new Dictionary<ulong, BaseEntity>());
                    }

                    specialGroups[specialGroup].Add(newItem.net.ID.Value, newItem);

                    entityToSpecialGroup.Add(newItem.net.ID.Value, specialGroup); //reverse lookup
                }
            ...
            public virtual BaseEntity AttachNewEntityToPivot(string prefabName, DroppedItem pivot, Vector3 position, Vector3 rotation, ulong skin, bool special, bool locked, bool mobile, int specialGroup, BuildingGrade.Enum grade = BuildingGrade.Enum.None, bool damagable = false, string gibsName = null)
            {
                ...
                Instance.entityToRide.Add(newEntity.net.ID.Value, ride);
                ...
                if (maybeHorse != null)
                {
                    Instance.timer.Once(2F, () =>
                    {
                        ...
                        {
                            allEntities.Add(saddle.net.ID.Value, saddle);
                            Instance.entityToRide.Add(saddle.net.ID.Value, ride);
                            mountables.Add(saddle.net.ID.Value, saddle);
                    ...
                    if (maybeDecayEntity != null)
                    {
                        ...
                        if (maybeStabilityEntity != null)
                        {
                           ...
                           // maybeStabilityEntity.SetHealth(maybeStabilityEntity.MaxHealth());
                            ...
                            if (!mobile)
                            {
                                immobileStabilityEntities.Add(maybeStabilityEntity.net.ID.Value, maybeStabilityEntity);
                            }
                ...
                allEntities.Add(newEntity.net.ID.Value, newEntity);

                if (damagable)
                {
                    damagableEntities.Add(newEntity.net.ID.Value, newEntity as BaseCombatEntity);
                }
                ...
                {
                    mountables.Add(maybeMountable.net.ID.Value, maybeMountable);
                ...
                if (special)
                {
                    ...
                    specialGroups[specialGroup].Add(newEntity.net.ID.Value, newEntity);

                    entityToSpecialGroup.Add(newEntity.net.ID.Value, specialGroup); //reverse lookup
                }
        ...
        public class RideHandler
        {
            ...
            public virtual bool IsPlayerAuthorisedOnRide(Ride ride, BasePlayer player)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            foreach (Item itemId in player.inventory.FindItemsByItemID(AmusementRidesPlugin.ITEM_LOCK_KEY))
                            {
            ...
            public void RefreshEntities(Ride ride, BasePlayer player)
            {
                ...
                if (ride.RefreshQueue == null)
                {
                    ...
                    foreach (var entry in ride.structure.allEntities)
                    {
                        ...
                        if (ride.structure.immobileStabilityEntities.ContainsKey(e.net.ID.Value))
                        {
                            continue;
                        }
            ...
            public IEnumerator RefreshCoroutine(Ride ride, BasePlayer player)
            {
                ...
                for (var i = 0; i < ride.RefreshQueue.Length; i++)
                {
                    ...
                    if (Network.Net.sv.IsConnected())
                    {
                        ...
                        netWrite.UInt32((uint)entity.net.ID.Value);
                ...
                for (var i = 0; i < ride.structure.allSpeakersArray.Length; i++)
                {
                    ...
                    speaker.ClientRPCPlayerAndSpectators(null, player, "Client_StopPlayingAudio", ride.structure.boombox.net.ID.Value);
                    speaker.Invoke(() =>
                    {
                        speaker.ClientRPCPlayerAndSpectators(null, player, "Client_PlayAudioFrom", ride.structure.boombox.net.ID.Value);
            ...
            public virtual bool OnRideTriggerEnter(Ride ride, Collider col, string segmentName = null)
            {
                ...
                else
                {
                    ...
                    {
                        if (!Instance.entityToRide.ContainsKey(entity.net.ID.Value))
                        {
            ...
            public virtual void WhenEntityKill(Ride ride, BaseEntity entity)
            {
                ...
                if (!ride.structure.damagableEntities.ContainsKey(entity.net.ID.Value))
                {
                ...
                else
                {
                    ...
                    ride.structure.damagableEntities.Remove(entity.net.ID.Value);
                }

                if (ride.structure.immobileStabilityEntities.ContainsKey(entity.net.ID.Value))
                {
                    ride.structure.immobileStabilityEntities.Remove(entity.net.ID.Value);
                }

                if (Instance.entityToRide.ContainsKey(entity.net.ID.Value))
                {
                    Instance.entityToRide.Remove(entity.net.ID.Value);
                }

                if (ride.structure.allEntities.ContainsKey(entity.net.ID.Value))
                {
                    ride.structure.allEntities.Remove(entity.net.ID.Value);
                }
            ...
            public virtual object WhenEntityTakeDamage(Ride ride, BaseCombatEntity entity, HitInfo info, bool megaDebug = false)
            {
                if (ride.rideData.isAdminRide)
                {
                    if (megaDebug)
                    {
                        Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: ADMIN RIDE, RETURNING TRUE");
                    }
                ...
                if (ride.isAlreadyDestroying)
                {
                    if (megaDebug)
                    {
                        Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: ALREADY DESTROYING, RETURNING TRUE");
                    }
                    return true;
                }
                ...
                if (ride.structure.damagableEntities.ContainsKey(entity.net.ID.Value))
                {
                    if (megaDebug)
                    {
                        Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: IT'S A DAMAGABLE ENTITY...");
                    }
                    ...
                    if (info.damageTypes.GetMajorityDamageType() == Rust.DamageType.Decay)
                    {
                        if (megaDebug)
                        {
                            Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: DECAY, RETURNING TRUE");
                        }
                        return true;
                    }
                    else
                    {
                        ...
                        if (total < entity.Health())
                        {
                            if (megaDebug)
                            {
                                Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: TOTAL DAMAGE TO ENTITY IS LESS THAN ENTITY HEALTH, RETURNING NULL");
                            }
                            return null;
                        }
                        else
                ...
                else
                {
                    if (megaDebug)
                    {
                        Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: IT'S NOT A DAMAGABLE ENTITY...");
                    }

                    //if it's not damagable and the container is a TC, pass the buck!
                    if (ride.structure.container.net.ID.Value != entity.net.ID.Value)
                    {
                        if (megaDebug)
                        {
                            Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: IT'S NOT THE RIDE CONTAINER.");
                        }
                        ...
                        if (entity.PrefabName == AmusementRidesPlugin.PREFAB_HORSE && info.damageTypes.GetMajorityDamageType() == Rust.DamageType.Decay)
                        {
                            if (megaDebug)
                            {
                                Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: HORSE DECAY DAMAGE, RETURNING TRUE...");
                            }
                            return true;
                        }
                        ...
                        else
                        {
                            if (megaDebug)
                            {
                                Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: RIDE CONTAINER DYING, RETURNING TRUE.");
                            }
                    ...
                    if (megaDebug)
                    {
                        Instance.PrintError($">>>>> MEGA DEBUG FOR {entity.ShortPrefabName} {entity.net.ID.Value}: WE GOT TO THE END, RETURNING TRUE.");
                    }
        ...
        public class Ride : AmusementBehaviour
        {
            ...
            public void LockToData(BaseLock baseLock)
            {
                ...
                if (!structure.allEntities.ContainsKey(baseLock.net.ID.Value))
                {
                    structure.allEntities.Add(baseLock.net.ID.Value, baseLock);
                }

                if (!Instance.entityToRide.ContainsKey(baseLock.net.ID.Value))
                {
                    Instance.entityToRide.Add(baseLock.net.ID.Value, this);
                }
                ...
                Instance.NextFrame(() =>
                {
                    if (rideData.hasLock)
                    {
                        if (rideData.isCodeLock)
                        {
                            ...
                            if (!structure.allEntities.ContainsKey(newCodelock.net.ID.Value))
                            {
                                structure.allEntities.Add(newCodelock.net.ID.Value, newCodelock);
                            }

                            if (!Instance.entityToRide.ContainsKey(newCodelock.net.ID.Value))
                            {
                                Instance.entityToRide.Add(newCodelock.net.ID.Value, this);
                            }
                        ...
                        else
                        {
                            ...
                            if (!structure.allEntities.ContainsKey(newKeyLock.net.ID.Value))
                            {
                                structure.allEntities.Add(newKeyLock.net.ID.Value, newKeyLock);
                            }

                            if (!Instance.entityToRide.ContainsKey(newKeyLock.net.ID.Value))
                            {
                                Instance.entityToRide.Add(newKeyLock.net.ID.Value, this);
                            }
                        ...
                        foreach (var group in structure.specialGroups)
                        {
                            ...
                            foreach (var entity in group.Value)
                            {
                                Instance.timer.Once(delay + ((float)counter / 10F), () =>
                                {
                                    ...
                                    sign.textureIDs[0] = (uint)sign.net.ID.Value; // Явное преобразование NetworkableId в uint
                                    string str = "";
            ...
            public void DefinitionToStructure()
            {
                ...
                structure.allEntities.Add(structure.vendingMachine.net.ID.Value, structure.vendingMachine);
                Instance.entityToRide.Add(structure.vendingMachine.net.ID.Value, this);
                ...
                structure.allEntities.Add(structure.boomboxGenerator.net.ID.Value, structure.boomboxGenerator);
                Instance.entityToRide.Add(structure.boomboxGenerator.net.ID.Value, this);//
                ...
                structure.allEntities.Add(structure.boombox.net.ID.Value, structure.boombox);
                Instance.entityToRide.Add(structure.boombox.net.ID.Value, this);
        ...
        public class ExtraRideData
        {
            ...
            public Dictionary<int, ulong> memoryUint = new Dictionary<int, ulong>();
        ...
        public class RideData
        {
            ...
            public ulong boomboxTapeAudioID = 0;
        ...
        private void cmdConsoleWorkbenchUI(ConsoleSystem.Arg arg)
        {
            ...
            if (arg.HasArgs())
            {
                ...
                {
                    // Преобразование uint в NetworkableId
                    NetworkableId netID = new NetworkableId(maybeNetID);
        ...
        public class WorkbenchUI : GenericUI
        {
            ...
            public void LoadDefinitionIntoDescription(string definitionName, BasePlayer player)
            {
                if (Instance.rideDefinitions.ContainsKey(definitionName))
                {
                    ...
                    craftButton.Command = $"workbench_ui {workbenchHelper.workbench.net.ID.Value} craft {definition.rideName}";
                }
            }
            ...
            public void SetPreviousAndNextCommands()
            {
                ...
                previousButton.Command = $"workbench_ui {workbenchHelper.workbench.net.ID.Value} page previous";

                var nextButton = containerMenu[2].Components[0] as CuiButtonComponent;
                nextButton.Command = $"workbench_ui {workbenchHelper.workbench.net.ID.Value} page next";
            ...
            public void SetRideButtonFromDefinition(int indexStartAt, RideDefinition definition, BasePlayer player)
            {
                ...
                buttonButton.Command = $"workbench_ui {workbenchHelper.workbench.net.ID.Value} ride {definition.rideName}";
