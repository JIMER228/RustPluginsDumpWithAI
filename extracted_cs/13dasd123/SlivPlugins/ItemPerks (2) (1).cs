...
/* 1.0.18
 * Added a config option to adjust the spawn position of a new node with RockCycler.
 * Added hookmethod: float IPAPI_GetDropChanceModifier(string userid) - returns the players drop chance modifier.
 * Moved Regrowth to next tick so it doesn't cause an infinite loop with woodcutting ultimate from SkillTree.
 * Updated unpatching for Harmony in Carbon.
 */

namespace Oxide.Plugins
{
    [Info("Item Perks", "imthenewguy", "1.0.18")]
