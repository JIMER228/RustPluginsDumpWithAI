...
{
    [Info("Space", "Adem", "1.3.0")]
    class Space : RustPlugin
    {
        [PluginReference] Plugin NpcSpawn, PveMode, GUIAnnouncements, DiscordMessages, Economics, ServerRewards, IQEconomic, NightVision, Friends, Clans;
        ...
        void OnServerInitialized()
        {
            ...
            if (_config.mainConfig.isAutoEvent) EventManager.TryStartEvent(immediately: false);
        }
        ...
        sealed class EventZone : FacepunchBehaviour
        {
            ...
            void CreatePveModeZone()
            {
                ...
                ins.PveMode.Call("EventAddPveMode", ins.Name, config, SpaceClass.GetSpaceTransform().position, ins._config.mainConfig.spaceRadius, crates, npcs, bradleys, new HashSet<ulong>(), new HashSet<ulong>(), null);
                ins.PveMode.Call("EventAddTurrets", ins.Name, turrets);
            }
                    ...
                    supportedPluginsConfig = new SupportedPluginsConfig
                    {
                        ...
                        pveMode = new PveModeConfig
                        {
                            ...
                            scaleDamage = new HashSet<ScaleDamageConfig>
                            {
                                ...
                                new ScaleDamageConfig { Type = "Turret", Scale = 1f },
                            },
                            lootCrate = false,
                            hackCrate = false,
                            lootNpc = false,
