...
{
    [Info("GatherLootMultiplier", "tofurahie", "1.3.6")]
    internal class GatherLootMultiplier : RustPlugin
    {
        ...
        {
            if (container == null || _config.IgnoreLootContainers.Contains(container.PrefabName))
                return;
        ...
        private void ShowUIPersonalRates(BasePlayer player, int customRatePage = 0, int page = 0)
        {
            ...
            UnityEngine.Debug.LogWarning(page); 
