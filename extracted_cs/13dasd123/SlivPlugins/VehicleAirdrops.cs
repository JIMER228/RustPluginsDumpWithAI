...

{
    ...
    public class VehicleAirdrops : RustPlugin
    {
        ...
        public const string MSG_DROP_NAME_SNOWMOBILE_RED = "MSG_DROP_NAME_SNOWMOBILE_RED";
        public const string MSG_DROP_NAME_SNOWMOBILE_TOMAHA = "MSG_DROP_NAME_SNOWMOBILE_TOMAHA";

        public const string MSG_DROP_NAME_SNOWMOBILE_REDS = "MSG_DROP_NAME_SNOWMOBILE_REDS";
        public const string MSG_DROP_NAME_SNOWMOBILE_TOMAHAS = "MSG_DROP_NAME_SNOWMOBILE_TOMAHAS";
        ...
        public const string MSG_PLEASE_SPECIFY_PATCH6 = "MSG_PLEASE_SPECIFY_PATCH6";
        ...
        public static Dictionary<string, string> LangMessages = new Dictionary<string, string>
        {
            ...
            [MSG_DROP_NAME_SNOWMOBILE_RED] = "Snowmobile Red",
            [MSG_DROP_NAME_SNOWMOBILE_TOMAHA] = "Snowmobile Tomaha",

            [MSG_DROP_NAME_SNOWMOBILE_REDS] = "Snowmobiles Red",
            [MSG_DROP_NAME_SNOWMOBILE_TOMAHAS] = "Snowmobiles Tomaha",
            ...
            [MSG_PLEASE_SPECIFY_PATCH6] = "Please specify the kind: <color=yellow>random</color>, <color=yellow>minicopter</color>, <color=yellow>scrapheli</color>, <color=yellow>rowboat</color>, <color=yellow>rhib</color>, <color=yellow>car</color>, <color=yellow>solosub</color>, <color=yellow>duosub</color>, <color=yellow>crate</color>, <color=yellow>snowmobile_red</color>, <color=yellow>snowmobile_tomaha</color>",
        ...
        public static LayerMask CollisionLayer = 1 << (int)Rust.Layer.Water | 1 << (int)Rust.Layer.Tree | /*1 << (int)Rust.Layer.Debris |*/ 1 << (int)Rust.Layer.Clutter | 1 << (int)Rust.Layer.Default | 1 << (int)Rust.Layer.Player_Server | 1 << (int)Rust.Layer.Construction | 1 << (int)Rust.Layer.Terrain | 1 << (int)Rust.Layer.World | 1 << (int) Rust.Layer.Deployed;
        ...
        public static Dictionary<string, string> KindToFakeItemName = new Dictionary<string, string>
        {
            ...
            ["car"] = "sticks",
            ["crate"] = "paper",
            ["solosub"] = "chicken.spoiled",
            ["duosub"] = "wolfmeat.spoiled",
            ["snowmobile_red"] = "humanmeat.spoiled",
            ["snowmobile_tomaha"] = "apple.spoiled"
        };
        ...
        public static Dictionary<string, string> FakeItemNameToKind = new Dictionary<string, string>
        {
            ...
            ["sticks"] = "car",
            ["paper"] = "crate",
            ["chicken.spoiled"] = "solosub",
            ["wolfmeat.spoiled"] = "duosub",
            ["humanmeat.spoiled"] = "snowmobile_red",
            ["apple.spoiled"] = "snowmobile_tomaha"
        };
        ...
        public static Dictionary<ulong, string> SkinIDToItemName = new Dictionary<ulong, string>
        {
            ...
            [2567551241] = "solosub",
            [2567552797] = "duosub",
            [2756133263] = "snowmobile_red",
            [2756136166] = "snowmobile_tomaha",
        };
        ...
        public static Dictionary<string, ulong> ItemNameToSkinID = new Dictionary<string, ulong>
        {
            ...
            ["solosub"] = 2567551241,
            ["duosub"] = 2567552797,
            ["snowmobile_red"] = 2756133263,
            ["snowmobile_tomaha"] = 2756136166,
        };
        ...
        public static Dictionary<string, string> ShortPrefabName = new Dictionary<string, string>
        {
            ...
            ["snowmobile_red"] = "assets/content/vehicles/snowmobiles/snowmobile.prefab",
            ["snowmobile_tomaha"] = "assets/content/vehicles/snowmobiles/tomahasnowmobile.prefab",
        };
        ...
        public static class SignalDefinitions
        {
            ...
            public static void GetTranslatedDefinitions()
            {
                definitions = new Dictionary<string, SignalDefinition>
                {
                    ...
                    ["snowmobile_red"] = new SignalDefinition { itemSuffix = MSG(MSG_DROP_NAME_SNOWMOBILE_RED), skinID = 2756133263 },
                    ["snowmobile_tomaha"] = new SignalDefinition { itemSuffix = MSG(MSG_DROP_NAME_SNOWMOBILE_TOMAHA), skinID = 2756136166 },
                };
            }
        }
        ...
        //public static Dictionary<ulong, CustomSignal> CustomSignals;// = new Dictionary<ulong, CustomSignal>();
        public static Dictionary<BaseEntity, string> CustomCargoPlanes;// = new Dictionary<BaseEntity, string>();
        public static Dictionary<ulong, CustomDrop> EntityIDToCustomDrop;// = new Dictionary<ulong, CustomDrop>();
        //same as above, but used for quick iterating when unloading
        public static Dictionary<ulong, CustomDrop> JustMainEntityIDToCustomDrop;// = new Dictionary<ulong, CustomDrop>();
        public static Dictionary<ulong, CustomNormalDrop> EntityIDToNormalDrop;// = new Dictionary<ulong, CustomNormalDrop>();
        ...
        private void ProcessConfigData()
        {
            ...
            else if (configData.version == "1.0.5" || configData.version == "1.0.6" || configData.version == "1.0.7")
            {
                migrateStage6 = true;
            }
            ...
            if (migrateStage6)
            {
                ...
                if (!configData.dropConfigs.ContainsKey("snowmobile_red"))
                {
                    configData.dropConfigs.Add("snowmobile_red", new DropConfig
                    {
                        name = "snowmobile_red",
                        priceCurrency = 200,
                        priceEconomics = 200,
                ...
                if (!configData.dropConfigs.ContainsKey("snowmobile_tomaha"))
                {
                    configData.dropConfigs.Add("snowmobile_tomaha", new DropConfig
                    {
                        name = "snowmobile_tomaha",
                        priceCurrency = 100,
                        priceEconomics = 100,
            ...
            updateConfig = migrateStage1 || migrateStage2 || migrateStage3 || migrateStage4 || migrateStage5 || migrateStage6;
        ...
        public class ConfigData
        {
            ...
            [JsonProperty("Supply signal smoke length, in seconds (210 = default Rust)")]
            public float smokeEffectLength = 210F;
            ...
            public ulong vendingMachineRestockEvery = 60;
            ...
            public Dictionary<string, DropConfig> dropConfigs = new Dictionary<string, DropConfig>
            {
                ...
                ["snowmobile_tomaha"] = new DropConfig
                {
                    name = "snowmobile_tomaha",
                    priceCurrency = 100,
                    priceEconomics = 100,
        ...
        public class FireworkLauncher : MonoBehaviour
        {
            ...
            void Awake()
            {
                stopLaunchingAt = UnityEngine.Time.realtimeSinceStartup + Instance.configData.maxFireworkShowDuration;
                ready = true;
            }
        ...
        public class CustomDrop : MonoBehaviour
        {
            ...
            public bool isSnowmobile = false;
            ...
            public List<ulong> personalGarbage = new List<ulong>();
            ...
            void Awake()
            {
                ...
                Snowmobile maybeSnowmobile = null;
                ...
                else
                {
                    ...
                    maybeSnowmobile = vehicle as Snowmobile;
                    ...
                    {
                        isSnowmobile = true;
                        this.snowmobile = maybeSnowmobile;

                        maybeSnowmobile.rigidBody.useGravity = false;
                        //maybeModular.rigidBody.isKinematic = false;
                        maybeSnowmobile.rigidBody.drag = 0;
                    }
                }
            ...
            void FixedUpdate()
            {
                ...
                if (!landed)
                {
                    ...
                    else
                    {
                        ...
                        if (isModularVehicle || isSnowmobile)
                        {
                            if (vehicle.rigidBody.useGravity == false)
                            {
                                ...
                                vehicle.rigidBody.velocity = Instance.configData.fallSpeedWithParachute * 5 * Vector3.down;
                            }
                        }
        ...
        public class CustomSignal : MonoBehaviour
        {
            ...
            {
                signal.Invoke(new Action(signal.FinishUp), Instance.configData.smokeEffectLength);
        ...
        private void OnServerInitialized(bool serverInitialized)
        {
            ...
            //CustomSignals = new Dictionary<ulong, CustomSignal>();
            CustomCargoPlanes = new Dictionary<BaseEntity, string>();
            EntityIDToCustomDrop = new Dictionary<ulong, CustomDrop>();

            JustMainEntityIDToCustomDrop = new Dictionary<ulong, CustomDrop>();
            EntityIDToNormalDrop = new Dictionary<ulong, CustomNormalDrop>();
        ...
        /*
        object CanMoveItem(Item item, PlayerInventory playerLoot, ulong targetContainer, int targetSlot, int amount)
        {
            if (item.skin == 0) return null;
        ...
        void OnItemAddedToContainer(ItemContainer container, Item item)
        {
            ...
            if (maybeVendingMachine != null)
            {
                ...
                if (maybeVendingMachine != configData.dedicatedVendingMachine)
                {
                    return;
                }
        ...
        void OnExplosiveThrown(BasePlayer player, SupplySignal entity, ThrownWeapon item)
        {
            ...
            if (SkinIDToItemName.ContainsKey(actualItem.skin) || actualItem.skin == 0)
            {
                ...
                //add to the registry
                //CustomSignals.Add(entity.net.ID.Value, compo);
        ...
        object OnEntityTakeDamage(BaseCombatEntity entity, HitInfo info)
        {
            ...
            {
                /*
                if (!EntityIDToNormalDrop.ContainsKey(entity.net.ID.Value))
                {
                    return null;
                }

                var maybeNormalDrop = EntityIDToNormalDrop[entity.net.ID.Value];
            ...
            {
                if (!EntityIDToCustomDrop.ContainsKey(entity.net.ID.Value))
                {
                    return null;
                }
                ...
                var maybeCustomDrop = EntityIDToCustomDrop[entity.net.ID.Value];
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        var maybeSnowmobileAny = vehicle as Snowmobile;
                                        if (maybeSnowmobileAny != null)
                                        {
                                            //which one?
                                            if (maybeSnowmobileAny.PrefabName.Contains("tomaha"))
                                            {
                                                EquipVehicle(maybeSnowmobileAny, "snowmobile_tomaha");
                                            }
                                            else
                                            {
                                                EquipVehicle(maybeSnowmobileAny, "snowmobile_red");
                                            }
                                        }
                                    }
                                }
        ...
        public object CanAccessDrop(BasePlayer player, BaseNetworkable entity)
        {
            ...
            if (!EntityIDToCustomDrop.ContainsKey(entity.net.ID.Value) && !EntityIDToNormalDrop.ContainsKey(entity.net.ID.Value))
            {
                return null;
            }
            ...
            if (EntityIDToCustomDrop.ContainsKey(entity.net.ID.Value)) dropComponent = EntityIDToCustomDrop[entity.net.ID.Value];

            if (dropComponent == null)
            {
                var normalComponent = EntityIDToNormalDrop[entity.net.ID.Value];
        ...
        private void cmdChatSignal(BasePlayer player, string command, string[] args)
        {
            ...
            {
                Instance.TellMessage(player, MSG(MSG_PLEASE_SPECIFY_PATCH6, player.UserIDString));
            }
        ...
        public class GuiManager
        {
            ...
            public static readonly float heightMenuButton = 0.0254F;
            ...
            public CuiButton elementButtonPage11 = new CuiButton
            {
                Button =
                {
                    Color = $"{ColorPalette.BurgundyDark.rustString}",
                    Command = "vagui_page 11",
                },
                Text =
                {
                    Align = TextAnchor.MiddleCenter,
                ...
                RectTransform = { AnchorMin = $"{leftP.ToString()} {(bottomB - 11 * (paddingV + heightMenuButton)).ToString()}", AnchorMax = $"{rightL.ToString()} {(topB - 11 * (paddingV + heightMenuButton)).ToString()}" },
            };

            public CuiButton elementButtonPage12 = new CuiButton
            {
                Button =
                {
                    Color = $"{ColorPalette.CaramelDark.rustString}",
                    Command = "vagui_page 12",
                },
                Text =
                {
                    Align = TextAnchor.MiddleCenter,
                ...
                RectTransform = { AnchorMin = $"{leftP.ToString()} {(bottomB - 12 * (paddingV + heightMenuButton)).ToString()}", AnchorMax = $"{rightL.ToString()} {(topB - 12 * (paddingV + heightMenuButton)).ToString()}" },
            };
            ...
            public GuiPage pageSnowmobileRed;
            public GuiPage pageSnowmobileTomaha;
            ...
            public void PrepareCommon()
            {
                ...
                containerNav.Add(elementButtonPage11, "Overlay", "vagui.button11");
                containerNav.Add(elementButtonPage12, "Overlay", "vagui.button12");
                ...
                pageSnowmobileRed = new GuiPageParticularDrop(this, "Snowmobile R.", "snowmobile_red", "11", true);
                pageSnowmobileTomaha = new GuiPageParticularDrop(this, "Snowmobile T.", "snowmobile_tomaha", "12", true);
            ...
            public void ButtonsHide(BasePlayer player)
            {
                ...
                CuiHelper.DestroyUi(player, "vagui.button11");
                CuiHelper.DestroyUi(player, "vagui.button12");
            }
            ...
            public void PagesHide(BasePlayer player)
            {
                ...
                pageSnowmobileRed.GuiPageHide(player);
                pageSnowmobileTomaha.GuiPageHide(player);
            }
        }
        ...
        private void cmdConsoleGuiOption(ConsoleSystem.Arg arg)
        {
            ...
            switch (option)
            {
                ...
                case "vendingrestock":
                    {
                        //check if value is a ulong
                        ulong maybeUint;
                        if (ulong.TryParse(value, out maybeUint))
                        {
                            if (maybeUint > 0)
                            {
        ...
        public GuiManager.GuiPage PageIDtoInstance(string pageID)
        {
            ...
            switch (pageID)
            {
                ...
                case "11":
                    {
                        page = GUI.pageSnowmobileRed;
                    }
                    break;
                case "12":
                    {
                        page = GUI.pageSnowmobileTomaha;
                    }
                    break;
            }   
        ...
        public void RidiculousWorkaround(CustomDrop drop)
        {
            ...
            {
                drop.dummyPlayer = GameManager.server.CreateEntity("assets/prefabs/player/player.prefab", drop.vehicle.transform.position, drop.vehicle.transform.rotation, true).ToPlayer();
                drop.dummyPlayer.limitNetworking = true;
                drop.dummyPlayer.Spawn();

                if (drop.dummyPlayer != null)
                {
                    var seat = drop.vehicle.gameObject.GetComponentsInChildren<BaseVehicleSeat>().FirstOrDefault();

                    drop.dummyPlayer.MountObject(seat);
                    drop.vehicle.SendNetworkUpdateImmediate();
            ...
            if (isDrop || Instance.configData.dropConfigs[kind].applyToNatural)
            {
                if (Instance.configData.dropConfigs[kind].comesWithFuel > 0)
                {
                    ...
                    var maybeBoat = entity as MotorRowboat;
                        ...
                        {
                            var maybeSnowmobileAny = entity as Snowmobile;

                            if (maybeSnowmobileAny != null)
                            {
                                container = maybeSnowmobileAny.GetFuelSystem().fuelStorageInstance.Get(true);
        ...
        public void DetachParachute(CustomDrop drop)
        {
            if (!drop.landed)
            {
                ...
                {
                    if (drop.isModularVehicle || drop.isSnowmobile)
                    {
                        drop.vehicle.rigidBody.useGravity = true;
                        //drop.modularCar.rigidBody.drag = drop.landDrag;
                        //drop.modularCar.rigidBody.isKinematic = false;
                        drop.vehicle.rigidBody.velocity = Vector3.zero;
        ...
        private BaseEntity SpawnCustomDrop(string kind, Vector3 position, Vector3 eulerAngles, ulong ownerID = 0)
        {
            ...
            if (!EntityIDToCustomDrop.ContainsKey(newDrop.net.ID.Value))
            {
                EntityIDToCustomDrop.Add(newDrop.net.ID.Value, compo);
            }

            //again, this will help with fast lookup
            if (!JustMainEntityIDToCustomDrop.ContainsKey(newDrop.net.ID.Value))
            {
                JustMainEntityIDToCustomDrop.Add(newDrop.net.ID.Value, compo);
            }

            //and add to personal garbage
            compo.personalGarbage.Add(newDrop.net.ID.Value);
            ...
            Instance.NextTick(() =>
            {
                ...
                if (tryNormalSeats != null)
                {
                    foreach (var entity in tryNormalSeats)
                    {
                        ...
                        if (!EntityIDToCustomDrop.ContainsKey(entity.net.ID.Value))
                        {
                            EntityIDToCustomDrop.Add(entity.net.ID.Value, compo);
                        }
                        //give the seat the same OwnerID
                        if (!compo.personalGarbage.Contains(entity.net.ID.Value))
                        {
                            compo.personalGarbage.Add(entity.net.ID.Value);
                        }
