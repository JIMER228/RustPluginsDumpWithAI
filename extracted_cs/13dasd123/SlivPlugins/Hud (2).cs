    ...
    internal class Hud : RustPlugin
    {
        ...
        private class Configuration
        {
            ...
            { 
                IsOverall = false,
                Size = 80,
                Logo = "https://www.dropbox.com/scl/fi/9j4fv475el3gfbq9wvoox/logo.png?rlkey=rq710tuayr8syuk54fljluqqa&dl=1",
                EventsBGOpacity = 80,
                BGOpacity = 60,
        ...
        private void ShowUIAdditionalMenu(BasePlayer player, bool isOpen = false)
        {
            ...
            UI.Image(ref container, ".AdditionalMenuButton.bg", ".AdditionalMenuButton", oXMin: -16, oYMin: _data.PlayersState[player.UserIDString] == States.Full ? -17 : 4, oXMax: 16, oYMax: _data.PlayersState[player.UserIDString] == States.Full ? 4 : 25, image: GetImage("https://www.dropbox.com/scl/fi/vh7wa9xu1i9x1an2krl7p/lip.png?rlkey=2m4pchuc61wkiujqyelusm9ao&dl=1"), color:$"1 1 1 {_config.MainSetup.BGOpacity / 100f}");

            UI.Image(ref container, ".AdditionalMenuButton", image: GetImage(isOpen ? "https://www.dropbox.com/scl/fi/7no7pb2f3338ehv0vveh9/closedropmenu.png?rlkey=300qqg5h0toj82m44cax6ws9x&dl=1" : "https://www.dropbox.com/scl/fi/9ixcfozmw1nri68pnsfez/dropmenu.png?rlkey=drbm12eemjcis6vbxobhju534&dl=1"), color: _config.MainSetup.AdditionalMenu.ButtonColor);
        ...
        private void ShowUIMain(BasePlayer player)
        {
            ...
            if (_data.PlayersState[player.UserIDString] == States.Full)
                UI.Image(ref container, ".Offsets.bg", ".Main.bg", null, null, null, oXMin: _config.MainSetup.Position.Align.ToLower().Contains("right") ? -300 : 0, oYMin: -100, oXMax: _config.MainSetup.Position.Align.ToLower().Contains("right") ? 0 : 300, oYMax: 0, image: GetImage("https://www.dropbox.com/scl/fi/rjblh1bqw08v5aang4e8p/background.png?rlkey=wqvjou54kgbkww3ex3arg84pe&dl=1"), color: $"1 1 1 {_config.MainSetup.EventsBGOpacity / 100f}");

            if (_data.PlayersState[player.UserIDString] != States.Hide || _data.PlayersState[player.UserIDString] == States.Close)
                UI.Image(ref container, ".Offsets.bg", ".Events.bg", null, "0 1", "0 1", oXMin: _config.MainSetup.Position.Align.ToLower().Contains("right") ? -300 - (EnableEventsCount > 7 ? (EnableEventsCount - 7) * 34 : 0) : 0, oYMin: -60, oXMax: _config.MainSetup.Position.Align.ToLower().Contains("right") ? 0 : 300 + (EnableEventsCount > 7 ? (EnableEventsCount - 7) * 34 : 0), oYMax: 0, image: GetImage("https://www.dropbox.com/scl/fi/xg4f7knl7mpb7x5zrle24/events.png?rlkey=xa2scr137t4kc64wpcldddovy&dl=1"), color: $"1 1 1 {_config.MainSetup.BGOpacity / 100f}");
        ...
        private void LoadImages()
        {
            ...
            AddImage("https://www.dropbox.com/scl/fi/rjblh1bqw08v5aang4e8p/background.png?rlkey=wqvjou54kgbkww3ex3arg84pe&dl=1");
            AddImage("https://www.dropbox.com/scl/fi/xg4f7knl7mpb7x5zrle24/events.png?rlkey=xa2scr137t4kc64wpcldddovy&dl=1");

            AddImage("https://www.dropbox.com/scl/fi/vh7wa9xu1i9x1an2krl7p/lip.png?rlkey=2m4pchuc61wkiujqyelusm9ao&dl=1");
            AddImage("https://www.dropbox.com/scl/fi/9ixcfozmw1nri68pnsfez/dropmenu.png?rlkey=drbm12eemjcis6vbxobhju534&dl=1");
            AddImage("https://www.dropbox.com/scl/fi/7no7pb2f3338ehv0vveh9/closedropmenu.png?rlkey=300qqg5h0toj82m44cax6ws9x&dl=1");
