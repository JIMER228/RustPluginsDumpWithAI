        ...
        */
        ...
        public class VehicleHelper : MonoBehaviour
        {
            ...
            public void Prepare(BaseCombatEntity newlySpawnedVehicle)
            {
                ...
                if (vehicle != null)
                {
                    ...
                    if (maybeCar != null)
                    {
                        ...
                        fuelSystem = maybeCar.engineController.FuelSystem;
                    }
                    else
                    {
                        ...
                        if (maybeCopter != null)
                        {
                            ...
                            fuelSystem = maybeCopter.GetFuelSystem();
                        }
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (maybeTrain != null)
                                {
                                    ...
                                    fuelSystem = maybeTrain.engineController.FuelSystem;
                                }
                                else
                                {
                                    ...
                                    if (maybeCrane != null)
                                    {
                                        ...
                                        fuelSystem = maybeCrane.GetFuelSystem();
                                    }
                                    else
                                    {
                                        ...
                                        if (maybeSubDuo != null)
                                        {
                                            ...
                                            fuelSystem = maybeSubDuo.GetFuelSystem();
                                        }
                                        else
                                        {
                                            ...
                                            if (maybeSubSolo != null)
                                            {
                                                ...
                                                fuelSystem = maybeSubSolo.GetFuelSystem();
                                            }
                                        }
                                    }
                                }
            ...
            public void PrepareFuelSystem()
            {
                ...
                fuelContainer = fuelSystem.fuelStorageInstance.Get(true);
                ...
                else
                {
                    ...
                    VehicleHelper.StorageToHelper.Add(fuelContainer.net.ID.Value, this);
            ...
            public object HasFuel(bool forceCheck = false)
            {
                if (vehicle != null)
                {
                    if (vehicle.OwnerID == 1337422) return true;
                }
            ...
            public object TryUseFuel(float seconds, float fuelUsedPerSecond)
            {
                ...
                if ((double)fuelSystem.pendingFuel >= 1.0)
                {
                    ...
                    if (Instance.configData.globalNoNeedForFuel || Instance.configData.specificNoNeedForFuel[vehicleType] || vehicle?.OwnerID == 1337422)
                    {
        ...
        object OnFuelCheck(EntityFuelSystem fuelSystem)
        {
            ...
            _checkedEntity1 = fuelSystem.fuelStorageInstance.Get(true)?.parentEntity.Get(true);
        ...
        {
            if (Instance == null) return null;
            _checkedEntity3 = fuelSystem.fuelStorageInstance.Get(true)?.parentEntity.Get(true);
        ...
        void OnServerInitialized(bool serverInitialized)
        {
            ...
            foreach (BaseVehicle vehicle in UnityEngine.Object.FindObjectsOfType<BaseVehicle>())
            {
        ...
        object OnCounterModeToggle(PowerCounter counter, BasePlayer player, bool wants)
        {
            ...
            if (VehicleHelper.VehicleToHelper.ContainsKey((ulong)counter.OwnerID))
            {
                return false;
            }
            return null;
