...
namespace Oxide.Plugins
{
    ...
    class HomesGUI : RustPlugin
    {
        ...
        class HomePoint
        {
            ...
            public HomePoint(string name, GamePos position, bool isSleeping = false, ulong bedID = 0)
            {
                this.Name = name;
        ...
        void OnEntitySpawned(BaseEntity entity)
        {
                ...
                (entity.ShortPrefabName == "beachtowel.deployed" && ConfigFile.SleepingBags.CreateHomeOnBeachTowelPlacement))
            {
                ...
                var newHome = new HomePoint(homeName, (GamePos)bag.transform.position, true, bag.net.ID.Value);
        ...
        void OnEntityDeath(BaseCombatEntity entity, HitInfo info)
        {
            ...
            var matchingHome = storedData.Homes[player.userID].FirstOrDefault(x => x.IsSleeping && x.BedID == bag.net.ID.Value);
        ...
        void OnEntityKill(BaseNetworkable entity)
        {
            ...
            {
                var foundHome = homes.Value?.FirstOrDefault(x => x != null && x.IsSleeping && x.BedID == bag.net.ID.Value);
                if (foundHome == null)
                    continue;
        ...
        void CanRenameBed(BasePlayer player, SleepingBag bed, string bedName)
        {
            ...
            var bagHome = homes.FirstOrDefault(x => x.IsSleeping && x.BedID == bed.net.ID.Value);
