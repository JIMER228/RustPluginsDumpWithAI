...
namespace Oxide.Plugins
{
    ...
    public class Statistics : RustPlugin
	{
		...
		private void OnPlayerConnected(BasePlayer player)
		{
			...
			{
				ImageLibrary.Call("AddImage", avatar, $"avatar_{player.UserIDString}");
			});
		...
		private void OnEntityDeath(BaseCombatEntity entity, HitInfo info)
		{
			...
			{
				AddToStats(player.userID, victimPlayer.displayName);
				return;
			}
                    ...
                    if (ImageLibrary)
                        container.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
								...
								{
									ItemId = GetItemId(resource),
									//Png = ImageLibrary.Call<string>("GetImage", $"{resource}")
								},
