...
namespace Oxide.Plugins
{
    ...
    public class AdminMenu : RustPlugin
    {
        ...
        public class UserInfoContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                else
                {
                    ...
                    {
                        Instance.ImageLibrary.Call("AddImage", steamInfo.Avatars[2], player.Id, 1080UL, new Action(() => Render(connectionData)));
                    }
                }
        ...
        {
            private static readonly Label KICK_LABEL = new Label("BAN");
            ...
            public BanPopup()
            {
                ...
                Modules.Add(new HeaderModule("BAN", 30) { TextColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER_TEXT], BackgroundColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER] });
            }
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddButton(color: "0.1 0.1 0.1 1", command: $"adminmenu userinfo.action ban {reason}", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: KICK_LABEL.Localize(connectionData.connection), color: "0.8 0.8 0.8 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
                return panel;
            }
        }
        ...
        public class CloneGroupPopup : BasePopup
        {
            ...
            public CloneGroupPopup()
            {
                ...
                Modules.Add(new HeaderModule("CLONE GROUP", 30) { TextColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER_TEXT], BackgroundColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER] });
            }
        ...
        public class CreateGroupPopup : BasePopup
        {
            ...
            public CreateGroupPopup()
            {
                ...
                Modules.Add(new HeaderModule("CREATE GROUP", 30) { TextColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER_TEXT], BackgroundColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER] });
            }
        ...
        {
            private static readonly Label KICK_LABEL = new Label("KICK");
            private static readonly Label REASON_LABEL = new Label("REASON");
            public KickPopup()
            {
                Width = 400;
                Height = 140;
                Modules.Add(new HeaderModule("KICK", 30) { TextColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER_TEXT], BackgroundColor = Theme.Get()[Theme.KeyCollection.POPUP_HEADER] });
            }
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddButton(color: "0.1 0.1 0.1 1", command: $"adminmenu userinfo.action kick {reason}", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: KICK_LABEL.Localize(connectionData.connection), color: "0.8 0.8 0.8 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
                return panel;
            }
        }
            ...
            switch (command)
            {
                ...
                case "userinfo.action":
                    ...
                    if (connectionData != null)
                    {
                        ...
                        if (button != null && !button.UserHasPermission(connection))
                            return;
                        ...
                        switch (action)
                        {
                            ...
                            case "showkickpopup":
                                ...
                                break;
                            case "kick":
                                string kickCmdArg = args[1];
                                if (kickCmdArg == "showpopup")
                                {
                                    (connectionData.currentContent as UserInfoContent).ShowKickPopup(connectionData);
                                    return;
                                }
                                ...
                                break;
                            case "ban":
                                string banCmdArg = args[1];
                                if (banCmdArg == "showpopup")
                                {
            ...
            QuickMenuContent quickMenuContent = new QuickMenuContent()
            {
                buttons = new ButtonArray[16]
                {
                    ...
                    new ButtonArray
                    {
                        ...
                        new Button("Time to 0", null, "quickmenu.action", "settime", "0")
                        {
                            Permission = "quickmenu.settime"
                        },
                    },
            ...
            UserInfoContent userInfoContent = new UserInfoContent()
            {
                buttons = new ButtonArray[10]
                {
                    ...
                    new ButtonArray
                    {
                        ...
                        new Button("<color=red>Kick</color>", null, "userinfo.action", "kick", "showpopup")
                        {
                            Permission = "userinfo.kick"
                        },
                        new Button("<color=red>Ban</color>", null, "userinfo.action", "ban", "showpopup")
                        {
