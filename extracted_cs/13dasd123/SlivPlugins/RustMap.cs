...
{
    [Info("RustMap", "OxideBro - rustplugin.ru/org", "2.1.6")]
 ...
 void OnPlayerInput(BasePlayer player, InputState input)
        ...
        void OnEntitySpawned(BaseEntity entity)
        {
            ...
            if (config.mainSettings.heli && entity is PatrolHelicopter)
        ...
        void OnEntityKill(BaseNetworkable entity)
        {
            ...
            if (entity is CargoPlane || entity is SupplyDrop || entity is PatrolHelicopter || entity is HelicopterDebris || entity is VendingMachine)
            {
