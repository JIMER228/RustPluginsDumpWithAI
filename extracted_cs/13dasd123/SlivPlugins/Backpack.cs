    ...
    public class Backpack : RustPlugin
    {
        ...
        void OnEntityDeath(BaseCombatEntity ent, HitInfo info)
        {
            ...
            if (droppedItemContainer != null)
            {
                ...
                if (SoundOnDrop) Effect.server.Run("assets/bundled/prefabs/fx/dig_effect.prefab", droppedItemContainer.transform.position);
            }
        }
        ...
        bool SoundOnDrop = false;
        bool EnabledMainBackpackLoot = true;
        float KillTimeout = 300f;
        string ImageURL = "https://i.imgur.com/ydEnRpe.png";
        ...
        private void LoadConfigValues()
        {
            ...
            if (GetConfig("Основные настройки", "Воспроизводить звук выкапывания стеша при выпадении рюкзака", ref SoundOnDrop))
            {
                changed = true;
            }
       ...
       public bool BackpackHide(ulong userId)
        {
            ...
            if (otherPlayer != null) DrawUI(otherPlayer);
                ...
                if (BasePlayer.FindByID(userId) != null) DrawUI(BasePlayer.FindByID(userId));
            return true;
