    ...
    public class TownWars : RustPlugin
    {
                        ...
                        [""] = new TownSettings()
                        {
                            ...
                            rewards = new List<Reward>()
                            {
                                ...
                                new Reward()
                                {
                                    ...
                                    skinID = 2409891781,
                                    customName = "Баксы",
                                    imageUrl = "https://i.imgur.com/jBaVKHu.png",
                                    command = ""
                                }
                            }

                        },
                        ["assets/bundled/prefabs/autospawn/monument/large/airfield_1.prefab"] = new TownSettings()
                        {
                            name = "Аэропорт",
                            capDist = 55,
                            rewards = new List<Reward>()
        ...
        private void LoadTownsData()
        {
            ...
            foreach (var mon in monuments)
            {
                ...
                {
                    data.Add(mon.name, new townsData() { OwnerName = "Нет Владельца", OwnerID = "0", lastCapture = Facepunch.Math.Epoch.Current - config.settings.delayCapture, lastReward = Facepunch.Math.Epoch.Current });
                }
