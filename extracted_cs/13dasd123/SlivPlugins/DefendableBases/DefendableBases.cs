        ...
        private void Start()
        {
            ...
            timer.In(_config.PreStartTime, () =>
            {
                ...
                if (_config.PveMode.Pve && plugins.Exists("PveMode"))
                {
                    ...
                    PveMode.Call("EventAddPveMode", Name, config, _controller.transform.position, _controller.Config.Radius, new HashSet<ulong>(), new HashSet<ulong>(), new HashSet<ulong>(), new HashSet<ulong>(), null);
                }
