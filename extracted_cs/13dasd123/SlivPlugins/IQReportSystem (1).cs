...
namespace Oxide.Plugins
{
    ...
    internal class IQReportSystem : RustPlugin
    {
		...
		{
			if (!Friends)
				return RelationshipManager.Instance.playerToTeam.ContainsKey(userID) && RelationshipManager.Instance.playerToTeam[userID].members.Contains(targetID);
				...
				return new Configuration
				{
					...
					ReasonList = new List<ReasonReport>()
					{
                        ...
                        new ReasonReport
						{
							Title = new LangText()
							{
								LanguageRU = "Оскорбление модерации",
								LanguageEN = "Insult to moderation"
							},
							BanCommand = "ban {0} 3d {1}",
							HideUser = false,
						},
        ...
        private void SendSound(UInt64 netId, byte[] data)
        {
	        ...
	        {
		        NetWrite netWrite = Net.sv.write;
				netWrite.Start();
        ...
        private class ImageUi
        {
            ...
            public static void Unload()
            {
                ...
                foreach (KeyValuePair<String, String> item in Images)
                    FileStorage.server.Remove(UInt32.Parse(item.Value), FileStorage.Type.png, CommunityEntity.ServerInstance.net.ID);
        ...
        private class InterfaceBuilder
        {
            ...
            private void Building_HeaderPanel_Search()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components =
		            {
			            new CuiInputFieldComponent { Text = "%TITLE_PLAYER_HEADER_TITLE_SEARCH_PLAYER%", FontSize = 14, Command = $"report.panel search.player %ISMODERATOR% {NickName}", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleLeft, Color = config.ColorsSettings.AdditionalColorText, CharsLimit = 13},
			            new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
		            }
	            });
            ...
            private void Building_PoopUp_Player()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components =
		            {
			            new CuiInputFieldComponent {  Text = "%NICK_NAME%", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleLeft, Color = config.ColorsSettings.MainColorText},
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components =
		            {
			            new CuiInputFieldComponent {  Text = "%STEAMID%", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleLeft, Color = config.ColorsSettings.MainColorText},
            ...
            private void Building_PoopUP_Moderator()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components =
		            {
			            new CuiInputFieldComponent {  Text = "%PLAYER_NAME%", Font = "robotocondensed-regular.ttf", FontSize = 16, Align = TextAnchor.UpperLeft, Color = config.ColorsSettings.MainColorText},
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components =
		            {
			            new CuiInputFieldComponent {  Text = "%PLAYER_USERID%", Font = "robotocondensed-regular.ttf", FontSize = 16, Align = TextAnchor.UpperLeft, Color = config.ColorsSettings.MainColorText},
            ...
            private void Building_ModeratorMenuChecked_InfoDiscord()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components =
		            {
			            new CuiInputFieldComponent {  Text = "%TITLE_PROFILE_MODERATOR_CHECKED_MENU_TITLE_DISCORD%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = config.ColorsSettings.MainColorText},
            ...
            private void Building_Player_Alert()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components = {
			            ...
			            new CuiRectTransformComponent { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = "-483.3332323 -372.66", OffsetMax = "483.333 0.00732321" }
		            }
	            });
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components = {
			            ...
			            new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 39.676", OffsetMax = "0 -228.2032329" },
			            new CuiOutlineComponent { Color = "0 0 0 1", Distance = "-0.5 0.5" }
		            }
	            });
