    ...
    { 
        ...
        void OnEntityTakeDamage(BaseCombatEntity entity, HitInfo info)
        {
            if (entity is BaseHelicopter && info.Initiator is BasePlayer)
            {
                ...
                if (!lastdamage.ContainsKey((ulong)entity.net.ID.Value))
                {
                    lastdamage.Add((ulong)entity.net.ID.Value, new LastAttacker()
                    {  
                ...
                {
                    lastdamage[(ulong)entity.net.ID.Value].SteamId = info.InitiatorPlayer.userID;
                    lastdamage[(ulong)entity.net.ID.Value].Weapon = _weapon;
                }
            }
        ...
        private void OnEntityDeath(BaseCombatEntity entity, HitInfo info)
        {
            ...
            if (entity is BradleyAPC || entity is BaseHelicopter)
            {
                ...
                if(!lastdamage.TryGetValue((ulong)entity.net.ID.Value, out attackerid)) return;
                ...
                lastdamage.Remove((ulong)entity.net.ID.Value);
                return;
            }
        ...
        private void Check(object owner, Zadachi zadachi, int amount, PlayerData f)
        {
