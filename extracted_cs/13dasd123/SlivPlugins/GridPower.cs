...
namespace Oxide.Plugins
{
    ...
    public class GridPower : RustPlugin
    {
                ...
                ContainerIcon3 = new CuiElementContainer
                {
                    ...
                    new CuiElement
                    {
                        ...
                        Components =
                        {
                            new CuiImageComponent
                            {
                                ItemId = ItemManager.FindItemDefinition(ITEM_FUSE).itemid,
                                SkinId = 0
                            },
                            AnchorIcon3Image
                        }
     ...
     current.Replace(value.Key, value.Value));
        ...
        {
            player.SendConsoleCommand("gametip.showtoast", (int)style, toast);
        }
        ...
        public static void MakeHangingWireConnection(IOEntity inputEntity, IOEntity outputEntity, int inputSlot, int outputSlot, float slack, int subdivisions, List<Vector3> lines, Action<Vector3[]> executeAfterDoneExtra = null)
        {
            ...
            ServerMgr.Instance.StartCoroutine(CrunchWireCoroutine(outputEntity.transform, lines, /*resultingPoints,*/ slack, subdivisions, executeAfterDone));
        }
        ...
        public static IEnumerator CrunchWireCoroutine(Transform transform, List<Vector3> originalLinePoints,/* Vector3[] resultingPoints, */float slack, int subdivisions, Action<Vector3[]> executeAfterCrunching)
        {
            var waitFor = new WaitForEndOfFrame();
