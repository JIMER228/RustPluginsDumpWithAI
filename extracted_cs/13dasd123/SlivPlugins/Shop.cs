...
{
    [Info("Shop", "David", "1.1.81")]
    // compatible with WelcomePanel 3.0.7 and higher
    ...
    {   
        ...
        private void SendDiscordMessage(BasePlayer player, string item, int amount, int price, bool buy = true, string icon = "https://rustlabs.com/img/items180/cratecostume.png")
        {    
        ...
        private void Buy(BasePlayer player, string category, string itemName, int amount)
        {
            ...
            if (TakeFrom(player, items[itemName].Currency, price))
            {
                ...
                if (!image.StartsWith("http"))
                    image = "https://rustlabs.com/img/items180/" + image;
