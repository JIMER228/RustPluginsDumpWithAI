...
{
    [Info("LockOnRockets", "k1lly0u", "0.3.16")]
    class LockOnRockets : RustPlugin
    {
        ...
        {
            if (newItem?.info.itemid != LAUNCHER_ITEMID)
                return;
        ...
        {
            if (baseProjectile?.primaryMagazine.contents > 0 && baseProjectile?.primaryMagazine.ammoType.itemid == SMOKE_ITEMID)
       ...
       private static void CreateUIOverlay(BasePlayer player, string targetShortname, string distance, bool isLocked)
        ...
        private class LockOnPlayer : MonoBehaviour
        {
           ...
           public BaseEntity Target => lastTarget;
            ...
            {                
                ...
                return baseProjectile.primaryMagazine.contents > 0 && baseProjectile.primaryMagazine.ammoType.itemid == SMOKE_ITEMID;
            }
            ...
            private bool CanTargetEntity(BaseEntity entity, float distance, out ConfigData.LockType lockType)
            {
                ...
                else if (entity is BaseNpc || entity is BaseRidableAnimal)
                {
                ...
                else if (entity is ModularCar || entity is BaseVehicleModule)
                {
                ...
                else if ((entity is LootContainer || entity is StorageContainer) && !(entity is StashContainer))
                {
        ...
        #region Config        
        internal enum LockTypes { AttackHelicopter, CH47, Minicopter, TransportHelicopter, RHIB, Boat, Car, APC, Plane, NPC, Player, Animal, Structure, Resource, Loot, GunTrap, ModularCar, HotAirBalloon, Drone, TrainEngine, TrainCar }
        ...
        private void UpdateConfigValues()
        {
            ...
            if (configData.Version < new Core.VersionNumber(0, 3, 11))
            {
                ...
                configData.LockOnTypes[LockTypes.AttackHelicopter].DamageModifier = 5f;
                configData.LockOnTypes[LockTypes.AttackHelicopter].SpeedModifier = 2.5f;
            }
