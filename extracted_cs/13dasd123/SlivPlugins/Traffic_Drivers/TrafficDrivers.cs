...
{
    [Info("Traffic Drivers", "walkinrey", "1.2.92")]
    ...
    public class TrafficDrivers : RustPlugin
    {
        ...
        private object CanMoveItem(Item item, PlayerInventory playerLoot, ulong targetContainer, int targetSlot, int amount)
        {
        ...
        private void showDebugInfo(ConsoleSystem.Arg arg)
        {
            ...
            if(arg.Player() != null) 
            {
                ...
                foreach(var driver in drivers)
                {
                    ...
                    marker.position = driver.transform.position;
                    marker.duration = 15;
