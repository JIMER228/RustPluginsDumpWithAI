    ...
    internal class Hud : RustPlugin
    {
        ...
        private class Configuration
        {
            ...
            { 
                IsOverall = false,
                Size = 80,
                Logo = "https://media.discordapp.net/attachments/335512864548847617/1134455399756607549/logo.png",
                EventsBGOpacity = 80,
                BGOpacity = 60,
                ...
                ActivePlayersAppearance = new BaseAppearance
                {
                    Color = "#fff",
                ...
                AdditionalMenu = new AdditionalMenu
                {
                    ...
                    Commands = new List<CommandAppearance>
                    {
                        new CommandAppearance
                        {
                            ...
                            Icon = "https://media.discordapp.net/attachments/335512864548847617/1134455395813965934/active.png",
                            Image = "https://media.discordapp.net/attachments/335512864548847617/1134455392420761671/command.png",
                            Text = "Say Something",
                            OutlineColor = "#000",
                            IsConsole = true,
                        },
            ...
            public List<CustomEventsAppearance> CustomEvents = new List<CustomEventsAppearance>
            {
                new CustomEventsAppearance
                {
                    ...
                    IsEnable = false,
                    OnEventStart = "OnConvoyStart",
                    OnEventEnd = "OnConvoyStop",
                },
                new CustomEventsAppearance 
                {
                    Name = "Sputnik",
                    ...
                    IsEnable = false,
                    OnEventStart = "OnSputnikEventStart",
                    OnEventEnd = "OnSputnikEventStop",
                },
                new CustomEventsAppearance
                {
                    Name = "ArmoredTrain",
                    ...
                    IsEnable = false,
                    OnEventStart = "OnArmoredTrainEventStart",
                    OnEventEnd = "OnArmoredTrainEventStop",
                },
                new CustomEventsAppearance
                {
                    Name = "Harbor",
                    ...
                    IsEnable = false,
                    OnEventStart = "OnHarborEventStart",
                    OnEventEnd = "OnHarborEventEnd",
                },
            };
        ...
        private class MainSetup
        {
            ...
            public BaseAppearance ActivePlayersAppearance;
        ...
        {
            [JsonProperty("Hook OnEventStart")]
            public string OnEventStart;

            [JsonProperty("Hook OnEventStop")]
            public string OnEventEnd;
        }
                ...
                case "s":
                    ...
                    switch (arg.GetString(1))
                    {
                        ...
                        case "activeopen":
                            ...
                            OpenPlayersConfiguration(player, "Active players", ap.IsEnable, ap.Icon, ap.Color, "UI_H s aenable", "UI_H s aicon ", "UI_H s acolor ");
                            break;
                        case "sleepopen":
                        ...
                        case "ceicon":
                            ...
                            break;
                        case "ceeventstart":
                            _config.CustomEvents[arg.GetInt(2)].OnEventStart = arg.GetString(3);
                            OpenCustomEventConfiguration(player, arg.GetInt(2));
                            break;
                        case "ceeventend":
                            _config.CustomEvents[arg.GetInt(2)].OnEventEnd = arg.GetString(3);
                            OpenCustomEventConfiguration(player, arg.GetInt(2));
                            break;
                        case "ceactivecolor":
        ...
        private void FillCustomHooks()
        {
            ...
            {
                if (!check.IsEnable || used.Contains(check.OnEventStart) || used.Contains(check.OnEventEnd))
                    continue;
                
                currentCode += $"private void {check.OnEventStart}()=>OnEventTouch(System.Reflection.MethodBase.GetCurrentMethod().Name);private void {check.OnEventEnd}()=>OnEventTouch(System.Reflection.MethodBase.GetCurrentMethod().Name);";
                used.Add(check.OnEventEnd);
                used.Add(check.OnEventStart);
            }
        ...
        private void OnEventTouch(string name)
        {
            foreach (var check in _config.CustomEvents)
            {
                if (!check.IsEnable || !string.Equals(check.OnEventStart, name, StringComparison.CurrentCultureIgnoreCase) && !string.Equals(check.OnEventEnd, name, StringComparison.CurrentCultureIgnoreCase))
                    continue;
                
                check.isActive = string.Equals(check.OnEventStart, name, StringComparison.CurrentCultureIgnoreCase);
        ...
        private void ShowUISettingsBg(BasePlayer player)
        {
            ...
            UI.Label(ref container, ".bgSettings", aMin: "0.5 0.5", aMax: "0.5 0.5", oXMin: -190, oXMax: 190, oYMin: -238, oYMax: -208, text: "Click anywhere outside the panel to exit", color: "0.9686 0.9216 0.8824 0.502", fontSize: 12, ignoreSize: true);
        ...
        private void ShowUISettings(BasePlayer player)
        {
            ...
            UI.Panel(ref container, ".bgSettings", ".bgSettings.Main", ".bgSettings.Main", "0.5 0.5", "0.5 0.5", -198, -208, 198, 268, "0.9686 0.9216 0.8824 0.0392", "assets/icons/greyout.mat", "assets/content/ui/ui.background.tile.psd", ignoreSize: true);
        ...
        {
            var x = (4 * (_config.CustomEvents.Count - 1) + 30 * _config.CustomEvents.Count) / -2;
            ...
            if (_config.CustomEvents.Count < 11)
        ...
        private void OpenCustomEventConfiguration(BasePlayer player, int index)
        {
            ...
            AddInputConfiguration(ref container, ".bgSettings.Main.Additional", ref y, "OnEventStart Hook:", menu.OnEventStart, $"UI_H s ceeventstart {index} ");
            AddInputConfiguration(ref container, ".bgSettings.Main.Additional", ref y, "OnEventEnd Hook:", menu.OnEventEnd, $"UI_H s ceeventend {index} ");
        ...
        private void ShowUIAdditionalMenu(BasePlayer player, bool isOpen = false)
        {
            ...
            UI.Image(ref container, ".AdditionalMenuButton.bg", ".AdditionalMenuButton", oXMin: -16, oYMin: _data.PlayersState[player.UserIDString] == States.Full ? -17 : 4, oXMax: 16, oYMax: _data.PlayersState[player.UserIDString] == States.Full ? 4 : 25, image: GetImage("https://media.discordapp.net/attachments/335512864548847617/1134455394480177183/lip.png"), color:$"1 1 1 {_config.MainSetup.BGOpacity / 100f}");

            UI.Image(ref container, ".AdditionalMenuButton", image: GetImage(isOpen ? "https://media.discordapp.net/attachments/335512864548847617/1134455397382639756/closedropmenu.png" : "https://media.discordapp.net/attachments/335512864548847617/1134455392798265446/dropmenu.png"), color: _config.MainSetup.AdditionalMenu.ButtonColor);
        ...
        private void ShowUIBalance(BasePlayer player) 
        {
            ...
            UI.Label(ref container, ".Main.bg", ".Balance", ".Balance", "0 0", "0.3 0", oXMin: 10, oYMin: 7, oXMax: 0, oYMax: 24, text:_config.MainSetup.Economy.Currency + (string.Equals(_config.MainSetup.Economy.Plugin, "ServerRewards", StringComparison.CurrentCultureIgnoreCase) ? ServerRewards?.Call<int>("CheckPoints", player.userID) : Economics == null ? 0 : (int) Economics.Call<double>("Balance", player.userID)), fontSize:14, align:TextAnchor.MiddleLeft, color:_config.MainSetup.Economy.Color);
        ...
        private void ShowUITime(BasePlayer player) 
        {
            ...
            UI.Label(ref container, ".Main.bg", ".Time", ".Time", "0 1", "0 1", oXMin: 180, oYMin: -75, oXMax: 250, oYMax: -45, text:_config.MainSetup.Time.IsAutomaticDetection ? TOD_Sky.Instance.Cycle.DateTime.ToString(CultureInfo.GetCultureInfo(lang.GetLanguage(player.UserIDString) != "en-PT" ? lang.GetLanguage(player.UserIDString) : "en").DateTimeFormat.ShortTimePattern) : TOD_Sky.Instance.Cycle.DateTime.ToString(_config.MainSetup.Time.IsAmPm ? "hh:mm tt" : "HH:mm"), fontSize:18, color:_config.MainSetup.Time.Color);
        ...
        private void ShowUIPlayersCounts(BasePlayer player = null)
        {
            ...
            if (_config.MainSetup.ActivePlayersAppearance.IsEnable)
                UI.Label(ref container, ".Main.bg", ".ActivePlayers.count", ".ActivePlayers.count", "0 1", "1 1", oXMin: 44, oYMin: -70, oXMax: 0, oYMax: -50, text: BasePlayer.activePlayerList.Count.ToString(), align:TextAnchor.MiddleLeft);
            ...
            if (_config.MainSetup.QueuePlayersAppearance.IsEnable)
                UI.Label(ref container, ".Main.bg",".QueuePlayers.count", ".QueuePlayers.count", "0 1", "1 1", oXMin: 154, oYMin: -70, oXMax: 0, oYMax: -50,text: ServerMgr.Instance.connectionQueue.queue.Count.ToString(), align:TextAnchor.MiddleLeft);
        ...
        private void ShowUIBaseInfo(BasePlayer player)
        {
            ...
            UI.Label(ref container, ".Main.bg", aMin:$"{(_config.MainSetup.Economy.IsEnable ? "0.3" : "0")} 0", aMax:"1 0", oXMin: 5, oYMin: 7, oXMax: -5, oYMax: 24, text:_config.MainSetup.ServerName, fontSize:14);

            if (_config.MainSetup.ActivePlayersAppearance.IsEnable)
                UI.Image(ref container, ".Main.bg", aMin:"0 1", aMax:"0 1", oXMin: 20, oYMin: -70, oXMax: 40, oYMax: -50, image:GetImage(_config.MainSetup.ActivePlayersAppearance.Icon), color:_config.MainSetup.ActivePlayersAppearance.Color);

            if (_config.MainSetup.SleepPlayersAppearance.IsEnable)
                UI.Image(ref container, ".Main.bg", aMin:"0 1", aMax:"0 1", oXMin: 75, oYMin: -70, oXMax: 95, oYMax: -50, image:GetImage(_config.MainSetup.SleepPlayersAppearance.Icon), color:_config.MainSetup.SleepPlayersAppearance.Color);

            if (_config.MainSetup.QueuePlayersAppearance.IsEnable)
                UI.Image(ref container, ".Main.bg", aMin:"0 1", aMax:"0 1", oXMin: 130, oYMin: -70, oXMax: 150, oYMax: -50, image:GetImage(_config.MainSetup.QueuePlayersAppearance.Icon), color:_config.MainSetup.QueuePlayersAppearance.Color);
        ...
        private void ShowUIMain(BasePlayer player)
        {
            ...
            if (_data.PlayersState[player.UserIDString] == States.Full)
                UI.Image(ref container, ".Offsets.bg", ".Main.bg", null, null, null, oXMin: _config.MainSetup.Position.Align.ToLower().Contains("right") ? -300 : 0, oYMin: -100, oXMax: _config.MainSetup.Position.Align.ToLower().Contains("right") ? 0 : 300, oYMax: 0, image: GetImage("https://media.discordapp.net/attachments/335512864548847617/1134455396443115581/background.png"), color: $"1 1 1 {_config.MainSetup.EventsBGOpacity / 100f}");

            if (_data.PlayersState[player.UserIDString] != States.Hide || _data.PlayersState[player.UserIDString] == States.Close)
                UI.Image(ref container, ".Offsets.bg", ".Events.bg", null, "0 1", "0 1", oXMin: _config.MainSetup.Position.Align.ToLower().Contains("right") ? -300 - (EnableEventsCount > 7 ? (EnableEventsCount - 7) * 34 : 0) : 0, oYMin: -60, oXMax: _config.MainSetup.Position.Align.ToLower().Contains("right") ? 0 : 300 + (EnableEventsCount > 7 ? (EnableEventsCount - 7) * 34 : 0), oYMax: 0, image: GetImage("https://media.discordapp.net/attachments/335512864548847617/1134455393649705033/events.png"), color: $"1 1 1 {_config.MainSetup.BGOpacity / 100f}");
        ...
        private void AddImage(string url) => ImageLibrary.Call("AddImage", url, url);
        ...
        private void LoadImages()
        {
            ...
            AddImage("https://media.discordapp.net/attachments/335512864548847617/1134455396443115581/background.png");
            AddImage("https://media.discordapp.net/attachments/335512864548847617/1134455393649705033/events.png");

            AddImage("https://media.discordapp.net/attachments/335512864548847617/1134455394480177183/lip.png");
            AddImage("https://media.discordapp.net/attachments/335512864548847617/1134455392798265446/dropmenu.png");
            AddImage("https://media.discordapp.net/attachments/335512864548847617/1134455397382639756/closedropmenu.png");
        ...
        /*CUSTOMEVENTAUTOCODE-START*//*CUSTOMEVENTAUTOCODE-END*/
    }
}