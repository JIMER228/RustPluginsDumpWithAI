...
{
	[Info("Panel System", "Mevent", "1.1.2")]
	internal class PanelSystem : RustPlugin
	{
		...
		private const string Layer = "UI.PanelSystem";

		private const string EventsLayer = "UI.PanelSystem.Events";

		private const string SettingsLayer = "UI.PanelSystem.Settings";
		...
		private class Configuration
		{
			...
			public LogoSettings Logo = new LogoSettings
			{
				...
				Image = "https://i.imgur.com/eeuY1WI.png",
			...
			public InfoPanel Players = new InfoPanel
			{
				Enabled = true,
				Permission = string.Empty,
				Image = "https://i.imgur.com/Ik9YSZS.png",
				SettingsImage = "https://i.imgur.com/Ltn0Jr1.png",
			...
			public InfoPanel Sleepers = new InfoPanel
			{
				Enabled = false,
				Permission = string.Empty,
				Image = "https://i.imgur.com/J2QIswN.png",
				SettingsImage = "https://i.imgur.com/84eMeAq.png",
				Settings = new PanelSettings(true, string.Empty, true, false, true),
				Size = new InfoPanel.InfoPanelSizeSettings(0, new List<SizeData>(), new List<InfoPanel.InfoPanelSize>
				{
					new InfoPanel.InfoPanelSize("sizeBig", string.Empty, 35, 12, 16, 40, 145),
			...
			public TimeSettings Time = new TimeSettings
			{
				...
				GameUpdate = false,
				Permission = string.Empty,
				Image = "https://i.imgur.com/ZI5vJk9.png",
				SettingsImage = "https://i.imgur.com/MhfhTLP.png",
				Settings = new PanelSettings(true, string.Empty, true, false, true),
				Size = new InfoPanel.InfoPanelSizeSettings(0, new List<SizeData>(), new List<InfoPanel.InfoPanelSize>
				{
			...
			public SettingsInfo Settings = new SettingsInfo
			{
				Enabled = true,
				Permission = string.Empty,
				Image = "https://i.imgur.com/zrGBH8Q.png",
			...
			public ButtonsSettings ButtonsSettings = new ButtonsSettings
			{
				...
				Buttons = new List<ButtonInfo>
				{
					...
					{
						Enabled = true,
						Image = "https://i.imgur.com/RScZfCg.png",
						Permission = string.Empty,
						LangKey = "BtnShop",
					...
					{
						Enabled = true,
						Image = "https://i.imgur.com/84ixNM9.png",
						Permission = string.Empty,
						LangKey = "BtnStats",
					...
					{
						Enabled = true,
						Image = "https://i.imgur.com/hIyouiW.png",
						Permission = string.Empty,
						LangKey = "BtnBank",
						Command = "chat.say /bank"
					}
				},
				SettingsImage = "https://i.imgur.com/mJih52U.png",
				Settings = new PanelSettings(true, string.Empty, true, false, true),
			...
			{
				new EventConf(true, "https://i.imgur.com/kxeEFQG.png", string.Empty, PanelType.CH47,
					...
					new ColorInfo(0, 2),
					"CH47"),
				new EventConf(true, "https://i.imgur.com/zjzI25y.png", string.Empty, PanelType.Bradley,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(2, 3),
					"Bradley"),
				new EventConf(true, "https://i.imgur.com/PclffR9.png", string.Empty, PanelType.Helicopter,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(3, 2),
					"Helicopter"),
				new EventConf(true, "https://i.imgur.com/NKNIqxz.png", string.Empty, PanelType.Airdrop,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"Airdrop"),
				new EventConf(false, "https://i.imgur.com/lsEIGc5.png", string.Empty, PanelType.CargoShip,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"CargoShip"),
				new EventConf(false, "https://i.imgur.com/Mkan1Ac.png", string.Empty, PanelType.Convoy,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"Convoy"),
				new EventConf(false, "https://i.imgur.com/LkmaOCm.png", string.Empty, PanelType.ArmoredTrain,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"ArmoredTrain"),
				new EventConf(false, "https://i.imgur.com/GbJGvQM.png", string.Empty, PanelType.WipeBlock,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"WipeBlock"),
				new EventConf(false, "https://i.imgur.com/CukDURt.png", string.Empty, PanelType.Sputnik,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"Sputnik"),
				new EventConf(false, "https://i.imgur.com/p4rxub9.png", string.Empty, PanelType.SpaceEvent,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
					...
					new ColorInfo(0, 2),
					"SpaceEvent"),
				new EventConf(false, "https://i.imgur.com/asflpJe.png", string.Empty, PanelType.Custom,
					new PanelSettings(true, string.Empty, true, true, true),
					new EventSizesInfo(0, new List<SizeData>(), new List<EventSizeData>
					{
						new EventSizeData("sizeBig", string.Empty, 25f),
			...
			{
				new EconomyConf(1, true, "https://i.imgur.com/Q21Pwq9.png", "Economics", "Balance",
					new PanelSettings(true, string.Empty, true, true, true),
					...
					6, string.Empty),
				new EconomyConf(2, true, "https://i.imgur.com/DhSC8z0.png", "ServerRewards", "CheckPoints",
					new PanelSettings(true, string.Empty, true, true, true),
					new EconomyConf.EconomySizeSettings(0, new List<SizeData>(), new List<EconomyConf.EconomySize>
					{
						new EconomyConf.EconomySize("sizeBig", string.Empty, 20),
		...
		private class EventConf
		{
			...
			[JsonProperty(PropertyName = "Type")] public PanelType Type;
		...
		private class PlayerData
		{
			...
			{
				if (!_instance._data.Players.ContainsKey(player.userID))
					_instance._data.Players.Add(player.userID, new PlayerData());
		...
		private void MainUi(BasePlayer player, bool first = false)
		{
			...
			if (first)
			{
				...
				container.Add(new CuiPanel
				{
					...
					Image = {Color = "0 0 0 0"}
				}, _config.DisplayType, Layer + ".Background");
			}
			...
			if (((hided && _config.Hide.ShowLogo) || hided == false) && _config.Logo.Enabled &&
			    _config.Logo.HasPermission(player))
			{
				container.Add(new CuiElement
				{
					...
					Components =
					{
						new CuiRawImageComponent {Png = ImageLibrary.Call<string>("GetImage", _config.Logo.Image)},
			    ...
			    _config.Players.HasPermission(player))
			{
				...
				container.Add(new CuiPanel
				{
					...
					{
						AnchorMin = "0 0", AnchorMax = "1 1",
						OffsetMin = $"-{size.SideIndent} {heightSwitch}",
						OffsetMax = $"-{size.SideIndent} {heightSwitch}"
					},
					Image = {Color = "0 0 0 0"}
			...
			if (hided == false && _config.ButtonsSettings.Enabled && _config.ButtonsSettings.HasPermission(player))
			{
				...
				buttons.ForEach(btn =>
				{
					...
					container.Add(new CuiPanel
					{
						...
						{
							AnchorMin = "0 0", AnchorMax = "1 1",
							OffsetMin = $"-{size.SideIndent} {ySwitch - height}",
							OffsetMax = $"-{size.SideIndent} {ySwitch}"
						},
						Image =
						{
							Color = "0 0 0 0"
					...
					if (!string.IsNullOrEmpty(btn.Image))
						container.Add(new CuiElement
						{
							...
							Components =
							{
								...
								{
									Png = ImageLibrary.Call<string>("GetImage", btn.Image)
								},
								new CuiRectTransformComponent
								{
		...
		private void EventsUi(BasePlayer player, bool first = false)
		{
			...
			if (first)
			{
				CuiHelper.DestroyUi(player, EventsLayer + ".Background");
				...
				container.Add(new CuiPanel
				{
					...
					Image = {Color = "0 0 0 0"}
				}, _config.DisplayType, EventsLayer + ".Background");
			}
			...
			container.Add(new CuiPanel
			{
				...
				Image = {Color = "0 0 0 0"}
			}, EventsLayer + ".Background", EventsLayer);
			...
			if (hided == false && _config.Settings.Enabled && _config.Settings.HasPermission(player))
			{
				...
				container.Add(new CuiElement
				{
					...
					Components =
					{
						new CuiRawImageComponent {Png = ImageLibrary.Call<string>("GetImage", _config.Settings.Image)},
						new CuiRectTransformComponent
						{
							AnchorMin = "0 0", AnchorMax = "1 1",
			...
			switch (type)
			{
				case PanelType.Online:
				{
					...
					container.Add(new CuiElement
					{
						...
						Components =
						{
							new CuiRawImageComponent {Png = ImageLibrary.Call<string>("GetImage", panel.Image)},
							new CuiRectTransformComponent
							{
								AnchorMin = "0 0", AnchorMax = "1 1",
								OffsetMin =
					...
					CuiHelper.DestroyUi(player, Layer + $".Update.{type}.Update");
					break;
				}
				...
				case PanelType.Economics:
				{
					...
					_config.Economics.FindAll(economy => economy.Enabled && economy.HasPermission(player)).ForEach(
						economy =>
						{
							...
							container.Add(new CuiLabel
							{
								...
								{
									AnchorMin = "0 0", AnchorMax = "1 1",
									OffsetMin = $"{-length - fontSize - 5} {ySwitch - fontSize - 5}",
									OffsetMax = $"-25 {ySwitch}"
								},
								Text =
								{
									Text = balance,
							...
							container.Add(new CuiElement
							{
								...
								Components =
								{
									new CuiRawImageComponent
									{
										Png = ImageLibrary.Call<string>("GetImage", economy.Image),
										Color = _config
							...
							CuiHelper.DestroyUi(player, Layer + $".Economics.{index}");

							ySwitch = ySwitch - fontSize - 5 - margin;
							index++;
						});
					break;
				}
				...
				default: //events
				{
					...
					container.Add(new CuiElement
					{
						...
						Components =
						{
							new CuiRawImageComponent
							{
								Png = ImageLibrary.Call<string>("GetImage", eventConf.Image),
					...
					CuiHelper.DestroyUi(player, EventsLayer + $".{eventConf.Type}.Icon");
					break;
				}
			}
			...
			string key = "")
		{
			...
			container.Add(new CuiPanel
			{
				...
				Image = {Color = "0 0 0 0"}
			}, SettingsLayer, SettingsLayer + ".Main");
					...
					for (var i = 0; i < settings.Count; i++)
					{
						...
						container.Add(new CuiElement
						{
							...
							Components =
							{
								new CuiRawImageComponent
								{
									Png = ImageLibrary.Call<string>("GetImage", setting.Image)
								},
								new CuiRectTransformComponent
								{
									AnchorMin = "0 0", AnchorMax = "1 1",
			...
			CuiHelper.DestroyUi(player, SettingsLayer + ".Main");
			CuiHelper.AddUi(player, container);
		}
		...
		private void LoadImages()
		{
			...
			else
			{
				...
				if (_config.Logo.Enabled)
					if (!string.IsNullOrEmpty(_config.Logo.Image) && !imagesList.ContainsKey(_config.Logo.Image))
						imagesList.Add(_config.Logo.Image, _config.Logo.Image);

				if (_config.Players.Enabled)
				{
					if (!string.IsNullOrEmpty(_config.Players.Image) && !imagesList.ContainsKey(_config.Players.Image))
						imagesList.Add(_config.Players.Image, _config.Players.Image);

					if (!string.IsNullOrEmpty(_config.Players.SettingsImage) &&
					    !imagesList.ContainsKey(_config.Players.SettingsImage))
						imagesList.Add(_config.Players.SettingsImage, _config.Players.SettingsImage);
				}

				if (_config.Time.Enabled)
				{
					if (!string.IsNullOrEmpty(_config.Time.Image) && !imagesList.ContainsKey(_config.Time.Image))
						imagesList.Add(_config.Time.Image, _config.Time.Image);

					if (!string.IsNullOrEmpty(_config.Time.SettingsImage) &&
					    !imagesList.ContainsKey(_config.Time.SettingsImage))
						imagesList.Add(_config.Time.SettingsImage, _config.Time.SettingsImage);
				}

				if (_config.Sleepers.Enabled)
				{
					if (!string.IsNullOrEmpty(_config.Sleepers.Image) &&
					    !imagesList.ContainsKey(_config.Sleepers.Image))
						imagesList.Add(_config.Sleepers.Image, _config.Sleepers.Image);

					if (!string.IsNullOrEmpty(_config.Sleepers.SettingsImage) &&
					    !imagesList.ContainsKey(_config.Sleepers.SettingsImage))
						imagesList.Add(_config.Sleepers.SettingsImage, _config.Sleepers.SettingsImage);
				}

				if (_config.ButtonsSettings.Enabled)
				{
					if (!string.IsNullOrEmpty(_config.ButtonsSettings.SettingsImage) &&
					    !imagesList.ContainsKey(_config.ButtonsSettings.SettingsImage))
						imagesList.Add(_config.ButtonsSettings.SettingsImage, _config.ButtonsSettings.SettingsImage);

					_config.ButtonsSettings.Buttons.ForEach(btn =>
					{
						if (btn.Enabled && !string.IsNullOrEmpty(btn.Image) && !imagesList.ContainsKey(btn.Image))
							imagesList.Add(btn.Image, btn.Image);
					});
				}

				if (!string.IsNullOrEmpty(_config.Settings.Image) && !imagesList.ContainsKey(_config.Settings.Image))
					imagesList.Add(_config.Settings.Image, _config.Settings.Image);

				_config.Events.ForEach(x =>
				{
					if (x.Enabled && !string.IsNullOrEmpty(x.Image) && !imagesList.ContainsKey(x.Image))
						imagesList.Add(x.Image, x.Image);
				});
