...
{
    [Info("Building Upgrade", "OxideBro", "1.1.32")]
    class BuildingUpgrade : RustPlugin
    {
        ...
        private bool permissionAutoGradeAdmin = false;
        ...
        private string ConsoleCMD = "building.up";
        ...
        void UpdateTimer(BasePlayer player, ulong playerid = 3059712)
        {
            timers[player] = resetTime;
