...
{
    [Info("Team Marker", "thouxanbanfauni", "1.0.0")]
    [Description("TeamMarker - быстрые метки по нажатию на СКМ.")]
    /*
    * Author info:
    *   Plugins & Maps: https://oxide-russia.ru/members/11769/#resources
    *   Кастомные карты на заказ: https://oxide-russia.ru/conversations/add?to=thouxanbanfauni
    */
