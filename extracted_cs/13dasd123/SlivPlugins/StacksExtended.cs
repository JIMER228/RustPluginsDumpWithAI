...
{
    [Info("StacksExtended", "k1lly0u", "2.0.12")]
    ...
    class StacksExtended : ChaosPlugin
    {
        ...
        private Datafile<OrderedHash<string, VIPLimits>> m_VIPLimits;
        ...
        private void Loaded()
        {
            ...
            m_VIPLimits = new Datafile<OrderedHash<string, VIPLimits>>("StacksExtended/vip_limits");
        ...
        private int GetMaxStackable(Item item, ItemContainer container)
        {
            ...
            if ((int)container.flags == 1 || (int)container.flags == 5)
            {
                ...
                if (m_PlayerLimits.Data.TryGetValue(item.info.shortname, out stackLimit))
        ...
        private void UpdateStorageContainerStackSize(StorageContainer storageContainer)
        {
            ...
            foreach (var kvp in m_VIPLimits.Data)
            {
                    ...
                    switch (uiUser.Category)
                    {
                        ...
                        case UICategory.VIPStorage:
                            ...
                            else
                            {
                                ...
                                else CreateStorageGridLayout(uiUser, parent, FormatString("Label.VIPStorage", player, uiUser.Permission), m_VIPLimits.Data[uiUser.Permission].StorageOverrides.Keys, CreateStorageEntry);
                            }
                            ...
                            ImageContainer.Create(stackSize, Anchor.FullStretch, new Offset(100f, 1f, -5f, -1f))
                                ...
                                .WithChildren(input =>
                                {
                                    InputFieldContainer.Create(input, Anchor.FullStretch, Offset.zero)
                                        ...
                                        .WithCallback(m_CallbackHandler, arg =>
                                        {
                                            stackLimit.MaxStackSize = arg.GetInt(1);
                            ...
                            ImageContainer.Create(stackMultiplier, Anchor.FullStretch, new Offset(100f, 1f, -5f, -1f))
                                ...
                                .WithChildren(input =>
                                {
                                    InputFieldContainer.Create(input, Anchor.FullStretch, Offset.zero)
                                        ...
                                        .WithCallback(m_CallbackHandler, arg =>
                                        {
                                            stackLimit.StackMultiplier = arg.GetFloat(1, stackLimit.StackMultiplier);
                            ...
                            ImageContainer.Create(stackSize, Anchor.FullStretch, new Offset(100f, 1f, -5f, -1f))
                                ...
                                .WithChildren(input =>
                                {
                                    InputFieldContainer.Create(input, Anchor.FullStretch, Offset.zero)
                                        ...
                                        .WithCallback(m_CallbackHandler, arg =>
                                        {
                                            storageLimit.MaxStackSize = arg.GetInt(1);
                            ...
                            ImageContainer.Create(stackMultiplier, Anchor.FullStretch, new Offset(100f, 1f, -5f, -1f))
                                ...
                                .WithChildren(input =>
                                {
                                    InputFieldContainer.Create(input, Anchor.FullStretch, Offset.zero)
                                        ...
                                        .WithCallback(m_CallbackHandler, arg =>
                                        {
                                            storageLimit.StackMultiplier = arg.GetFloat(1, storageLimit.StackMultiplier);
