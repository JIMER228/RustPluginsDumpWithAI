...
{
    [Info("TeleportGUI", "k1lly0u", "2.0.19")]
    class TeleportGUI : ChaosPlugin
    {
        ...
        private class TeleportRequest : Pool.IPooled, ITeleport
        {
            ...
            {
                List<TeleportRequest> list = Pool.GetList<TeleportRequest>();
        ...
        private class PlayerTeleporter : Pool.IPooled, ITeleport
        {
            ...
            public static void Clear()
            {
                List<PlayerTeleporter> list = Pool.GetList<PlayerTeleporter>();
        ...
        private class PositionTeleporter : Pool.IPooled, ITeleport
        {
            ...
            public static void Clear()
            {
                List<PositionTeleporter> list = Pool.GetList<PositionTeleporter>();
        ...
        {
            Vector3 position;
            if (!m_LastWarp.TryGetValue(player.userID, out position))
            {
