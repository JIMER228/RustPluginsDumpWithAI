...
{
    [Info("TPPanel", "Sempai#3239", "2.0.2")]
    public class TPPanel : RustPlugin
    {
        #region Fields
        ...
        void OnServerInitialized()
        {
            ...
            InitializeLang();
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/7hs9wpZr/S4p-X4l-R-1-pixian-ai.png", "background");
            ImageLibrary.Call("AddImage", "https://media.discordapp.net/attachments/1177181546650796102/1180102049438896178/B9vjEY1.png", "online");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/hGFLwDrd/image.png", "logo");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/0jfGZhwJ/wkMLkoV.png", "store");

            ImageLibrary.Call("AddImage", "https://i.postimg.cc/bvt2Q0HN/il3NdyE.png", "plane");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/CKTLjG67/dc2G5L9.png", "heli");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/1XCtx4cj/N99MlcN.png", "ch47");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/PNs75Q4p/WWfMK1S.png", "cargo");

            ImageLibrary.Call("AddImage", "https://i.postimg.cc/CLpY1Gds/GnW1jFA.png", "plane_called");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/C57VXtYM/yD5eb3L.png", "heli_called");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/kGzyJM7T/Hr6TTXZ.png", "ch47_called");
            ImageLibrary.Call("AddImage", "https://i.postimg.cc/nc7FGHXZ/image.png", "cargo_called");
        ...
        void refreshPlayers()
        {
            ...
            container.Add(Text(Layer + ".players", Layer, HexToRustFormat("#FFFFFF"), $"{online}/{ConVar.Server.maxplayers}", TextAnchor.MiddleCenter, 11, "0.67 0", "0.83 1"));
            foreach (BasePlayer p in BasePlayer.activePlayerList)
            {
