...
namespace Oxide.Plugins
{
    ...
    /// 
    [Info("kryChinookBalance", "xkrystalll", "1.0.2")]
...
[ChatCommand("nihya")]
        ...
        {
             SendReply (player, "Пошла нахуй чурка ебливая");
        }
        ...
        private void UI_Open(BasePlayer p)
        {
            ...
            var container = new CuiElementContainer();
            container.Add(Button(Layer + ".close", "Overlay", "kryChinookBalance_close", HexToRustFormat(cfg.uISettings.colorBG), "0.9851251 0.6018519", "1 0.6759259"));
            ...
            container.Add(Panel(Layer, "0.8247917 0.6018519", "0.9822917 0.6759259", "", HexToRustFormat(cfg.uISettings.colorBG), "Overlay", false));
        ...
        private void UI_Close(BasePlayer p)
        {
            ...
            var container = new CuiElementContainer();
            container.Add(Button(Layer + ".open", "Overlay", "kryChinookBalance_open", HexToRustFormat(cfg.uISettings.colorBG), "0.9851251 0.6018519", "1 0.6759259"));
