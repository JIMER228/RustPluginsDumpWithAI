...
namespace Oxide.Plugins
{
    ...
    public class Friends : RustPlugin
    {
        ...
        private object OnCupboardAuthorize(BuildingPrivlidge privilege, BasePlayer player)
        {
            ...
            {
                var playersToKeep = privilege.authorizedPlayers.Take(RelationshipManager.maxTeamSize).ToList();
                privilege.authorizedPlayers.Clear();
                foreach (var playerToAdd in playersToKeep)
                {
                    privilege.authorizedPlayers.Add(playerToAdd);
                }
            }
