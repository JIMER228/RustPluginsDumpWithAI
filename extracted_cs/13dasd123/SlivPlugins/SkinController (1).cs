...
{
    [Info("SkinController", "Amino", "1.4.0")]
    ...
    public class SkinController : RustPlugin
    {
        ...
        public class SkinnerConfig
        {
            ...
            public string UIImage { get; set; } = "https://i.ibb.co/3SNBq4W/Adv-Skinner.png";
        ...
        private void SkinItemContainer(BasePlayer player, PlayerSettings playerSettings, ItemContainer container, bool playerInv = true, bool isInd = false, string InputSkinID = "0", int InputItemID = 0)
        {
            ...
            {
                if (_config.DissallowedSkinIDs.Contains(item.skin.ToString())) continue;
        ...
        {
            if (item == null || player == null || _config.DissallowedSkinIDs.Contains(item.skin.ToString())) return;
        ...
        private void SkinTeam(BasePlayer player, PlayerSettings playerSettings)
        {
            foreach (var member in player.Team.members)
            {
                ...
                SkinItemContainer(teamMember, playerSettings, teamMember.inventory.containerBelt, true);
                SkinItemContainer(teamMember, playerSettings, teamMember.inventory.containerMain, true);
                SkinItemContainer(teamMember, playerSettings, teamMember.inventory.containerWear, true);
            }
        }
        #endregion
        ...
        private void CMDSkin(ConsoleSystem.Arg arg)
        {
            ...
            switch (arg.Args[0])
            {
                case "remove":
                    ...
                    break;
                case "team":
                    SkinTeam(arg.Player(), playerSettings);
                    break;
                case "inv":
        ...
        private void UIMainLoadoutDisplay(BasePlayer player)
        {
            ...
            if (_config.AllowSkinTeam && player.Team != null && player.userID == player.Team.teamLeader) CreateButton(ref container, ".6 .15", ".705 .81", $"{_config.UISecondaryButtonColor} 1", "1 1 1 1", "SKIN TEAM", 18, "sc_skin team", "SCMainLoadoutName");
