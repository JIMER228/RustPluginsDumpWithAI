        ...
        */
        ...
        void DVTeleportationAcceptUI(BasePlayer target, string TprName)
        {
            ...
            container.Add(new CuiPanel
            {
                ...
                Image = { Color = HexToRustFormat("#492a47"), Material = "assets/content/ui/uibackgroundblur.mat" } // , #bdb4ab #4b98d0
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Close = PARENT_TELEPORT, Command = "chat.say /tpa", Color = HexToRustFormat("#7a318bFF"), Material = "assets/content/ui/uibackgroundblur.mat" },
