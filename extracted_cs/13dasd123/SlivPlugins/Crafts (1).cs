...
namespace Oxide.Plugins
{
	...
	public class Crafts : RustPlugin
	{
		...
		private const string PermBypass = "crafts.bypass";
		...
		private readonly Dictionary<ulong, CustomWorkbenchConf> _openedCustomWb =
			...
			public List<Category> Categories = new List<Category>
			{
				new Category
				{
					...
					Crafts = new List<CraftConf>
					{
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/mqYTq4P/image.png",
							Title = "Minicopter",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/LJdqQ6z/image.png",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/HpkTsBZ/image.png",
							Description = "Slow water transport",
							Title = "RHIB",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/gr64fDx/image.png",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/nzXCNws/image.png",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/gdcVNwr/image.png",
							Title = "Snowmobile",
				...
				new Category
				{
					...
					Crafts = new List<CraftConf>
					{
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/MG4N1cs/image.png",
							Title = "Sedan",
							Description = "5KM/H",
							CmdToGive = "givesedan",
							Permission = "crafts.all",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/nwsDTbW/image.png",
							Title = "Ferrari",
							Description = "25KM/H",
							CmdToGive = "givemod1",
							Permission = "crafts.all",
				...
				new Category
				{
					...
					Crafts = new List<CraftConf>
					{
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/mHRkk5P/image.png",
							Title = "Home Recycler",
						...
						{
							Enabled = true,
							Image = "https://i.ibb.co/024076x/image.png",
							Title = string.Empty,
							Description = string.Empty,
							CmdToGive = "givelr300",
							Permission = "crafts.all",
			...
			public UserInterface UI = new UserInterface
			{
				...
				CraftMenuSettings = new UserInterface.CraftMenu
				{
					...
					Description = new PanelSettings
					{
						...
						BackgroundColor = new IColor("#0E0E10", 100)
					}
				}
			};
		...
		private class UserInterface
		{
			...
			[JsonProperty(PropertyName = "Craft Menu")]
			...
			public class CraftMenu
			{
				...
				[JsonProperty(PropertyName = "Max Items On String")]
				public int MaxItemsOnString;

				[JsonProperty(PropertyName = "Item Up Indent")]
		...
		private class CraftConf
		{
			...
			[JsonProperty(PropertyName = "Multiple Craft")]
			public bool MultipleCraft;

			[JsonProperty(PropertyName = "Maximum number of crafts")]
			public int MaxAmount;

			[JsonProperty(PropertyName = "Enable Craft?")]
			public bool Craft;

			[JsonProperty(PropertyName = "Enable Sales?")]
			public bool Sale;

			[JsonProperty(PropertyName = "Cost")] public float Cost;

			[JsonProperty(PropertyName = "Set OwnerID for child containers?")]
			public bool SetOwnerID;

			[JsonProperty(PropertyName = "Need to customize the rotation when spawning?")]
			public bool CustomizeRotationOnSpawning;

			[JsonProperty(PropertyName = "Description settings (in the craft menu)")]
		...
		private class RecyclerConfig
		{
			...
			[JsonProperty(PropertyName = "Use recycling speed?")]
			...
			if (_config.Version != default(VersionNumber))
			{
				...
				if (_config.Version < new VersionNumber(2, 10, 10))
				{
					_config.Categories.ForEach(category =>
					{
						...
						{
							category.Crafts.Add(new CraftConf
							{
								Enabled = false,
								Image = "https://i.ibb.co/tmsNRcB/newkopter.png",
								Title = "Attack Helicopter",
		...
		private object CanLootEntity(BasePlayer player, Workbench workbench)
		{
			...
			if (_config.CustomWorkbench.TryGetValue(workbench.net.ID.Value, out customWb))
			{
			...
			switch (arg.Args[0])
			{
				...
				case "craft":
				{
					...
					if (!bypass)
					{
						...
						allItems = player.inventory.AllItems();
					...
					ServerMgr.Instance.StartCoroutine(TakeAndGiveCraftItems(player, amount, allItems, craft, bypass));
