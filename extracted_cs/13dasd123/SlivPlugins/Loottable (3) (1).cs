...
{
    [Info(nameof(Loottable), "The_Kiiiing", "2.1.5")]
...
throw;
        ...
        static class LootManager
        {
            ...
            {
                Instance.lang.BroadcastMessage("loot_refresh_warning");
                Log("Refreshing loot ...");
            ...
            private static void ApplyCustomLoot(ItemContainer container, LootConfig config, bool clear, ItemContainer altContainer = null, bool forPlayer = false, bool forWagon = false)
            {
                ...
                if (Config.GeneratorOptions.UseExpAdjustedChance)
                {
        ...
        private class LootConfig
        {
            ...
            public void OnSave()
            {
                ...
                var expectedAmount = DefaultCategory.Sum(x => x.Chance);
                ...
                LogDebug($"Config saved with m {ChanceMultiplier} e {expectedAmount} d {desiredAmount}");
            }
        ...
        public class Configuration
        {
            ...
            public class LootGeneratorOptions
            {
                ...
                [JsonProperty("Use expectancy adjusted chances (experimental)")]
                public bool UseExpAdjustedChance { get; set; }
            }
        }
        ...
        public static LootableDataList Get()
        {
            var list = new LootableDataList
            {
                ...
                CrateData = new CrateData[]
                {
                    ...
                    // 56 Present drop
                    new("crate_present_drop", null, "assets/prefabs/misc/xmas/sleigh/presentdrop.prefab"),
                    new("crate_present_small", null, "assets/prefabs/misc/xmas/giftbox/giftbox_loot.prefab")
                }
            };
