...
{
    [Info("ComponentsEvent", "Oxide-Russia", "1.0.2")]
    public class ComponentsEvent : RustPlugin
    {
        ...
        public List<ulong> LootedBoxes = new List<ulong>();
        ...
        private void OnLootEntity(BasePlayer player, BaseEntity entity)
        {
            ...
            if (LootedBoxes.Contains(container.net.ID.Value)) return;
            ...
            if (!LootedBoxes.Contains(container.net.ID.Value)) LootedBoxes.Add(container.net.ID.Value);
        }
