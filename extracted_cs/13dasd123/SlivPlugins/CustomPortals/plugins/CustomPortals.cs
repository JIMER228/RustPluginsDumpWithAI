...
{
    [Info("CustomPortals", "_senyaa", "1.3.8")]
    class CustomPortals : RustPlugin
    {
        ...
        {
            public static CustomPortalComponent Spawn(Vector3 position, Quaternion rotation, string name = "Unnamed", bool isManuallyPlaced = false, string placedBy = "", string portalPermission = "", bool broadcastEnabled = false, BasePlayer placedByPlayer = null, float itemCondition = 100f, string ownerGroup = "", bool placedByAdmin = false)
            {
        ...
        class PortalDataLoader : MonoBehaviour
        {
            ...
            IEnumerator LoadPlayerData()
            {
                ...
                {
                    CustomPortalComponent.Spawn(sPortal.Position, Quaternion.Euler(sPortal.Rotation), sPortal.Name, isManuallyPlaced: true, placedBy: sPortal.PlacedBy, portalPermission: sPortal.Permission, broadcastEnabled: sPortal.IsBroadcastEnabled, itemCondition: sPortal.ItemCondition, ownerGroup: sPortal.OwnerGroup, placedByAdmin: sPortal.IsPlacedByAdmin);
                    yield return null;
                }
