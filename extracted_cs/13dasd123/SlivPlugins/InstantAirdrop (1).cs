...
{
    [Info("InstantAirdrop", "Rogder Dodger", "1.0.9")]
    ...
    internal class InstantAirdrop : RustPlugin
    {
        ...
        private void RefundAndNotify(BasePlayer player, BaseEntity entity)
        {
            ...
            var item = ItemManager.CreateByName("supply.signal", 1, entity.skinID);
            if (item != null)
            {
        ...
        private void SpawnAirdrop(Vector3 pos, ulong playerId)
        {
            ...
            newEntity.skinID = 234501; //adds integration with loot defender 
            newEntity.Spawn();
