    ...
    public class OneVSOne : RustPlugin
    {
        ...
        void OnServerInitialized()
        {
            ...
            else
            {
                ...
                privilege = hitInfo.GetEntity().GetBuildingPrivilege().net.ID.Value;
            }
        ...
        private bool IsEventArena(ulong priv)
        {
        ...
        private void OnPasteFinished(List<BaseEntity> entitys)
        {
            ...
            privilege = first.GetBuildingPrivilege().net.ID.Value;
