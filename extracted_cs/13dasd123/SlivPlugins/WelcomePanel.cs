...
{
    /*ПЛАГИН БЫЛ ПОФИКШЕН С ПОМОЩЬЮ ПРОГРАММЫ СКАЧАНОЙ С https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ ПОФИКШЕН С ПОМОЩЬЮ ПРОГРАММЫ СКАЧАНОЙ С https://discord.gg/dNGbxafuJn */ [Info("WelcomePanel", "https://discord.gg/dNGbxafuJn", "3.0.8")]
    ...
    public class WelcomePanel : RustPlugin
    {
        ...
        private void SetPresetValues(int presetNumber)
        {
            ...
            if (presetNumber == 2)
            {
                ...
                cuiData["logoPanel"].color = "0 0 0 0"; cuiData["logoPanel"].material = "assets/icons/iconmaterial.mat";
                cuiData["logoPanel"].image = "https://stihi.ru/pics/2022/11/07/7330.jpg"; cuiData["logoPanel"].fade = 0.5f;
                //close button
