...
{
    [Info("MinicopterCombat", "Bxrflip", "1.1.2")]
    public class MinicopterCombat : RustPlugin
    {
        ...
        public class HelicopterWrapper : MonoBehaviour, Lock
        {
            ...
            {
                var ammoItemId = weaponsToAmmoTypeItemIdMap[ammoTypeShortName];
                var ammo = player.inventory.FindItemsByItemID(ammoItemId).FirstOrDefault();
