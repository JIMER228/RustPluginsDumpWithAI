...
{
    [Info("TeamInfo", "AhigaO#4485", "1.2.15")]
    internal class TeamInfo : RustPlugin 
    {
        ...
        private void OnPlayerDisconnected(BasePlayer player, string reason) => NextTick(() => ShowUIMain(player.Team));
        ...
        private void OnTeamCreate(BasePlayer player) 
        {
            NextTick(() =>
            {
                ...
                playersTeams.Add(playerTeam, new List<BasePlayer> { player });
