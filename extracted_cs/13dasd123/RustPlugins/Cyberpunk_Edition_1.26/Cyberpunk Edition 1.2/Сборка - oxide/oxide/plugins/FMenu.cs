...
{
    [Info("FMenu","Discord: Netrunner#0115","1.0")]
...

    {
        ...
        void InitImages()
        {
            ...
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/raG8sxW.png", "fclock");
        }
        ...
        void MenuUI(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiRectTransformComponent{AnchorMin = "1 0",AnchorMax = "1 0",OffsetMin = "-110 47",OffsetMax = "-70 87"},
                    new CuiRawImageComponent{Png = (string) ImageLibrary.Call("GetImage","fclock")}
                }
            });
        ...
        void UpdateCurrency(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0",AnchorMax = "0 1",OffsetMin = "100 0",OffsetMax = "140 0"
                    },
                    new CuiRawImageComponent
                    {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = {AnchorMin = "0.5 0",AnchorMax = "1 1",OffsetMin = "55 0",OffsetMax = "0 0"},
