...
namespace Oxide.Plugins
{
    ...
    {																			
		...
		private const string FarmMainFon = /*"https://lc-crb.ru/CyberPunk/Zkj8Mq0.png";*/"https://lc-crb.ru/CyberPunk/3dNVkKf.png";
		private const string FarmGreyFon = /*"https://lc-crb.ru/CyberPunk/YHOIQIy.png";*/"https://lc-crb.ru/CyberPunk/uTr7F0K.png";
		
		private const string FarmExit = "https://lc-crb.ru/CyberPunk/s7DX62V.png";
		private const string FarmBack = "https://lc-crb.ru/CyberPunk/hYoguVb.png";
		private const string FarmExchange = "https://lc-crb.ru/CyberPunk/rDk4DEY.png";
		
		private readonly Dictionary<int, string> FarmArts = new Dictionary<int, string>()
		{
			{ 1, "https://lc-crb.ru/CyberPunk/xkvRBMp.png" },
			{ 2, "https://lc-crb.ru/CyberPunk/4U8Uyur.png" },
			{ 3, "https://lc-crb.ru/CyberPunk/srwzAIt.png" },
			{ 4, "https://lc-crb.ru/CyberPunk/uF6l4Ao.png" },
			{ 5, "https://lc-crb.ru/CyberPunk/Nzx528V.png" },
			{ 6, "https://lc-crb.ru/CyberPunk/Qnn2kpA.png" },
			{ 7, "https://lc-crb.ru/CyberPunk/EB7V0bD.png" },
			{ 8, "https://lc-crb.ru/CyberPunk/1xDvHZn.png" },
			{ 9, "https://lc-crb.ru/CyberPunk/BS6bnOI.png" },
			{ 10, "https://lc-crb.ru/CyberPunk/yH3afVL.png" }
		};				
		...
		private void DoInitImages(BasePlayer player, bool isFull = false)
		{
			...
			UI_MainPanel(ref container, "0 0 0 0", "1.1 1.1", "1.2 1.2", false, false, false, InitPanel);
		...
		private void DrawUI(BasePlayer player)
		{
			...
			var container = new CuiElementContainer();
			UI_MainPanel(ref container, "0 0 0 0", "0 0", "1 1", true, true, false);
