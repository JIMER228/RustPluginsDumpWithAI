...
namespace Oxide.Plugins
{
    ...
    public class VehileShop : RustPlugin
    {
        ...
        {
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/SbuDZ8Z.png", "https://lc-crb.ru/CyberPunk/SbuDZ8Z.png");
        ...
        void SpawnVehile(BasePlayer player, int number)
        {
            ...
            {
               Broadcast.Call("GetPlayerNotice", player, "АВТОМАТОН","Неподходящие место. Выберете другое место для спавна","infoicn","assets/bundled/prefabs/fx/invite_notice.prefab");
            ...
            Broadcast.Call("GetPlayerNotice", player, "АВТОМАТОН",$"Транспорт \"{element.Name}\" успешно приобретен!",config.VehileSettings[number].Image,"assets/bundled/prefabs/fx/invite_notice.prefab");
        ...
        void OpenUI(BasePlayer player,int page = 0)
        {
            ...
            if (config.VehileSettings.Count>(page+1)*12)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    Button = {Color = "0.00 0.95 1.00 0.7",Close = _layer,Command = $"vehilepage {page+1}"},
            ...
            foreach (var vehile in config.VehileSettings.Skip(page*12).Take(12))
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRawImageComponent{Png = (string) ImageLibrary.Call("GetImage","https://lc-crb.ru/CyberPunk/SbuDZ8Z.png")}
                    }
                });
                ...
                container.Add(new CuiButton
                {
                    ...
                    Button = {Color = "0.00 0.95 1.00 0.7",Command = $"buyvehile {i}"},
                    Text = {Text = "КУПИТЬ",FontSize = 15,Align = TextAnchor.MiddleCenter, Color = "0.0 0 0 0.95"}
                }, $"Vehile{i}");
