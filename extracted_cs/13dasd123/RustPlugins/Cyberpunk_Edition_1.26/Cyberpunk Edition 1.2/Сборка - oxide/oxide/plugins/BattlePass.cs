...
namespace Oxide.Plugins
{
    ...
    public class BattlePass : RustPlugin
    {
        ...
        {
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/AEWjmy1.png", "claimed");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/vqf3UnA.png", "notclaimed");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/vU0S6Lc.png", "lock");
            
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/NExeF1X.png", "logo");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/back1.png", "lback");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/QcMLq8j.png", "expback");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/QcMLq8j.png", "layer");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/SbuDZ8Z.png", "rBack");
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/sn0PkQy.png", "rIcon");
            
            ImageLibrary.Call("AddImage", "https://lc-crb.ru/CyberPunk/noMTzFe.png", "bar");
        }
