...
{
    [Info("CrystalFarm", "wazzzup", "1.2.2")]
    ...
    public class CrystalFarm : RustPlugin
    {
        ...
        public class ConfigData
        {
            ...
            public string message                   = "Тебе улыбнулась удача и ты смог найти редкую породу";
        ...
        class PluginData
        {
            public Dictionary<uint, MagicCrystalItemConfig> trees = new Dictionary<uint, MagicCrystalItemConfig>();
        }
        ...
        void OnEntityBuilt(Planner plan, GameObject obj)
        {
            ...
            if (entity != null && entity.ShortPrefabName == "corn.entity" && entity.skinID == 2226183438)
            {
                ...
                mtree.InitFaze(3); 
                crystal.Spawn(); /*var planter = GetPlanterBox(crystal.transform.position); if (planter != null) { crystal.transform.parent = planter.transform; }*/
