    ...
    public class Menu : RustPlugin
    {
        ...
        private class MenuHandler : MonoBehaviour
        {
            ...
            public void Awake()
            {
                ...
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/7lOYsov.png", "NotificationImage");
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/HiEEg07.png", "MenuHeaderImage");
                _.ImageLibrary.Call("AddImage", "https://i.imgur.com/7lOYsov.png", "RaidNotification");
