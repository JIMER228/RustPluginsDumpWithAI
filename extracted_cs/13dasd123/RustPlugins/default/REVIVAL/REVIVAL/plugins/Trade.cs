...
namespace Oxide.Plugins
{
    [Info("Trade", "OxideBro", "1.1.41")] public class Trade: RustPlugin
    {
        ...
        Dictionary < string, string > Messages = new Dictionary < string, string > ()
        {
            ...
            {
                "TRADE.HELP",
                "REVIAL RUST\nИспользуйте комманду <color=blue>/trade \"НИК\"</color> для обмена\nЧто бы принять обмен, введите: <color=blue>/trade yes</color> (или /trade accept)\nЧто бы отказаться от обмена введите: <color=blue>/trade no </color> (или /trade cancel)"
            },
            {
                "PLAYER.NOT.FOUND",
                "Игрок '{0}' не найден!"
            ...
            },
            {
                ...
                "Игрок '{0}' отправил вам предложние обмена\nДля принятия обмена используйте команду <color=blue>/trade yes</color>\nЧто бы отказаться введите <color=blue>/trade no</color>"
            },
            {
