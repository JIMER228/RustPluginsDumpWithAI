...
namespace Oxide.Plugins
{
    ...
    class Obmen : RustPlugin
    {
        ...
        private Dictionary<string, string> images = new Dictionary<string, string>()
        {
            ...
            ["Image0"] = "https://rustlabs.com/img/items180/wood.png",
            ["Image1"] = "https://rustlabs.com/img/items180/lowgradefuel.png",
            ["Image2"] = "https://rustlabs.com/img/items180/sulfur.png",
            ["Image3"] = "https://rustlabs.com/img/items180/coffin.storage.png",
            ["Image4"] = "https://rustlabs.com/img/items180/jackhammer.png",
            ["Image5"] = "https://rustlabs.com/img/items180/scrap.png",
        };
        ...
        private void DrawInterface(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = "SUNSHINE RUST", Align = TextAnchor.MiddleCenter, FontSize = 40 }
            }, Layer);
