...
namespace Oxide.Plugins
{
    ...
    public class Crafts : RustPlugin
    {
        ...
        private class Configuration
        {
            ...
            public string GreenColor = "#B8860B";
            ...
            public Dictionary<WorkbenchLevel, WorkbenchConfig> Workbenchs =
                ...
                {
                    [WorkbenchLevel.None] = new WorkbenchConfig("#DAA520", "Верстак не требуется"),
                    [WorkbenchLevel.One] = new WorkbenchConfig("#DAA520", "Верстак 1 уровня"),
                    [WorkbenchLevel.Two] = new WorkbenchConfig("#DAA520", "Верстак 2 уровня"),
                    [WorkbenchLevel.Three] = new WorkbenchConfig("#DAA520", "Верстак 3 уровня")
                };
