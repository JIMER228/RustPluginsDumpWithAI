...
namespace Oxide.Plugins
{
    ...
    class XMenu : RustPlugin
    {
        ...
        {		
			...
			[JsonProperty("Настройка информации других плагинов. [ Хуки c типом параметра - player(FramePlayer) | userID(ulong) ]")]
			...
			public static MenuConfig GetNewConfiguration()
            {
                return new MenuConfig
                {
					...
					{
						LogoURL = "https://media.discordapp.net/attachments/964197283157659658/999263076832509962/imgonline-com-ua-Transparent-backgr-AQD0bapn1Kb5bp6V.png",
						LogoColor = "1 1 1 1",
					...
					Button = new Dictionary<string, string>
					{
			            ...
			            ["МАГАЗИН"] = "chat.say /store",
			            ["КРАФТ"] = "chat.say /craft",  
			            ["ОБМЕН"] = "chat.say /obmen" 
					},					
        ...
        void InitializeLang()
        {
			...
			llang.Add("TITLE", "HARDRUST <color=#ff01f0>MAX 5 X10</color>\n<size=10>ОНЛАЙН: {0}/{1} | ЗАХОДЯТ: {2} | СЛИПЕРЫ: {3} | ВРЕМЯ: {4}</size>");	
