...
{
    [Info("ScrapHelicopterFix", "OxideBro", "0.1.1")]
        ...
        private void UpdateConfigValues()
        {
            ...
            if (config.PluginVersion < Version)
            {
                if (config.PluginVersion < new VersionNumber(0, 1, 1))
                {
                    ...
                    {
                        DisabledEffectsMinicopter = true;
,
                        DisableFireBallsMinicopter = true;
        ...
        public class ConfigMinicopter
        {
            ...
            public bool DisableFireBallsMinicopter = true;
        ...
        private class PluginConfig
        {
            ...
            public bool EnabledFixesFireBalls = true;
;
            ...
            public bool DisableServerGibs = true;
;
            ...
            public bool DisabledEffects = true;
;
