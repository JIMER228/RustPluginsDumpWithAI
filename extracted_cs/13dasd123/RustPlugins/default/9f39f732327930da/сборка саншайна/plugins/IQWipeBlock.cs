...
{
    [Info("IQWipeBlock", "Mercury", "0.0.9")]
    ...
    class IQWipeBlock : RustPlugin
    {
        ...
        #region Reference
        [PluginReference] Plugin ImageLibrary, Battles, Duel, Duelist; // https://umod.org/plugins/duelist
        ...
        void ReadData() => BlockHideInfo = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<Dictionary<UInt64, Boolean>>("IQWipeBlock/HideStatus");
        void WriteData() => Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("IQWipeBlock/HideStatus", BlockHideInfo);
        ...
        void UI_IQ_WipeBlock(BasePlayer player)
        {
            ...
            {
                RectTransform = { AnchorMin = "0.155722781 0.9231482", AnchorMax = "0.8375002 0.9842593" },
        ...
        void HideButtonIsMenu(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.1557295 0.90372781", AnchorMax = "0.8375002 0.9351867" },
        ...
        void UI_Category_More_Popup(BasePlayer player, Configuration.Blocks.BlockElement BlockElement)
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.3281249 0.67962781", AnchorMax = "0.6927 0.7268518" },
        ...
        Boolean Interface_UI_Block(BasePlayer player, String Shortname, String ShortnameModule = "", UInt64 SkinID = 0, List<Connection> playerList = null)
        {
            ...
            String ColorBackground = Block_Skin_Controller(BlockAll[Shortname], BlockAll, TimeUnblock(BlockAll[Shortname].TimeBlock) > 0, SkinID) ? Interface.BlockedPanel : BlockAll[Shortname].BlockMoreList.Count > 0 && !String.IsNullOrWhiteSpace(ShortnameModule) && TimeUnblock(Block.VaribleUnlockMore ? BlockAll[Shortname].TimeBlock + BlockAll[Shortname].BlockMoreList[ShortnameModule] : BlockAll[Shortname].BlockMoreList[ShortnameModule]) > 0 ? Interface.UnblockedMorePanel : "";
        ...
        public Double TimeUnblock(Int32 BlockTime) => (SaveRestore.SaveCreatedTime.ToUniversalTime().Subtract(epoch).TotalSeconds + BlockTime) - CurrentTime();
        ...
        private new void LoadDefaultMessages()
        {
            ...
            {
                ["TITLE_BLOCK"] = "<size=35><b>Sunshine Block</b></size>",
