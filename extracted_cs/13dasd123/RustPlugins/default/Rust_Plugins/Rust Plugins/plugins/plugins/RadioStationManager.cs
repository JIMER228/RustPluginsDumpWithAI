...
{
    [Info("Radio Station Manager", "Whispers88", "1.0.2")]
    ...
    public class RadioStationManager : RustPlugin
    {
        ...
        public class Configuration
        {
            ...
            public Dictionary<string, string> RadioStations = new Dictionary<string, string>() {
                { "Capital Glasgow", "https://icecast.thisisdax.com/CapitalGlasgowMP3" },
                { "NSB Base Beats", "https://443-1.autopo.st/130/;" }
            };
        ...
        private void OnServerInitialized()
        {
            ...
            if (!BoomBox.ServerUrlList.IsNullOrEmpty())
            {
                ...
                {
                    Puts("Invalid number of stations in BoomBox.ServerUrlList, ensure you always have a name and a url");
                    return;
                }
