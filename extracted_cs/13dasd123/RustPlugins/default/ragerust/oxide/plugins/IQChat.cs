        ...
        private class InterfaceBuilder
        {
            ...
            private void BuildingMuteAlert()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiRawImageComponent { Color = "1 1 1 1",Png = ImageUi.GetImage("IQCHAT_IGNORE_ALERT_BUTTON_YES") },
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-100 49.703517", OffsetMax = "100 79.703517" }
                }
                });
            ...
            private void BuildingMuteAlert_DropList_Title()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-199.828 -9.4303517", OffsetMax = "199.832 27.4303517" }
                }
                });
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = "1 1 1 0" },
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-147.497 -265.54403517", OffsetMax = "147.503 -24.703517" }
