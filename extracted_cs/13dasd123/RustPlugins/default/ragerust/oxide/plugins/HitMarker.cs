...
[ChatCommand("hitmarker")]
        ...
        string GetDamageArg(BasePlayer player)
        {
            ...
            {
                var item = damages[i];
                sb.Append($"<color=#fffff{GetDamageColor(item.Value)}>{item.Value}</color>" + Environment.NewLine);
        ...
        Dictionary<string, string> Images = new Dictionary<string, string>()
        {
            ...
            { "hitmarker.hit.normal", "https://media.discordapp.net/attachments/981485853790572585/1059558724479500429/d9316b32e1637722_1.png" },
            { "hitmarker.hit.head", "https://media.discordapp.net/attachments/981485853790572585/1059568414525493358/d9316b32e1637722_1_1.png" },
