...
{
    [Info("DeathMessages", "Sempai#3239", "2.3.1")]
    class DeathMessages : RustPlugin
    {
        ...
        class PluginConfig
        {
            ...
            public static PluginConfig DefaultConfig()
            {
                ...
                {
                    { "Arrow", "{attacker} изрешетил {victim} ({weapon}, {distance} м.)" },
                    { "Blunt",  "{attacker} изрешетил {victim} ({weapon})" },
                    { "Bullet", "{attacker} изрешетил {victim} ({weapon}, {distance} м.)" },
                    { "Flamethrower", "{attacker} сжег заживо игрока {victim} ({weapon})" },
                    { "Drowned", "{victim} захлебнулся." },
                    { "Explosion", "{attacker} забил насмерть {victim} ({weapon})" },
                    ...
                    { "Explosion Sleeping", "{attacker} забил насмерть {victim} ({weapon})" },
