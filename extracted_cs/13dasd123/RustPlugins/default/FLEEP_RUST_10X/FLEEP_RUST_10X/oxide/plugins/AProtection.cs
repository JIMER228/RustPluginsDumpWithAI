...
{
    [Info("AProtection", "https://discord.gg/9vyTXsJyKR", "1.5.6")]
    public class AProtection : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            lang.RegisterMessages(new Dictionary<string, string>()
            {
                ...
                ["НЕВЕРНЫЙ ПАРОЛЬ"] = $"Не удалось ввести пароль, либо вы подменили SteamID!" +
            ...
            lang.RegisterMessages(new Dictionary<string, string>()
            {
                ...
                ["НЕВЕРНЫЙ ПАРОЛЬ"] = $"Admin - Не угодал пароль?" +
