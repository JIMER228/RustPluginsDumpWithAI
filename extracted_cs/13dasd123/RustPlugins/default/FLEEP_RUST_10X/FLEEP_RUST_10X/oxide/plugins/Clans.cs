...
{
    [Info("Clans", "https://discord.gg/9vyTXsJyKR", "1.0.5", ResourceId = 14)]
...
'\n'
        ...
        public bool HasFFEnabled(ulong playerid = 5319680) => !enableFFOPtion ? false : !manuallyEnabledBy.Contains(playerid) ? false : true;
