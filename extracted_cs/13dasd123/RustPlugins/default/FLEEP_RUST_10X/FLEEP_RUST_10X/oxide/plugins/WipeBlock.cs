...
{
    [Info("WipeBlock", "https://discord.gg/9vyTXsJyKR", "2.0.12")]
    ...
    public class WipeBlock : RustPlugin
    {
        ...
        private void DrawBlockGUI(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent {Text = $"БЛОКИРОВКА ПРЕДМЕТОВ", FontSize = 30, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
