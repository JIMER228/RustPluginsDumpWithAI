...
{
    [Info("IQMenu", "https://discord.gg/9vyTXsJyKR", "0.0.4")]
    [Description("tilt")]
    class IQMenu : RustPlugin
    {
        ...
        void InterfaceMenu(BasePlayer player)
        {
            ...
            {
                RectTransform = { AnchorMin = "0 0", AnchorMax = "0.20221466 0.5515152" },
            ...
            if (config.UseOnlineInMenu)
            {
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.2422231466 0", AnchorMax = "0.5311159 0.5515152" },
