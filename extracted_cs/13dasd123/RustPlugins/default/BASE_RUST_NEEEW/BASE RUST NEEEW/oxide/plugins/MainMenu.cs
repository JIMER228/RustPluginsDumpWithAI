    ...
    public class MainMenu : RustPlugin
    {
        ...
        void CreateMenu(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Color = "0 0 0 0.01", Close = MainLayer, Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = "0.67 0.38 1.00 0.9" },
                RectTransform = { AnchorMin = "0.19 0.32", AnchorMax = "0.81 0.78" },
            }, MainLayer);
