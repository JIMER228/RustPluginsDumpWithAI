                    ...
                    case 200:
                        {
                            ...
                            if (firstInfo.ContainsKey("result"))
                            {
                                ...
                                else
                                {
                                    ...
                                    foreach (var check in data.Skip(page * 32).Take(32))
                                    {
                                    ...
                                    secondContainer.Add(new CuiButton
                                    {
                                        ...
                                        Text = { Text = ">", Color = (page + 1) * 32 < data.Count ? "1 1 1 1" : "1 1 1 0.2", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 80 }
                                    }, StoreLayer + ".BlockPanel");
