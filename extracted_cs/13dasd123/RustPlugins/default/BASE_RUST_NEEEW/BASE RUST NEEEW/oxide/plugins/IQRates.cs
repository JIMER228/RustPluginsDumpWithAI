...
namespace Oxide.Plugins
{
    ...
    class IQRates : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {                       
                PrintWarning(LanguageEn ? "Error #3329903" + $"read configuration 'oxide/config/{Name}', create a new configuration!!" : "Ошибка #3329903" + $"чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!!"); //#333
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
