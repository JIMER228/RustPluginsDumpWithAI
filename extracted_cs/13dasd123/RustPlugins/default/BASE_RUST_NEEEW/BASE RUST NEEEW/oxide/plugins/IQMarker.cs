...
namespace Oxide.Plugins
{
    ...
    class IQMarker : RustPlugin
    {
        ...
        public void Interface_Main_Menu(BasePlayer player)
        {
            ...
            container.Add(new CuiLabel
            {                                    
                RectTransform = { AnchorMin = "0.088022695 0.9287037", AnchorMax = "0.2541667 0.9796296" },
            ...
            if(config.AccessSettings.UseSettingsMarker)
            {
                container.Add(new CuiLabel
                {                                             
                    RectTransform = { AnchorMin = "0.6880208 0.90832695", AnchorMax = "0.9869792 0.9398148" }, 
        ...
        public void Interface_Marker_Panels(BasePlayer player)
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.003125004 0.8769602", AnchorMax = "0.1854167 0.99032695" },  
