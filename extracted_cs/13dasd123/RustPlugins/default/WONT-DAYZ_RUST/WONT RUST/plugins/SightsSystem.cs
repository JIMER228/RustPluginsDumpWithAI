    ...
    class SightsSystem : RustPlugin
    {
        ...
        void OnPlayerConnected(BasePlayer player)
        {
            if (!DB.ContainsKey(player.userID))
                DB.Add(player.userID, "https://media.discordapp.net/attachments/615106543662268418/1053799072080855090/offhair.png");
        ...
        List<string> Hair = new List<string>()
        {
	        ...
	        "https://i.imgur.com/mIbPpj3.png",
	        "https://i.imgur.com/RACMuqg.png",
            "https://media.discordapp.net/attachments/615106543662268418/1053799072080855090/offhair.png"
        };
        #endregion
