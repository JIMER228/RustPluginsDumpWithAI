...
{
    [Info("XRaidProtection", "kdsds", "1.0.9")]
	...
	{	
        ...
        private void InitializeLang()
        {
            ...
            {
                ["UI_MESSAGE"] = "NIGHT RIDING PROTECTION ACTIVE: 100%. FROM 22:00 TO 15:00!",
                ["CHAT_MESSAGE"] = "NIGHT RIDING PROTECTION ACTIVE: 100%. FROM 22:00 TO 15:00!"
            }, this);

            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["UI_MESSAGE"] = "АКТИВНА НОЧНАЯ ЗАЩИТА ОТ РЕЙДА: 100%. С 22:00 ДО 15:00!",
                ["CHAT_MESSAGE"] = "АКТИВНА НОЧНАЯ ЗАЩИТА ОТ РЕЙДА: 100%. С 22:00 ДО 15:00!"
            }, this, "ru");
        }
