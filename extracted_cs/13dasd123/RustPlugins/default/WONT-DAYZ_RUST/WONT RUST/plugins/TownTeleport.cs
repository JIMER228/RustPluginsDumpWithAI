...
namespace Oxide.Plugins
{
    ...
    class TownTeleport : RustPlugin
    {
        ...
        private string teleportCommandOutpost = "outpost";
        private string teleportCommandBandit = "btp";
        private string cancelTeleportCommand = "tpc";
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            Config["OutpostTeleportCommand"] = teleportCommandOutpost = GetConfig("OutpostTeleportCommand", "outpost");
            Config["BanditCampTeleportCommand"] = teleportCommandBandit = GetConfig("BanditCampTeleportCommand", "btp");
            Config["CancelTeleportCommand"] = cancelTeleportCommand = GetConfig("CancelTeleportCommand", "tpc");
        ...
        private void LoadDefaultMessages()
        {
            ...
            {
                ["OutpostTeleport"] = "Телепортация в ГОРОД чеоез {0} seconds...\nType /{1} Вы отменили телепортацию.",
                ["BanditTeleport"] = "Teleporting to BanditCamp in {0} seconds...\nType /{1} to cancel the teleport.",
                ["TeleportSuccessMessage"] = "You have successfully teleported to the Outpost.",
                ["NoActiveTeleport"] = "You are not about to teleport to Bandit Camp or Outpost.\nType /{0} to teleport to the Outpost.\nType /{1} to teleport to Bandit Camp.",
                ["AlreadyTeleporting"] = "You are already about to teleport to the Outpost.",
                ...
                ["TeleportCancelled"] = "You have cancelled the teleport timer.",
                ...
                ["TeleportCancelledDamage"] = "Teleport cancelled because you took damage.",

                ["OutpostNotFound"] = "Plugin was unable to locate Outpost.",
                ["BanditNotFound"] = "Plugin was unable to locate BanditCamp.",
