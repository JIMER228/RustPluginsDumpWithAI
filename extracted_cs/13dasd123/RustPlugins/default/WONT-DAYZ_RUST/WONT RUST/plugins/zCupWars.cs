...
namespace Oxide.Plugins
{
    ...
    public class zCupWars : RustPlugin
    {
        ...
        {
            string text = "<size=18>Количество захватов</size>";
        ...
        private void CreateCaptureTable(BasePlayer player, CupManager comp)
        {
            ...
            container.Add(new CuiElement { Parent = "Overlay", Name = "CaptTableMain", Components = { new CuiImageComponent { Color = "1 1 1 0" }, new CuiRectTransformComponent { AnchorMin = "0.84 0.58", AnchorMax = "0.99 0.675" } } });
            ...
            {
                UI.CreatePanel(ref container, "CaptTablePanel", "CaptTableMain", $"1 1 1 0.2", "0 0.1", "0.75 0.9");
