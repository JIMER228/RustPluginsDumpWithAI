...
namespace Oxide.Plugins
{
    ...
    class Teleportation : RustPlugin
    {
        ...
        private void DDrawMenu(BasePlayer player)
        {
            ...
            {
                Image = { Color = "0 0 0 0.1", Material = "" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiImageComponent { Color =  "0.1 0.1 0.1 0.5", Material = "" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiImageComponent { Color =  "0.1 0.1 0.1 0.5" },
            ...
            container.Add(new CuiElement
            {
                Parent = "TPMENULAYER",
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 1", Text = "МЕНЮ ТЕЛЕПОРТАЦИИ", FontSize = 28, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
            ...
            container.Add(new CuiElement
            {
                Parent = "TPMENULAYER",
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 1", Text = "ТЕЛЕПОРТАЦИЯ К ДРУГУ", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
            ...
            container.Add(new CuiElement
            {
                Parent = "TPMENULAYER",
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 1", Text = "ТЕЛЕПОРТАЦИЯ ДОМОЙ", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = $"ГОРОД NPC", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 1", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER"); 
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Close = Layer, Command = $"chat.say /outpost", Color = "0 0 0 0.75" },
                Text = { Text = $"ГОРОД БАНДИТОВ", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 1", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");   
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Close = Layer, Command = $"tp.cmd sethome {pos}", Color = "0 0 0 0.75" },
                Text = { Text = $"Сохранить Дом", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 1", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");
            }
            }
            ...
            container.Add(new CuiButton
            {
                ...
                Button = { Close = Layer, Command = $"chat.say /tpa", Color = "0 0 0 0.75" },
                Text = { Text = $"Принять ТП", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 1", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.195 0.705", AnchorMax = "0.49 0.825" },
                Button = { Close = Layer, Command = $"chat.say /tpc", Color = "0 0 0 0.75" },
                Text = { Text = $"Отклонить ТП", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 1", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = check.Key, FontSize = 14, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.7", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER_" + b );
            b++;
            }  
            }
