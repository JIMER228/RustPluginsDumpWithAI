...
namespace Oxide.Plugins
{
    ...
    public class EvaScanner : CovalencePlugin
    {
        ...
        private static EvaScanner _instance;

        private const string PermUse = "evascanner.use";

        private const string PermUnlimited = "evascanner.unlimited";

        private const string PermCupboard = "evascanner.cupboard";
        private const string PermCodeLock = "evascanner.codelock";
        private const string PermAutoTurret = "evascanner.autoturret";

        private const string PermHome = "evascanner.home";
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                [NoPermission] = "Нет полномочий",
                [TitleMenu] = "Scanner",
                [CloseButton] = "✕",
                [CooldownMsg] = "Перезарядка сканера {0} sec.",
                [EntityNotFound] = "Постройка не найдена!",
                [OwnerTitle] = "Владелец",
                [ListTitle] = "Лист авторизованных",
                [NextBtn] = "▼",
                [BackBtn] = "▲",
                [OwnerSecondTitle] = "Владелец"
            }, this);
        }
