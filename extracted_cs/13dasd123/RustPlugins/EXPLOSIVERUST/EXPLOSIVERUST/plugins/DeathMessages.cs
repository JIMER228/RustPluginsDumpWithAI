...
{
    [Info("Death Messages", "oxide-russia.ru", "2.1.55")]
    class DeathMessages : RustPlugin
    {
        ...
        class Attacker
        {
            ...
            private AttackerType InitializeType()
            {
                ...
                if (Entity is ScarecrowNPC || Entity is Zombie)
        ...
        {
            if (victim == null || info == null || info.Initiator == null || info.InitiatorPlayer == null) return;
