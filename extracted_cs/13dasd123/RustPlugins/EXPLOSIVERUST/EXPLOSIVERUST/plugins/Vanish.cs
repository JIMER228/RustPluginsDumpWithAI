...
namespace Oxide.Plugins
{
    ...
    public class Vanish : CovalencePlugin
    {
        ...
        void OnServerInitialized()
        {
            ...
            ImageLibrary.Call("AddImage", "https://i.imgur.com/VU0rmrV.png", "icon");
        }
        ...
        private void DrawUI(BasePlayer player)
        {
            ...
            {
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-455 18", OffsetMax = "-395 77" },
                CursorEnabled = false,
            }, "Overlay", "VanishUI");
			...
			container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiRawImageComponent {Png = (string) ImageLibrary.CallHook("GetImage", "icon")},
                    new CuiRectTransformComponent {AnchorMin = "0.1311475 0.1311475", AnchorMax = "0.8306011 0.8306011"}
                }
            });
