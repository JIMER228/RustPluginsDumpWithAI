...
namespace Oxide.Plugins
{
    ...
    public class FSocial : RustPlugin
    {
        ...
        void DownloadImages()
        {
            ImageLibrary.Call("AddImage", "https://i.ibb.co/VH2tM0C/promobg2.png", "prombg");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/VH2tM0C/promobg2.png", "socbg");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/VH2tM0C/promobg2.png", "infoicn");
