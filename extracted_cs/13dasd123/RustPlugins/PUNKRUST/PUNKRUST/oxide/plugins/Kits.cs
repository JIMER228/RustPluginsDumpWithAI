...
namespace Oxide.Plugins
{
    ...
    public class Kits : RustPlugin
    {
        ...
        {
            ImageLibrary.Call("AddImage", "https://i.imgur.com/fMDPD7s.png", "kitback");
        ...
        void OpenUI(BasePlayer player, int freePage = 0,int paidPage = 0)
        {
            ...
            container.Add(new CuiPanel
            {
                ...
                Image = {Color = "0.88 0.83 0.63 0.5"}
            }, _mainLayer,"FreeName");
            container.Add(new CuiPanel
            {
            ...
            if (freeList.Count>4*(freePage+1))
            {
                container.Add(new CuiPanel
                {
                    Image = {Color = "0.82 0.78 0.59 0.9"},
        ...
        void ShowKitInventory(BasePlayer player, KitData kitData)
        {
            ...
            container.Add(new CuiPanel
                ...
                container.Add(new CuiButton
                {
                    ...
                    Button = { Color = "0.88 0.83 0.63 0.9", Command = "kit" },
                    Text = { Text = "НАЗАД", Align = TextAnchor.MiddleCenter,Color = "0.47 0 0 0.95",FontSize = 20, Font = "robotocondensed-bold.ttf" }
                }, _invLayer, "Back");
