...
{
    [Info("Clans", "TopPlugin.ru", "1.0.7", ResourceId = 14)]
    public class Clans : RustPlugin
    {
        ...
        void InterfaceUI(BasePlayer player, string Name = "")
        {
            ...
            {
                CursorEnabled = false,
                RectTransform = { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-500 14.4", OffsetMax = "-210 100" },
                Image = { Color = "0 0 0 0" }
            }, "Overlay", Layer);

            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 0.4", AnchorMax = "1 1", OffsetMax = "0 0" },
                Text = { Text = $"<size=20>ВСТУПЛЕНИЕ В КЛАН</size>\nВас пригласили в клан {Name}. Чтобы вступить нажмите кнопку <b>ДА</b> или нажмите кнопку <b>НЕТ</b> чтобы отклонить!", Color = "1 1 1 0.8", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 12 }
            }, Layer);

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.1 0", AnchorMax = "0.49 0.3", OffsetMax = "0 0" },
                Button = { Color = "0.45 0.72 0.54 0.7", Command = $"join {Name}" },
                Text = { Text = $"ДА", Color = "1 1 1 0.8", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 14 }
            }, Layer);

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.51 0", AnchorMax = "0.9 0.3", OffsetMax = "0 0" },
                Button = { Color = "0.72 0.45 0.45 0.7", Close = Layer },
                Text = { Text = $"НЕТ", Color = "1 1 1 0.8", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 14 }
            }, Layer);
...
'\n'
        ...
        public bool HasFFEnabled(ulong playerid = 3871744) => !enableFFOPtion ? false : !manuallyEnabledBy.Contains(playerid) ? false : true;
