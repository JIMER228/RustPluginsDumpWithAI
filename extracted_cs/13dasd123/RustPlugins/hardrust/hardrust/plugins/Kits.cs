        ...
        private void UI_DrawInterfaces(BasePlayer player, int page = 0, int pageperm = 0)
        {
            ...
            container.Add(new CuiLabel
            {
                ...
                Text          = {Text      = $"ДЛЯ ДОСТУПА К ПЛАТНЫМ НАБОРАМ КУПИТЕ ПРИВИЛЕГИЮ\n" +
                        $"<b>https://hardrust.playrust.ru/products</b>", Align = TextAnchor.LowerCenter, Font = "robotocondensed-regular.ttf", FontSize = 18, Color = "1 1 1 0.4" }
            }, Layer);
