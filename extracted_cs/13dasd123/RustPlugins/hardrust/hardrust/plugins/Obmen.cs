...
namespace Oxide.Plugins
{
    ...
    class Obmen : RustPlugin
    {
        ...
        private Dictionary<string, string> images = new Dictionary<string, string>()
        {
            ...
            ["Image0"] = "https://rustwiki.su/images/thumb/d/df/Wood.png/300px-Wood.png",
            ["Image1"] = "https://rustwiki.su/images/8/8f/Low_Grade_Fuel.png",
            ["Image2"] = "https://media.discordapp.net/attachments/962631871894786078/962703273092063252/unnamed.png?width=676&height=676",
            ["Image3"] = "https://otvet.imgsmail.ru/download/276581551_005fafb43bb25430cccbcee9f92a533a_800.png",
            ["Image4"] = "http://rustwiki.su/images/1/15/Jackhammer.png",
            ["Image5"] = "https://cdn.medal.tv/avatars/d3f66a9b0f2d0cebd63098d439bc8068/1641865972111.png",
        };
        ...
        private void DrawInterface(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = "HARD RUST", Align = TextAnchor.MiddleCenter, FontSize = 40 }
            }, Layer);
