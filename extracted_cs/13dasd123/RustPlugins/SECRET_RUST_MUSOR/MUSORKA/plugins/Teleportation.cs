...
{
    [Info("Teleportation", "Dezz|kpot", "1.0.2")]
    class Teleportation : RustPlugin
    {
        ...
        [ChatCommand("tpmenu")]
        private void cmdChatS(BasePlayer player)
        {
            if (player != null);
            {
...
//            player.ChatMessage("Для открытия тп меню вам нужен клан! /clan create TAG");
            }
        ...
        private void DDrawMenu(BasePlayer player)
        {
            ...
            {
                Image = { Color = "0 0 0 0.1", Material = "assets/content/ui/uibackgroundblur.mat" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiImageComponent { Color =  "0.38 0.36 0.31 0.65", Material = "assets/icons/greyout.mat" },
                    new CuiRectTransformComponent {AnchorMin = "0.23 0.2625", AnchorMax = "0.77 0.745"}
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiImageComponent { Color =  "0.2901961 0.2862745 0.2352941 0.6509804" },
                    new CuiRectTransformComponent {AnchorMin = "0.2375 0.2775", AnchorMax = "0.763 0.38"}
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                {
                    new CuiImageComponent { Color =  "0.2901961 0.2862745 0.2352941 0.6509804" },
                    new CuiRectTransformComponent {AnchorMin = "0.2375 0.4235", AnchorMax = "0.763 0.4925"}
                }
            });                            
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.3 0.6525", AnchorMax = "0.7 1.5" },
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.3 0.085", AnchorMax = "0.7 0.95" },
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.3 0.075", AnchorMax = "0.7 0.5" },
                }
            });

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.195 0.85", AnchorMax = "0.49 0.97" },
                Button = { Close = Layer, Command = $"chat.say /outpost", Color = "0 0 0 0.75" },
                Text = { Text = $"ГОРОД NPC", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.5", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER"); 

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.51 0.85", AnchorMax = "0.8 0.97" },
                Button = { Close = Layer, Command = $"chat.say /outpost", Color = "0 0 0 0.75" },
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.195 0.56", AnchorMax = "0.49 0.68" },
                Button = { Close = Layer, Command = $"tp.cmd sethome {pos}", Color = "0.81 0.51 0.18 0.98" },
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.51 0.705", AnchorMax = "0.8 0.825" },
                Button = { Close = Layer, Command = $"chat.say /tpa", Color = "0.44 0.50 0.29 0.98" },
                Text = { Text = $"Принять ТП", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.5", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.195 0.705", AnchorMax = "0.49 0.825" },
                Button = { Close = Layer, Command = $"chat.say /tpc", Color = "0.54 0.22 0.18 0.98" },
                Text = { Text = $"Отклонить ТП", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.5", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.51 0.56", AnchorMax = "0.8 0.68" },
                Button = { Close = Layer, Command = $"chat.say /atp", Color = "0.44 0.50 0.29 0.98" },
                Text = { Text = $"Автопринятие ТП", FontSize = 18, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.5", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER");
            ...
            container.Add(new CuiElement
            {
                ...
                Parent = "TPMENULAYER1",
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.02 0.125", AnchorMax = "0.11 0.85" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.13 0.125", AnchorMax = "0.22 0.85" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.24 0.125", AnchorMax = "0.33 0.85" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.35 0.125", AnchorMax = "0.44 0.85" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.46 0.125", AnchorMax = "0.55 0.85" },
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.57 0.125", AnchorMax = "0.66 0.85" },
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.68 0.125", AnchorMax = "0.77 0.85" },
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.79 0.125", AnchorMax = "0.88 0.85" },
                }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.90 0.125", AnchorMax = "0.99 0.85" },
                }
            });
            ...
            {
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1" },
                Button = { Close = Layer, Command = $"tp.cmd home {check.Key}", Color = "0.31 0.30 0.25 0.8" },
                Text = { Text = check.Key, FontSize = 16, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.7", Font = "robotocondensed-bold.ttf" }
            }, "TPMENULAYER_" + b );
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.01 0.125", AnchorMax = "0.15 0.85" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.16 0.025", AnchorMax = "0.31 0.95" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.32 0.025", AnchorMax = "0.47 0.95" },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiTextComponent() { Color = "1 1 1 0", FadeIn = 0.25f, Text = "", FontSize = 20, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"  },
                    new CuiRectTransformComponent { AnchorMin = "0.48 0.025", AnchorMax = "0.63 0.95" },
                }
            });

            var clanmates = Clans.Call("GetClanMembers", player.userID) as List<string>;
            int i = 0;
            foreach (var friend in clanmates)
                {
                    var covFriend = covalence.Players.FindPlayerById(friend.ToString());
                if (friend.ToString() == player.UserIDString)
                {
                    continue;
                }
                ...
                {
                    RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1" },
                    Button = { Close = Layer, Command = $"tp.cmd tpr {covFriend.Name}", Color = "0.31 0.30 0.25 0.8", FadeIn = 0.1f },
                    Text = { Text = $"{covFriend.Name}", FontSize = 14, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.7", Font = "robotocondensed-bold.ttf" }
                }, "TPMENULAYERR" + i);
                i++;
            }
