        ...
        private void CmdMenu(IPlayer user, string cmd, string[] args)
		{
            ...
            else
            {
                ...
                for(int i = 0; i < config.commandButton.Count;i++)
                {
                    ...
                    UI.AddButton(ref c, Layer, Layer + $"buttons{config.titleButton[i]}", $"chat.say {config.commandButton[i]}", "", "0.8 0.8 0.8 0.1", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", $"-16.615 {l -= 32}", $"77.255 {p -= 32}");
        ...
        public void RefreshUI(BasePlayer player ,string Type)
        {
            ...
            switch(Type)
            {
                ...
                case "all":
                    ...
                    UI.AddImage(ref c, Layer, Layer + "events2", "0.8 0.8 0.8 0.1", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "60.334 -35.48", "76.547 -20.878");
