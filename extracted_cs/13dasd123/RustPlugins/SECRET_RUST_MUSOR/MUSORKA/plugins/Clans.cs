...
namespace Oxide.Plugins
{
    ...
    public class Clans : RustPlugin
    {
        ...
        void OnServerInitialized()
        {
            ...
            ImageLibrary?.Call("AddImage", "https://i.imgur.com/gj0087m.jpeg", "logopng");
        ...
        void NewClanUI(BasePlayer player, bool leadermode = false)
        {
            ...
            foreach (var type in clan.SkinList)
            {
                foreach (var skin in type.Value)
                {
                    ...
                    if (clan.IsOwner(player.UserIDString))
                        elements.Add(new CuiButton
                        {
                            Button = { Color = "0.43 0.68 0.42 0", Command = $"UI_CLAN edit {"clans_item" + skinCount} {command}" },
                            Text = { Text = $"" },
                            RectTransform = { AnchorMin = "0 0", AnchorMax = $"1 1" },
                        }, "clans_item" + skinCount);
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.353 0.353 0.353 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0 0.68", AnchorMax = $"0.32 1" },
            }, "clans_main88", "clans_res0");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.353 0.353 0.353 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.34 0.68", AnchorMax = $"0.65 1" },
            }, "clans_main88", "clans_res1");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.67 0.68", AnchorMax = $"1 1" },
            }, "clans_main88", "clans_res2");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0 0.35", AnchorMax = $"0.32 0.66" },
            }, "clans_main88", "clans_res3");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.34 0.35", AnchorMax = $"0.65 0.66" },
            }, "clans_main88", "clans_res4");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.67 0.35", AnchorMax = $"1 0.66" },
            }, "clans_main88", "clans_res5");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.32 0.33" },
            }, "clans_main88", "clans_res6");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.34 0", AnchorMax = $"0.65 0.33" },
            }, "clans_main88", "clans_res7");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.337 0.337 0.337 0.60" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.67 0", AnchorMax = $"1 0.33" },
            }, "clans_main88", "clans_res8");
            for (int i = 0; i < clan.Change.Count; i++)
            {
                elements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0.15 0.15", AnchorMax = "0.85 0.85" }
                    }
                });
                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = "" },
                    Text = { Text = $"{GetPercent((int)clan.Change.ToList()[i].Value.Need, (int)clan.Change.ToList()[i].Value.Complete)}%", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Align = TextAnchor.MiddleRight },
                    RectTransform = { AnchorMin = "0.5 0.7", AnchorMax = "0.95 1" },
                }, "clans_res" + i);

                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = "" },
                    Text = { Text = $"{(int)clan.Change.ToList()[i].Value.Complete}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Align = TextAnchor.MiddleRight },
                    RectTransform = { AnchorMin = "0.5 0", AnchorMax = "0.95 0.3" },
                }, "clans_res" + i);
            }
        ...
        void OnDispenserBonus(ResourceDispenser disp, BasePlayer player, Item item)
        {
            ...
            if (clan != null && clan.members[player.UserIDString].GatherInfo.ContainsKey(item.info.shortname))
            {
                NextTick(() =>
                {
                    ...
                    if ((bool)ClanTournament?.Call<bool>("CheckFarm", player.userID) == true)
                    {
                        clan.ClanPoints += 2;
                    ...
                    {
                        clan.ClanPoints += 0;
                        clan.members[player.UserIDString].PlayerPoints += 0;
                    }
                });
            }
        ...
        void cmdSetChangeOfClan(ConsoleSystem.Arg args)
        {
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.13 0.44 0.48 0.7", Close = "clan_setChange" },
        ...
        void OnEntityDeath(BaseCombatEntity entity, HitInfo info)
        {
            ...
            if (entity is BaseHelicopter)
            {
                ...
                foreach (var pp in BasePlayer.activePlayerList)
                    pp.ChatMessage($"Вертолет был взорван кланом <color=orange>{newClan.tag}</color>");
                return;
            }
        ...
        string ButtonListedClan = "[{\"name\":\"clans_player{id}\",\"parent\":\"Clanstop_main8\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01 {amin}\",\"anchormax\":\"0.99 {amax}\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{command}\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";

        string TOP = "[{\"name\":\"Clanstop_main2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.9\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main3\",\"parent\":\"Clanstop_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2985 0.197\",\"anchormax\":\"0.705 0.84\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main8\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.205\",\"anchormax\":\"0.9953553 0.8929524\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main9\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.8946524\",\"anchormax\":\"0.9953553 0.9410777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"#\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0.09 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main11\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НАЗВАНИЕ КЛАНА\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.105 0\",\"anchormax\":\"0.6283538 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКИ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1 0\",\"anchormax\":\"1.47 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main121\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.69 0\",\"anchormax\":\"0.79 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main122\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"К/Д\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.35 0\",\"anchormax\":\"0.69 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main125\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0\",\"anchormax\":\"0.5 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main124\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5 0\",\"anchormax\":\"0.6 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main123\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ШКАФ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 0\",\"anchormax\":\"0.61 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main121\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ФАРМ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.55 0\",\"anchormax\":\"0.75 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИГРОКОВ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.78 0\",\"anchormax\":\"1.065 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]}]";

        string TOP2 = "[{\"name\":\"Clanstop_main2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main3\",\"parent\":\"Clanstop_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2985 0.197\",\"anchormax\":\"0.705 0.84\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main8\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.205\",\"anchormax\":\"0.9953553 0.8929524\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main9\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.8946524\",\"anchormax\":\"0.9953553 0.9410777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"#\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0.09 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main11\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НАЗВАНИЕ КЛАНА\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.105 0\",\"anchormax\":\"0.6283538 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"РЕЙДОВ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1 0\",\"anchormax\":\"1.47 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main121\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.69 0\",\"anchormax\":\"0.79 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main122\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.35 0\",\"anchormax\":\"0.69 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main125\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0\",\"anchormax\":\"0.5 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main124\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5 0\",\"anchormax\":\"0.6 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main123\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 0\",\"anchormax\":\"0.61 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main121\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.55 0\",\"anchormax\":\"0.75 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКОВ\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.78 0\",\"anchormax\":\"1.065 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]}]";

        string InfoTOP = "[{\"name\":\"Clanstop_info2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.9\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info3\",\"parent\":\"Clanstop_info2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2985 0.197\",\"anchormax\":\"0.705 0.84\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info10\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.88\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.005012453\",\"anchormax\":\"0.9953553 0.425259\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info11\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0.05\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.9173692\",\"anchormax\":\"1 1.000001\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИМЯ ИГРОКА\",\"fontSize\":10,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0175 0\",\"anchormax\":\"0.2528636 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"СТАТУС\",\"fontSize\":10,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2449865 0\",\"anchormax\":\"0.4594171 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКИ\",\"fontSize\":10,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4576665 0\",\"anchormax\":\"0.6055799 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ФАРМ\",\"fontSize\":10,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6073302 0\",\"anchormax\":\"0.7771242 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"К/Д\",\"fontSize\":10,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.7841259 0\",\"anchormax\":\"0.9985565 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info12\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.01011801\",\"anchormax\":\"1 0.9123102\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info13\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.36 0.34 0.32 0.88\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.42699\",\"anchormax\":\"0.9953553 0.9410777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info14\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6318366 0.1428573\",\"anchormax\":\"0.9670526 0.8928576\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info8\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{return}\",\"color\":\"0.46 0.44 0.42 0.5\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.58 0.025\",\"anchormax\":\"0.78 0.2\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info9\",\"parent\":\"Clanstop_info8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НАЗАД\",\"fontSize\":14,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info14\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.65\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.33 0.72\",\"anchormax\":\"0.89 0.8\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info15\",\"parent\":\"Clanstop_info14\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"Лидер Клана: {lname}\",\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01 0\",\"anchormax\":\"0.99 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info23\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.65\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.33 0.63\",\"anchormax\":\"0.89 0.71\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info22\",\"parent\":\"Clanstop_info23\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"Игроков в клане: {ccount}\",\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01 0\",\"anchormax\":\"0.99 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info23\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.65\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.33 0.54\",\"anchormax\":\"0.89 0.62\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_infokoloc\",\"parent\":\"Clanstop_info23\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"Количество очков: {Points}\",\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01 0\",\"anchormax\":\"0.99 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info24\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.65\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.33 0.45\",\"anchormax\":\"0.89 0.53\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info24raid\",\"parent\":\"Clanstop_info24\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"Количество рейдов: {craid}\",\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01 0\",\"anchormax\":\"0.99 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info24c\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.25 0.25 0.23 0.65\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.33 0.36\",\"anchormax\":\"0.89 0.44\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info25cup\",\"parent\":\"Clanstop_info24c\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"Количество захватов: {ccup}\",\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01 0\",\"anchormax\":\"0.99 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info8\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"Clanstop_info2\",\"color\":\"0.46 0.44 0.42 0.5\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.79 0.025\",\"anchormax\":\"0.99 0.2\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info9\",\"parent\":\"Clanstop_info8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ЗАКРЫТЬ\",\"fontSize\":14,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 0.8\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info18\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.03318176 0.07857105\",\"anchormax\":\"0.1382089 0.9357135\",\"offsetmax\":\"0 0\"}]}]";
        ...
        [ChatCommand("ctop")]
        void cmdClanTOP(BasePlayer player, int page)
        {
            ClanTOP(player, 0);
        }
        ...
        void ClanTOPInfo(BasePlayer player, Clan clan, int page)
        {
            ...
            CuiHelper.AddUi(player, InfoTOP.Replace("{clanname}", "КЛАН: " + clan.tag.ToUpper() + " | ")
                .Replace("{RANK}", GetClanIndex(clan.tag).ToString())
                 .Replace("{ccount}", clan.members.Count.ToString())
                  .Replace("{ffarm}", clan.CupCount.ToString())
            ...
            if (clan.ClanAvatar != "")
            {
                elements.Add(new CuiElement
                {
                    ...
                    {
                        new CuiRawImageComponent { Png = (string)ImageLibrary?.Call("GetImage", clan.ClanAvatar)},
                        new CuiRectTransformComponent { AnchorMin = "0.06 0.35", AnchorMax = "0.31 0.87" }
                    }
                });
            }
            else
            ...
            foreach (KeyValuePair<string, PlayerStats> key in ClanMembers.Skip(11 * page).Take(ClanMembers.ToList().Count >= 10 ? 10 : ClanMembers.ToList().Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{i}", Color = "1 0.9294118 0.8666667 0", FontSize = 12, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.0225 0", AnchorMax = $"0.1 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.01 0", AnchorMax = $"0.2528636 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = GetPlayerStatus(key.Key, clan), Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.2449865 0", AnchorMax = $"0.4594171 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.PlayerPoints.ToString(), Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.4576665 0", AnchorMax = $"0.6055799 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{GetFullPercent(key.Key)}%", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.6073302 0", AnchorMax = $"0.7771242 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{key.Value.Killed}/{key.Value.Death + key.Value.Suicide}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.025 0.025", AnchorMax = "0.12 0.225" },
            }, "Clanstop_info13", "clans_res0");

            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.13 0.025", AnchorMax = "0.225 0.225" },
            }, "Clanstop_info13", "clans_res1");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.235 0.025", AnchorMax = "0.3325 0.225" },
            }, "Clanstop_info13", "clans_res2");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.3425 0.025", AnchorMax = "0.4325 0.225" },
            }, "Clanstop_info13", "clans_res3");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.45 0.025", AnchorMax = "0.54 0.225" },
            }, "Clanstop_info13", "clans_res4");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.55 0.025", AnchorMax = "0.64 0.225" },
            }, "Clanstop_info13", "clans_res5");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.65 0.025", AnchorMax = "0.74 0.225" },
            }, "Clanstop_info13", "clans_res6");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.75 0.025", AnchorMax = "0.84 0.225" },
            }, "Clanstop_info13", "clans_res7");
            elements.Add(new CuiButton
            {
                Button = { Color = "0 0 0 0.35" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = "0.85 0.025", AnchorMax = "0.95 0.225" },
            }, "Clanstop_info13", "clans_res8");
            for (int ii = 0; ii < clan.Change.Count; ii++)
            {
                elements.Add(new CuiElement
                {
                    Parent = "clans_res" + ii,
                    Components =
                    {
                        new CuiRawImageComponent { Png = (string)ImageLibrary.Call("GetImage", clan.Change.ToList()[ii].Key) },
                        new CuiRectTransformComponent { AnchorMin = "0.15 0.15", AnchorMax = "0.85 0.85" }
                    }
                });
                ...
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = "" },
                    Text = { Text = $"{(int)clan.Change.ToList()[ii].Value.Complete}", Color = "1 0.9294118 0.8666667 1", FontSize = 12, Align = TextAnchor.MiddleRight, Font = "robotocondensed-regular.ttf" },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.93 0.3" },
                }, "clans_res" + ii);
            }
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.46 0.44 0.42 0.7", Command = page > 0 ? $"clanstop_info {clan.tag} {page - 1}" : "" },
                Text = { Text = "-", Color = "1 0.9294118 0.8666667 1", FontSize = 18, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.01 0.025", AnchorMax = $"0.07 0.2" },
            }, "Clanstop_info10");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.3294118 0.3294118 0.3294118 0.7" },
                Text = { Text = $"{page + 1}", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-bold.ttf", FontSize = 13, Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.07 0.025", AnchorMax = $"0.14 0.2" },
            }, "Clanstop_info10");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.46 0.44 0.42 0.7", Command = ClanMembers.Skip(5 * (page + 1)).Count() > 0 ? $"clanstop_info {clan.tag} {page + 1}" : "" },
                Text = { Text = "+", Color = "1 0.9294118 0.8666667 1", FontSize = 18, Font = "robotocondensed-bold.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.14 0.025", AnchorMax = $"0.20 0.2" },
            }, "Clanstop_info10");
            CuiHelper.AddUi(player, elements);
        ...
        void ClanTOP(BasePlayer player, int page)
        {
            ...
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(13 * page).Take(ClanMembers.ToList().Count >= 13 ? 13 : ClanMembers.ToList().Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{page * 13 + i}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.001 0", AnchorMax = $"0.07 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.tag.ToUpper(), Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.098 0", AnchorMax = $"0.6705538 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{clan.KillC}/{clan.DeathC}", Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.32 0", AnchorMax = $"0.715 1" },
                }, "clans_player" + key.Key);
                ...
                if ((bool)ClanTournament?.Call<bool>("CheckTournament", ulong.Parse(key.Value.owner)) == true)
                {
                    elements.Add(new CuiLabel
                    {
                        ...
                        RectTransform = { AnchorMin = $"0.15 0", AnchorMax = $"0.6 1" },
                    }, "clans_player" + key.Key);
                }
                else
                {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.ClanPoints.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.235 0", AnchorMax = $"1.345 1" },
                }, "clans_player" + key.Key);
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.55 0", AnchorMax = $"0.75 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{key.Value.members.Count}".ToUpper(), Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.8 0", AnchorMax = $"1.06 1" },
                }, "clans_player" + key.Key);
            ...
            elements.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.0025 0.005", AnchorMax = $"0.9975 0.197" },
                Image = { Color = "0.36 0.34 0.32 0.80" }
            }, "Clanstop_main3", "InfoTop");

            elements.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.01 0.01", AnchorMax = $"0.99 0.99", OffsetMax = "0 0" },
                Text = { Text = "Очки даются:\nУбийство +25,добыча руды +3, разрушение бочки +2 Захват зоны +600\nCбитие вертолета +1500,уничтожение танка +1000 Захват рт +300\nОчки отнимаются:\nСмерть и самоубийство -25! При сносе турнирного шкафа - вы вылетаете с турнира!", Color = "1 1 1 0.8", Align = TextAnchor.MiddleLeft, FontSize = 12, Font = "robotocondensed-regular.ttf" }
            }, "InfoTop");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.46 0.44 0.42 0.7", Command = page > 0 ? $"clanstop_main {page - 1}" : "" },
                Text = { Text = "<", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.01 0.025", AnchorMax = $"0.088 0.12" },
            }, "Clanstop_main8");
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.3294118 0.3294118 0.3294118 0.7" },
                Text = { Text = $"{page + 1}", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 13, Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.088 0.025", AnchorMax = $"0.165 0.12" },
            }, "Clanstop_main8");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.46 0.44 0.42 0.7", Command = clans.Keys.Skip(13 * (page + 1)).Count() > 0 ? $"clanstop_main {page + 1}" : "" },
                Text = { Text = ">", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.165 0.025", AnchorMax = $"0.240 0.12" },
            }, "Clanstop_main8");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.38 0.71 0.12 0.75", Command = $"clanstop_infobysteamid {player.UserIDString}" },
                Text = { Text = "МОЙ КЛАН", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.3985 0.025", AnchorMax = $"0.6 0.12" },
            }, "Clanstop_main8");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.46 0.44 0.42 0.75", Close = "Clanstop_main2" },
                Text = { Text = "ЗАКРЫТЬ", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"0.795 0.025", AnchorMax = $"0.9885 0.12" },
            }, "Clanstop_main8");
            CuiHelper.AddUi(player, elements);
        }

        [ChatCommand("rrtop")]
        void cmdClanTOPRaid(BasePlayer player, string command, string[] args)
        {
            ClanTOPRaid(player, 0);
        }

        void ClanTOPRaid(BasePlayer player, int page)
        {
            CuiHelper.DestroyUi(player, "Clanstop_info2");
            CuiHelper.DestroyUi(player, "Clanstop_main2");
            CuiHelper.AddUi(player, TOP2.Replace("{title}", msg("clanTOP2UItitle", player.UserIDString).ToUpper()));
            string colored = "0.25 0.25 0.23 0.5";
            var elements = new CuiElementContainer();
            double Amin = 0.925;
            double Amax = 0.992;
            ...
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(13 * page).Take(ClanMembers.ToList().Count >= 13 ? 13 : ClanMembers.ToList().Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.098 0", AnchorMax = $"0.9983538 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = clan.KilledTCAll.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.785 0", AnchorMax = $"1.345 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.ClanPoints.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.91 0", AnchorMax = $"1.26 1" },
                }, "clans_player" + key.Key);

//                elements.Add(new CuiButton
//                {
//                    Button = { Color = "0 0 0 0", Command = $"" },
//                    Text = { Text = "", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 0" },
//                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
//                }, "clans_player" + key.Key);
                i++;
                Amin = Amin - 0.073;
