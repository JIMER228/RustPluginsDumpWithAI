...
namespace Oxide.Plugins
{
    ...
    class BuildingUpgrade : RustPlugin
    {
        ...
        private string GUI = @"[{""name"": ""autograde.panel"",""parent"": ""Hud"",""components"": [{""type"": ""UnityEngine.UI.Image"",""color"": ""{PanelColor}""},{""type"": ""RectTransform"",""anchormin"": ""{PanelAnchorMin}"",""anchormax"": ""{PanelAnchorMax}""}]}, {""name"": ""autogradetext"",""parent"": ""autograde.panel"",""components"": [{""type"": ""UnityEngine.UI.Text"",""text"": ""Авто-улучшение до <color=#00FF00>{0}</color> закончится через: " + @"{1} сек."",""fontSize"": ""{TextFontSize}"",""align"": ""MiddleCenter""}, {""type"": ""RectTransform"",""anchormin"": ""{TextAnchorMin}"",""anchormax"": ""{TextAnchorMax}""}]}]";
