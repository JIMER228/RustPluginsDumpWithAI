...
{
    [Info("IQChat", "https://discord.gg/9vyTXsJyKR", "1.0.0")]
                ...
                return new Configuration
                {
                    ...
                    InterfaceChat = new Interface
                    {
                        ...
                        InterfacePositions = new Interface.InterfacePosition
                        {
                            ...
                            {
                                BackgroundAnchorMin = "0.57 0.1186",
                            ...
                            MutePanels = new Interface.InterfacePosition.MutePanel
                            {
                                ...
                                BackgroundAnchorMax = "0.57 0.8814",
                            },
...
;        }
        ...
        private void IQChat_UI_Menu(BasePlayer player)
        {
            ...
            CuiHelper.DestroyUi(player, "MainChat");
            ...
            }, "SubContent_UI", "MainChat");

            /*container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1" },
                Text = { Text = "" },
                Button = { Color = "0 0 0 0", Close = "MainChat", Command = "chat.say /profile" }
            }, "MainChat");*/

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.25 0", AnchorMax = "1 0.9" },
                Text = { Text = "" },
                Button = { Color = "0 0 0 0" }
            }, "MainChat", IQCHAT_PARENT_MAIN);
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                        {
                        new CuiImageComponent { FadeIn = FadeIn, Color = "1 1 1 0" },
                        ...
                        new CuiOutlineComponent { Color = "0 0 0 0", Distance = "1.2 -1.2", UseGraphicAlpha = true }
        ...
        private void UI_Chat_Taked(BasePlayer player, int Index = 0, int Page = 0)
        {
            ...
            string Color = ColorList == null || ColorList.Count == 0 ? GetLang("UI_CHAT_PANEL_TAKE_COLOR", player.UserIDString) : $"<color={ColorList[Index].Argument}>   ваш текст</color>";
        ...
        void LoadedElementList(BasePlayer player, TakeElemntUser Type, int Page = 0)
        {
            ...
            else
            {
                ...
                {
                    string DisplayElement = Type == TakeElemntUser.Chat ? $"<b><color={Element.Argument}>   ваш текст</color></b>" : Type == TakeElemntUser.Nick ? $"<color={Element.Argument}>{player.displayName}</color>" : Element.Argument;
                    container.Add(new CuiButton
                    {
                        RectTransform = { AnchorMin = $"{0 + (x * 0.504)} {0.752 - (y * 0.245)}", AnchorMax = $"{0.495 + (x * 0.504)} {0.975 - (y * 0.245)}" },
                        Button = { Command = $"iq.chat take.element.user {Type} {i} {Page}", Color = HexToRustFormat(Interface.HexButton) },
        ...
        { 
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.9492017 0.318992657", AnchorMax = "0.98 0.6709784" }, 
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.374989 0", AnchorMax = "0.938702657 1" }, 
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.01 0.31899", AnchorMax = "0.05 0.6709784" },
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.06 0.31899", AnchorMax = "0.28 0.6709784" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiInputFieldComponent { Text = SearchName, Command = $"iq.chat mute.controller search.player {SearchName}", Align = TextAnchor.MiddleLeft, Color = HexToRustFormat(Interface.HexLabel), CharsLimit = 25},
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.2725679 0", AnchorMax = "0.38 1" },
        ...
        void Loaded_Players_Mute_Menu(BasePlayer player, int Page = 0, string Search = "")
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.43 0.318992657", AnchorMax = "0.45 0.6709784" }, 
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.46 0.3189905", AnchorMax = "0.49 0.6709783" },
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.39 0.31899", AnchorMax = "0.42 0.6709784" },
        ...
        private void UI_Ignored_Menu(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.9492017 0.31899", AnchorMax = "0.98 0.6709784" },
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.06 0.31899", AnchorMax = "0.2685355 0.6709784" },
                Image = { FadeIn = FadeIn, Color = HexToRustFormat(Interface.HexPanel), Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" }
        ...
        void UpdateNick(BasePlayer player)
        {
            ...
            string ResultNick = !String.IsNullOrEmpty(Rank) ? $"<b>[{Rank}] {Prefix}<color={DataPlayer.NickColor}>{player.displayName}</color> : <color={DataPlayer.MessageColor}>  ваш текст</color></b>" : $"<b>{Prefix}<color={DataPlayer.NickColor}>{player.displayName}</color> : <color={DataPlayer.MessageColor}>   ваш текст</color></b>";
        ...
        private new void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["UI_CHAT_PANEL_MODERATOR_MUTE_PANEL_TITLE"] = "<size=14>УПРАВЛЕНИЕ БЛОКИРОВКАМИ ЧАТА</size>",
                ["UI_CHAT_PANEL_MODERATOR_MUTE_PANEL_TITLE_SEARCH"] = "<size=14>ПОИСК</size>",
                ...
                ["UI_CHAT_PANEL_IGNORED_MENU_TITLE"] = "<size=14>УПРАВЛЕНИЕ ИГНОРИРОВАНИЕМ</size>",
