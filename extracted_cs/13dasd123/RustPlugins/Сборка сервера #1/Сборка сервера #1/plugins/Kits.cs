...
{
    [Info("Kits", "https://discord.gg/9vyTXsJyKR", 1.0)]
            ...
            switch (cmd)
            {
                ...
                case "showavailablekits":
                {
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        {
                            GetImageComponent("https://static.moscow.ovh/images/games/rust//plugins/ultimate_ui/exit.png", "Kits_img_exit"),
                            new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "0 0", OffsetMin = "-73.9 20", OffsetMax = "-28.6 80"},
                        }
                    });
                    container.Add(new CuiElement
                    {
                        ...
                        Components =
                        {
                            new CuiImageComponent {Color = "0.33 0.87 0.59 0.0"},
                            new CuiRectTransformComponent {AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-291.3 22.6", OffsetMax = "-108 25.2"}
                        }
                    });
                    container.Add(new CuiButton
                    ...
                    var kitSepX = 13.3f;
                    var kitSepY = 24f;
                    var num = Mathf.Min(4, kits.Count);
