...
{
    [Info("GameStoresRUST", "https://discord.gg/9vyTXsJyKR", "1.0.0")]
    public class GameStoresRUST : RustPlugin
    {
        ...
        private void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>() 
            {
                ...
                { "BASKET.NO.AUTH", "Вы не авторизованы в магазине!\n" +
                                    "Ссылку на авторизацию вы можете найти кликнув на 'КОРЗИНА СЕРВЕРА'" },
        ...
        private void InitializeStore(BasePlayer player, int page, bool first = true)
        {
            ...
            if (first)
            {
                ...
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.3 0.895", AnchorMax = "0.7 1", OffsetMax = "0 0" },
                            ...
                            if (firstInfo.ContainsKey("result"))
                            {
                                ...
                                else
                                {
                                    ...
                                    for (int i = 0; i < Settings.InterfaceSettings.ItemOnString * Settings.InterfaceSettings.StringAmount; i++)
                                    {
                                        ...
                                        secondContainer.Add(new CuiButton
                                        {
                                            RectTransform = { AnchorMin = "0.495 0.6", AnchorMax = "0.495 0.6", OffsetMin = $"{xSwitch} {ySwitch - Settings.InterfaceSettings.ItemSide}", OffsetMax = $"{xSwitch + Settings.InterfaceSettings.ItemSide} {ySwitch}" },
                                            Button = { Color = "0 0 0 0.6", Command = $"" },
                                            Text = { Text = "" }
