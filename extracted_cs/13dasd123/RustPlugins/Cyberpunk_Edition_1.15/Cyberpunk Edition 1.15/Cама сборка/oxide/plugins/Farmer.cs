...
namespace Oxide.Plugins
{
    ...
    {																			
		...
		private const string FarmMainFon = /*"https://ztreh.ru/CyberPunk/Zkj8Mq0.png";*/"https://ztreh.ru/CyberPunk/3dNVkKf.png";
		private const string FarmGreyFon = /*"https://ztreh.ru/CyberPunk/YHOIQIy.png";*/"https://ztreh.ru/CyberPunk/uTr7F0K.png";
		
		private const string FarmExit = "https://ztreh.ru/CyberPunk/s7DX62V.png";
		private const string FarmBack = "https://ztreh.ru/CyberPunk/hYoguVb.png";
		private const string FarmExchange = "https://ztreh.ru/CyberPunk/rDk4DEY.png";
		
		private readonly Dictionary<int, string> FarmArts = new Dictionary<int, string>()
		{
			{ 1, "https://ztreh.ru/CyberPunk/xkvRBMp.png" },
			{ 2, "https://ztreh.ru/CyberPunk/4U8Uyur.png" },
			{ 3, "https://ztreh.ru/CyberPunk/srwzAIt.png" },
			{ 4, "https://ztreh.ru/CyberPunk/uF6l4Ao.png" },
			{ 5, "https://ztreh.ru/CyberPunk/Nzx528V.png" },
			{ 6, "https://ztreh.ru/CyberPunk/Qnn2kpA.png" },
			{ 7, "https://ztreh.ru/CyberPunk/EB7V0bD.png" },
			{ 8, "https://ztreh.ru/CyberPunk/1xDvHZn.png" },
			{ 9, "https://ztreh.ru/CyberPunk/BS6bnOI.png" },
			{ 10, "https://ztreh.ru/CyberPunk/yH3afVL.png" }
		};				
