...
{
    [Info("InfoMenu","Discord: Netrunner#0115","1.0")]
        ...
        void PageUI(BasePlayer player,string key,int page = 1)
        {
            ...
            if (page<maxIndex)
            {
                container.Add(new CuiButton
                {
                    ...
                    Button = { Color = "0.59 0.18 0.18 0.9", Command = $"infopage {key} {page+1}",Material = "assets/icons/greyout.mat" },
                    Text = { Text = "<b>ВПЕРЁД</b>", Align = TextAnchor.MiddleCenter, FontSize = 21, Font = "robotocondensed-regular.ttf",Color = HexToCuiColor("#EBD4AE") }
                },  _layer, _layer + ".Forward");
            }
            ...
            if (page>minIndex)
            {
                container.Add(new CuiButton
                {
                    RectTransform = {AnchorMin = "0 0",AnchorMax = "0 0",OffsetMin = "190 10",OffsetMax = "550 80"},
                    Button = { Color = "0.59 0.18 0.18 0.9", Command = $"infopage {key} {page-1}",Material = "assets/icons/greyout.mat" },
                    Text = { Text = "<b>НАЗАД</b>", Align = TextAnchor.MiddleCenter, FontSize = 21, Font = "robotocondensed-regular.ttf",Color = HexToCuiColor("#EBD4AE") }
                },  _layer, _layer + ".Back");
            }
