...
namespace Oxide.Plugins
{
    ...
    public class Expedition : RustPlugin
    {
        ...
        void OnServerInitialized()
        {
            ...
            LoadData();
            LoadImages();
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/CJZ923P.png","eitem");
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/naPbhDD.png","eback"); 
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/CvjN8DD.png","elock");
