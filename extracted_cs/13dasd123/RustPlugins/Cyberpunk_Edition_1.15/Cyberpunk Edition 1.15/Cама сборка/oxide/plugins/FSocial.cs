...
namespace Oxide.Plugins
{
    ...
    public class FSocial : RustPlugin
    {
        ...
        void DownloadImages()
        {
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/8s1jLEv.png", "prombg");//https://ztreh.ru/CyberPunk/z8HUcIz.png
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/8s1jLEv.png", "socbg");
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/8s1jLEv.png", "infoicn");
