...
{
    [Info("GameStoresRUST", "HOUGAN & Sstine & rostov114 # GAMESTORES", "0.3.9")]
    public class GameStoresRUST : RustPlugin
    {
        ...
        private void InitializeStore(BasePlayer player, int page, bool first = true)
        {
            ...
            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0 0.05", AnchorMax = "1 0.9", OffsetMax = "0 0" },
                Image = { Color = "0 0 0 0" }
                            ...
                            if (firstInfo.ContainsKey("result"))
                            {
                                ...
                                else
                                {
                                    ...
                                    secondContainer.Add(new CuiLabel
                                    {
                                        ...
                                        Text = { Text = (page + 1).ToString(), Align = TextAnchor.MiddleCenter, FontSize = 21 }
                                    }, StoreLayer + ".BlockPanel");

                                    secondContainer.Add(new CuiButton
                                    {
                                        RectTransform = { AnchorMin = "0.4 0.14", AnchorMax = "0.4 0.14", OffsetMin = "-20 -67", OffsetMax = "67 20" },
                                    ...
                                    secondContainer.Add(new CuiButton
                                    {
                                        RectTransform = { AnchorMin = "0.6 0.7", AnchorMax = "0.6 0.7", OffsetMin = "-67 -67", OffsetMax = "20 20" },
                                        Button = { Color = "0 0 0 0", Command = (page + 1) * 21 < data.Count ? $"UI_GameStoresRUST page {page + 1}" : "" },
                                        Text = { Text = ">", Color = (page + 1) * 21 < data.Count ? "1 1 1 1" : "1 1 1 0.2", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 35 }
                                    }, StoreLayer + ".BlockPanel");
        ...
        private void FetchShopUrl()
        {
            ...
            {
                LogAction(null, $"-----------------------------", true);
                LogAction(null, $" GameStores {Version} (c) 2022", true);
                try
                {
                    if (response.Length < 1)
                    {
