    ...
    class IQChat : RustPlugin
    {
        ...
        private class InterfaceBuilder
        {
            ...
            private void BuildingStaticContext()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "0.6 0.5", AnchorMax = "0.6 0.5", OffsetMin = "-379 -217", OffsetMax = "-31 217" },
                    Image = { Color = "0 0 0 0" }
                }, "ContentUI", UI_Chat_Context);
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiRawImageComponent { Color = "0.58 0.18 0.18 0.5", Png = "%IMG_BACKGROUND%" },
            ...
            private void BuildingMuteAndIgnorePanelAlert()
            {
                ...
                }, "ContentUI", "MUTE_AND_IGNORE_PANEL_ALERT");
