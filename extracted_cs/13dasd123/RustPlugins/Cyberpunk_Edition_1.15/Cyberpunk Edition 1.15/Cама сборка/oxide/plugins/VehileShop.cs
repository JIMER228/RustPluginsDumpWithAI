...
namespace Oxide.Plugins
{
    ...
    public class VehileShop : RustPlugin
    {
        ...
        {
            ImageLibrary.Call("AddImage", "https://ztreh.ru/CyberPunk/SbuDZ8Z.png", "https://ztreh.ru/CyberPunk/SbuDZ8Z.png");
            ...
            foreach (var vehile in config.VehileSettings.Skip(page*12).Take(12))
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRawImageComponent{Png = (string) ImageLibrary.Call("GetImage","https://ztreh.ru/CyberPunk/SbuDZ8Z.png")}
                    }
                });
