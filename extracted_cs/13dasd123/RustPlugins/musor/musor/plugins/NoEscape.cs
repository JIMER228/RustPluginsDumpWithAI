    ...
    public class NoEscape : RustPlugin
    {
        ...
        private class PlayerBlockStatus : FacepunchBehaviour
        {
            ...
            public void CreateUI()
            {
                ...
                {
                    RectTransform = { AnchorMin="0.5 0", AnchorMax="0.5 0", OffsetMin="185 18", OffsetMax="285 48" },
            ...
            public void UpdateUI()
            {
                ...
                container.Add(new CuiLabel
                {
                    ...
                    Text = { Text = string.Format(ins.Messages["guitimertext"], ins.GetFormatTime(TimeSpan.FromSeconds(CurrentBlocker.TotalTime - CurrentTime))), Font = "robotocondensed-regular.ttf", Color = "1 1 1 0.9", FontSize = 14, Align = TextAnchor.MiddleCenter }
