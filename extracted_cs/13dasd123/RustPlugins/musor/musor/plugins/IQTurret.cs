...
namespace Oxide.Plugins
{
    ...
    internal class IQTurret : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {
                PrintWarning(LanguageEn ? $"Error #842665 configuration readings 'oxide/config/{Name}', creating a new configuration!" : $"Ошибка #842665 чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!"); //
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
        ...
        private new void LoadDefaultMessages()
        {
            ...
            PrintWarning("Logs : #32142662 | Языковой файл загружен успешно"); 
        }
