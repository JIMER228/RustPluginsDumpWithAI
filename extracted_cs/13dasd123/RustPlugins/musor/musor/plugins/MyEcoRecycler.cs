...
{
    [Info("MyEcoRecycler", "Sempai#3239", "1.0.7")]
    class MyEcoRecycler : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            LoadConfig();
            LoadMessages();
            foreach (var perm in config.permis.Keys.ToList()) permission.RegisterPermission(perm, this);
        ...
        object OnRecycleItem(Recycler recycler, Item item) => OnItemRecycle(recycler, item);
        object OnItemRecycle(Recycler recycler, Item item)
        {
