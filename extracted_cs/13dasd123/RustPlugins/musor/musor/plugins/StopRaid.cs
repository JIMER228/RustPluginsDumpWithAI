...
namespace Oxide.Plugins
{
    ...
    public class StopRaid : RustPlugin
    {
        ...
        private void StopMAIN(BasePlayer player) 
        {
            ...
            {
                Image = { Color = "0.00 0.02 0.00 0.25", Material = "assets/icons/greyout.mat" },
                RectTransform ={ AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-700.010 -100", OffsetMax = "700.50 10" }
            },"Overlay","StopMAIN");
            ...
            container.Add(new CuiElement
            {
                ...
                Components = 
                {
                    new CuiTextComponent { Text = "Стоп рейд!\nВы не можете двигаться и наносить урон.\nПожалуйста! Подождите пока Администратор выключит его вам", Font = "robotocondensed-regular.ttf", FontSize = 20, Align = TextAnchor.UpperCenter, Color = "1 1 1 1" },
                    new CuiOutlineComponent { Color = "0 0 0 0.5", Distance = "1 -1" },
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-640 -150.025", OffsetMax = "640 45.124" }
                }
            });
