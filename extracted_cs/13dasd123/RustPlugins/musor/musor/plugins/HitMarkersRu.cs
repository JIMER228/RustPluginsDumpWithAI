...
namespace Oxide.Plugins
{
    ...
    public class HitMarkersRu : RustPlugin
    {
        ...
        private class Configuration
        {
            ...
            [JsonProperty(PropertyName = "", ObjectCreationHandling = ObjectCreationHandling.Replace)]
            ...
            [JsonProperty(PropertyName = "Иконка хитмаркера")]
            public string HitIcon = "https://i.imgur.com/YIRjnIT.png";
        ...
        {
            [JsonProperty(PropertyName = "")] public string Font;
        ...
        private void OnServerInitialized()
        {
            ...
            ImageLibrary?.Call("AddImage", _config.HitIcon, _config.HitIcon);
        ...
        private void MainUi(BasePlayer player, bool first = false)
        {
            ...
            foreach (var fontConf in _config.Fonts)
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    Image =
                    {
                        Color = selected ? "0.00 0.35 1.00 1.00" : "0.50 0.47 0.40 0.6"
                    }
        ...
        {
            var x = (float)Random.Range(50, 52) / 100;
            var y = (float)Random.Range(44, 50) / 100;
        ...
        private class MarkerComponent : FacepunchBehaviour
        {
                        ...
                        container.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                ...
                                new CuiRectTransformComponent
                                {
                                    ...
                                    OffsetMin = "90  -25", OffsetMax = "90 25"
                                }
                            }
                        });
            ...
            var hitId = CuiHelper.GetGuid();
                        ...
                        var color = "1 1 1 0.5";
                        var image = "assets/icons/bite.png";
                        float margin = 15;
                        ...
                        container.Add(new CuiButton
                        {
                            ...
                            Button = { Color = "1 1 1 1", Sprite = image,  },
