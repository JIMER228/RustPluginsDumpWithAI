...
namespace Oxide.Plugins
{
    ...
    [Info("Turret Limits", "Whispers88, gsuberland", "1.2.2")]
    ...
    class TurretLimits : RustPlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["TurretLimitReached_AutoTurret"] = "Вы превысили лимит турелей!",

                ["TurretLimitReached_FlameTurret"] = "Вы превысили лимит турелей!",
        ...
        object CanBuild(Planner planner, Construction prefab, Construction.Target target)
        {
            ...
            if (isAutoTurret || isFlameTurret || isShotgunTrap  || isSamSite)
            {
                ...
                {
                    SendReply(player, "Установка турелей без доступа шкафу запрещена!");
                    return false;
                }
                ...
                if (isFlameTurret)
                {
                    ...
                    {
                        SendReply(player, "Вы превысили лимит турелей!");
                        return false;
                    }
                }
