...
namespace Oxide.Plugins
{
    ...
    class Arkan : RustPlugin
    {
		...
		private const string permName = "Arkan.use";
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                ["PlayerAIMViolation"] = "<color=red><color=green>Protect_GT:</color> Player <color=yellow>{0}/{1}</color> has possibly AIMBOT violation <color=yellow>#{2}</color>. Target <color=yellow>{3}/{4}</color></color>",
				["PlayerAIMViolationCon"] = "Player {0}/{1} has possibly AIMBOT violation #{2}. Target {3}/{4}",
				["PlayerIRViolation"] = "<color=red><color=green>Protect_GT:</color> Player <color=yellow>{0}/{1}</color> has In Rock violation <color=yellow>#{2}</color>. Shots count <color=yellow>{3}</color></color>",
				["PlayerIRViolationCon"] = "<color=green>Protect_GT:</color> Player {0}/{1} has In Rock violation #{2}. Shots count <color=yellow>{3}</color></color>",
				...
				["ClearVD"] = "<color=red><color=green>Protect_GT:</color> Violations data cleared</color>",
                ["SaveVD1"] = "<color=red><color=green>Protect_GT:</color> Violation data saved in file <color=yellow>{0}</color></color>",
                ["LoadVD1"] = "<color=red><color=green>Protect_GT:</color> File <color=yellow>{0}</color> exist, saved data loaded</color>",
                ["LoadVD2"] = "Saved data map seed:{0} doesn't match map seed:{1}",
                ["LoadVD3"] = "Saved data map size:{0} doesn't match map size:{1}",
                ["LoadVD4"] = "<color=red><color=green>Protect_GT:</color> File <color=yellow>{0}</color> doesn't exist</color>",
				...
				["ShowLog1v1.0.13"] = "<size=14><color=orange><color=green>Arkan</color> by GT</color></size>\n" +
                    "Commands in chat:\n" +
                    "<color=orange>/logs</color> - Show all No Recoil/AIMBOT/In Rock violations\n" +
				...
				["ShowInfo"] = "<size=14><color=orange><color=green>Arkan</color> by GT</color></size>\n" +
                    "Protect_GT commands info: <color=orange>/arkaninfo</color>\n\n",
                ...
                ["Player"] = "<color=green>Protect_GT:</color> <color=red>Player <color=yellow>{0}</color>\n",
                ...
                ["PlayerNRViolation"] = "<size=14><color=red><color=green>Protect_GT:</color> Player <color=yellow>{0}/{1}</color> has possibly No Recoil violation <color=yellow>#{2}</color>\ntotal shots cnt: <color=yellow>{3}</color> | shots with low recoil cnt: <color=yellow>{4}</color>\nprobability: <color=yellow>{5}%</color></color></size>",
				["PlayerNRViolationCon"] = "Arkan: Player {0}/{1} has possibly No Recoil violation #{2}\ntotal shots cnt: {3} | shots with low recoil cnt: {4}\nprobability: {5}",
            }, this, "en");
			
			lang.RegisterMessages(new Dictionary<string, string>
            {
                ["PlayerAIMViolation"] = "<color=red><color=green>Protect_GT:</color> У игрока <color=yellow>{0}/{1}</color> обнаружено возможное нарушение AIM <color=yellow>#{2}</color>. Жертва <color=yellow>{3}/{4}</color></color>",
				["PlayerAIMViolationCon"] = "У игрока {0}/{1} обнаружено возможное нарушение AIM #{2}. Жертва {3}/{4}",
				["PlayerIRViolation"] = "<color=red><color=green>Protect_GT:</color> У игрока <color=yellow>{0}/{1}</color> обнаружено нарушение In Rock <color=yellow>#{2}</color>. Количество выстрелов <color=yellow>{3}</color></color>",
				["PlayerIRViolationCon"] = "<color=green>Protect_GT:</color> У игрока {0}/{1} обнаружено нарушение In Rock #{2}. Количество выстрелов <color=yellow>{3}</color></color>",
				...
				["ClearVD"] = "<color=red><color=green>Protect_GT:</color> Данные нарушений очищены</color>",
                ["SaveVD1"] = "<color=red><color=green>Protect_GT:</color> Данные нарушений сохранены в файл <color=yellow>{0}</color></color>",
                ["LoadVD1"] = "<color=red><color=green>Protect_GT:</color> Файл <color=yellow>{0}</color> существует, сохранненые в нем данные загружены</color>",
                ...
                ["LoadVD4"] = "<color=red><color=green>Protect_GT:</color> Файл <color=yellow>{0}</color> не существует</color>",
                ...
                ["ShowLog1v1.0.13"] = "<size=14><color=orange><color=green>FLASH LOG</color> by GT</color></size>\n" +
                    "Команды в чат:\n" +
                    "<color=orange>/logs</color> - Показывает список всех No Recoil/AIMBOT/In Rock нарушений\n" +
				...
				["ShowInfo"] = "<size=14><color=orange><color=green>FLASH LOG</color> by GT</color></size>\n" +
                    "Инфо по командам Protect_GT: <color=orange>/arkaninfo</color>\n\n",
                ...
                ["Player"] = "<color=green>Protect_GT:</color> <color=red>Игрок <color=yellow>{0}</color>\n",
                ...
                ["PlayerNRViolation"] = "<size=14><color=red><color=green>Protect_GT:</color> У игрока <color=yellow>{0}/{1}</color> обнаружено возможное нарушение No Recoil <color=yellow>#{2}</color>\nобщее количество выстрелов: <color=yellow>{3}</color> | количество выстрелов с низкой отдачей: <color=yellow>{4}</color>\nвероятность: <color=yellow>{5}%</color></color></size>",
					...
					if (_config.isDetectAIM && isAIMBodyPart && info.Initiator.Distance(entity.transform.position) > _config.minDistanceAIMCheck)
					{
                        ...
                        if (AIMViolation)
                        {
							...
							{	
								...
								if (permission.UserHasPermission(_player.UserIDString, permAIMReportConsole))
									_player.ConsoleMessage("<color=green>Protect_GT:</color> " + Lang("PlayerAIMViolationCon", _player.UserIDString, attacker.displayName, attacker.userID, PlayersViolations.Players[attacker.userID].AIMViolations.Count, target.displayName, target.userID));
							}
		...
		private void LoadViolationsData(BasePlayer player, string command, string[] args)
        {
            ...
            if (Interface.Oxide.DataFileSystem.ExistsDatafile("Arkan/" + fileName))
            {
                ...
                if (tmpPlayersViolations.seed != ConVar.Server.seed)
                {
                    SendReply(player, "<color=green>Protect_GT: </color><color=red>" + Lang("LoadVD2", player.UserIDString, "<color=yellow>" + tmpPlayersViolations.seed + "</color>", "<color=yellow>" + ConVar.Server.seed + "</color>") + "</color>");
                ...
                if (tmpPlayersViolations.mapSize != ConVar.Server.worldsize)
                {
                    SendReply(player, "<color=green>Protect_GT: </color><color=red>" + Lang("LoadVD3", player.UserIDString, "<color=yellow>" + tmpPlayersViolations.mapSize + "</color>", "<color=yellow>" + ConVar.Server.worldsize + "</color>") + "</color>");
        ...
        private void ShowLog(BasePlayer player, string command, string[] args)
        {
			...
			{	
                ...
                if (PlayersViolations.Players.Count > 0)
                {
					...
					string txtTmp = "";
					string txtConsole = "<color=green>Protect_GT: </color>" + Lang("ShowLog2");
					int i = 1;
