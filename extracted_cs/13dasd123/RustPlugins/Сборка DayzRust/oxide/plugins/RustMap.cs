...
{
    [Info("RustMap", "FOX", "2.4.2")]
    [Description("FOX✓#2698")]
    class RustMap : RustPlugin
    {
        ...
        bool bradley = false;
        float bradleyIconSize = 0.05f;
        float bradleyIconAlpha = 0.99f;
        bool plane = true;
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            GetVariable("Элементы", "Отображать местоположение танка", ref bradley);
            GetVariable("Размеры элементов", "Размер иконки танка", ref bradleyIconSize);
            GetVariable("Прозрачность элементов", "Прозрачность иконки танка", ref bradleyIconAlpha);
        ...
        private List<ulong> GetTeamMembers(BasePlayer player)
        {
            if (player.currentTeam == 0)
                return null;
            return RelationshipManager.ServerInstance.FindTeam(player.currentTeam).members.Where(p => p.ToString() != player.UserIDString).ToList();
        }
        ...
        {
            {"player1", "https://i.ibb.co/HVVMsKf/player1.png"},
            {"player2", "https://i.ibb.co/wCHPYdf/player2.png"},
            {"player3", "https://i.ibb.co/6NzM7xJ/player3.png"},
            {"player4", "https://i.ibb.co/JxG6Jby/player4.png"},
            {"player5", "https://i.ibb.co/vJSmMFQ/player5.png"},
            {"player6", "https://i.ibb.co/QC8QgX1/player6.png"},
            {"player7", "https://i.ibb.co/tYhB2Xw/player7.png"},
            {"player8", "https://i.ibb.co/HCD9y7J/player8.png"},
            {"player9", "https://i.ibb.co/JdCWTT7/player9.png"},
            {"player10", "https://i.ibb.co/QcdyZzL/player10.png"},
            {"player11", "https://i.ibb.co/TTVnNbx/player11.png"},
            {"player12", "https://i.ibb.co/7v2pMHP/player12.png"},
            {"player13", "https://i.ibb.co/nm9hV82/player13.png"},
            {"player14", "https://i.ibb.co/M13d3kB/player14.png"},
            {"player15", "https://i.ibb.co/z2vwJqx/player15.png"},
            {"player16", "https://i.ibb.co/4V373hX/player16.png"},

            {"friend1", "https://i.ibb.co/47kW70R/friend1.png"},
            {"friend2", "https://i.ibb.co/sKZgL2y/friend2.png"},
            {"friend3", "https://i.ibb.co/X3ZCWJy/friend3.png"},
            {"friend4", "https://i.ibb.co/K0RRLHx/friend4.png"},
            {"friend5", "https://i.ibb.co/17JK1Lh/friend6.png"},
            {"friend6", "https://i.ibb.co/17JK1Lh/friend6.png"},
            {"friend7", "https://i.ibb.co/rHLc6bn/friend7.png"},
            {"friend8", "https://i.ibb.co/XLR3m7R/friend8.png"},
            {"friend9", "https://i.ibb.co/x5Qyfzx/friend9.png"},
            {"friend10", "https://i.ibb.co/bbqqf7K/friend10.png"},
            {"friend11", "https://i.ibb.co/LPFBrNg/friend11.png"},
            {"friend12", "https://i.ibb.co/VDG4XtY/friend12.png"},
            {"friend13", "https://i.ibb.co/27D6fbv/friend13.png"},
            {"friend14", "https://i.ibb.co/b6y2xy5/friend14.png"},
            {"friend15", "https://i.ibb.co/vLKgdnt/friend15.png"},
            {"friend16", "https://i.ibb.co/Y0kdhBZ/friend16.png"},

            {"plane1", "https://i.ibb.co/gTn6W2z/plane1.png"},
            {"plane2", "https://i.ibb.co/j60bDXw/plane2.png"},
            {"plane3", "https://i.ibb.co/9VBNxwH/plane3.png"},
            {"plane4", "https://i.ibb.co/WBwp3tK/plane4.png"},
            {"plane5", "https://i.ibb.co/qkwGzB3/plane5.png"},
            {"plane6", "https://i.ibb.co/S5dSPns/plane6.png"},
            {"plane7", "https://i.ibb.co/27gJswN/plane7.png"},
            {"plane8", "https://i.ibb.co/p49STKG/plane8.png"},
            {"plane9", "https://i.ibb.co/5B6p1XB/plane9.png"},
            {"plane10", "https://i.ibb.co/YLfSsLM/plane10.png"},
            {"plane11", "https://i.ibb.co/0X12GdG/plane11.png"},
            {"plane12", "https://i.ibb.co/J7qjWjY/plane12.png"},
            {"plane13", "https://i.ibb.co/LSdrPKc/plane13.png"},
            {"plane14", "https://i.ibb.co/h7v7s7B/plane14.png"},
            {"plane15", "https://i.ibb.co/s339GQK/plane15.png"},
            {"plane16", "https://i.ibb.co/yF90zzJ/plane16.png"},

            {"bradley1", "https://i.ibb.co/Nxzn8d2/bradley1.png"},
            {"bradley2", "https://i.ibb.co/g4S3LLs/bradley2.png"},
            {"bradley3", "https://i.ibb.co/w6qY4DH/bradley3.png"},
            {"bradley4", "https://i.ibb.co/cQbgpcv/bradley4.png"},
            {"bradley5", "https://i.ibb.co/yBCfsS7/bradley5.png"},
            {"bradley6", "https://i.ibb.co/XZWYw6T/bradley6.png"},
            {"bradley7", "https://i.ibb.co/Z67svm6/bradley7.png"},
            {"bradley8", "https://i.ibb.co/dfyhC9W/bradley8.png"},
            {"bradley9", "https://i.ibb.co/Lps4W3h/bradley9.png"},
            {"bradley10", "https://i.ibb.co/hBsg00B/bradley10.png"},
            {"bradley11", "https://i.ibb.co/R7bYNj0/bradley11.png"},
            {"bradley12", "https://i.ibb.co/nwPH0Rq/bradley12.png"},
            {"bradley13", "https://i.ibb.co/PxSZNW2/bradley13.png"},
            {"bradley14", "https://i.ibb.co/0KBK9bP/bradley14.png"},
            {"bradley15", "https://i.ibb.co/68DcHVN/bradley15.png"},
            {"bradley16", "https://i.ibb.co/ZVjt1Qt/bradley16.png"},

            { "newheli1", "https://i.ibb.co/PrDnybH/newheli1.png"},
            { "newheli2", "https://i.ibb.co/mR38PJT/newheli2.png"},
            { "newheli3", "https://i.ibb.co/86G2RgW/newheli3.png"},
            { "newheli4", "https://i.ibb.co/bFntyZK/newheli4.png"},
            { "newheli5", "https://i.ibb.co/hBD6N1y/newheli5.png"},
            { "newheli6", "https://i.ibb.co/9qkX904/newheli6.png"},
            { "newheli7", "https://i.ibb.co/4sPbKt6/newheli7.png"},
            { "newheli8", "https://i.ibb.co/KhTQQWk/newheli8.png"},
            { "newheli9", "https://i.ibb.co/Hdhp8Hm/newheli9.png"},
            { "newheli10", "https://i.ibb.co/8YZQcLR/newheli10.png"},
            { "newheli11", "https://i.ibb.co/swtXYvk/newheli11.png"},
            { "newheli12", "https://i.ibb.co/xS8BPfd/newheli12.png"},
            { "newheli13", "https://i.ibb.co/RpSqb7w/newheli13.png"},
            { "newheli14", "https://i.ibb.co/7JBLpfk/newheli14.png"},
            { "newheli15", "https://i.ibb.co/1GM8GdF/newheli15.png"},
            { "newheli16", "https://i.ibb.co/4gX3gyw/heli16.png"},

            { "ship1", "https://i.ibb.co/n07YdBB/ship1.png" },
            { "ship2", "https://i.ibb.co/drfLFwn/ship2.png" },
            { "ship3", "https://i.ibb.co/Ht2y4Zj/ship3.png" },
            { "ship4", "https://i.ibb.co/LzcLXWS/ship4.png" },
            { "ship5", "https://i.ibb.co/55fKQK8/ship5.png" },
            { "ship6", "https://i.ibb.co/YtM9x5m/ship6.png" },
            { "ship7", "https://i.ibb.co/4sCvcPp/ship7.png" },
            { "ship8", "https://i.ibb.co/QJZjZVg/ship8.png" },
            { "ship9", "https://i.ibb.co/yRfXn9v/ship9.png" },
            { "ship10", "https://i.ibb.co/fvvdFD4/ship10.png" },
            { "ship11", "https://i.ibb.co/bLmPmtS/ship11.png" },
            { "ship12", "https://i.ibb.co/XVLMtSx/ship12.png" },
            { "ship13", "https://i.ibb.co/t3VVFcV/ship13.png" },
            { "ship14", "https://i.ibb.co/zxkQ1GQ/ship14.png" },
            { "ship15", "https://i.ibb.co/ssWCpPF/ship15.png" },
            { "ship16", "https://i.ibb.co/SQTSMGw/ship16.png" },
            { "newhelicreate", "https://i.ibb.co/56nYmkN/newhelicreate.png"},
            { "heli1", "https://i.ibb.co/rxz6s3m/heli1.png"},
            { "heli2", "https://i.ibb.co/qpYZRLY/heli2.png"},
            { "heli3", "https://i.ibb.co/7Sthpfb/heli3.png"},
            { "heli4", "https://i.ibb.co/6yZ5HGD/heli4.png"},
            { "heli5", "https://i.ibb.co/k6H8myx/heli5.png"},
            { "heli6", "https://i.ibb.co/gSHMDhk/heli6.png"},
            { "heli7", "https://i.ibb.co/XX8KrZy/heli7.png"},
            { "heli8", "https://i.ibb.co/x5BzkjM/heli8.png"},
            { "heli9", "https://i.ibb.co/8g58fH3/heli9.png"},
            { "heli10", "https://i.ibb.co/RQnsFzN/heli10.png"},
            { "heli11", "https://i.ibb.co/zbSRXNT/heli11.png"},
            { "heli12", "https://i.ibb.co/BNhsJMV/heli12.png"},
            { "heli13", "https://i.ibb.co/VjxpD84/heli13.png"},
            { "heli14", "https://i.ibb.co/7gf7MFz/heli14.png"},
            { "heli15", "https://i.ibb.co/Zm1vnfK/heli15.png"},
            { "heli16", "https://i.ibb.co/4gX3gyw/heli16.png"},
            { "lighthouse", "https://i.ibb.co/GJP72WF/lighthouse.png" },
            { "special", "https://i.ibb.co/mc5BV4d/special.png" },
            { "militarytunnel", "https://i.ibb.co/8X1vng3/militarytunnel.png"},
            { "airfield", "https://i.ibb.co/bv8Ymzm/airfield.png" },
            { "trainyard", "https://i.ibb.co/wNN8vcH/trainyard.png" },
            { "gasstation", "https://i.ibb.co/Bwdv4Fj/gasstation.png" },
            { "supermarket", "https://i.ibb.co/Qnm0VzX/supermarket.png" },
            { "watertreatment", "https://i.ibb.co/RyTG57Y/watertreatment.png" },
            { "warehouse", "https://i.ibb.co/wsc7wfG/warehouse.png" },
            { "satellitedish", "https://i.ibb.co/RN2VtQt/satellitedish.png" },
            { "spheretank", "https://i.ibb.co/Ns6HkGj/spheretank.png" },
            { "radtown", "https://i.ibb.co/1sCPvrr/radtown.png" },
            { "powerplant", "https://i.ibb.co/5v5cVzy/powerplant.png" },
            { "harbor", "https://i.ibb.co/3Cp0qnB/harbor.png" },
            { "powersub", "https://i.ibb.co/R71m5j8/powersub.png" },
            { "cave", "https://i.ibb.co/tPRLH9X/cave.png" },
            { "launchsite", "https://i.ibb.co/N2zrGq7/launchsite.png" },
            { "OilrigAI", "https://i.ibb.co/KX6qChL/OilrigAI.png" },
            { "excavator", "https://i.ibb.co/7XzVqvG/excavator.png" },
            { "spawnRight", "https://i.ibb.co/99yHnFW/gUpyctl.png" },
            { "spawnLeft", "http://i.imgur.com/mmabTrn.png" },
            { "raidhome", "http://i.imgur.com/fdLjkq7.png" },
            { "mapsupply","https://i.ibb.co/g38RdCM/mapsupply.png" },
            { "avanpost","https://i.ibb.co/gmj0cpn/avanpost.png" },
            { "helidebris", "https://i.ibb.co/3N6rgpM/helidebris.png" },
            { "banned", "https://i.ibb.co/vk8tjRT/banned.png" },
            { "vending", "https://i.ibb.co/yfxg0Zq/vending.png" },
            { "sethome", "https://i.ibb.co/44J0Wms/homes.png" },
            { "treasurebox", "https://i.ibb.co/CJ2Z4kG/treasurebox.png" },
            { "death", "https://i.ibb.co/VYg93JD/death.png" },
            { "sleep", "https://rustlabs.com/img/items180/sleepingbag.png" },
            { "meteor", "https://i.imgur.com/BFCdsOx.png" },
            { "rad", "https://i.ibb.co/8P6mNLS/radhouse.png" },
            { "quarry", "https://i.ibb.co/k4ZqHq9/quarry.png" },
            { "cquarry", "https://i.ibb.co/HPxJhTS/cquarry.png" },
            { "dump", "https://i.ibb.co/2K2fy4W/dump.png" },
            { "water", "https://i.ibb.co/HY3rKHk/water.png" },
            { "custom", "https://i.ibb.co/99yHnFW/gUpyctl.png" },
            { "bandit", "https://i.ibb.co/YTM6p6p/bandit.png" },
            { "swamp", "https://i.ibb.co/2YmngF6/swamp.png" }
        ...
        public static class MapRender
        {
            ...
            public static byte[] Render()
            {
                ...
                if (instance == null)
                    return null;
                terrain = instance.GetComponent<Terrain>();
                terrainHeightMap = instance.GetComponent<TerrainHeightMap>();
                terrainSplatMap = instance.GetComponent<TerrainSplatMap>();
