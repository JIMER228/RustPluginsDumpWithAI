// ZenPanel скачан с сайта Server-rust.ru Сотни новых бесплатных плагинов уже на нашем сайте! 
	...
	class ZenPanel : RustPlugin {
      ...
      //  Слив плагинов server-rust by Apolo YouGame
		...
		private static List<BasePlayer> GetActivePlayers() {
			return BasePlayer.activePlayerList.FindAll(p => p.IsConnected);
		}
      ...
      //  Слив плагинов server-rust by Apolo YouGame
			...
			foreach (var player in BasePlayer.activePlayerList) DrawUI(cb, player);
		}
