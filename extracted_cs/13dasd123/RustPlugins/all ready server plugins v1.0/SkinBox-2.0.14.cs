...
{
    [Info("SkinBox", "Skuli Dropek", "2.0.14"), Description("Allows you to reskin item's by placing it in the SkinBox and selecting a new skin")]
    class SkinBox : RustPlugin
    {
        ...
        private void SendWorkshopCollectionQuery(ulong collectionId, bool add, int success, ConsoleSystem.Arg arg = null, string perm = null)
        {
            string details = string.Format(COLLECTION_BODY, Configuration.Skins.APIKey, collectionId);

            try
            {
                webrequest.Enqueue(COLLECTION_DETAILS, details, (code, response) => ServerMgr.Instance.StartCoroutine(ProcessCollectionRequest(code, response, add, success, arg, perm)), this, RequestMethod.POST);
            }
            catch { }
        }
        ...
        private IEnumerator ProcessCollectionRequest(int code, string response, bool add, int success, ConsoleSystem.Arg arg, string perm)
        {
            if (response != null && code == 200)
            {
        ...
        private class LootHandler : MonoBehaviour
        {
            ...
            internal void OnItemRemoved(Item item)
            {
                ...
                if (item.skin != 0UL && Configuration.Skins.ShowSkinIDs)
        ...
        private void consoleAddCollection(ConsoleSystem.Arg arg)
        {
            ...
            SendWorkshopCollectionQuery(collectionId, true, 0, arg);
        }
        ...
        private void consoleRemoveCollection(ConsoleSystem.Arg arg)
        {
            ...
            SendWorkshopCollectionQuery(collectionId, false, 0, arg);
        }
        ...
        private void consoleAddVIPCollection(ConsoleSystem.Arg arg)
        {
            ...
            SendWorkshopCollectionQuery(collectionId, true, 0, arg, perm);
        }
        ...
        private void consoleRemoveVIPCollection(ConsoleSystem.Arg arg)
        {
            ...
            SendWorkshopCollectionQuery(collectionId, false, 0, arg, perm);
        }
        #endregion
