...
{
    [Info("Friends", "Admin", "1.0.0", ResourceId = 686)]
    ...
    public class Friends : CovalencePlugin
    {
        ...
        private class ConfigData
        {
            ...
            [JsonProperty("Автоматические замки для друзей")]
            public bool ShareCodeLocks { get; set; }
            [JsonProperty("Автоматические турели для друзей")]
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                {"HelpText", "<size=16><color=#FFCF40>Friends</color> </size>\n\n<size=16><color=#FFCF40>Команды:</color></size>\n<color=#FFCF40>/friend add (+)</color> - что бы добавить нового друга\n<color=#FFCF40>/friend remove (-) </color>- что бы удалить друга\n<color=#FFCF40>/friend list </color>- Список ваших друзей\n<color=#FFCF40>/friend accept </color>- Принять заявку в друзья."},
                ...
                {"Syntax", "<size=16><color=#FFCF40>Friends</color> </size>\n\n<size=16><color=#FFCF40>Команды:</color></size>\n<color=#FFCF40>/friend add (+)</color> - что бы добавить нового друга\n<color=#FFCF40>/friend remove (-) </color>- что бы удалить друга\n<color=#FFCF40>/friend list </color>- Список ваших друзей\n<color=#FFCF40>/friend accept </color>- Принять заявку в друзья."},
                ...
                {"Pending", "{0} отправил вам запрос в друзья, чтобы принять введите в чат <color=orange>/friend accept</color>"},
            }, this);
        }
        ...
        private void FriendCommand(IPlayer player, string command, string[] args)
        {
            ...
            if (args == null || args.Length <= 0 || args.Length == 1 && args[0].ToLower() != "accept" && !args[0].Equals("list", StringComparison.OrdinalIgnoreCase))
            {
                Reply(player, "Syntax");
                return;
            }
