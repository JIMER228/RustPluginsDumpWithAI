...
{
    [Info("RustMap", "RustPlugin.ru", "1.3.3")]
    ...
    class RustMap : RustPlugin
    {
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            Config["Отображать местоположение танка"] = bradley = GetConfig("Отображать местоположение танка", true);
      ...
      //  Слив плагинов server-rust by Apolo YouGame
        ...
        void OnEntitySpawned(BaseEntity entity)
        {
            ...
            if (NewHeliCrate && entity is HackableLockedCrate)
            {
                ...
                RaycastHit rHit;
                if (!Physics.Raycast(new Vector3(ePos.x, ePos.y + 1, ePos.z), Vector3.down, out rHit, 2f, LayerMask.GetMask("Terrain", "World"))) return;
