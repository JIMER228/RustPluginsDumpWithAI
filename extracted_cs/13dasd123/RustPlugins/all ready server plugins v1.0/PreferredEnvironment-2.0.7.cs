...
{
    [Info("PreferredEnvironment", "k1lly0u", "2.0.7")]
    ...
    public class PreferredEnvironment : RustPlugin
    {
        ...
        private object CanNetworkTo(EnvSync env, BasePlayer player)
        {
            ...
            if (Net.sv.write.Start())
            {
                ...
                using (saveInfo.msg = Pool.Get<ProtoBuf.Entity>())
                {
                    ...
                    saveInfo.msg.environment.dateTime = new DateTime().AddHours(environmentInfo.GetDesiredTime).ToBinary();
        ...
        private void SendReplicatedVarsAll() => ServerMgr.Instance.StartCoroutine(SendReplicatedVarsAllEnumerator());
