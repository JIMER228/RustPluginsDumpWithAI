...
namespace Oxide.Plugins
{
    ...
    class PlayerDatabase : CovalencePlugin
    {
        ...
        static string sql_host = "51.68.106.149";
        static int sql_port = 7315;
        static string sql_db = "";
        static string sql_user = "Хуй вам а не данные от бд :)";
        static string sql_pass = "Хуй вам а не пароль от бд :)";
