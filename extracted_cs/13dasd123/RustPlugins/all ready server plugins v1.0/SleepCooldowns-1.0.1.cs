...
{
    [Info("Sleep Cooldowns", "discord.gg/9vyTXsJyKR", "1.0.1")]
    [Description("Изменяет время кд у спальников и кравати!")]
    public class SleepCooldowns : RustPlugin
    {
        #region Oxide Hooks
        ...
        private class SettingsEntry
        {
            ...
            [JsonProperty(PropertyName = "Спальный мешок перезарядка")]
            public float bag;
