...
{
    [Info("Extended Crafting", "nivex & judess69er", "0.3.5")]
    [Description("Allows players to deploy additional entities.")]
    class ExtendedCrafting : RustPlugin
    {
		#region Engine
        private static Dictionary<uint, ExtendedController> _controllers = new Dictionary<uint, ExtendedController>();
        ...
        private void Init()
        {
            ...
            _controllers = new Dictionary<uint, ExtendedController>();
        }
