...
{
    [Info("Notify", "Mevent", "1.0.8")]
    [Description("Adds custom notifications for players")]
    public class Notify : CovalencePlugin
    {
        #region Fields
            ...
            public Dictionary<int, TypeConf> Types = new Dictionary<int, TypeConf>
            {
                ...
                [1] = new TypeConf
                {
                    ...
                    Image = new ImageSettings
                    {
                        ...
                        OffsetMax = "37.5 37.5",
                        Enabled = true,
                        Image = "https://i.imgur.com/TZebBzv.jpg"
                    }
                }
            };
        }
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                [NotFound] = "Player '{args[0]}' not found!"
            }, this);
        }
