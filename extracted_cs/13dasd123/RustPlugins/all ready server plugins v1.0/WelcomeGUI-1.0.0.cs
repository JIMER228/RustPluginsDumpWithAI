...
{
    [Info("Welcome GUI", "Replce RustPLugin.ru", "1.0.0")]
	...
	{ 
		...
		void LoadVariables() 
		{
            ...
            "<size=23><color=#F49F28>SERVERNAME</color> приветствует тебя, <color=#F49F28>{name}</color>!</size>",
			"На сервере разрешено играть не более 2 человек!",
			"",
			"",
			"— — — — — — — — — — — — — — — — — — — — — — — — — —",
			"Группа ВКонтакте - <color=#97EA57>VK.COM/</color>",
			"— — — — — — — — — — — — — — — — — — — — — — — — — —",
			"Донат услуги - <color=#97EA57>SITE.RU</color>",
			"— — — — — — — — — — — — — — — — — — — — — — — — — —",
			"IP Адрес сервера - <color=#97EA57>IP</color>",
			"— — — — — — — — — — — — — — — — — — — — — — — — — —",
			"",
			"",
			"Команды и возможности игроков <color=#FFEB95>/info</color>"
