...
{
    [Info("WipeBlock", "https://topplugin.ru / https://discord.com/invite/5DPTsRmd3G", "1.0.2")]
    class WipeBlock : RustPlugin
    {
        ...
        private void BlockUi(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Button =
                {
                    Color = "0 0 0 0.8", Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat",
                    Close = Layer
                },
                Text =
                {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiImageComponent {Color = HexToRustFormat("#534E48D4")},
            ...
            foreach (var check in config.items.Select((i, t) => new {A = i, B = t}))
            {
                ...
                string text = BlockTimeGui(check.A.Key) ? $"<color=#ffffff>{TimeSpan.FromSeconds((int) IsBlocked(check.A.Key)).ToShortString()}</color>" : "<color=#D4AD5A>Доступно</color>";
                container.Add(new CuiButton
                    {
                        RectTransform =
                        {
                            AnchorMin =
                                $"{0.00961443 + check.B * 0.090 - Math.Floor((double) check.B / 11) * 11 * 0.090} {0.7812496 - Math.Floor((double) check.B / 11) * 0.16}",
                            AnchorMax =
                                $"{0.09290709 + check.B * 0.090 - Math.Floor((double) check.B / 11) * 11 * 0.090} {0.9312496 - Math.Floor((double) check.B / 11) * 0.16}",
                            OffsetMax = "0 0"
                        },
                        Button =
                        {
                            Color = "1 1 1 0.1", Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat",
                        },
                        Text =
                        {
                            Text = ""
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0 0.39375", AnchorMax = "0.9875 0.60625" }
                    }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent()
                        {
                            ...
                            Text =
                                $"{text}",
                            FontSize = 14, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-bold.ttf"
                        },
                        new CuiRectTransformComponent {AnchorMin = "0 0.3900002", AnchorMax = "1 0.6099998"},
                    }
                });
            }
