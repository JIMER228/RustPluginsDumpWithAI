...
{
    [Info("EventsCore", "BadMandarin, Ryamkk", "1.2.0")]
    ...
    class EventsCore : RustPlugin
    {
      ...
      //  Слив плагинов server-rust by Apolo YouGame
		...
		private void Unload() 
        {
            BasePlayer.activePlayerList.ForEach(p => CuiHelper.DestroyUi(p, NotifyLayer));
        } 
        ...
        private void Draw_UIEvents(BasePlayer player)
        {
            ...
            container.Add(new CuiPanel
            {
                ...
                Image = { Color = HexToCuiColor("#000000"), Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" }
            }, "Hud", Layer);
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiImageComponent { Color = HexToCuiColor(EventsList[curEvent].eBackground), Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
		...
		private void ShowNotify(BasePlayer player, string text)
        {
			...
			container.Add(new CuiButton
            {
                ...
                Button = { Color = HexToCuiColor(EventsList[curEvent].eBackground) }, 
