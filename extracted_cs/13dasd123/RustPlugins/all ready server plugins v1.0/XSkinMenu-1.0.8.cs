...
{ 
    [Info("XSkinMenu", "[modhub.to] SkuliDropek", "1.0.8")]
    ...
    { 
		...
		private void GUI(BasePlayer player)
		{
			...
			container.Add(new CuiLabel
            {
                ...
                Text = { Text = lang.GetMessage("TITLE", this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 18, Color = "1 1 1 0.750604" }
            }, ".SGUI");
