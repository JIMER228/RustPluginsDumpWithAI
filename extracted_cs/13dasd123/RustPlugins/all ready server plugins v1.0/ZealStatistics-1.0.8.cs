...
{
    [Info("ZealStatistics", "Kira", "1.0.8")]
    ...
    class ZealStatistics : RustPlugin
    {
        ...
        public class ConfigData
        {
            ...
            public class GUICFG
            {
                [JsonProperty(PropertyName = "Allow viewing other people's statistics?")]
                public bool info;
            }
        }
        ...
        {
            PrintError("The configuration file is damaged (or does not exist), a new ...");
        ...
        private new void LoadDefaultMessages()
        {
            ...
            timer.In(2.5f, () =>
            {
                Dictionary<string, string> LangEN = new Dictionary<string, string>
                {
                    ["STATS_KILLS"] = "Kills",
                    ["STATS_DEATHS"] = "Deaths",
                    ["STATS_ANIMALKILLS"] = "Killing animals",
                    ["STATS_DTANK"] = "Tanks destroyed",
                    ["STATS_DHELI"] = "Helicopters destroyed",
                    ["STATS_PSULFUR"] = "Sulfur produced",
                    ["STATS_PWOOD"] = "Wood produced",
                    ["STATS_PMETALL"] = "Mined metal",
                    ["STATS_PSTONE"] = "Quarried stone",
                    ["STATS_PTIME"] = "Time playing",
                    ["STATS_GOTOGENERAL"] = "Go to general statistics",
                    ["STATS_GOTODASHBOARD"] = "Statistics Dashboard",
                    ["STATS_GOTOPERSONAL"] = "Go to personal statistics",
                    ["STATS_GENERALSTATISTIC"] = "General statistics",
                    ["STATS_SORT"] = "Sort by",
                    ["STATS_INFO"] = "Info",
                    ["STATS_PSTATS"] = "Player stats",
                    ["STATS_SKILL"] = "● The killings",
                    ["STATS_SDEATH"] = "● To death",
                    ["STATS_SKILLINGANIMALS"] = "● Killing animals",
                    ["STATS_SSULFUR"] = "● Sulfur mining",
                    ["STATS_SSTONE"] = "● Stone mining",
                    ["STATS_SMETAL"] = "● Metal mining",
                    ["STATS_SWOOD"] = "● Wood mining",
                    ["STATS_SHELI"] = "● Destroyed helicopters",
                    ["STATS_STANK"] = "● Destroyed tanks",
                    ["STATS_STIME"] = "● Playing times",
                    ["STATS_BLOCKDATA"] = "Choose a player to block data collection for him"
                };
                
                Dictionary<string, string> LangRU = new Dictionary<string, string>
                {
                    ["STATS_KILLS"] = "Убийства",
                    ["STATS_DEATHS"] = "Смертей",
                    ["STATS_ANIMALKILLS"] = "Убийств животных",
                    ["STATS_DTANK"] = "Уничтожено танков",
                    ["STATS_DHELI"] = "Уничтожено вертолётов",
                    ["STATS_PSULFUR"] = "Добыто серы",
                    ["STATS_PWOOD"] = "Добыто дерева",
                    ["STATS_PMETALL"] = "Добыто металла",
                    ["STATS_PSTONE"] = "Добыто камня",
                    ["STATS_PTIME"] = "Наигранно времени",
                    ["STATS_GOTOGENERAL"] = "ПЕРЕЙТИ В ОБЩУЮ СТАТИСТИКУ",
                    ["STATS_GOTODASHBOARD"] = "ПАНЕЛЬ УПРАВЛЕНИЯ СТАТИСТИКОЙ",
                    ["STATS_GOTOPERSONAL"] = "ПЕРЕЙТИ В ЛИЧНУЮ СТАТИСТИКУ",
                    ["STATS_GENERALSTATISTIC"] = "ОБЩАЯ СТАТИСТИКА",
                    ["STATS_SORT"] = "ОТСОРТИРОВАТЬ ПО",
                    ["STATS_INFO"] = "ИНФО",
                    ["STATS_PSTATS"] = "СТАТИСТИКА ИГРОКА",
                    ["STATS_SKILL"] = "● Убийствам",
                    ["STATS_SDEATH"] = "● Смертям",
                    ["STATS_SKILLINGANIMALS"] = "● Убийствам животных",
                    ["STATS_SSULFUR"] = "● Добыче серы",
                    ["STATS_SSTONE"] = "● Добыче камня",
                    ["STATS_SMETAL"] = "● Добыче металла",
                    ["STATS_SWOOD"] = "● Добыче дерева",
                    ["STATS_SHELI"] = "● Уничтоженным вертолётам",
                    ["STATS_STANK"] = "● Уничтоженным танкам",
                    ["STATS_STIME"] = "● Наигранному времени",
                    ["STATS_BLOCKDATA"] = "Выберите игрока, чтобы заблокировать сбор данных для него"
                };

                lang.RegisterMessages(LangEN, this, "en");
                lang.RegisterMessages(LangRU, this, "ru");
                PrintWarning("Lang file loaded");
            });
        }
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 35,
                        Text = lang.GetMessage("STATS_GOTODASHBOARD", this, player.UserIDString),
                        Font = regular
                    },
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        Color = HexToRustFormat("#EAEAEAFF"),
                        FontSize = 25,
                        Text = lang.GetMessage("STATS_BLOCKDATA", this, player.UserIDString),
                        Font = regular
                    },
                    new CuiRectTransformComponent
                    {
        ...
        void MainGui(BasePlayer player)
        {
            ...
            Gui.Add(new CuiButton
            {
                ...
                Text =
                {
                    ...
                    Color = HexToRustFormat("#EAEAEAFF"),
                    FontSize = 18,
                    Text = $"{lang.GetMessage("STATS_GOTOGENERAL", this, player.UserIDString)}\n▼"
                },
                RectTransform =
                {
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_KILLS", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_DEATHS", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_ANIMALKILLS", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 17,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_DTANK", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 17,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_DHELI", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PSULFUR", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PSTONE", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PMETALL", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PWOOD", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PTIME", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
        ...
        void InfoPlayer(ulong steamid, ulong initiator)
        {
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        Color = HexToRustFormat("#EAEAEAFF"),
                        FontSize = 40,
                        Text = $"{lang.GetMessage("STATS_PSTATS", this, initiator.ToString())} : {DB.Name}"
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.9213709",
            ...
            Gui.Add(new CuiButton
            {
                ...
                Text =
                {
                    ...
                    Color = HexToRustFormat("#EAEAEAFF"),
                    FontSize = 18,
                    Text = $"{lang.GetMessage("STATS_GOTOGENERAL", this, initiator.ToString())}\n▼"
                },
                RectTransform =
                {
                    AnchorMin = "0.3665158 0.01108896",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_KILLS", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_DEATHS", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_ANIMALKILLS", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 17,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_DTANK", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 17,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_DHELI", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PSULFUR", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PSTONE", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PMETALL", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PWOOD", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
            ...
            Gui.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        FontSize = 18,
                        Color = HexToRustFormat("#CBCBCBFF"),
                        Text = lang.GetMessage("STATS_PTIME", this, steamid.ToString())
                    },
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0 0.5300055",
        ...
        void ServerTOP(BasePlayer player, int filter)
        {
            ...
            GUI.Add(new CuiButton
            {
                ...
                Text =
                {
                    ...
                    Color = HexToRustFormat("#EAEAEAFF"),
                    FontSize = 18,
                    Text = $"{lang.GetMessage("STATS_GOTOPERSONAL", this, player.UserIDString)}\n▼"
                },
                RectTransform =
                {
                    AnchorMin = "0.3665158 0.01108896",
            ...
            GUI.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        Color = HexToRustFormat("#EAEAEAFF"),
                        FontSize = 40,
                        Text = lang.GetMessage("STATS_GENERALSTATISTIC", this, player.UserIDString)
                    },
                    new CuiRectTransformComponent
                    {
                ...
                if (config.ZealStatistics.info == true)
                {
                    GUI.Add(new CuiButton
                    {
                        ...
                        Text =
                        {
                            ...
                            FontSize = 15,
                            Color = HexToRustFormat("#EAEAEAFF"),
                            Text = lang.GetMessage("STATS_INFO", this, player.UserIDString)
                        },
                        RectTransform =
                        {
        ...
        void DrawFilters(BasePlayer player)
        {
            ...
            GUI.Add(new CuiButton
            {
                ...
                Text =
                {
                    ...
                    FontSize = 16,
                    Text = $"<size=15>{lang.GetMessage("STATS_SORT", this, player.UserIDString)}</size> ▼"
                },
                RectTransform =
                {
                    ...
                    GUI.Add(new CuiButton
                        {
                            ...
                            Text =
                            {
                                ...
                                Color = HexToRustFormat("#8E8E8EFF"),
                                FontSize = 14,
                                Text = $"{lang.GetMessage(Filter.Name, this, player.UserIDString)}",
                                Font = "robotocondensed-regular.ttf",
                                FadeIn = 0.1f + (y * 0.1f)
                            },
                            RectTransform =
        ...
        void OnServerInitialized()
        {
            ...
            {
                PrintError($"Plugin [ImageLibrary] not install");
            ...
            Puts("----------------------Contacts----------------------");
            Puts(" ");
            Puts(" VK : vk.com/kira_22001");
            Puts(" Discord : -Kira#1920");
            Puts(" VK Group : vk.com/skyeyeplugins");
            Puts(" ");
            Puts("---^-^----Good Luck----^-^---");
            Puts(" ");
            ...
            foreach (var player in BasePlayer.activePlayerList)
            {
                if (!DataBase.StatisticDB.ContainsKey(player.userID))
                {
                    if (!player.userID.IsSteamId()) return;
                    AddPlayer(player);
                    Puts($"Player add to database {player.displayName}");
                }
            }
        }
