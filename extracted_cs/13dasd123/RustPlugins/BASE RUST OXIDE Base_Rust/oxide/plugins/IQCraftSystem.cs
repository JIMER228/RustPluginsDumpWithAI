...
{
    [Info("IQCraftSystem", "oxide russia", "0.0.8")]
    ...
    class IQCraftSystem : RustPlugin
    {
                ...
                Components =
                    {
                        ...
                        new CuiRectTransformComponent{ AnchorMin = "0.96250012551 0.9351854", AnchorMax = "0.9958335 0.9944444" },  
                    }
            });
        ...
        void LoadedCategory(BasePlayer player)
        {
            ...
            {
                FadeOut = FadeOut, 
                RectTransform = { AnchorMin = "0.309375 0.833332551", AnchorMax = "0.5677084 0.8787037" }, 
        ...
        void LoadedItems(BasePlayer player, CategoryItem SortCategory = CategoryItem.All, int SlotActive = 0)
        {
            ...
            {
                FadeOut = FadeOut, 
                RectTransform = { AnchorMin = "0.309375 0.144442551", AnchorMax = "0.5677084 0.8296297" },  
                Image = { FadeIn = FadeIn, Color = "0 0 0 0" }
