...
namespace Oxide.Plugins
{
    ...
    class Remove : RustPlugin
    {
        ...
        {
            if (plugins.Exists("Clans")) return (bool)(Clans?.Call("IsTeammate", playerID, targetID) ?? false);
            return false;
        }
        bool IsFriends(ulong playerID, ulong friendId, ulong playerid = 1)
        {
        ...
        object OnHammerHit(BasePlayer player, HitInfo info)
        {
            ...
            switch (activePlayers[player.userID])
            {
                ...
                case "admin":
                    ...
                    return true;
                case "normal":
                    if (entity.ShortPrefabName.Contains("recycler")) return false;
        ...
        private static class NumericalFormatter
        {
            ...
            public static string FormatTime(int seconds, object player) => FormatTime(new TimeSpan(0, 0, seconds), IsEng(player));
