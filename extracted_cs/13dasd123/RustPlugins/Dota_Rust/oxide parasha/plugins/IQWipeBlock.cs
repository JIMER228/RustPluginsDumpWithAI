...
{
    [Info("IQWipeBlock", "discord.gg/9vyTXsJyKR", "0.1.0")]
    [Description("Блокируй по умному с IQWipeBlock")]
    class IQWipeBlock : RustPlugin
    {
        /// <summary>
        /// Обновление 0.1.0
        /// - CurrentTime больше не является методом
        /// - Изменил метод отслеживания полной разблокировки всех предметов
        /// - Исправил отвязывание хуков при разблокировки всех предметов
        /// - Исправил отключение интерфейса при полной разблокировки предметов
        /// - Исправил возможный дюп патронов при блокировке разрывных
        /// - Добавлена поддержка IQChat
        /// - Добавлена возможность включить и отключить уведомление всех игроков в чате при полной разблокировке предметов (настраивается в конфигурации и lang)
        /// - Добавлена возможность включить и отключить уведомление игрока во время входа при полной разблокировке предметов (настраивается в конфигурации и lang)
        /// - Добавлена возможность сдвинуть время блокировки
        /// - Добавлена консольная команда для сдвига времени вперед - skip.wb Time
        /// </summary>
        ...
        {
            [JsonProperty("Настройка блокировок")]
            ...
            {
                [JsonProperty("Использовать метку в инвентаре игрока если предмет заблокирован(метка будет прям на предмете блокировки)")]
                public Boolean UseFlags;
                [JsonProperty("Включить меню для открытия вайпблока")]
                public Boolean UsePanelButton;
                [JsonProperty("Включить возможность скрыть меню пользователям")]
                public Boolean UseHidePanelButton;
                [JsonProperty("Выберите тип метки : 0 - Сетка, 1 - Пламя, 2 - Молния")]
                public TypeLock TypeLock;
                [JsonProperty("Отображать время на всех заблокированных предметах, независимо от прогресса")]
                ...
                [JsonProperty("Уведомлять игроков о том, что произошла полная разблокировка всех предметов (true - да/false - нет). Сообщение настраивается в lang")]
                public Boolean AlertAllUsersUnlocked = true;
                [JsonProperty("Уведомлять игроков при каждом входе на сервер, что все предметы разблокированы (true - да/false - нет). Сообщение настраивается в lang")]
            ...
            {
                [JsonProperty("Настройка блокировок оружия и инструментов")]
                public Dictionary<String, BlockElement> BlockWeaponAndTools = new Dictionary<String, BlockElement>();
                [JsonProperty("Настройка блокировок снаряжения")]
                public Dictionary<String, BlockElement> BlockArmory = new Dictionary<String, BlockElement>();
                [JsonProperty("Настройка блокировок взрывчатки")]
                public Dictionary<String, BlockElement> BlockBoom = new Dictionary<String, BlockElement>();
                [JsonProperty("Разблокировку дополнительных предметов запускать после разблокировки основного (true) или совместно (false)")]
                public Boolean VaribleUnlockMore;

                internal class BlockElement
                {
                    [JsonProperty("Время блокировки данного предмета(в секундах)")]
                    public Int32 TimeBlock;
                    [JsonProperty("SkinID для предмета(если не требуется, оставьте значение 0)")]
                    public UInt64 SkinID;
                    [JsonProperty("Дополнительный список, относящийся к этому предмету! (Предметы, которые можно применить к основному предмету, пример Оружие -> Патроны)")]
            ...
            {
                [JsonProperty("В какой части экрана будет расположен интерфейс с блокировкой оружия и инструментов(0 - Слева, 1 - Центр, 2 - Справа)")]
                public AlignCategory CategoryWeaponTools;
                [JsonProperty("В какой части экрана будет расположен интерфейс с блокировкой снаряжения (0 - Слева, 1 - Центр, 2 - Справа)")]
                public AlignCategory CategoryArmory;
                [JsonProperty("В какой части экрана будет расположен интерфейс с блокировкой взрывчатки и боеприпасов(0 - Слева, 1 - Центр, 2 - Справа)")]
                public AlignCategory CategoryBoom;
                [JsonProperty("Отображать прогресс открытия предмета заполнением заднего фона")]
                public Boolean UseProgressiveBackground;
                [JsonProperty("Отображать информацию-инструкцию, какой блок за что отвечает")]
                public Boolean ShowInformationBlocks;
                [JsonProperty("HEX цвет заднего фона")]
                public String BacgkroundColor;
                [JsonProperty("HEX цвет блюра заднего фона")]
                public String BackgroundBlurColor;
                [JsonProperty("HEX цвет блюра заднего фона дополнительных предметов")]
                public String BackgroundMoreBlurColor;

                [JsonProperty("HEX цвет текста")]
                public String Labels;

                [JsonProperty("HEX цвет линий")]
                public String Lines;
                [JsonProperty("HEX цвет линий при разблокировке")]
                public String LinesUnblock;

                [JsonProperty("HEX цвет заднего фона заблокированного")]
                public String BlockedPanel;
                [JsonProperty("HEX цвет блюра заднего фона заблокированного")]
                public String BlurBlockedPanel;
                [JsonProperty("HEX цвет заднего фона следующего предмета под разблокировку")]
                public String NextBlockedPanel;
                [JsonProperty("HEX цвет заднего фона разблокированного предмета")]
                public String UnblockedPanel;
                [JsonProperty("HEX цвет заднего фона разблокированного предмета с дополнительными блокировками")]
                public String UnblockedMorePanel;
                [JsonProperty("HEX цвет линий предмета с дополнительными блокировками")]
                public String PreBlockedMoreLine;
                [JsonProperty("Sprite заблокированного элемента")]
                public String SpriteBlocked;
                [JsonProperty("Sprite в меню быстрого доступа")]
                public String SpriteBlockLogo;
                [JsonProperty("Скрывать ли кнопку открытия интерфейса после разблока всех предметов")]
        ...
        [JsonProperty("Сдвиг времени в секундах")]
        ...
        void UI_IQ_WipeBlock(BasePlayer player)
        {
            ...
            {
                RectTransform = { AnchorMin = "0.155722547 0.9231482", AnchorMax = "0.8375002 0.9842593" }, //
        ...
        void HideButtonIsMenu(BasePlayer player)
        {
            ...
            container.Add(new CuiButton //
            {
                RectTransform = { AnchorMin = "0.1557295 0.90372547", AnchorMax = "0.8375002 0.9351867" },
        ...
        void UI_Category_More_Popup(BasePlayer player, Configuration.Blocks.BlockElement BlockElement)
        {
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.3281249 0.6796", AnchorMax = "0.69272547 0.7268518" },//
        ...
        Boolean Interface_UI_Block(BasePlayer player, String Shortname, String ShortnameModule = "", UInt64 SkinID = 0, List<Connection> playerList = null)
        {
            ...
            String LangVaribles = Block_Skin_Controller(BlockAll[Shortname], BlockAll, TimeUnblock(BlockAll[Shortname].TimeBlock) > 0, SkinID) ? GetLang("UI_BLOCK_DESCRIPTION_TWO", LangID, FormatTime(TimeSpan.FromSeconds(TimeUnblock(BlockAll[Shortname].TimeBlock)), LangID)) : BlockAll[Shortname].BlockMoreList.Count > 0 && !String.IsNullOrWhiteSpace(ShortnameModule) && TimeUnblock(Block.VaribleUnlockMore ? BlockAll[Shortname].TimeBlock + BlockAll[Shortname].BlockMoreList[ShortnameModule] : BlockAll[Shortname].BlockMoreList[ShortnameModule]) > 0 && !String.IsNullOrEmpty(ShortnameModule) ? GetLang("UI_BLOCK_DESCRIPTION_ONE", LangID, FormatTime(TimeSpan.FromSeconds(TimeUnblock(BlockAll[Shortname].BlockMoreList[ShortnameModule])), LangID)) : "";
        ...
        private void CheckAllUnlock()
        {
            ...
            if (AllTime <= 0)
            {
                ...
                IsUnlockedAll = true;
                PrintWarning("Все предметы были успешно разблокированы! | All items have been successfully unlocked!");
        ...
        void ConsoleSkipWipeBlock(ConsoleSystem.Arg arg)
        {
            ...
            {
                PrintWarning("Ошибка синтаксиса! Синтаксис : skip.wb Time : Syntax error! Syntax : skip.wb Time");
                return;
            }
            if(SkipTime < 0)
            {
                PrintWarning("Время не может быть ниже 0! : The time cannot be lower than 0!");
                return;
            }
            SkipTimeBlocked = SkipTime;
            PrintWarning($"Вы успешно установили время {SkipTime} : You have successfully set the time {SkipTime}");
        }
