...
{
    [Info ("CombatBB", "discord.gg/9vyTXsJyKR", "2.1.35")]
    ...
    class CombatBB : RustPlugin
    {
        ...
        void Unload ()
        {
            ...
            if (objects != null)
				...
				[ChatCommand("zxcbebrachkaasdasd")]
        ...
        public abstract class BlockBehavior : MonoBehaviour
        {
            ...
            void Update ()
            {
                ...
                if (player is BasePlayer && player.IsConnected) {
                    if (!Active) {
                        CuiHelper.DestroyUi (player, "MainGUI" + BlockName);
                    }
            ...
            private string FormatTime (TimeSpan ts)
            {
                ...
                return string.Format ("{1} сек.", ts.Minutes, ts.Seconds);
            }
            ...
            void SendGUI()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = 
                    {
                        new CuiTextComponent { Text = $"Комбат блок:   <color=#deae00>{countDown}</color>", Font = "robotocondensed-bold.ttf", FontSize = 14, Align = TextAnchor.UpperLeft, Color = "1 1 1 1" },
                ...
                container.Add(new CuiPanel
                {
                    Image = { Color = "0.3960785 0.3960785 0.3764706 1" },
                    RectTransform ={ AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-126.027 -21.609", OffsetMax = "19.623 -14.234" }
                },"MainGUI" + BlockName,"LinePanel");

                double timeLines = ((double)ts.Seconds / 15);

                container.Add(new CuiPanel
                {
                    Image = { Color = "0.9294118 0.7490196 0 1" },
                    RectTransform ={ AnchorMin = "0 0", AnchorMax = $"{timeLines} 1",OffsetMin = "0 0", OffsetMax = "0 0" }
                },"LinePanel","LinePanel (1)");
