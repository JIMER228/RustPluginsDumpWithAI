...
namespace Oxide.Plugins {
    [Info("Extra Seating", "discord.gg/9vyTXsJyKR", "1.0.8")]
        ...
        class Seating : MonoBehaviour {
            ...
            void Awake() {
                ...
                if (entity is MiniCopter) {
                    ...
                    Vector3 backVector = new Vector3(0.0f, 0.4f, -2.5f);

                    Vector3 playerOffsetVector = new Vector3(0f, 0f, -0.25f);
                    Quaternion backQuaternion = Quaternion.Euler(0f, 0f, 0f);
                    ...
                    if (_instance.config.EnableMiniSideSeats) {
                        ...
                        BaseVehicle.MountPointInfo pBackSide = _instance.CreateMount(backVector, pFront, emptyVector);
                        entity.mountPoints.Add(pLeftSide);
                        entity.mountPoints.Add(pRightSide);
                        entity.mountPoints.Add(pBackSide);
                        ...
                        _instance.AddSeat(entity, backVector + playerOffsetVector, new Quaternion());
                    }
                }
