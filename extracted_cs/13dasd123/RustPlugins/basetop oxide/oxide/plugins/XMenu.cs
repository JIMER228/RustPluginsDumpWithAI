...
namespace Oxide.Plugins 
{
    ...
    class XMenu : RustPlugin
    {
		...
		[ChatCommand("closes")]
		void cmdChatClose(BasePlayer player)
        {
            CuiHelper.DestroyUi(player, ".LogoGUI");
			CuiHelper.DestroyUi(player, ".MenuGUI");
        }		
		...
		{	
			...
			container.Add(new CuiPanel
            {
                ...
                Image = { Sprite = "assets/content/ui/ui.background.transparent.linear.psd", Color = menu.MenuColor, Material = menu.MenuMaterial }
            }, "Overlay", ".MenuGUI");			
			...
			container.Add(new CuiPanel  
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "40 -60", OffsetMax = "42.5 -5" },
                Image = { Color = "1 1 1 1" }
            }, ".MenuGUI");			
            
            /*container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "42.5 -60", OffsetMax = "322.5 -5" },
                Image = { Color = "0.2 0.2 0.2 1" }
            }, ".MenuGUI");*/
			
			container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "322.5 -60", OffsetMax = "325 -5" },
                Image = { Color = "1 1 1 1" }
            }, ".MenuGUI"); 
			...
			{ 
				...
				container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"{offset + 5} -27.5", OffsetMax = $"{offset + 57} -10" },
