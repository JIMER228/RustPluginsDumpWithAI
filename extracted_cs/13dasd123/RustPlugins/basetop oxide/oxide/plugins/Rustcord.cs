...
{
    [Info("Rustcord", "Kirollos & OuTSMoKE", "3.2.5")]
    [Description("Complete game server monitoring through discord.")]
    internal class Rustcord : RustPlugin
    {
        [PluginReference] Plugin PrivateMessages, BetterChatMute, Clans, AdminChat, DiscordAuth, AdminHammer, AdminRadar, Kits, Vanish, RaidableBases, DangerousTreasures, NoGiveNotices, Give;
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                { "PLUGIN_DangerousTreasures_Started", ":moneybag: Dangerous Treasure event has started at {gridtile} {position}."},
                { "PLUGIN_DangerousTreasures_Ended", ":moneybag: Dangerous Treasure event at {gridtile} has ended."},
        ...
        void cmdReport(BasePlayer player, string command, string[] args)
        {
            ...
            if (_settings.OutputFormat.OutputTypeReports == "Embed")
            {
                ...
                DiscordEmbedBuilder builder = new DiscordEmbedBuilder()
                                                  ...
                                                  .AddFooter($"Rustcord {this.Version}")
                                                  .AddNowTimestamp()
        ...
        private void OnDeauthenticate(IPlayer player, DiscordUser user)
        {
            if (player == null || user == null) return;
            if (_settings.OutputFormat.OutputTypeDiscordAuth == "Simple")
            {
