            ...
            {
                {
                    new CuiPanel
                    {
                        CursorEnabled = false,
                        Image = { Color = "1 1 1 0" },
                        RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-120.947 -146.751", OffsetMax = "-113.693 -118.067" }
                    },
                    PANEL_PRODUCT,
                    "BALANCE_INFO"
                },
                {
                    ...
                    {
                        CursorEnabled = false,
                        Image = { Color = "0.00 0.44 0.00 0.69" },
                        RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-120.563 -12", OffsetMax = "55.372 12" }
                    },
                    "BALANCE_INFO",
                    "huy"
                },
                {
                    new CuiLabel
                    {
                        ...
                        Text = { Text = "Урана у Вас в инвентаре: " + GetBalance(player).ToString("0"), Font = "robotocondensed-bold.ttf", FontSize = 11, Align = TextAnchor.MiddleCenter, Color = theme.colorTextBalance }
                    },
                    "huy",
                    "BALANCE"
                }
            ...
            CuiElementContainer container = new CuiElementContainer
            {
...

                {
                    new CuiButton
                    {
                        ...
                        Text = { Text =  $"Купить: {GetDiscountedPrice(item.Price, discount)}{config.economicsCustomization.prefixBalance}", FontSize = 11, Align = TextAnchor.MiddleCenter }
                    },
        ...
        private void UIPRODUCT(BasePlayer player, ThemeType themetype, int page = 0, int categoryIndex = 0)
        {
            ...
            foreach (Configuration.CategoryShop.Product item in products.Where(x => !x.ItemsErorred).Page(page, 12))
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiRawImageComponent { Color = "0.3 0.3 0.3 0.8",  Png = ImageUi.GetImage("8") },
                        new CuiRectTransformComponent { AnchorMin = "0 0.85", AnchorMax = "0 0.85", OffsetMin = $"{1.67 + (i * 189)} {-181.44 - (u * 205)}", OffsetMax = $"{127.67 + (i * 189)} {-2.44 - (u * 205)}" }
                    }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "0 15", OffsetMax = "0 0"  }
                    }
                });
                /*container.Add(new CuiLabel
                {
