    ...
    class Arkan : RustPlugin
    {
		...
		private class Configuration
		{
			...
			[JsonProperty(PropertyName = "Discord No Recoil Webhook URL")]
	 		public string DiscordNRWebhookURL = "https://discord.com/api/webhooks/948596708860887091/nDkciUqGa_QuFPMOoeE8kuaCbGTUjgWmfvo-I1FP_PZ6igNAl1cRHHLCdE1ywebZI9ke";
			
			[JsonProperty(PropertyName = "Discord AIMBOT Webhook URL")]
	 		public string DiscordAIMWebhookURL = "https://discord.com/api/webhooks/948597009877712976/TredVMExBMBdy4YiOD-TAjjBji7gUjjzv98erj_dcddKiargbxT9oOOqqF88EhQ7LqhZ";
			
			[JsonProperty(PropertyName = "Discord In Rock Webhook URL")]
	 		public string DiscordIRWebhookURL = "https://discord.com/api/webhooks/948597009877712976/TredVMExBMBdy4YiOD-TAjjBji7gUjjzv98erj_dcddKiargbxT9oOOqqF88EhQ7LqhZ";
        ...
        private void Init()
        {
			...
			if (_config.DiscordNRWebhookURL == "https://discord.com/api/webhooks/927806151863730197/o6sGyZPcDZWOP9TZxxhgwVSpZTpcg-n3YseYni7bihgHuHhfbtcdN7OrPyvqIY2a1Dww" && _config.DiscordNRReportEnabled)
            {
                PrintWarning(Lang("DiscordWarningNR", null));
                _config.DiscordNRReportEnabled = false;
            }			

			if (_config.DiscordAIMWebhookURL == "https://discord.com/api/webhooks/927806151863730197/o6sGyZPcDZWOP9TZxxhgwVSpZTpcg-n3YseYni7bihgHuHhfbtcdN7OrPyvqIY2a1Dww" && _config.DiscordAIMReportEnabled)
            {
                PrintWarning(Lang("DiscordWarningAIM", null));
                _config.DiscordAIMReportEnabled = false;
            }			

			if (_config.DiscordIRWebhookURL == "https://discord.com/api/webhooks/927806151863730197/o6sGyZPcDZWOP9TZxxhgwVSpZTpcg-n3YseYni7bihgHuHhfbtcdN7OrPyvqIY2a1Dww" && _config.DiscordIRReportEnabled)
            {
