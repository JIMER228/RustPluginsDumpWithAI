...
{
	/* Based on version 0.3.5 by HOUGAN & Sstine */
    [Info("GameStoresRUST", "HOUGAN & Sstine # GAMESTORES | Nimant", "1.0.2")]
                    ...
                    case 200:
                        {
                            ...
                            if (firstInfo.ContainsKey("result"))
                            {
                                ...
                                else
                                {
                                    ...
                                    foreach (var check in data.Skip(page * 18).Take(18))
                                    {
                                    ...
                                    secondContainer.Add(new CuiLabel
                                    {
                                        RectTransform = { AnchorMin = "0 0", AnchorMax = "1 0.42", OffsetMax = "0 0" },
                                    ...
                                    {
                                        RectTransform = { AnchorMin = "0.4 0.14", AnchorMax = "0.4 0.4", OffsetMin = "-40 -125", OffsetMax = "125 40" },
                                    ...
                                    secondContainer.Add(new CuiButton
                                    {
                                        RectTransform = { AnchorMin = "0.6 0.14", AnchorMax = "0.6 0.4", OffsetMin = "-125 -125", OffsetMax = "40 40" },
                                        Button = { Color = "0 0 0 0", Material = "", Command = (page + 1) * 18 < data.Count ? $"UI_GameStoresRUST page {page + 1}" : "" },
                                        Text = { Text = ">", Color = (page + 1) * 18 < data.Count ? "1 1 1 1" : "1 1 1 0.2", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 80 }
                                    }, StoreLayer + ".BlockPanel");
