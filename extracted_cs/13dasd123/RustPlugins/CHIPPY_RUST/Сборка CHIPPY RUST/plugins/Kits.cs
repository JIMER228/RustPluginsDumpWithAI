...
namespace Oxide.Plugins
{
    ...
    class Kits : RustPlugin
    {
        ...
        {
            SaveData();
            foreach (var plobj in BasePlayer.activePlayerList) DestroyUI(plobj);
            InvokeHandler.Instance.CancelInvoke(RefreshCooldownKitsUI);
        }
        ...
        private void OnServerInitialized()
        {
           ...
           InvokeHandler.Instance.InvokeRepeating(RefreshCooldownKitsUI, 1, 1);
        }
        void CheckKits()
        {
            kitsList.ForEach(kit =>
        ...
        private void InitilizeUI(BasePlayer player, int page)
        {
            ...
            {
                Image = {
                    Color="0.19 0.19 0.18 0", /*Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" */
				}
                ,
                RectTransform = {
        ...
        private void InitilizeKitsUI(BasePlayer player, int page = 0)
        {
            ...
            {
                RectTransform = { AnchorMin = "0.9656251 0.9435185", AnchorMax = "0.9960139 0.9938782" },
                Button = { Color = "0 0 0 0", Close = "ui.kits" },
                Text = { Text = "X", FontSize = 14, Align = TextAnchor.MiddleCenter, Color = "1 1 1 1", Font = "robotocondensed-bold.ttf" }
            }, "ui.kits");
            ...
            if (kits.Count > 0) foreach (var kit in kits)
                {
                    ...
                    {
                        Button = {
                        Color="0.24 0.24 0.24 1.00", Command=$"kit.drawkitinfo {kit.Name} {page}", Material = "assets/content/ui/uibackgroundblur.mat",
					}
                        ,
                        RectTransform = {
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        new CuiTextComponent {
                            FadeIn=0.1f, Color="1 1 1 0.5", Text=GetMsg("UI READ", player).ToUpper(), FontSize=16, Font="robotocondensed-regular.ttf", Align=TextAnchor.MiddleCenter,
                        }
                        , new CuiRectTransformComponent {
                            AnchorMin=$"0 0", AnchorMax=$"1 1"
                        }
            ...
            if (player.IsAdmin)
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    ,
                    RectTransform = {
                        AnchorMin="0.03 0.2", AnchorMax="0.12 0.8"
                    }
                    ,
                }
                , "kits.adminSettings");
        ...
        private void InitilizeCooldown(ref CuiElementContainer container, BasePlayer player, Kit kit, int page)
        {
            ...
            {
                Image = {
                    Color="0.24 0.24 0.24 0.88", /*Material= "assets/content/ui/ui.background.tile.psd", */
				}
                ,
                RectTransform = {
                    AnchorMin=$"0 0", AnchorMax=$"1 1"
        ...
        void DrawKitInfo(BasePlayer player, Kit kit, int page)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    , new CuiRectTransformComponent {
                        AnchorMin=$"0 0.69", AnchorMax=$"1 0.89"
                    }
                    , new CuiOutlineComponent {
                        Color="0 0 0 0.3", Distance="-0.5 0.5"
                    }
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    , new CuiRectTransformComponent {
                        AnchorMin=$"0 0.09074078", AnchorMax=$"1 0.3907408"
                    }
                    , new CuiOutlineComponent {
                        Color="0 0 0 0.3", Distance="-0.5 0.5"
                    }
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiRawImageComponent {
                                                       Png =!string.IsNullOrEmpty(item.A.CustomImage) ? GetImage(item.A.CustomImage) :  item.A.ShortName == "mailbox"? GetImage("mailbox_1812087291") : GetImage(item.A.ShortName),
