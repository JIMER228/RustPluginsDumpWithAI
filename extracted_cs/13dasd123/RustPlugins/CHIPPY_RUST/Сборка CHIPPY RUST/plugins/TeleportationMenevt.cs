...
{
    [Info("Teleportation", "Menevt", "1.5.2")]
    class TeleportationMenevt : RustPlugin
    {
        ...
        bool IsClanMember(ulong playerid = 5824512, ulong targetID = 0)
        {
