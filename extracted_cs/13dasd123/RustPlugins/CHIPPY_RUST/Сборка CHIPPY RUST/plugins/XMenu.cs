        ...
        {		
			...
			public static MenuConfig GetNewConfiguration()
            {
                return new MenuConfig
                {
					...
					{
			            ["chat.say /capsules"] = "assets/icons/open.png",
			            ["chat.say /capsules"] = "assets/icons/community_servers.png",
			            ["chat.say /capsules"] = "assets/icons/market.png"
					},
