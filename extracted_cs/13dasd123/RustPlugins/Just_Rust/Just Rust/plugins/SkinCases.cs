        ...
        private void UI_DrawCaseInventory(BasePlayer player, int page = 0)
        {
            ...
            container.Add(new CuiLabel
            {
                ...
                Text = {Text = "Вы получаете <b>простой кейс</b>, каждые 24 часа, просто играя на сервере!\n" +
                        "Если хотите больше кейсов, они ждут вас на сайте JustRust.ru", Align = TextAnchor.UpperCenter, Font = "robotocondensed-regular.ttf", Color = "1 1 1 0.7"}
            }, Layer); 
            ...
            if (PlayerInventories[player.userID].Inventory.Count == 0)
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    Text = { Text = $"У ВАС НЕТУ ПРЕДМЕТОВ\n" +
                                    ...
                                    $"<size=16>ЗАХОДИТЕ НА САЙТЕ JUSTRUST.RU И НАЙДЁТЕ ТАМ БОЛЬШЕ КЕЙСОВ</size>", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 34 }
                }, Layer + ".SkinsHandler");
