                ...
                Components =
                        {
                            ...
                            {
                                Text = $"<color=#90BD47>Список ваших привилегий</color>",
                    ...
                    { 
                        Container.Add(new CuiElement
                        {
                            ...
                            Components =
                            {
                                new CuiTextComponent
                                {
                                    Text = $"{j}. <color=#90BD47>" + (NicePerms.ContainsKey(player.Groups.ElementAt(i).Value) ? NicePerms[player.Groups.ElementAt(i).Value] : player.Groups.ElementAt(i).Value) + "</color> до " + player.Groups.ElementAt(i).ExpireDate.ToString("dd/MM/yyyy HH:mm"),
