                ...
                Components =
                        {
                            new CuiTextComponent
                            {
                                Text = $"<color=#fff9f9AA>ДОБРО ПОЖАЛОВАТЬ НА СЕРВЕР\n<size=58><b>ЖИРНЫЙ <color=#D04425>RUST</color> X20</b></size>\nОзнакомиться с сервером, узнать команды, особенности и другую полезную информацию вы сможете в данном меню.\nОбязательно прочитайте правила сервера!\n\nIP-Адрес сервера: <color=#FFAA00AA>37.230.162.214:7777</color>\nНаш магазин: <color=#FFAA00AA>http://www.TRASHRUST.ru</color>\nНаша группа ВК: <color=#FFAA00AA>http://vk.com/TRASHRUST.ru</color></color>",
