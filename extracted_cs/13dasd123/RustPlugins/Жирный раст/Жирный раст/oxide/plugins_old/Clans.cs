...
{
    [Info("Clans", "OxideBro - RustPlugin.ru", "1.0.2", ResourceId = 14)]
    public class Clans : RustPlugin
    {
        ...
        void OnServerInitialized()
        {
			...
			TimerInitialize = timer.Every(5f, () =>
            {
                if (XMenu.IsLoaded)
                {
                    XMenu.Call("API_RegisterMenu", this.Name, "CLANS", "assets/icons/ignite.png", "RenderClans", null);

                    cmd.AddChatCommand("clans", this, (p, cmd, args) => rust.RunClientCommand(p, "custommenu true CLANS"));
        ...
        private void RenderClans(ulong userID, object[] objects)
        {
            ...
            NewClanUI(BasePlayer.FindByID(userID), Container);
        }
		
        void NewClanUI(BasePlayer player, CuiElementContainer container)
        {
            var clan = findClanByUser(player.UserIDString);
            if (clan == null)
			{
					...
					Components =
								{
									new CuiTextComponent {
										Color = "1 1 1 1", Text = $"<color=#FFFFFFB3>КЛАНОВАЯ СИСТЕМА СЕРВЕРА\nВы не состоите ни в одном клане,\n чтобы включить кланы требуется его создать!\n\n\nКоманда для создания клана: </color><color=#FFAA00>/clan create тэг</color>\n<color=#FFFFFFB3>Команда для вступления в клан: </color><color=#FFAA00>/clan join тэг</color>", Align = TextAnchor.MiddleCenter,  FontSize = 35 },
                ...
                Components =
                            {
                                ...
                                new CuiRectTransformComponent{ AnchorMin = $"0.4 0.87", AnchorMax = $"1 0.92" },
                            }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiButtonComponent { Color = "0 0 0 0", Close = MainLayer},
                                new CuiRectTransformComponent{ AnchorMin = $"0 0", AnchorMax = $"1 1" },
                            }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                            {
                                new CuiTextComponent {
                                    Color = "1 1 1 1", Text =  "ДОПОЛНИТЕЛЬНАЯ ИНФОРМАЦИЯ", Align = TextAnchor.UpperCenter, Font = "robotocondensed-regular.ttf", FontSize = 16 },
                                new CuiRectTransformComponent{ AnchorMin = $"0 0.08", AnchorMax = $"1 0.13" },
                            }
            });
        ...
        void cmdUIClan(ConsoleSystem.Arg args)
        {
            ...
            switch (args.Args[0])
            {
                case "edit":
                    ...
                    container.Add(new CuiButton
                    {
                        Button = { Color = "0 0 0 0.5", Command = command, Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
                ...
                case "member":
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        Components =
                    {
                        new CuiImageComponent {Color = "0 0 0 0.95", Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
                    });
                    ...
                    container.Add(new CuiButton
                    {
                        ...
                        Text = { Text = $"статистика", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 10 },
                    ...
                    if (clan.IsOwner(player.UserIDString) && user != player.UserIDString)
                    {
                        container.Add(new CuiButton
                        {
                            ...
                            Text = { Text = $"выгнать", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 10 },
        ...
        void CreatePlayerInfo(BasePlayer player, Clan clan, PlayerStats stats, string userID)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiButtonComponent {Color = "0 0 0 0", Command = $"UI_CLAN close UICLAN_stats UICLAN_member"},
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
            });
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = $"УБИЙСТВ\n<size=12>{stats.Killed}</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 12},
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = $"СМЕРТЕЙ\n<size=12>{stats.Death}</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 12},
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = $"СБИТО ВЕРТОЛЁТОВ\n<size=12>{stats.KilledHeli}</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 12},
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = $"СУИЦИДОВ\n<size=12>{stats.Suicide}</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 12},
            ...
            foreach (var item in stats.GatherInfo)
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent { Text = $"{name}\n<size=10>{item.Value}</size>", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", FontSize = 10},
        ...
        void cmdClanOverview(BasePlayer player)
        {
            ...
            sb.Append($"<size=14><color={pluginPrefixColor}>Кланы:</color></size>{Messages}");
			...
			rust.RunClientCommand(player, "custommenu true CLANS");
            //NewClanUI(player);
        ...
        void cmdClanCreate(BasePlayer player, string[] args)
        {
            ...
            myClan = Clan.Create(args[1], args.Length > 2 ? args[2] : string.Empty, current.Id, current.Name, "https://gspics.org/images/2020/05/16/NSTfL.png");
        ...
        void cmdClansGetSkinList(ConsoleSystem.Arg args)
        {
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiButtonComponent {Color = "0 0 0 0.85" ,Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat", Command = $"UI_CLAN close clans_skinlist1 UICLAN_edit"},
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
            });
        ...
        void cmdSetChangeOfClan(ConsoleSystem.Arg args)
        {
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiRawImageComponent {Color = "0 0 0 0.85",  Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
            });
        ...
        void cmdChatSkinOfClan(ConsoleSystem.Arg args)
        {
            ...
            rust.RunClientCommand(player, "custommenu false CLANS");
			//NewClanUI(player);
        }
...
'\n'
        ...
        void cmdChatClanInfo(BasePlayer player, string command, string[] args)
        {
            ...
            var sb = new StringBuilder();
            string Messages = pluginPrefixREBORNShow == true ? $"<size=14><color= {pluginPrefixREBORNColor}>REBORN\n</color></size>" : "\n";
            sb.Append($"<size=15><color={pluginPrefixColor}>{this.Title}</color></size>{Messages}");
