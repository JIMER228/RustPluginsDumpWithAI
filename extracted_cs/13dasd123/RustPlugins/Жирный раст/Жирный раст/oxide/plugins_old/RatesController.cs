...
{
    [Info("RatesController", "Vlad-00003", "3.0.4")]
    ...
    class RatesController : RustPlugin
    {
        ...
        private Dictionary<uint,string> _quarryOwners = new Dictionary<uint, string>();
        ...
        private class LootController : FacepunchBehaviour
        {
            ...
            private ItemContainer CopyInventory()
            {
                var container =new ItemContainer
                {
                    ...
                    onlyAllowedItem = _lootContainer.inventory.onlyAllowedItem,
        ...
        {
            string owner;
            if (quarry.OwnerID != 0 || !_quarryOwners.TryGetValue(quarry.net.ID, out owner))
