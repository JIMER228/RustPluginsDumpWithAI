...
{
    [Info("Arena Slasher", "k1lly0u", "2.0.9"), Description("Slasher event mode for Arena")]
    class ArenaSlasher : RustPlugin, IEventPlugin
    {
        ...
        {
            if (env == null || player == null || !EventPlayers.TryGetValue(player, out SlasherEvent slasherEvent) || slasherEvent == null)
                return null;
