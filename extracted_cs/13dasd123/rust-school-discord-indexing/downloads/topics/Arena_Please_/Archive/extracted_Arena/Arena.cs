...
namespace Oxide.Plugins
{
    ...
    [Info("Arena", "k1lly0u", "2.0.38"), Description("The core mechanics for arena combat games")]
    public class Arena : RustPlugin
    {
        ...
        public abstract class BaseEventGame : MonoBehaviour
        {
            ...
            internal List<BaseEventPlayer> joiningSpectators = Pool.Get<List<BaseEventPlayer>>();
        ...
        public class BaseEventPlayer : MonoBehaviour
        {
            ...
            protected List<ulong> _damageContributors = Pool.Get<List<ulong>>();
