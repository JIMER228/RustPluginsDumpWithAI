...
{
    [Info("AdminHammer2", "mvrb", "1.13.0")]
    class AdminHammer2 : RustPlugin
    {
        public static AdminHammer2 plugin;
        ...
        private string toolUsed = "toolgun";
        ...
        {
            Config["LogToConsole"] = logToConsole = GetConfig("LogToFile", false);
            ...
            Config["ToolUsed"] = toolUsed = GetConfig("ToolUsed", "toolgun");
