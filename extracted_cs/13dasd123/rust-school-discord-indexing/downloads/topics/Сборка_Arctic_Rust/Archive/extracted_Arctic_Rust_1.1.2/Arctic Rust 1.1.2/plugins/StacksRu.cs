...
namespace Oxide.Plugins
{
	...
	public class StacksRu : RustPlugin
	{
		...
		private static StacksRu _instance;

		private const string Layer = "UI.Stacks";

		private const string AdminPerm = "stacksru.admin";
		...
		private class Configuration
		{
			...
			[JsonProperty(PropertyName = "Изменение множителей в контейнерах при помощи киянки")]
			public bool UserHammer = false;

			[JsonProperty(PropertyName = "Стандартный множитель для новых контейнеров")]
			public readonly float DefaultContainerMultiplier = 1f;

			[JsonProperty(PropertyName = "Заблокированный список")]
		...
		private class BlockList
		{
			...
			[JsonProperty(PropertyName = "Скины", ObjectCreationHandling = ObjectCreationHandling.Replace)]
