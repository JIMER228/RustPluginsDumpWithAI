...
namespace Oxide.Plugins
{
    ...
    public class InventoryCleaner : RustPlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                [MessageKey.NoPermission] = "У вас нет разрешения <color=#FF0000>{0}</color> на выполнение этого действия!",
                [MessageKey.NotFound] = "Команда <color=red>{0}</color> не найдена!",
                [MessageKey.OptNotFound] = "Опция <color=red>/clearinv {0}</color> не найдена!",
                [MessageKey.CorrectUse] = "Правильное использование: <color=green>/clearinv [команда]</color>",
                [MessageKey.BeltCleaned] = "{0}, ваш пояс только что был очищен!",
                [MessageKey.EveryBeltCleaned] = "Пояс всех игроков, находящихся на сервере, только что был отчищен!",
                [MessageKey.InvCleaned] = "{0}, ваш инвентарь только что был очищен!",
                [MessageKey.EveryInvCleaned] = "Инвентарь всех игроков, находящихся на сервере, только что был отчищен!",
                [MessageKey.WearCleaned] = "{0}, ваши слоты одежды только что были очищены!",
                [MessageKey.EveryWearCleaned] = "Слоты одежды всех игроков, находящихся на сервере, только что были отчищены!",
                [MessageKey.AllCleaned] = "{0}, ваш инвентарь полностью очищен!",
                [MessageKey.EveryAllCleaned] = "Все предметы всех игроков на сервере только что были удалены!",
                [MessageKey.OnDeath] = "{0}, вы умерли и все, что у вас было, было удалено до вашей смерти!",
                [MessageKey.Header] = "<size=16><color=green>Очистка инвентаря от {0}</color></size> v{1} \n",
                [MessageKey.Gone] = "<color=#ff0000>Внимание:</color> После удаления предметы исчезают безвозвратно! \n\n",
                [MessageKey.Opts] = "Привет, базовая команда <color=green>/clearinv [opts]</color>, смотри опции:\n\n",
                [MessageKey.Perms] = "Привет <color=green>{0}</color>, вот ваши разрешения: \n",
                [MessageKey.OptAll] = "<color=yellow>main</color>: удалить все ваши предметы \n",
                [MessageKey.OptInv] = "<color=yellow>inv</color>: удалить все предметы из вашего инвентаря \n",
                [MessageKey.OptBelt] = "<color=yellow>belt</color>: удалить все предметы с вашего пояса \n",
                [MessageKey.OptWear] = "<color=yellow>wear</color>: удалить всю одежду из ваших слотов одежды \n\n",
                [MessageKey.OptEvery] = "А если у вас есть разрешение, вы можете использовать <color=red>/clearinv [opts] everyone</color> чтобы удалить предметы у всех, кто находится на сервере!",
                [MessageKey.PermUse] = "<color=yellow>Использование Clear:</color> {0} \n",
                [MessageKey.PermEvery] = "<color=yellow>Очистить Все:</color> {0} \n",
                [MessageKey.PermDeath] = "<color=yellow>Очистить при смерти:</color> {0} \n",
                [MessageKey.PermLogout] = "<color=yellow>Очистить при выходе:</color> {0} \n\n",
                [MessageKey.InvComands] = "Используйте <color=green>/clearinv cmds</color>, чтобы увидеть команды."
            }, this, "en"); ; ;
