...
namespace Oxide.Plugins
{
    ...
    class Obmen : RustPlugin
    {
        ...
        private Dictionary<string, string> images = new Dictionary<string, string>()
        {
            ...
            ["Image1"] = "https://www.rust-items.com/icons/298d95e4b3d13860d8cdf6a2c98b892d.png",
        ...
        private void DrawInterface(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = "KEEP RUST", Align = TextAnchor.MiddleCenter, FontSize = 40 }
            }, Layer);
