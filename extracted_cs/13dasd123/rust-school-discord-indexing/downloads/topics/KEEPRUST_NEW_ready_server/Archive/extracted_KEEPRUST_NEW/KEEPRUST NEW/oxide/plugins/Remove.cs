...
{
    [Info("Remove", "https://oxide-russia.ru/resources/338/", "1.5.25")]
    class Remove : RustPlugin
    {
        ...
        {
            PrintWarning("Благодарим за приобретение плагина на сайте Oxide-Russia.ru. Если вы приобрели этот плагин на другом ресурсе, знайте - это лишает вас гарантированных обновлений!");
        ...
        {
            [JsonProperty("Включить выключение авто-улучшения при включении режима удаления (Поддержка плагина BuildingUpgrade с сайта Oxide-Russia.ru)")]
            ...
            [JsonProperty("Включить поддержку NoEscape (С сайта Oxide-Russia.ru)")]
