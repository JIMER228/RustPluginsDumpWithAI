...
namespace Oxide.Plugins
{
    ...
    class IQRates : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {                       
                PrintWarning(LanguageEn ? "Error #358543" + $"read configuration 'oxide/config/{Name}', create a new configuration!!" : "Ошибка #358543" + $"чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!!"); //#333
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
        ...
        /// Обновление 1.4.8
        /// - Исправлены рейты на трупы NPC после обновления игры
        /// - Корректировки в методе со скоростью плавки печей
        /// - Добавлен черный список префабов (указывайте короткое имя префаба) - на которые не будут дейстовать рейтинги
        /// - Корректировка скорости плавки
        /// - Рейтинги по привилегиям на карьеры будут работать в оффлайн
