...
namespace Oxide.Plugins
{
    ...
    internal class IQTurret : RustPlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            {
                PrintWarning(LanguageEn ? $"Error #89285 configuration readings 'oxide/config/{Name}', creating a new configuration!" : $"Ошибка #89285 чтения конфигурации 'oxide/config/{Name}', создаём новую конфигурацию!"); //
                LoadDefaultConfig();
            }
            NextTick(SaveConfig);
        }
