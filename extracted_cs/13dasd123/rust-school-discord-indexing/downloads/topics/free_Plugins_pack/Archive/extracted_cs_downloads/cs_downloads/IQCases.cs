...
{ 
    [Info("IQCases", "Mercury", "2.4.74")]
    [Description("Кейсы на ваш сервер")]
    public class IQCases : RustPlugin
    {
        ...
        private new void LoadDefaultMessages()
        {
	        ...
	        lang.RegisterMessages(new Dictionary<string, string>
	        {
		        ...
		        ["UI_CASE_BUTTON_NO_OPEN_AMOUNT_CASE"] = "<b><size=17>НЕДОСТАТОЧНО КЕЙСОВ</size></b>",
	    ...
	    /// - Добавлена комнсольная команда, с помощью которой можно выдать кейсы всем игрокам на сервере : case.give.all KEY_CASE AMOUNT
	    /// Изменения :
	    ...
	    [PluginReference] Plugin ImageLibrary, IQEconomic, Economics, ServerRewards, IQChat, Battles, Duel, Duelist, ArenaTournament, AimTraining, XFarmRoom, IQRankSystem;
	    ...
	    {
		    DataPlayer = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<Dictionary<UInt64, InformationPlayer>>("IQSystem/IQCases/DataPlayer");
		    DataPlayerTakeGiftCase = Oxide.Core.Interface.Oxide.DataFileSystem.ReadObject<Dictionary<UInt64, List<String>>>("IQSystem/IQCases/DataPlayerTakeGiftCase");
	    }
	    private void WriteData()
	    {
		    Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("IQSystem/IQCases/DataPlayer", DataPlayer);
		    Oxide.Core.Interface.Oxide.DataFileSystem.WriteObject("IQSystem/IQCases/DataPlayerTakeGiftCase", DataPlayerTakeGiftCase);
	    }
	    ...
	    private class InterfaceBuilder
	    {
		    ...
		    private void Building_CaseMenu()
		    {
			    ...
			    }, "Overlay", UI_CASES_MENU);
			    
			    container.Add(new CuiButton
			    {
				    Button = { Color = "0 0 0 0", Command = "case.func close.case.menu" },
				    Text = { Text = "", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter, Color = "0 0 0 0" },
				    RectTransform =
				    {
					    AnchorMin = "-100 -100", AnchorMax = "100 100"
				    }
			    }, UI_CASES_MENU);
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-472.954 -83.327", OffsetMax = "-246.913 -67.606"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "287.387 -83.327",
						    OffsetMax = "386.879 -67.606"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "431.894 -83.327",
						    OffsetMax = "509.741 -67.606"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    new CuiTextComponent
					    {
						    ...
						    Align = TextAnchor.UpperLeft, Color = "0.2196078 0.8196079 0.6392157 1"
					    },
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-44.057 0",
						    OffsetMax = "71.133 13.083"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "387.793 257.067",
						    OffsetMax = "506.46 287.733"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-24.057 0",
						    OffsetMax = "51.133 13.083"
					    }
				    }
			    });
			    ...
			    if (_.IQEconomic || _.Economics)
			    {
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    ...
						    {
							    Color = "1 1 1 1",
							    Png = ImageUi.GetImage(config.InterfaceSettings.PanelCasesBalancePanel)
						    },
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "425.127 219.067",
							    OffsetMax = "506.46 249.733"
						    }
					    }
				    });
				    ...
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    new CuiTextComponent
						    {
							    ...
							    Align = TextAnchor.UpperLeft, Color = "0.8078431 0.8196079 0.2196078 1"
						    },
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-10.199 0",
							    OffsetMax = "35.958 13.083"
						    }
					    }
				    });
			    }
		    ...
		    private void Building_CaseItemsPNG()
		    {
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-28.329 -32.2",
						    OffsetMax = "28.337 24.467"
					    }
				    }
			    });
		    ...
		    private void Building_CaseItemsPanel()
		    {
			     ...
			     container.Add(new CuiPanel
			    {
				    ...
				    RectTransform =
				    {
					    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-509.564 -310.109",
					    OffsetMax = "506.462 -92.667"
				    }
		    ...
		    private void Building_CaseItem()
		    {
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-41.099 22.807",
						    OffsetMax = "41.107 32.483"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    new CuiRawImageComponent { FadeIn = FadeIn, Color = "1 1 1 1", Png = ImageUi.GetImage(config.InterfaceSettings.RareMiniIcon) },
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "17 34.043",
						    OffsetMax = "25.667 42.71"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    new CuiTextComponent
					    {
						    Text = "%RARE%", Font = "robotocondensed-regular.ttf", FontSize = 9,
						    Align = TextAnchor.MiddleLeft, Color = "1 1 1 1",
						    FadeIn = FadeIn,
					    },
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "26.296 32.482", OffsetMax = "46.482 44.271"
					    }
				    }
			    });
		    ...
		    private void Building_Tumbler()
		    {
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "394.8 -83.133",
						    OffsetMax = "418.133 -69.8"
					    }
				    }
			    });
		    ...
		    private void Building_Cases()
		    {
			    ...
			    container.Add(new CuiPanel
			    {
				    ...
				    RectTransform =
				    {
					    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-313.267 -47.22",
					    OffsetMax = "310.333 287.737"
				    }
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    new CuiRawImageComponent { FadeIn = FadeIn, Color = "1 1 1 1", Png = "%THREE_CASE_PNG%" },
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-247 -34.258",
						    OffsetMax = "-113.666 99.075"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    new CuiRawImageComponent { FadeIn = FadeIn, Color = "1 1 1 1", Png = "%TWO_CASE_PNG%" },
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "119.667 -34.258",
						    OffsetMax = "253 99.075"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-113.666 -84.258",
						    OffsetMax = "119.667 149.075"
					    }
				    }
			    });
			    ...
			    container.Add(new CuiButton
			    {
				    ...
				    RectTransform =
					    { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-20 -20", OffsetMax = "20 20" }
			    }, "ButtonRightPanel", "RightBtn");
			    ...
			    container.Add(new CuiButton
			    {
				    ...
				    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-20 -20", OffsetMax = "20 21.111" }
			    }, "ButtonLeftPanel", "LeftBtn");
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-113.666 -124.392",
						    OffsetMax = "119.667 -93.725"
					    }
				    }
			    });
			    ...
			    if (_.IQEconomic || _.Economics)
			    {
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    ...
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-113.666 -162.667",
							    OffsetMax = "1.001 -132"
						    }
					    }
				    });
				    ...
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    ...
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-21.003 -15.333",
							    OffsetMax = "51.177 15.333"
						    }
					    }
				    });
				    ...
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    ...
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "5.001 -162.667",
							    OffsetMax = "119.667 -132"
						    }
					    }
				    });
				    ...
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    ...
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-19.49 -15.333",
							    OffsetMax = "52.69 15.333"
						    }
					    }
				    });
				    ...
				    container.Add(new CuiElement 
				    {
					    ...
					    Parent = "SellButtonCase",
					    Components = {
						    new CuiTextComponent { FadeIn = FadeIn, Text = "%PRICE_SELL%", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleRight, Color = "1 1 1 1" },
						    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-134.479 -15.333", OffsetMax = "-60.188 15.333" }
					    }
				    });
				    ...
				    container.Add(new CuiElement
				    {
					    ...
					    Parent = "SellButtonCase",
					    Components = {
						    new CuiTextComponent { FadeIn = FadeIn, Text = "%PRICE_BUY%", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleLeft, Color = "1 1 1 1" },
						    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "178.588 -15.333", OffsetMax = "252.879 15.333" }
					    }
				    });
			    }
		    ...
		    private void Building_Cases_Opened()
		    {
			    ...
			    container.Add(new CuiButton
			    {
				    ...
				    Text =
				    {
					    Text = "%UI_CASE_BUTTON_OPEN_CASE%", Font = "robotocondensed-regular.ttf", FontSize = 20,
		    ...
		    private void Building_Cases_Label_Amounts()
		    {
			    ...
			    container.Add(new CuiElement
			    {
				    ...
				    Components =
				    {
					    ...
					    new CuiRectTransformComponent
					    {
						    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-44.057 -12.675",
						    OffsetMax = "71.133 3.408"
					    }
				    }
			    });
			    ...
			    if (_.IQEconomic || _.Economics)
			    {
				    container.Add(new CuiElement
				    {
					    ...
					    Components =
					    {
						    ...
						    new CuiRectTransformComponent
						    {
							    AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-10.199 -17.083",
							    OffsetMax = "45.958 -1"
						    }
					    }
				    });
        ...
        private void Log(String LoggedMessage)
        {
	        ...
	        LogToFile("IQCasesLog", LoggedMessage, this);
        }
	    ...
	    private class Configuration
	    {
		    ...
		    internal class CasesPreset
		    {
			    ...
			    [JsonProperty(LanguageEn ? "Setting up the sale and purchase of cases (IQEconomic/Economics)" : "Настройка продажи и покупки кейсов (IQEconomic/Economics)")]
		    ...
		    public static Configuration GetNewConfiguration()
		    {
			    return new Configuration
			    {
					...
					{
						UseEffects = true,
						TumblerLeft = "https://i.postimg.cc/TPV6nzWw/6moqO9u.png",
						TumblerRight = "https://i.postimg.cc/j5xGPLbg/hB3jlO3.png", 
						...
						RareMiniIcon = "https://i.postimg.cc/BZYdPTnR/wBWiYSE.png",
					...
					ReferencePluginsPreset = new ReferencePlugins
					{
						...
						{
							CustomPrefix = "<color=#F6C0DC>[IQCases]</color>\n",
							CustomAvatar = "0",
							UIAlertUse = false
						}
					},
	    ...
	    private object OnLootEntityNetworking(BasePlayer player, BaseEntity entity)
	    {
		    ...
		    UInt64 NetID = entity.net.ID.Value;
		    if(NetID == entity.skinID || NetID >= 7557884340) return null;
	    ...
	    private void DrawUI_ShowItem(BasePlayer player, Int32 I, Int32 X, Int32 Y, Configuration.CasesPreset.RewardPreset Reward = null)
	    {
		    if (Reward != null)
		    {
			    ...
			    Interface = Interface.Replace("%OFFSET_MIN%", $"{-505.133 + (X * 102)} {2 - (Y * 110)}");
			    Interface = Interface.Replace("%OFFSET_MAX%", $"{-409.8 + (X * 102)} {105.333 - (Y * 110)}");
		    ...
		    else DrawUI_NoRare_Panel(player, "PanelItemCase", "0.5 0.5", "0.5 0.5", $"{-505.133 + (X * 102)} {2 - (Y * 110)}", $"{-409.8 + (X * 102)} {105.333 - (Y * 110)}");
	    }
