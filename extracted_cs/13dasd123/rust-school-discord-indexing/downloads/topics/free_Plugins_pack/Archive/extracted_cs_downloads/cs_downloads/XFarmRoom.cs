...
namespace Oxide.Plugins 
{
    ...
    class XFarmRoom : RustPlugin
    {
		...
		void cmdTPFarmRoom(BasePlayer player)
		{
			...
			if(!_players_in_room.ContainsKey(player.userID))
			{
				if(Cooldowns.ContainsKey(player.userID))
				{
				   ...
				   if(config.Setting.UseMaxCountItem && 
				   ((player.inventory.containerMain?.itemList?.Count ?? 0) + 
					(player.inventory.containerBelt?.itemList?.Count ?? 0)) > config.Setting.MaxCountItem)
				{
		...
		{
			["sulfur-ore"] = "https://pic.moscow.ovh/images/2024/12/16/c4711c9144ac3689191df31f63b63b77.png",
			["metal-ore"] = "https://pic.moscow.ovh/images/2024/12/16/62c450e9378028c5407a61e948f3008d.png",
			["stone-ore"] = "https://pic.moscow.ovh/images/2024/12/16/80c784de8d01a00a21f49c2637a9916e.png"
		};
