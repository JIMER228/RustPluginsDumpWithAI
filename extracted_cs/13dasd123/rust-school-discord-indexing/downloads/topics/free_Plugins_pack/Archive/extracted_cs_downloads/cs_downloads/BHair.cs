	...
	public class BHair : RustPlugin
	{
        ...
        private void MainUi(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiRawImageComponent { Png = GetImage($"{Name}.Background"), Color = "1 1 1 0.5" },
            ...
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-43 -298", OffsetMax = "46 -275" },
            ...
            if (Layer != null)
            {
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-93 -268", OffsetMax = "96 -245" },
                    Text = { Text = "ВКЛЮЧИТЬ ПРИЦЕЛ", Font = "robotocondensed-bold.ttf", FontSize = 11, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.65" },
                    Button = { Color = "0.3773585 0.3755785 0.3755785 0.65", Command = "" }
                }, Layer);
            }
            else
            {
                ...
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-93 -268", OffsetMax = "96 -245" },
                    Text = { Text = "ВЫКЛЮЧИТЬ ПРИЦЕЛ", Font = "robotocondensed-bold.ttf", FontSize = 11, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.65" },
                    Button = { Color = "0.00 1.00 0.50 0.65", Command = "" }
                }, Layer);
            }
            ...
            {
                Text = { Text = $"НАСТРОЙКА ПРИЦЕЛА", Color = "1 1 1 0.85", FontSize = 32, Font = "robotocondensed-bold.ttf", Align = TextAnchor.UpperCenter },
        ...
        private void HairList(BasePlayer player, Int32 page = 0)
        {
            ...
            container.Add(new CuiButton
            {
                Button = { Color = "0.3773585 0.3755785 0.3755785 0.0", Command = config._SettingsHair.Skip(25 * (page + 1)).Count() > 0 ? $"UI_BHAIR setpage {page + 1}" : "" },
            ...
            container.Add(new CuiButton
            {
                Button = { Color = "0.3773585 0.3755785 0.3755785 0.0", Command = page >= 1 ? $"UI_BHAIR setpage {page - 1}" : "" },
        ...
        private void SizeLine(BasePlayer player)
        {
            ...
            container.Add(new CuiPanel
            {
                ...
                Image = { Color = "0.00 1.00 0.50 1.00", Material = "assets/icons/greyout.mat" }
            }, ".HairSize.Line", ".HairSize.Line.Finish");

            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-7 -7", OffsetMax = "7 7" },
                Image = { Color = "0.00 1.00 0.50 1.00", Material = "assets/icons/greyout.mat" }
