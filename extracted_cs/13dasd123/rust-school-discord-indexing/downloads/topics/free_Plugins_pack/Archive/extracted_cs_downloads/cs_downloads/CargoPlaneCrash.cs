...
{
    [Info("CargoPlaneCrash", "https://discord.gg/TrJ7jnS233", "1.4.3")]
    ...
    class CargoPlaneCrash : CovalencePlugin
    {
        ...
        void crashSite()
        {
            ...
            if (Configuration.coordMessage != "")
                foreach (BasePlayer player in BasePlayer.activePlayerList)
                    player.ChatMessage(Configuration.coordMessage + MapHelper.PositionToString(entity.transform.position));
