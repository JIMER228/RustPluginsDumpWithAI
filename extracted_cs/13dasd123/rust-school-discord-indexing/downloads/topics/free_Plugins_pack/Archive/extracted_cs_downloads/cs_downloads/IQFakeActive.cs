...
{
    [Info("IQFakeActive", "Forum: https://topplugin.ru Ds: alone_sempai Vk: https://vk.com/rustnastroika", "2.6.34")]
    ...
    public class IQFakeActive : RustPlugin
    {
        ...
        private void GeneratePlayerPreset()
        {
            ...
            else
            {
                ...
                fakeDatabase.chatPresetFakePlayer.nickColor = "#55aafe"; // Takma adların varsayılan rengi değiştirildi (22 Şubat 2025)
                ...
                return new Configuration
                {
                    ...
                    messageFakeController = new MessageController()
                    {
                        ...
                        new List<string>()
                        {
                            ...
                            "When is the wipe", "friend ff", "PvE genius server", "6", "Let's go on autopilot", "Where are you?", "Selling cars", "Looking for a teammate DC Semka#6943 1675 hours",
                            ...
                            "Guess", "No, I just built", "Here, there was an HQ door", "Sleeping bag", "Who's team 12 years old from 700 hours", "No", "PINGGGGGGG6943", "Man, God",
