	...
	public class CombatBlock : RustPlugin
	{
        ...
        private class InterfaceBuilder
		{
			...
			private void BuildingCombatBlockMain()
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    RectTransform ={ AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = $"{-179.00 + Instance.config.CombatBlockInterface.OffsetX} {-34.5 + Instance.config.CombatBlockInterface.OffsetY}", OffsetMax = $"{-0.00 + Instance.config.CombatBlockInterface.OffsetX} {34.5 + Instance.config.CombatBlockInterface.OffsetY}" }
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-71.00 14.71", OffsetMax = "5.04 29.11"},
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "6.38 16.91", OffsetMax = "15.62 26.91" }
                    }
                });
			...
			private void BuildingCombatBlockMainV2()
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    RectTransform ={ AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = $"{-200.01 + Instance.config.CombatBlockInterface.OffsetX} {-20 + Instance.config.CombatBlockInterface.OffsetY}", OffsetMax = $"{-0.01 + Instance.config.CombatBlockInterface.OffsetX} {20 + Instance.config.CombatBlockInterface.OffsetY}" }
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = {AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-64.62 0", OffsetMax = "5.36 15.56" },
			...
			private void BuildingCombatBlockMainV3()
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = "1 1 1 0", FadeIn = _fade },
                    RectTransform ={ AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = $"{-200 + Instance.config.CombatBlockInterface.OffsetX} {-28 + Instance.config.CombatBlockInterface.OffsetY}", OffsetMax = $"{0 + Instance.config.CombatBlockInterface.OffsetX} {28 + Instance.config.CombatBlockInterface.OffsetY}" }
                },Instance.config.CombatBlockInterface.Layers,CB_MAIN);
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-15.95 1.54", OffsetMax = "83.97 21.85" },
		...
		private void OnPlayerAttack(BasePlayer attacker, HitInfo hitInfo)
		{
			...
			if(!target.IsNpc && !attacker.IsNpc)
				if(IsFriends(attacker.userID, target.userID) || IsClans(attacker.UserIDString, target.UserIDString))
					return;
