    ...
    class Arkan : RustPlugin
    {
		...
		private class Configuration
		{
			...
			[JsonProperty(PropertyName = "Notify when a player has a high value of the physics.steps parameter")]
	 		public bool notifyPhysicsStepsWarning = true;
			
			[JsonProperty(PropertyName = "Enable Discord No Recoil Notifications")]
	 		public bool DiscordNRReportEnabled = true;
			
			[JsonProperty(PropertyName = "Enable Discord AIMBOT Notifications")]
	 		public bool DiscordAIMReportEnabled = true;
			
			[JsonProperty(PropertyName = "Enable Discord In Rock Notifications")]
	 		public bool DiscordIRReportEnabled = true;
			
			[JsonProperty(PropertyName = "Discord No Recoil Webhook URL")]
	 		public string DiscordNRWebhookURL = "https://discordapp.com/api/webhooks/1358488287194386593/JlNlo2W4GvO4M3k7009L55F8MMgsBbpcyICCoUBJCq02b-VpRGaX3d2E-c15sYEpbBf4";
			
			[JsonProperty(PropertyName = "Discord AIMBOT Webhook URL")]
	 		public string DiscordAIMWebhookURL = "https://discordapp.com/api/webhooks/1358488287194386593/JlNlo2W4GvO4M3k7009L55F8MMgsBbpcyICCoUBJCq02b-VpRGaX3d2E-c15sYEpbBf4";
			
			[JsonProperty(PropertyName = "Discord In Rock Webhook URL")]
	 		public string DiscordIRWebhookURL = "https://discordapp.com/api/webhooks/1358488287194386593/JlNlo2W4GvO4M3k7009L55F8MMgsBbpcyICCoUBJCq02b-VpRGaX3d2E-c15sYEpbBf4";
