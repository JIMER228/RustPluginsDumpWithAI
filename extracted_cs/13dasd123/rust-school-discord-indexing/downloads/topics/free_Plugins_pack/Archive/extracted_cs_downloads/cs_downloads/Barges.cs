...
namespace Oxide.Plugins
{
    ...
    class Barges : RustPlugin
    {
        ...
        object CanChangeGrade(BasePlayer player, BuildingBlock block, BuildingGrade.Enum grade, ulong param4)
        {
            if (player == null)
                return null;
        ...
        class Barge : FacepunchBehaviour
        {
            ...
            {
                if (entity.ShortPrefabName == "electricfurnace.io" || entity is IndustrialStorageAdaptor or IndustrialCrafter or Door or CustomDoorManipulator)
                {
        ...
        class MovableBaseMountable : BaseMountable
        {
            ...
            public bool GetDismountPosition(BasePlayer player, out Vector3 result)
            {
                result = Vector3.zero;
                return true;
            }
