...
{
    [Info("StatsController", "Amino", "1.0.10")]
    ...
    public class StatsController : RustPlugin
    {
        ...
        {
            var playTime = PlaytimeTracker?.Call<object>("GetPlayTime", player.UserIDString);
        ...
        void UIOpenPersonalStats(BasePlayer player, ulong steamID, KillTypes currentData)
        {
            ...
            var timeSpan = TimeSpan.FromSeconds(GetPlayTime(player));
