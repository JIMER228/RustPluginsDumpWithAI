...
namespace Oxide.Plugins
{
    ...
    public class ServerChat : RustPlugin
    {
        ...
        public class ConfigData
        {
           ...
           [JsonProperty(PropertyName = "Titles Settings")]
            public ServerTitles serverTitlesSettings { get; set; }
        ...
        public class ServerTitles
        {
            [JsonProperty(PropertyName = "Titles")]
            public string titlesName { get; set; }

            [JsonProperty(PropertyName = "Colour")]
            public string titlesColour { get; set; }

            [JsonProperty(PropertyName = "Size")]
            public int titlesSize { get; set; }
        }
        ...
        protected override void LoadDefaultConfig()
        {
            config = new ConfigData
            {
                ...
                serverTitleSettings = new ServerTitle
                {
                 ...
                 serverTitlesSettings = new ServerTitles
                {
                    titlesName = "",
                    titlesColour = "purple",
                    titlesSize = 15
                ...
                {
                    messageFormat = "{title}{titles} {message}"
                }
            };
        }
        ...
        private object OnServerMessage(string serverMessage)
        {
           ...
           string titles = $"<size={config.serverTitlesSettings.titlesSize}><color={config.serverTitlesSettings.titlesColour}>{config.serverTitlesSettings.titlesName}</color></size>";
