...
{
    [Info("Teleportation", "North", "1.5.2")]
...
void TeleportationTimerHandle()
        ...
        Dictionary<string, string> Messages = new Dictionary<string, string>() {
                ...
                {
                "centerError", "Устанавливайте точку ближе к центру строения\nИмеется ввиду не дома а центра фундамента/потолка.\nВозможно вы стоите слишком близко к стене, слишком близко к потолку. "
            }
            ,
            {
            ...
            , {
                "tprrequestsuccess", "Запрос на телепорт к игроку '{0}' успешно отправлен"
            }
            , {
