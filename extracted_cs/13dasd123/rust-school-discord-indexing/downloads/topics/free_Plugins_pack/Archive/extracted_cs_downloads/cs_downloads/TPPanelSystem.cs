...
{
    [Info("TPPanelSystem", "Sempai#3239/https://topplugin.ru/", "5.0.0")]
    public class TPPanelSystem : RustPlugin
    {
        ...
        void OnServerInitialized()
        {
            ...
            InitializeLang();
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/04/09/0YGVlj.png", "background");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/KLxjyXF/B9vjEY1.png", "online");
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/04/12/0YvYxm.th.png", "logo");
            ...
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/04/09/0YGuP9.png", "plane_called");
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/04/09/0YGFj8.png", "heli_called");
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/04/09/0YGkQo.png", "ch47_called");
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/04/09/0YGIIu.png", "cargo_called");
