...
namespace Oxide.Plugins
{
    ...
    public class AdminMenu0xF : RustPlugin
    {
...
#endif
        private static AdminMenu0xF Instance;
        ...
        private static string AdminMenu0xF_IMAGECRC;
            ...
            public string Permission
            {
                ...
                set
                {
                    if (string.IsNullOrEmpty(value))
                        return;
                    permission = string.Format("AdminMenu0xF.{0}", value);
                ...
                return new Configuration()
                {
                    CustomQuickButtons = new List<QMCustomButton>
                    {
                        new QMCustomButton
                        {
                            ...
                            {
                                "chat.say \"/custom\"",
                                "AdminMenu0xF openinfopanel custom_buttons"
                            },
        ...
        public class ConnectionData
        {
            ...
            public bool IsAdminMenu0xFDisplay { get; set; }
            ...
            public void ShowAdminMenu0xF()
            {
                UI.ShowAdminMenu0xF();
                IsAdminMenu0xFDisplay = true;
            }

            public void HideAdminMenu0xF()
            {
                UI.HideAdminMenu0xF();
                IsAdminMenu0xFDisplay = false;
            }
            ...
            public void SetSidebar(Sidebar sidebar)
            {
                ...
                CUI.Root root = new CUI.Root("AdminMenu0xF_Panel");
                if (sidebar != null)
                    UI.AddSidebar(root, sidebar);
                else
                    root.Add(new CUI.Element { DestroyUi = "AdminMenu0xF_Panel_Sidebar" });
                root.Render(connection);
                if (needsChangeContentSize)
                {
                    CUI.Root updateRoot = new CUI.Root();
                    updateRoot.Add(new CUI.Element { Components = { new CuiRectTransformComponent { OffsetMin = $"{(sidebar != null ? 250 : 0)} 0", } }, Name = "AdminMenu0xF_Panel_Content" });
            ...
            public void ShowPanelContent(Content content)
            {
                if (content == null)
                {
                    ...
                    root.Add(new CUI.Element { DestroyUi = "AdminMenu0xF_Panel_TempContent" });
                    root.Render(connection);
                    return;
                }
        ...
        public class ConnectionUI
        {
            ...
            {
                CUI.Root root = new CUI.Root();
                root.Add(new CUI.Element { Components = { new CuiRectTransformComponent { AnchorMin = "0 0.00001", AnchorMax = "1 1.00001" } }, Name = "AdminMenu0xF", Update = true });
                root.Add(new CUI.Element { Components = { new CuiNeedsCursorComponent() }, Parent = "AdminMenu0xF", Name = "AdminMenu0xF_Cursor" });
                root.Render(connection);
            }
            ...
            {
                CUI.Root root = new CUI.Root();
                root.Add(new CUI.Element { Components = { new CuiRectTransformComponent { AnchorMin = "1000 1000", AnchorMax = "1001 1001" } }, DestroyUi = "AdminMenu0xF_Cursor", Name = "AdminMenu0xF", Update = true });
                root.Render(connection);
            }

            public void DestroyAdminMenu0xF()
            {
                CuiHelper.DestroyUi(connection.player as BasePlayer, "AdminMenu0xF");
                CuiHelper.DestroyUi(connection.player as BasePlayer, "AdminMenu0xF_Cursor");
            ...
            {
                DestroyAdminMenu0xF();
                CuiHelper.DestroyUi(connection.player as BasePlayer, "AdminMenu0xF_OpenButton");
            }
            ...
            public void AddSidebar(CUI.Element element, Sidebar sidebar)
            {
                if (sidebar == null)
                    return;
                var sidebarPanel = element.AddPanel(color: Themes.CurrentTheme.GetColorString(Theme.KeyCollection.PANEL_SIDEBAR_BACKGROUND), material: "assets/content/ui/uibackgroundblur-ingamemenu.mat", imageType: Image.Type.Tiled, anchorMin: "0 0", anchorMax: "0 1", offsetMin: "0 0", offsetMax: "250 0", name: "AdminMenu0xF_Panel_Sidebar").AddDestroySelfAttribute();
                ...
                if (categoryButtons != null)
                {
                    ...
                    for (int i = 0; i < categoryButtonsCount; i++)
                    {
                        ...
                        sidebarButtonGroup.AddButton(command: $"AdminMenu0xF uipanel.sidebar.button_pressed {i} {categoryButtonsCount}", color: $"0 0 0 0", anchorMin: "0 1", anchorMax: "1 1", offsetMin: $"16 -{(i + 1) * 48}", offsetMax: $"0 -{i * 48}", name: $"UIPanel_SideBar_Button{i}").AddText(text: categoryButton.Label.Localize(connection), color: "0.969 0.922 0.882 1", font: CUI.Font.RobotoCondensedBold, fontSize: categoryButton.FontSize, align: TextAnchor.MiddleRight, offsetMin: "16 0", offsetMax: "-16 0");
                    }
                }
            }
            ...
            public void RenderOverlayOpenButton()
            {
                ...
                root.AddButton(command: "AdminMenu0xF", color: "0.969 0.922 0.882 0.035", material: "assets/icons/greyout.mat", anchorMin: "0 0", anchorMax: "0 0", offsetMin: "0 0", offsetMax: "100 30", name: "AdminMenu0xF_OpenButton").AddDestroySelfAttribute().AddText(text: "ADMIN MENU", color: "0.969 0.922 0.882 0.45", font: CUI.Font.RobotoCondensedBold, fontSize: 14, align: TextAnchor.MiddleCenter);
                root.Render(connection);
            }
            ...
            public void RenderMainMenu(MainMenu mainMenu)
            {
                ...
                var container = root.AddPanel(color: "0.169 0.162 0.143 1", material: "assets/content/ui/uibackgroundblur-mainmenu.mat", imageType: Image.Type.Tiled, anchorMin: "1000 1000", anchorMax: "1001 1001", name: "AdminMenu0xF").AddDestroySelfAttribute();
                ...
                var navigation = container.AddContainer(anchorMin: "0 0", anchorMax: "0 1", offsetMin: "0 0", offsetMax: "350 0", name: "AdminMenu0xF_Navigation");
                var homeButton = navigation.AddContainer(//command: "AdminMenu0xF homebutton",
                anchorMin: "0 1", anchorMax: "1 1", offsetMin: $"64 -{102f + 32}", offsetMax: "0 -32");
                homeButton.AddImage(content: AdminMenu0xF_IMAGECRC, color: "0.811 0.811 0.811 1", material: "assets/content/ui/namefontmaterial.mat", anchorMin: "0 0", anchorMax: "0 1", offsetMax: $"146.4 0");
                ...
                var body = container.AddContainer(anchorMin: "0 0", anchorMax: "1 1", offsetMin: "350 0", offsetMax: "-64 0", name: "AdminMenu0xF_Body");
            ...
            public void RenderPanel(Panel panel)
            {
                if (panel == null)
                    return;
                CUI.Root root = new CUI.Root("AdminMenu0xF_Body");
                var container = root.AddContainer(anchorMin: "0 0", anchorMax: "1 1", name: "AdminMenu0xF_Panel").AddDestroySelfAttribute();
                Sidebar sidebar = panel.Sidebar;
                if (sidebar != null)
                    AddSidebar(container, sidebar);
                CUI.Element panelBackground = container.AddContainer(anchorMin: "0 0", anchorMax: "1 1", offsetMin: $"{(sidebar != null ? 250 : 0)} 0", offsetMax: "0 0", name: "AdminMenu0xF_Panel_Content");
                if (true)
                {
            ...
            public void RenderContent(Content content)
            {
                if (content == null)
                    return;
                CUI.Root root = new CUI.Root("AdminMenu0xF_Panel_Content");
                var container = root.AddContainer(name: "AdminMenu0xF_Panel_TempContent").AddDestroySelfAttribute();
                root.Render(connection);
        ...
        public class Content
        {
            ...
            {
                CUI.Root root = new CUI.Root("AdminMenu0xF_Panel_TempContent");
        ...
        public class ConvarsContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                var container = root.AddContainer(anchorMin: "0.03 0.04", anchorMax: "0.97 0.99", name: "AdminMenu0xF_Convars").AddDestroySelfAttribute();
                int rows = 16;
                float width = 1f / rows;
                ...
                var layout = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.04", anchorMax: "0.99 0.99", name: "AdminMenu0xF_Convars_Layout").AddDestroySelfAttribute();
                layout.Components.AddScrollView(vertical: true, scrollSensitivity: 20, anchorMin: $"0 -{pageCount - 1}", anchorMax: $"1 1");
                var bottom = root.AddContainer(anchorMin: "0.02 0", anchorMax: "0.98 0.035", name: "AdminMenu0xF_Convars_Bottom").AddDestroySelfAttribute();
                var searchPanel = bottom.AddButton(command: "AdminMenu0xF convars.opensearch", color: "0.15 0.15 0.15 1", anchorMin: "0 0", anchorMax: "0 1", offsetMin: "0 0", offsetMax: "250 0", name: "Search");
                ...
                {
                    searchPanel.AddInputfield(command: "AdminMenu0xF convars.search.input", text: searchQuery, align: TextAnchor.MiddleLeft, offsetMin: "10 0", name: "Search_Inputfield");
                }

                if (SAVE_BUTTON.UserHasPermission(connectionData.connection))
                {
                    bottom.AddButton(command: $"AdminMenu0xF {SAVE_BUTTON.Command}", sprite: "assets/content/ui/ui.background.rounded.png", imageType: UnityEngine.UI.Image.Type.Tiled, color: SAVE_BUTTON.Style.BackgroundColor, anchorMin: "1 0", anchorMax: "1 1", offsetMin: $"-100 0", offsetMax: $"0 0").AddText(text: SAVE_BUTTON.Label.Localize(connectionData.connection), align: TextAnchor.MiddleCenter, offsetMin: "10 0", offsetMax: "-10 0");
                }
                ...
                for (int i = 0; i < pageCount; i++)
                {
                    ...
                    for (int j = 0; j < rows; j++)
                    {
                        ...
                        convarContainer.AddPanel(sprite: "assets/content/ui/ui.background.rounded.png", imageType: UnityEngine.UI.Image.Type.Tiled, color: "0.2 0.2 0.2 1", anchorMin: "0.75 0.1", anchorMax: "1 0.9").AddInputfield(command: $"AdminMenu0xF convar.setvalue {command.FullName} ", text: command.String, align: TextAnchor.MiddleCenter, offsetMin: "10 0", offsetMax: "-10 0");
                    }
            ...
            public void OpenSearch(Connection connection)
            {
                ...
                root.AddInputfield(command: "AdminMenu0xF convars.search.input", text: "", align: TextAnchor.MiddleLeft, autoFocus: true, offsetMin: "10 0", name: "Search_Inputfield").DestroyUi = "Search_Placeholder";
                root.Render(connection);
            }
        }
        ...
        public class GiveMenuContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                {
                    root.AddEmpty().AddDestroy("AdminMenu0xF_GiveMenu_GivePopup");
                }
                ...
                var layout = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.04", anchorMax: "0.99 0.99", name: "AdminMenu0xF_ItemList_Layout").AddDestroySelfAttribute();
                layout.Components.AddScrollView(vertical: true, scrollSensitivity: 60, anchorMin: $"0 -{pageCount - 1}", anchorMax: $"1 1");
                layout.AddEmpty().AddDestroy("AdminMenu0xF_GiveMenu_Give");
                var bottom = root.AddPanel(color: "0.25 0.25 0.25 0", anchorMin: "0.02 0", anchorMax: "0.98 0.035", name: "AdminMenu0xF_ItemList_Bottom").AddDestroySelfAttribute();
                ...
                var searchPanel = bottom.AddButton(command: "AdminMenu0xF givemenu.opensearch", color: "0.15 0.15 0.15 1", anchorMin: "0 0", anchorMax: "0 1", offsetMin: "0 0", offsetMax: "250 0", name: "Search");
                searchPanel.AddPanel(color: "0.9 0.4 0.4 0.5", anchorMin: "0 0", anchorMax: "0 1", offsetMin: "-2 0", offsetMax: "0 0");
                searchPanel.AddPanel(color: "0.9 0.4 0.4 0.5", anchorMin: "1 0", anchorMax: "1 1", offsetMin: "0 0", offsetMax: "2 0");
                if (string.IsNullOrEmpty(searchQuery))
                {
                ...
                {
                    searchPanel.AddInputfield(command: "AdminMenu0xF givemenu.search.input", text: searchQuery, align: TextAnchor.MiddleLeft, offsetMin: "10 0", name: "Search_Inputfield");
                }
                ...
                for (int i = 0; i < pageCount; i++)
                {
                    ...
                    for (int a = 0; a < rows; a++)
                    {
                        for (int b = 0; b < columns; b++)
                        {
                            ...
                            ulong skinId = 0UL;
                            string command = $"AdminMenu0xF givemenu.popup show {itemDef.itemid}";
                            if (itemDef == null)
                            {
                                ...
                                command = $"AdminMenu0xF givemenu.popup show_custom {itemDef.itemid} {preset.SkinId} {preset.Name}";
            ...
            private void Popup(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                var backgroundButton = root.AddButton(color: "0 0 0 0.8", command: "AdminMenu0xF givemenu.popup close", close: "AdminMenu0xF_GiveMenu_GivePopup", anchorMin: "0 0", anchorMax: "1 1", name: "AdminMenu0xF_GiveMenu_GivePopup").AddDestroySelfAttribute();
                ...
                outer.AddPanel(color: "0.05 0.05 0.05 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -75", offsetMax: "170 -50").AddInputfield(command: "AdminMenu0xF givemenu.popup set_skin", text: skinId.ToString(), font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                ...
                outer.AddPanel(color: "0.05 0.05 0.05 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -110", offsetMax: "50 -85").AddInputfield(command: "AdminMenu0xF givemenu.popup set_amount", text: amount.ToString(), font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                outer.AddButton(color: "0.2 0.2 0.2 1", command: $"AdminMenu0xF givemenu.popup set_amount {amount + 1}", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "55 -110", offsetMax: "78.75 -85").AddText(text: "+1", font: CUI.Font.RobotoCondensedBold, fontSize: 10, align: TextAnchor.MiddleCenter);
                outer.AddButton(color: "0.2 0.2 0.2 1", command: $"AdminMenu0xF givemenu.popup set_amount {amount + 100}", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "83.75 -110", offsetMax: "107.5 -85").AddText(text: "+100", font: CUI.Font.RobotoCondensedBold, fontSize: 10, align: TextAnchor.MiddleCenter);
                outer.AddButton(color: "0.2 0.2 0.2 1", command: $"AdminMenu0xF givemenu.popup set_amount {amount + 1000}", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "112.5 -110", offsetMax: "136.25 -85").AddText(text: "+1k", font: CUI.Font.RobotoCondensedBold, fontSize: 10, align: TextAnchor.MiddleCenter);
                outer.AddButton(color: "0.2 0.2 0.2 1", command: $"AdminMenu0xF givemenu.popup set_amount {amount + 10000}", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "141.25 -110", offsetMax: "170 -85").AddText(text: "+10k", font: CUI.Font.RobotoCondensedBold, fontSize: 10, align: TextAnchor.MiddleCenter);
                ...
                var blueprintCheckbox = outer.AddButton(command: "AdminMenu0xF givemenu.popup isblueprint_toggle", color: "0.05 0.05 0.05 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -145", offsetMax: "-15 -120");
                if (isBluprint)
                {
                    blueprintCheckbox.AddPanel(color: "0.698 0.878 0.557 0.6", offsetMin: "4 4", offsetMax: "-4 -4").WithFade(0.2f);
                }

                outer.AddButton(color: "0.2 0.2 0.2 1", command: "AdminMenu0xF givemenu.popup give", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: GIVE_LABEL.Localize(connectionData.connection), font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
            }

            public void OpenSearch(Connection connection)
            {
                CUI.Root root = new CUI.Root("Search");
                root.AddInputfield(command: "AdminMenu0xF givemenu.search.input", text: "", align: TextAnchor.MiddleLeft, autoFocus: true, offsetMin: "10 0", name: "Search_Inputfield").DestroyUi = "Search_Placeholder";
                root.Render(connection);
            }
        }
        ...
        public class GroupInfoContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                {
                    root.Add(new CUI.Element { DestroyUi = "AdminMenu0xF_Popup_CloneGroupPopup" });
                }
                ...
                if (!Instance.permission.GroupExists(groupName))
                    return;
                var container = root.AddContainer(name: "AdminMenu0xF_GroupInfo_Info").AddDestroySelfAttribute();
                ...
                for (int a = 0; a < buttons.Length; a++)
                {
                    ...
                    for (int b = 0; b < rowButtons.Count(); b++)
                    {
                        ...
                        if (button == null)
                            continue;
                        actionButtonsContainer.AddButton(color: "0.3 0.3 0.3 0.6", command: $"AdminMenu0xF {button.Command} {string.Join(" ", button.Args)}", anchorMin: "0 1", anchorMax: "0 1", offsetMin: $"{b * 150 + b * offset} -{(a + 1) * 35 + a * offset}", offsetMax: $"{(b + 1) * 150 + b * offset} -{a * 35 + a * offset}").AddText(text: button.Label.Localize(connectionUserId), font: CUI.Font.RobotoMonoRegular, fontSize: 12, align: TextAnchor.MiddleCenter);
                    }
                }
            }
        ...
        public class GroupListContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                {
                    root.Add(new CUI.Element { DestroyUi = "AdminMenu0xF_Popup_CreateGroupPopup" });
                }

                string[] groups = Instance.permission.GetGroups();
                int pageCount = Mathf.CeilToInt(groups.Length / (float)perPage);
                var layout = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.04", anchorMax: "0.99 0.99", name: "AdminMenu0xF_GroupList_Layout").AddDestroySelfAttribute();
                layout.Components.AddScrollView(vertical: true, scrollSensitivity: 20, anchorMin: $"0 -{pageCount - 1}", anchorMax: $"1 1");
                for (int page = 0; page < pageCount; page++)
                {
                    ...
                    for (int a = 0; a < rows; a++)
                    {
                        for (int b = 0; b < columns; b++)
                        {
                            ...
                            var button = container.AddButton(command: $"AdminMenu0xF permissionmanager.select_group {group}", color: "0.25 0.25 0.25 0.6", anchorMin: "0.5 0.5", anchorMax: "0.5 0.5", offsetMin: $"-73 -20", offsetMax: $"73 20");
                            button.AddText(text: group, fontSize: 12, align: TextAnchor.MiddleCenter, offsetMin: "6 0", offsetMax: "-6 0");
                        }
                    }

                    root.AddButton(command: "AdminMenu0xF grouplist[popup:creategroup] show", color: "0.25 0.25 0.25 0.6", anchorMin: "0 0", anchorMax: "1 0.035").AddText(text: CREATEGROUP_LABEL.Localize(connectionData.connection), fontSize: 12, align: TextAnchor.MiddleCenter, offsetMin: "6 0", offsetMax: "-6 0");
                }
            }
        }
        ...
        public class NewPermissionManagerContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                var layout = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.01", anchorMax: "0.99 0.99", name: "AdminMenu0xF_PermissionManager_Layout").AddDestroySelfAttribute();
                ...
                if (isTargetNull)
                {
                    targetContainer.AddButton(command: $"AdminMenu0xF permissionmanager.show_groups", color: ButtonStyle.Default.BackgroundColor, anchorMin: "0 1", anchorMax: "1 1", offsetMin: $"0 -{buttonHeight}").AddText(text: GROUP_LABEL.Localize(connectionData.connection), font: CUI.Font.RobotoCondensedBold, align: TextAnchor.MiddleCenter);
                    targetContainer.AddButton(command: $"AdminMenu0xF permissionmanager.show_players", color: ButtonStyle.Default.BackgroundColor, anchorMin: "0 1", anchorMax: "1 1", offsetMin: $"0 -{buttonHeight * 2 + 5}", offsetMax: $"0 -{buttonHeight + 5}").AddText(text: USER_LABEL.Localize(connectionData.connection), font: CUI.Font.RobotoCondensedBold, align: TextAnchor.MiddleCenter);
                    return;
                }
                ...
                targetContainer.AddButton(command: "AdminMenu0xF permissionmanager.reset", color: ButtonStyle.Default.BackgroundColor, anchorMin: "0 1", anchorMax: "1 1", offsetMin: "0 -40").AddText(text: targetButtonText, align: TextAnchor.MiddleCenter, overflow: VerticalWrapMode.Truncate);
            ...
            public static void AddGroupsBranch(CUI.Element parent, ConnectionData connectionData, ref int x, ref int y, out int totalY)
            {
                ...
                AddButtonBranch(parent, Instance.permission.GetGroups().OrderBy(s => s).OrderBy(s => s).Select((groupName, index) =>
                {
                    ...
                    CUI.Root root = new CUI.Root();
                    CUI.Element button = root.AddButton(command: $"AdminMenu0xF permissionmanager.usergroups {(!hasGroup ? "grant" : "revoke")} {groupName}", color: ButtonStyle.Default.BackgroundColor, anchorMin: "0 1", anchorMax: "0 1", offsetMax: $"150 {buttonHeight}", name: groupName);
            ...
            public static void AddPermissionsBranch(CUI.Element parent, Dictionary<string, object> userData, string pluginName, ref int x, ref int y, out int totalY)
            {
                ...
                AddButtonBranch(parent, permissions.OrderBy(s => s).Select(permission =>
                {
                    ...
                    if (target != null)
                    {
                        ...
                        button.Components.Get<CuiButtonComponent>().Command = $"AdminMenu0xF permission.action {(isTargetUser && !hasUser || !isTargetUser && !hasGroup ? "grant" : "revoke")} {permission}";
                    }
        ...
        public class PlayerListContent : Content
        {
            ...
            public override void LoadDefaultUserData(Dictionary<string, object> userData)
            {
                userData["playerlist.executeCommand"] = "AdminMenu0xF userinfo.open";
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                var layout = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.04", anchorMax: "0.99 0.99", name: "AdminMenu0xF_PlayerList_Layout").AddDestroySelfAttribute();
                layout.Components.AddScrollView(vertical: true, scrollSensitivity: 20, anchorMin: $"0 -{pageCount - 1}", anchorMax: $"1 1");
                float width = 1f / columns;
                float height = 1f / rows;
                var bottom = root.AddContainer(anchorMin: "0.02 0", anchorMax: "0.98 0.035", name: "AdminMenu0xF_PlayerList_Bottom").AddDestroySelfAttribute();
                var searchPanel = bottom.AddButton(command: "AdminMenu0xF playerlist.opensearch", color: "0.15 0.15 0.15 1", anchorMin: "0 0", anchorMax: "0 1", offsetMin: "0 0", offsetMax: "200 0", name: "Search");
                searchPanel.AddPanel(color: "0.9 0.4 0.4 0.5", anchorMin: "0 0", anchorMax: "0 1", offsetMin: "-2 0", offsetMax: "0 0");
                searchPanel.AddPanel(color: "0.9 0.4 0.4 0.5", anchorMin: "1 0", anchorMax: "1 1", offsetMin: "0 0", offsetMax: "2 0");
                if (string.IsNullOrEmpty(searchQuery))
                {
                ...
                {
                    searchPanel.AddInputfield(command: "AdminMenu0xF playerlist.search.input", text: searchQuery, align: TextAnchor.MiddleLeft, offsetMin: "10 0", name: "Search_Inputfield");
                }
            ...
            {
                CUI.Root root = new CUI.Root("Search");
                root.AddInputfield(command: "AdminMenu0xF playerlist.search.input", text: "", align: TextAnchor.MiddleLeft, autoFocus: true, offsetMin: "10 0", name: "Search_Inputfield").DestroyUi = "Search_Placeholder";
                root.Render(connection);
            }
        }
        ...
        public class PluginManagerContent : Content
        {
            ...
            private void AddButtons(CUI.Element root, string pluginName, Plugin plugin, ConnectionData connectionData, out int count)
            {
                ...
                for (int k = 0; k < buttonsToRender.Count; k++)
                {
                    ...
                    buttonsContainer.AddButton(command: $"AdminMenu0xF {button.Command} {pluginName}", sprite: "assets/content/ui/ui.background.rounded.png", imageType: UnityEngine.UI.Image.Type.Tiled, color: button.Style.BackgroundColor, anchorMin: "0.99 0.1", anchorMax: "0.99 0.9", offsetMin: $"-{(k + 1) * 100 + k * 5} 0", offsetMax: $"-{k * 100 + k * 5} 0").AddText(text: button.Label.Localize(connectionData.connection), align: TextAnchor.MiddleCenter, offsetMin: "10 0", offsetMax: "-10 0");
                }
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                var container = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.045", anchorMax: "0.99 0.99", name: "AdminMenu0xF_PluginManager").AddDestroySelfAttribute();
                ...
                var bottom = root.AddContainer(anchorMin: "0.01 0", anchorMax: "0.99 0.035", name: "AdminMenu0xF_PluginManager_Bottom").AddDestroySelfAttribute();
                if (RELOADALL_BUTTON.UserHasPermission(connectionData.connection))
                {
                    bottom.AddButton(command: $"AdminMenu0xF {RELOADALL_BUTTON.Command}", sprite: "assets/content/ui/ui.background.rounded.png", imageType: UnityEngine.UI.Image.Type.Tiled, color: RELOADALL_BUTTON.Style.BackgroundColor, anchorMin: "1 0", anchorMax: "1 1", offsetMin: $"-100 0", offsetMax: $"0 0").AddText(text: RELOADALL_BUTTON.Label.Localize(connectionData.connection), align: TextAnchor.MiddleCenter, offsetMin: "10 0", offsetMax: "-10 0");
                }

                var searchPanel = bottom.AddButton(command: "AdminMenu0xF pluginmanager.opensearch", color: "0.15 0.15 0.15 0.7", anchorMin: "0 0", anchorMax: "0 1", offsetMin: "0 0", offsetMax: "250 0", name: "Search");
                if (string.IsNullOrEmpty(searchQuery))
                {
                    searchPanel.AddText(text: SEARCH_LABEL.Localize(connectionData.connection), font: CUI.Font.RobotoCondensedBold, align: TextAnchor.MiddleLeft, offsetMin: "10 0", name: "Search_Placeholder");
                }
                ...
                {
                    searchPanel.AddInputfield(command: "AdminMenu0xF pluginmanager.search.input", text: searchQuery, align: TextAnchor.MiddleLeft, offsetMin: "10 0", name: "Search_Inputfield");
                }
                    ...
                    for (int j = 0; j < rows; j++)
                    {
                        ...
                        if (favoriteButton != null)
                        {
                            ...
                            if (favoriteButton.UserHasPermission(connectionData.connection))
                                command = $"AdminMenu0xF {favoriteButton.Command} {pluginName}";
                            else
                                command = null;
            ...
            {
                CUI.Root root = new CUI.Root("Search");
                root.AddInputfield(command: "AdminMenu0xF pluginmanager.search.input", text: "", align: TextAnchor.MiddleLeft, autoFocus: true, offsetMin: "10 0", name: "Search_Inputfield").DestroyUi = "Search_Placeholder";
                root.Render(connection);
            }
        }
        ...
        public class QuickMenuContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                if (this.buttonGrid == null)
                    return;
                string connectionUserId = ((ulong)userData["userId"]).ToString();
                var container = root.AddPanel(color: "0 0 0 0", anchorMin: "0.01 0.01", anchorMax: "0.99 0.99", name: "AdminMenu0xF_QuickMenu").AddDestroySelfAttribute();
                ...
                foreach (var item in buttons)
                {
                    ...
                    container.AddButton(color: backgroundColor, command: $"AdminMenu0xF {button.Command} {string.Join(" ", button.Args)}", anchorMin: "0 1", anchorMax: "0 1", offsetMin: $"{item.column * 150 + item.column * offset} -{(item.row + 1) * 35 + item.row * offset}", offsetMax: $"{(item.column + 1) * 150 + item.column * offset} -{item.row * 35 + item.row * offset}").AddText(text: button.Label.Localize(connectionUserId), color: button.Style.TextColor, font: CUI.Font.RobotoMonoRegular, fontSize: 12, align: TextAnchor.MiddleCenter);
                }
            }
        }
        ...
        public class UserInfoContent : Content
        {
            ...
            protected override void Render(CUI.Element root, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                var container = root.AddContainer(name: "AdminMenu0xF_UserInfo_Info").AddDestroySelfAttribute();
                var basic_info_container = container.AddContainer(anchorMin: "0 1", anchorMax: "1 1", offsetMin: "30 -180", offsetMax: "-30 -30");
                var avatarContainer = basic_info_container.AddContainer(anchorMin: "0 0", anchorMax: "0 0", offsetMin: "0 0", offsetMax: "150 150", name: "AdminMenu0xF_UserInfo_AvatarContainer");
                ...
                if (hasAvatar)
                {
                    ...
                    if (avatar != null)
                    {
                        avatarContainer.AddImage(content: avatar, color: "1 1 1 1", name: "AdminMenu0xF_UserInfo_Avatar").AddDestroySelfAttribute();
                    }
                }
                else
                {
                    avatarContainer.AddPanel(color: "0.3 0.3 0.3 0.5", name: "AdminMenu0xF_UserInfo_Avatar").AddDestroySelfAttribute().AddOutlinedText(text: "NO\nAVATAR", outlineWidth: 2, outlineColor: "0 0 0 0.5", font: CUI.Font.RobotoCondensedBold, fontSize: 25, align: TextAnchor.MiddleCenter);
        ...
        public class BanPopup : BasePopup
        {
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-90 -90", offsetMax: "-40 -55").AddInputfield(command: "AdminMenu0xF userinfo[popup:ban] set_days", text: days.ToString(), font: CUI.Font.RobotoCondensedRegular, fontSize: 24, align: TextAnchor.MiddleCenter, charsLimit: 2, offsetMin: "10 0", offsetMax: "-10 0");
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "0 -90", offsetMax: "50 -55").AddInputfield(command: "AdminMenu0xF userinfo[popup:ban] set_hours", text: hours.ToString(), font: CUI.Font.RobotoCondensedRegular, fontSize: 24, align: TextAnchor.MiddleCenter, charsLimit: 2, offsetMin: "10 0", offsetMax: "-10 0");
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "95 -90", offsetMax: "145 -55").AddInputfield(command: "AdminMenu0xF userinfo[popup:ban] set_minutes", text: minutes.ToString(), font: CUI.Font.RobotoCondensedRegular, fontSize: 24, align: TextAnchor.MiddleCenter, charsLimit: 2, offsetMin: "10 0", offsetMax: "-10 0");
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -130", offsetMax: "170 -105").AddInputfield(command: "AdminMenu0xF userinfo[popup:ban] set_reason", text: reason ?? string.Empty, font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                panel.AddButton(color: "0.1 0.1 0.1 1", command: $"AdminMenu0xF {BAN_BUTTON.FullCommand}", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: BAN_BUTTON.Label.Localize(connectionData.connection), color: "0.8 0.8 0.8 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
                return panel;
            }
        }
        ...
        public abstract class BasePopup : IUIModule
        {
            ...
            public virtual CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                string elementName = $"AdminMenu0xF_Popup_{typeName}";
                var container = parent.AddContainer(name: elementName).AddDestroySelfAttribute();
                container.AddButton(color: "0 0 0 0.8", command: CloseCommand ?? $"AdminMenu0xF popup {typeName} onClose", close: CloseCommand == null ? elementName : null, anchorMin: "0 0", anchorMax: "1 1");
        ...
        public class CloneGroupPopup : BasePopup
        {
            ...
            public CloneGroupPopup()
            {
                Width = 400;
                Height = 210;
                CloseCommand = "AdminMenu0xF groupinfo[popup:clonegroup] close";
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -80", offsetMax: "170 -55").AddInputfield(command: "AdminMenu0xF groupinfo[popup:clonegroup] set_name", text: name ?? string.Empty, font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -120", offsetMax: "170 -95").AddInputfield(command: "AdminMenu0xF groupinfo[popup:clonegroup] set_title", text: title ?? string.Empty, font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                ...
                var cloneUsersCheckbox = panel.AddButton(command: "AdminMenu0xF groupinfo[popup:clonegroup] cloneusers_toggle", color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -160", offsetMax: "-15 -135");
                if (cloneUsers)
                {
                    cloneUsersCheckbox.AddPanel(color: "0.698 0.878 0.557 0.6", offsetMin: "4 4", offsetMax: "-4 -4").WithFade(0.2f);
                }

                panel.AddButton(color: "0.1 0.1 0.1 1", command: "AdminMenu0xF groupinfo[popup:clonegroup] clone", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: CGP_CLONE_LABEL.Localize(connectionData.connection), color: "0.8 0.8 0.8 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
                return panel;
            }
        }
        ...
        public class CreateGroupPopup : BasePopup
        {
            ...
            public CreateGroupPopup()
            {
                Width = 400;
                Height = 210;
                CloseCommand = "AdminMenu0xF grouplist[popup:creategroup] close";
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddText(text: CGP_NAME_LABEL.Localize(connectionData.connection), color: "0.9 0.9 0.9 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 16, align: TextAnchor.MiddleCenter, anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-170 -80", offsetMax: "-60 -55");
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -80", offsetMax: "170 -55").AddInputfield(command: "AdminMenu0xF grouplist[popup:creategroup] set_name", text: name ?? string.Empty, font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                panel.AddText(text: CGP_TITLE_LABEL.Localize(connectionData.connection), color: "0.9 0.9 0.9 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 16, align: TextAnchor.MiddleCenter, anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-170 -120", offsetMax: "-60 -95");
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -120", offsetMax: "170 -95").AddInputfield(command: "AdminMenu0xF grouplist[popup:creategroup] set_title", text: title ?? string.Empty, font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                panel.AddButton(color: "0.1 0.1 0.1 1", command: "AdminMenu0xF grouplist[popup:creategroup] create", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: CGP_CREATE_LABEL.Localize(connectionData.connection), color: "0.8 0.8 0.8 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
                return panel;
            }
        }
        ...
        public class KickPopup : BasePopup
        {
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddPanel(color: "0.1 0.1 0.1 1", anchorMin: "0.5 1", anchorMax: "0.5 1", offsetMin: "-40 -80", offsetMax: "170 -55").AddInputfield(command: "AdminMenu0xF userinfo[popup:kick] set_reason", text: reason ?? string.Empty, font: CUI.Font.RobotoCondensedRegular, fontSize: 14, align: TextAnchor.MiddleLeft, offsetMin: "10 0", offsetMax: "-10 0");
                panel.AddButton(color: "0.1 0.1 0.1 1", command: $"AdminMenu0xF {KICK_BUTTON.FullCommand}", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-80 10", offsetMax: "80 37").AddText(text: KICK_BUTTON.Label.Localize(connectionData.connection), color: "0.8 0.8 0.8 0.8", font: CUI.Font.RobotoCondensedBold, fontSize: 18, align: TextAnchor.MiddleCenter);
                ;
                return panel;
            }
        }
        ...
        public class RemoveGroupPopup : BasePopup
        {
            ...
            public override CUI.Element AddUI(CUI.Element parent, ConnectionData connectionData, Dictionary<string, object> userData)
            {
                ...
                panel.AddButton(command: "AdminMenu0xF groupinfo.action remove.confirmed", color: "0.749 0.243 0.243 1", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "-150 20", offsetMax: "-30 50").AddText(text: REMOVE_LABEL.Localize(connectionData.connection), color: "1 0.8 0.8 1", align: TextAnchor.MiddleCenter);
                panel.AddButton(command: null, close: "AdminMenu0xF_Popup_RemoveGroupPopup", color: "0.25 0.25 0.25 1", anchorMin: "0.5 0", anchorMax: "0.5 0", offsetMin: "30 20", offsetMax: "150 50").AddText(text: CANCEL_LABEL.Localize(connectionData.connection), color: "0.9 0.9 0.9 1", align: TextAnchor.MiddleCenter);
                return panel;
            }
        }
        ...
        private void AdminMenu0xF_chatcmd(BasePlayer player)
        {
            HandleCommand(player.Connection, "");
        }

        [ConsoleCommand("AdminMenu0xF")]
        private void AdminMenu0xF_cmd(ConsoleSystem.Arg arg)
        {
        ...
        {
            if (connection == null || !CanUseAdminMenu0xF(connection))
                return;
            ConnectionData connectionData;
            switch (command)
            {
                ...
                case "True":
                {
                    ...
                    if (!connectionData.IsAdminMenu0xFDisplay)
                    {
                        connectionData.ShowAdminMenu0xF();
                ...
                case "close":
                    ...
                    if (connectionData != null)
                    {
                        ...
                        connectionData.HideAdminMenu0xF();
                    }
                ...
                case "openinfopanel":
                    ...
                    break;
                case "homebutton":
                    // Action when clicking on the AdminMenu0xF inscription at the top left
                    break;
                ...
                case "permissionmanager.show_user_category":
                {
                    ...
                    if (connectionData != null)
                    {
                        ...
                        CUI.Root root = new CUI.Root("AdminMenu0xF_PermissionManager_Layout");
                ...
                case "permissionmanager.show_players":
                    ...
                    if (connectionData != null)
                    {
                        ...
                        connectionData.userData["playerlist.executeCommand"] = "AdminMenu0xF permissionmanager.select_user";
                        connectionData.currentContent.Render(connectionData);
                    }
                ...
                case "permissionmanager.usergroups":
                    ...
                    if (connectionData != null)
                    {
                        ...
                        string color = hasGroup ? "0.3 0.6 0.7 1" : "0 0 0 0";
                        CUI.Root root = new CUI.Root();
                        root.AddUpdateElement(groupName).Components.AddButton($"AdminMenu0xF permissionmanager.usergroups {(!hasGroup ? "grant" : "revoke")} {groupName}");
                ...
                case "permission.action":
                {
                    ...
                    if (connectionData != null)
                    {
                        ...
                        if (permission == "AdminMenu0xF.fullaccess")
                            return;
                        if (isTargetUser)
                        {
                            if (isGrant)
                        ...
                        if (hasUser || hasGroup)
                            color = hasGroup ? groupColor : userColor;
                        CUI.Root root = new CUI.Root();
                        root.AddUpdateElement(permission).Components.AddButton($"AdminMenu0xF permission.action {(isTargetUser && !hasUser || !isTargetUser && !hasGroup ? "grant" : "revoke")} {permission}");
                ...
                case "changename":
                {
                    if (!UserHasPermission(connection.userid.ToString(), "AdminMenu0xF.changename"))
                        return;
        ...
        void Init()
        {
            ...
            cmd.AddChatCommand(config.ChatCommand, this, "AdminMenu0xF_chatcmd");
            FormatMainMenu();
            FormatPanelList();
        ...
        {
            AdminMenu0xF_IMAGECRC = FileStorage.server.Store(Convert.FromBase64String(AdminMenu0xF_IMAGEBASE64), FileStorage.Type.png, CommunityEntity.ServerInstance.net.ID).ToString();
        ...
        private bool CanUseAdminMenu0xF(Connection connection)
        {
            return UserHasPermission(connection.userid.ToString(), PERMISSION_USE);
        }

        private bool CanUseAdminMenu0xF(BasePlayer player)
        {
            return CanUseAdminMenu0xF(player.Connection);
        }

        public bool UserHasPermission(string userId, string permission)
        {
            if (!permission.StartsWith("AdminMenu0xF."))
                permission = $"AdminMenu0xF.{permission}";
        ...
        private void swapseats_hook(ConsoleSystem.Arg arg)
        {
            ...
            if (player == null)
                return;
            Connection connection = player.Connection;
            if (connection != null && CanUseAdminMenu0xF(connection) && !player.isMounted)
                ToggleMenu(player);
            else
        ...
        private void lighttoggle_hook(ConsoleSystem.Arg arg)
        {
            ...
            if (player == null)
                return;
            Connection connection = player.Connection;
            if (connection != null && CanUseAdminMenu0xF(connection) && !player.IsDucked())
                ToggleMenu(player);
            else
