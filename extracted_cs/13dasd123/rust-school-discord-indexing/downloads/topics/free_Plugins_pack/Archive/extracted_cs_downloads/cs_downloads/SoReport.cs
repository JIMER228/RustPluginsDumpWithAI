            ...
            cont.Add(new CuiElement()
            {
                ...
                Components =
                {
                    new CuiTextComponent()
                    {
                        ...
                        Text =
                            "Вас вызвали на проверку напиши ваш дискорд /discord <color=purple>{ВАШ ДИСКОРД}</color>.Если вы покините сервер ВЫ БУДЕТЕ ЗАБАНЕНЫ НАВСЕГДА, за отказ вы тоже будете наказаны!"
                    },
