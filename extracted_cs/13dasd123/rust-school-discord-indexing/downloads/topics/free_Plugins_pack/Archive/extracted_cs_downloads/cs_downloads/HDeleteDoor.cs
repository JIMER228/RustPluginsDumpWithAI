...
{
    [Info("DeleteDoorRT", "Hanrenko", "1.0.0")]
    class HDeleteDoor : RustPlugin
    {
		...
		{
		clearallchest();
        PrintWarning("Плагин для форума - https://topplugin.ru/ [Автор плагина: Hanrenko]");
        PrintWarning("Моя группа дискорд: https://discord.gg/alimpikrust");
		}
