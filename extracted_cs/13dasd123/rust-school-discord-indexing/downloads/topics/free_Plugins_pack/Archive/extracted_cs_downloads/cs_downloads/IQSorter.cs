...
namespace Oxide.Plugins
{
    ...
    public class IQSorter : RustPlugin
    {
        ...
        private readonly List<Int32> ItemIdCorrecteds = new List<Int32> { 1074866732, 2004072627, 2018009552, 2006957888, 930560607, 1123047824, 1130765085, 442289265, 090353317, 15332328, 118372687 }; //Игнорирование itemID (удаление дубликатов)
        private readonly Dictionary<Int32, List<Int32>> itemDlcReplaced = new Dictionary<Int32, List<Int32>>()
        {
            ...
            { 857465230, new List<Int32> { -75432325 } },
