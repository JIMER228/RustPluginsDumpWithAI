...
{
    [Info("BloodInfo", "rustmods.ru", "1.0.0")]
    public class BloodInfo : RustPlugin
    {
        #region Вар
        string LayerMain = "InfoUI";
        ...
        {
            ImageLibrary.Call("AddImage", "https://imgur.com/X0wgen6.png", "X0wgen6");
        ...
        #region Команда
        [ChatCommand("info")]
        void ChatInfo(BasePlayer player) => InfoUI(player);
        ...
        void InfoUI(BasePlayer player) {
            ...
            {
                RectTransform = { AnchorMin = "0.005 0.952", AnchorMax = "0.026 0.989" },
                Button = { Color = HexToCuiColor("#e0947a", 50), Close = LayerMain },
                Text = { Text = "✕", Color = HexToCuiColor("#e0947a", 100), Font = "robotocondensed-bold.ttf", FontSize = 20, Align = TextAnchor.MiddleCenter }
            }, LayerMain);

            container.Add(new CuiPanel
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-280.5 -227", OffsetMax = "282 227" },
                Image = { Color = "0 0 0 0" }
            }, LayerMain, Layer);
