...
{
    [Info("Menu", "Forum: https://topplugin.ru Ds: alone_sempai Vk: https://vk.com/rustnastroika", "1.0.3")]
    ...
    class Menu : RustPlugin
    {
        ...
        private void LoadImages()
        {
            ...
            else
            {
                ...
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/66mgD2G0/photo-2025-05-08-18-36-45-no-bg-preview-carve-photos.png", "logoava1");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/8z33n0dg/image-2.png", "bg1");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/dtW2Wrks/Rectangle-11.png", "poloskamenu1");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/WbP7GRVk/GAMMA-RUST.png", "name123");
                ImageLibrary?.Call("AddImage", "https://i.postimg.cc/8z2r3H1S/NOLIMIT-2.png", "name456");
        ...
        public void RefreshUI(BasePlayer player, string Type)
        {
            ...
            switch (Type)
            {
                ...
                case "all":
                    ...
                    UI.AddButton(ref c, Layer, Layer + "icons.store", $"chat.say /info", "", "0 0 0 0.3", "", "assets/icons/greyout.mat", "0.5 0.5", "0.5 0.5", "84 -47", "100.337 -33.008");
