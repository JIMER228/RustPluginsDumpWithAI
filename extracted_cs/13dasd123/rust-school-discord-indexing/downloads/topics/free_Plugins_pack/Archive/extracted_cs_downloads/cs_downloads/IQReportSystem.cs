...
{
    [Info("IQReportSystem", "Mercury", "2.27.98")]
    ...
    internal class IQReportSystem : RustPlugin
    {
        ...
        [ConsoleCommand("iqrs")]
        private void ConsoleCommandReport(ConsoleSystem.Arg arg) ///iqrs call 76569546715743214
        {
		...
		private void FuncionalCommandReport(ConsoleSystem.Arg arg)
        {
			...
			switch(ActionPanel)
            {
				...
				case "send.player.report"://report.panel send.player.report 76569546715743214 Reason
				{
					UInt64 TargetID;
        ...
        private class InterfaceBuilder
        {
            ...
            public static void AddInterface(String name, String json)
            {
                ...
                {
                    _.PrintError($"Error! #371574 Tried to add existing cui elements! -> {name}");
                    return;
                }
            ...
            private void Building_Bacgkround()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components = {
			            ...
			            new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-219.38 -21.383", OffsetMax = "-33.953 4.1715711" }
		            }
	            });
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components = {
			            ...
			            new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "136.333 -6.555", OffsetMax = "147 4.1715711" }
		            }
	            });
            ...
            private void Building_Profile_Template_Banner()
            {
	            ...
	            container.Add(new CuiElement
	            {
		            ...
		            Components = {
			            ...
			            new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "33.733 -9.333", OffsetMax = "77.0715767 9.333"}
		            }
	            });
