    ...
    internal class BackpackButton : CovalencePlugin
    {
        ...
        protected override void LoadConfig()
        {
            ...
            try
            {
                ...
                foreach (var buttonPosition in _config.ButtonPositions)
                {
                    if (buttonPosition.Url == "https://www.dropbox.com/scl/fi/bbfgp2tco7oeb9bwicwin/button.png?rlkey=l15aonagd3xcyfiluy68h207e&dl=1"
                        || buttonPosition.Url == "https://www.dropbox.com/scl/fi/bbfgp2tco7oeb9bwicwin/button.png?rlkey=l15aonagd3xcyfiluy68h207e&dl=1")
                    {
                        buttonPosition.SkinId = 3050420442;
                        buttonPosition.Url = "";
                        changed = true;
                    }
                    else if (buttonPosition.Url == "https://www.dropbox.com/scl/fi/bbfgp2tco7oeb9bwicwin/button.png?rlkey=l15aonagd3xcyfiluy68h207e&dl=1"
                             || buttonPosition.Url == "https://www.dropbox.com/scl/fi/bbfgp2tco7oeb9bwicwin/button.png?rlkey=l15aonagd3xcyfiluy68h207e&dl=1")
                    {
