...
/* 1.0.5
 * Patched pooling.
 * Patched for October's update.
 */

namespace Oxide.Plugins
{
	[Info("BuyableTugboats", "imthenewguy", "1.0.5")]
	[Description("Allows Tugboats to be purchased from Fishing Village")]
	class BuyableTugboats : RustPlugin
	{
        ...
        const string perm_admin = "buyabletugboats.admin";
        const string perm_free = "buyabletugboats.free";
        const string perm_use = "buyabletugboats.use";
        ...
        private void Option5(BasePlayer player)
        {
            ...
            container.Add(new CuiPanel
            {
                ...
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "150.8 35.5", OffsetMax = "411 55.5" }
            }, "Overlay", "Option5");
        ...
        {
            if (!CanAccess(player)) return;
            if (responseNode.responseText.Contains("buy a boat")) Option5(player);
