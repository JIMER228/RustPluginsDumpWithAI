    ...
    class ZLevelsRemastered : RustPlugin
    {
	   ...
	   #region Commands
        ...
        void SendHelpText(BasePlayer player)
        {
			...
			sb.AppendLine("<size=18><color=#518eef>Levels</color></size>");
        ...
        void StatsCommand(BasePlayer player, string command, string[] args)
        {
			...
			var text = "<size=18><color=#518eef>Levels</color></size>\n";
            foreach (var skill in Skills.ALL)
        ...
        void StatInfoCommand(BasePlayer player, string command, string[] args)
        {
			...
			messagesText += "<size=18><color=#518eef>Levels</color></size>\n";
