...
{
    [Info("Welcomer", "http://topplugin.ru/", "1.6")]
    ...
    public class Welcomer : RustPlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                ["Welcome"] = "<size=17>Добро пожаловать на <color=#0099CC>Rust</color></size>\n--------------------------------------------\n<color=#0099CC>•</color> Тип <color=#0099CC>/info</color>  для всех доступных команд\n<color=#0099CC>•</color> Чтобы прочитать правила сервера, введите  <color=#0099CC>/info</color>\n<color=#0099CC>•</color> Веселись и уважай других игроков",
                ["Joined"] = "<color=#37BC61>✔</color> {0} <color=#37BC61>присоединился к серверу</color> из <color=#37BC61>{1}</color>",
                ["JoinedUnknown"] = "<color=#37BC61>✔</color> {0} <color=#37BC61>присоединился к серверу</color>",
                ["Left"] = "<color=#FF4040>☒</color> {0} <color=#FF4040>покинул сервер </color> ({1})"
            }, this);
        }
        #endregion
