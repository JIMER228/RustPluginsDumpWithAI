    ...
    class Convoy : RustPlugin
    {
        ...
        class CollisionDisabler : FacepunchBehaviour
        {
            ...
            void OnCollisionEnter(Collision collision)
            {
                ...
                if (entity.net != null && ((entity is HelicopterDebris or LootContainer or TravellingVendor or DroppedItemContainer) || ConvoyPathVehicle.GetVehicleByNetId(entity.net.ID.Value) != null || (ConvoyPathVehicle.GetVehicleByChildNetId(entity.net.ID.Value) != null && entity is not TimedExplosive)))
                {
                    IgnoreCollider(collision.collider);
                    return;
                }
