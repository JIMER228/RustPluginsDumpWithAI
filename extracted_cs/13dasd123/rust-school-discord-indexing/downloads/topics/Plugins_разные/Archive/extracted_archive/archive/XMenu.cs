    ...
    class XMenu : RustPlugin
    {
		...
		private void GUIAddButtonOpen(BasePlayer player)
		{
			...
			container.Add(new CuiLabel
            {
                ...
                Text = { Text = lang.GetMessage("AddOPEN", this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 8, Color = "1 1 1 0.804402" }
            }, ".AddButton_Open");
        ...
        {		
			...
			public static MenuConfig GetNewConfiguration()
            {
                return new MenuConfig
                {
                    ...
                    {
						MenuColor = "1 0.2704402 0 0.504402",
						MenuMaterial = "assets/icons/greyout.mat",
						ButtonColor = "0.21704402 0.22104402 0.20904402 0.7504402",
					...
					{
						EMenuColor = "1 0.2704402 0 0.504402",
		...
		private void GUIAddButton(BasePlayer player)
		{
            ...
            {
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMax = "0 -1" },
                Text = { Text = lang.GetMessage("AddCLOSE", this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.804402" }
            }, ".AddButton_Close");
			...
			foreach(var button in config.ButtonAdd)
			{
                ...
                {
                    RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMax = "0 -1" },
                    Text = { FadeIn = fadein, Text = lang.GetMessage(button.Key, this, player.UserIDString), Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.804402" }
                }, ".AddButton_N");
