...
{
    [Info("MicroPanel", "https://topplugin.ru/", "2.0.95")]
    public class MicroPanel : RustPlugin
    {
        ...
        private class ConfigData
        {
            ...
            [JsonProperty("Показывать онлайн?")]
        ...
        [PluginReference] Plugin IQFakeActive, FGS;
        ...
        {
            int fake = FGS != null ? FGS.Call<int>("getFakes") : 0;
            int Online = BasePlayer.activePlayerList.Count + fake;
            foreach (var basePlayer in BasePlayer.activePlayerList)
            {
