...
{
    [Info("Cupboard Settings", "http://topplugin.ru/", "1.0.2")]
    class CupboardSettings : RustPlugin
    {
        ...
        {
            PrintWarning("Благодарим за заказ плагина на сайте RustPlugin.ru. Если вы передадите этот плагин сторонним лицам знайте - это лишает вас гарантированных обновлений!");
        ...
        void CuiAddButtonOther(BasePlayer player, uint netID, ulong playerid = 2984960)
        {
