...
namespace Oxide.Plugins
{
    ...
    class RustMap : RustPlugin
	{
        ...
        private string mapIconTextJson = @"[{""name"":""{0}"",""parent"":""map_mainImage"",""components"":[{""type"":""UnityEngine.UI.Text"",""font"":""robotocondensed-regular.ttf"",""text"":""{3}"",""align"":""MiddleCenter"",""fontSize"":12,""color"":""{color}""},{""type"": ""UnityEngine.UI.Outline"",""color"": ""0 0 0 1""},{""type"":""RectTransform"",""anchormin"":""{1}"",""anchormax"":""{2}""}]}]";
        private string mapIconTextJsonIcon = @"[{""name"":""{0}"",""parent"":""map_mainImage"",""components"":[{""type"":""UnityEngine.UI.Text"",""font"":""robotocondensed-regular.ttf"",""text"":""{3}"",""align"":""MiddleCenter"",""fontSize"":9,""color"":""{color1}""},{""type"": ""UnityEngine.UI.Outline"",""color"": ""0 0 0 1""},{""type"":""RectTransform"",""anchormin"":""{1}"",""anchormax"":""{2}""}]}]";
        ...
        private string mapCoordsTextJson = @"[{""name"":""map_coordinates"",""parent"":""map_mainImage"",""components"":[{""type"":""UnityEngine.UI.Text"",""font"":""robotocondensed-regular.ttf"",""text"":""{0}"",""align"":""MiddleCenter"",""fontSize"":18},{""type"": ""UnityEngine.UI.Outline"",""color"": ""0 0 0 1"",""distance"": ""0.5 -0.5""},{""type"":""RectTransform"",""anchormin"":""0 0.95"",""anchormax"":""1 1""}]}]";
        private string mapHelpJson = @"[{""name"":""map_help"",""parent"":""map_mainImage"",""components"":[{""type"":""UnityEngine.UI.Text"",""font"":""robotocondensed-regular.ttf"",""text"":""{0}"",""align"":""MiddleLeft"",""fontSize"":16},{""type"": ""UnityEngine.UI.Outline"",""color"": ""0 0 0 1"",""distance"": ""0.5 -0.5""},{""type"":""RectTransform"",""anchormin"":""0.02 0.001"",""anchormax"":""1 0.05""}]}]";
			...
			if (sethome)
			{
				if (args.Count() >= 1 && args[0] == "homes")
				{
					if (data.MapPlayerData[player.userID].Homes == true)
					{
						...
						SendReply(player, $"<color=#FF8C00>Map homes</color>: False");
						PlayerSaveData();
						return;
					}
					if (data.MapPlayerData[player.userID].Homes == false)
					{
						...
						PlayerSaveData();
						SendReply(player, $"<color=#FF8C00>Map homes</color>: True");
						return;
					}
				}
			}
			if (friendsSupport)
			{
				if (args.Count() >= 1 && args[0] == "friends")
				{
					if (data.MapPlayerData[player.userID].Friends == true)
					{
						...
						SendReply(player, $"<color=#FF8C00>Map friends</color>: False");
						PlayerSaveData();
						return;
					}
					if (data.MapPlayerData[player.userID].Friends == false)
					{
						...
						PlayerSaveData();
						SendReply(player, $"<color=#FF8C00>Map Friends</color>: True");
						return;
					}
				}
			}
			if (clanSupport)
			{
				if (args.Count() >= 1 && args[0] == "clans")
				{
					if (data.MapPlayerData[player.userID].Clans == true)
					{
						...
						SendReply(player, $"<color=#FF8C00>Map Clans</color>: False");
						PlayerSaveData();
						return;
					}
					if (data.MapPlayerData[player.userID].Clans == false)
					{
						...
						PlayerSaveData();
						SendReply(player, $"<color=#FF8C00>Map Clans</color>: True");
						return;
					}
				}
			}
			if (permission.UserHasPermission(player.UserIDString, MAP_ADMIN))
			{
				if (args.Count() >= 1 && args[0] == "players")
				{
					if (data.MapPlayerData[player.userID].AllPlayers == true)
					{
						...
						PlayerSaveData();
						SendReply(player, $"<color=#FF8C00>Map AllPlayers</color>: False");
						return;
					}
					if (data.MapPlayerData[player.userID].AllPlayers == false)
					{
						...
						PlayerSaveData();
						SendReply(player, $"<color=#FF8C00>Map AllPlayers</color>: True");
						return;
					}
				}
				...
				if (args.Count() >= 1 && args[0] == "bans")
				{
					if (data.MapPlayerData[player.userID].BanPlayers == true)
					{
						...
						SendReply(player, $"<color=#FF8C00>Map BanPlayers</color>: False");
						PlayerSaveData();
						return;
					}
					if (data.MapPlayerData[player.userID].BanPlayers == false)
					{
						...
						PlayerSaveData();
						SendReply(player, $"<color=#FF8C00>Map BanPlayers</color>: True");
						return;
					}
				}
			}
		...
		string button = "[{\"name\":\"CuiElement\",\"parent\":\"maphelp_2\",\"components\":[{\"type\":\"UnityEngine.UI.RawImage\",\"sprite\":\"Assets/Content/UI/UI.Background.Tile.psd\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.03 {amin}\",\"anchormax\":\"0.97 {amax}\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"CuiElement\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{text}\",\"font\":\"robotocondensed-regular.ttf\",\"fontSize\":16,\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"CuiElement\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{command}\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";
        private string MapHelp = "[{\"name\":\"maphelp_2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.RawImage\",\"sprite\":\"Assets/Content/UI/UI.Background.Tile.psd\",\"color\":\"0.1647059 0.1647059 0.1647059 1\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.3704246 0.1914063\",\"anchormax\":\"0.6222548 0.7773438\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"maphelp_3\",\"parent\":\"maphelp_2\",\"components\":[{\"type\":\"UnityEngine.UI.RawImage\",\"sprite\":\"Assets/Content/UI/UI.Background.Tile.psd\",\"color\":\"0.8431373 0.3372549 0.2509804 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.9359605\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"maphelp_4\",\"parent\":\"maphelp_3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"font\":\"robotocondensed-regular.ttf\",\"text\":\"<b>RustMap v{version}</b>\",\"fontSize\":18,\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"maphelp_5\",\"parent\":\"maphelp_2\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>by RustLehaa</b>\",\"align\":\"MiddleRight\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.01492521 0.004926026\",\"anchormax\":\"1 0.06896545\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"maphelp_6\",\"parent\":\"maphelp_2\",\"components\":[{\"type\":\"UnityEngine.UI.RawImage\",\"sprite\":\"Assets/Content/UI/UI.Background.Tile.psd\",\"color\":\"0.2728048 0.2728048 0.2728048 1\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0.8431373 0.3372549 0.2509804 1\",\"distance\":\"0 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.51 0.07635458\",\"anchormax\":\"0.97 0.135468\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"maphelp_7\",\"parent\":\"maphelp_6\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"font\":\"robotocondensed-regular.ttf\",\"text\":\"☓ <b>Закрыть</b>\",\"fontSize\":16,\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"button1\",\"parent\":\"maphelp_6\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"maphelp_2\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\"}]},{\"name\":\"maphelp_8\",\"parent\":\"maphelp_2\",\"components\":[{\"type\":\"UnityEngine.UI.RawImage\",\"sprite\":\"Assets/Content/UI/UI.Background.Tile.psd\",\"color\":\"0.8431373 0.3372549 0.2509804 1\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0.8431373 0.3372549 0.2509804 1\",\"distance\":\"0 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.03 0.07731612\",\"anchormax\":\"0.48 0.1364295\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"maphelp_9\",\"parent\":\"maphelp_8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"font\":\"robotocondensed-regular.ttf\",\"text\":\"♦ <b>Открыть карту</b>\",\"fontSize\":16,\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"button2\",\"parent\":\"maphelp_8\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"map.open\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\"}]}]";
		...
		void OnEntityKill(BaseNetworkable entity) 
		{
			...
			if (entity is CargoPlane || entity is SupplyDrop || entity is BaseHelicopter || entity is HelicopterDebris || entity is VendingMachine) 
			{
				...
				var mm = temporaryMarkers.FirstOrDefault(p => p.transform == transform);
				if (mm != null)
            ...
            foreach (var monument in monuments)
            {
                ...
                if (!string.IsNullOrEmpty(text) && monumentIconNames)
                {
                        ...
                        Components =
                    {
                        ...
                        {
                            Text = text, FontSize = monumentsFontSize, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter,
                        },
