...
{
    [Info(nameof(HeliSpeed), "The_Kiiiing", "1.2.2")]
    class HeliSpeed : BasePlugin<HeliSpeed, HeliSpeed.Configuration>
    {
        #region Fields
        ...
        public enum VehicleType { MiniCopter, ScrapHeli, RowBoat, RHIB, ModularCar, Tugboat, AttackHelicopter, SubSolo, SubDuo, Bike }
        ...
        private class BikeSpeedController : BaseSpeedController<Bike>
        {
            ...
            protected override void Awake()
            {
                ...
                initialEngineKw = entity.GetField<int>("engineKW");
            }
            ...
            {
                entity.SetField("engineKW", Mathf.RoundToInt(initialEngineKw * m));
            }
