...
{
    [Info("AutoBaseUpgrade", "https://discord.gg/96eJaVaWBv", "1.1.0")]
    internal class AutoBaseUpgrade : RustPlugin
    {
        ...
        private List<ImageSettings> ImageSettingsList = new List<ImageSettings>()
        {
            ...
            {
                Name = "wood",
                Url = "https://images-ext-1.discordapp.net/external/YHjDPSTftnFJhMEJyoITXnogM_A-uU-Tpa-6J-eaTnk/https/i.imgur.com/sb6PGMP.png"
            },
            new ImageSettings()
            {
                Name = "stones",
                Url = "https://images-ext-1.discordapp.net/external/5iSphHWpbCPSw8NgDQ3fvTjpm4C4XTLmF76x6-DTFZA/https/i.imgur.com/PcFCPyT.png"
            },
            new ImageSettings()
            {
                Name = "metal.fragments",
                Url = "https://images-ext-1.discordapp.net/external/Sh02HYGKFkRI-y18c2_WKBiqNjgFql0jNKRKkqZc7ac/https/i.imgur.com/THDdDMu.png"
            },
            new ImageSettings()
            {
                Name = "metal.refined",
                Url = "https://images-ext-2.discordapp.net/external/G4GEmWX5L1Qv6FwMIikKL6O7OvGQCHiuXHPRmxcEp6o/https/i.imgur.com/oVayI4A.png"
            }
        };
