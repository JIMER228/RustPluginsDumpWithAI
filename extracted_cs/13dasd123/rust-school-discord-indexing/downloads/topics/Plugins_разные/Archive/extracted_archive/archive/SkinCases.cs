...
{
    [Info("SkinCases", "https://topplugin.ru/", "0.0.83")]
        ...
        { 
            ...
            CaseHandler.CaseSettings.CaseLits.ForEach(c =>
            {
                ...
                c.Items.ForEach(i =>
                {
                    ...
                    {
                        if (!(bool)ImageLibrary?.Call("HasImage", i.ShortName)) ImageLibrary.Call("AddImage", $"https://www.rustedit.io/images/imagelibrary/{i.ShortName}.png", i.ShortName, i.SkinID);
                    } /*
                    if (i.SkinID != 0)
                    { 
                        if (!(bool)ImageLibrary?.Call("HasImage", $"{i.ShortName}_{i.SkinID}")) ImageLibrary.Call("AddImage", $"https://www.rustedit.io/images/imagelibrary/{i.ShortName}.png", i.ShortName, i.SkinID);
                    }*/
            ...
            for (int z = 0; z < skinList.Count - 5; z++)
            {
                ...
                foreach (var check in localList.Select((i, t) => new {A = i, B = t}))
                {
                    try
                    {
                        ...
                        string imageName = check.A.SkinID == 0 && check.A.PictureURL.IsNullOrEmpty() ? check.A.ShortName: img; 
