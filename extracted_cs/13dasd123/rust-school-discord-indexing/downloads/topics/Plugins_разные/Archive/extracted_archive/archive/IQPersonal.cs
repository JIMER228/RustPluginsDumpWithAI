    ...
    class IQPersonal : RustPlugin
    {
        ...
        void BalanceSet(ulong UserID)
        {
            ...
            if(Store.GameStores)
            {
                ...
                {
                    PrintWarning("Ошибка #789 : Магазин не настроен! Он будет работать неккоректно!");
                    return;
                }
        ...
        void VKSendMessage(string Message, string CustomChatID = "")
        {
            ...
            {
                PrintWarning("Ошибка #34789: Вы не настроили конфигурацию,в пункте с ВК"); 
                return;
            }
