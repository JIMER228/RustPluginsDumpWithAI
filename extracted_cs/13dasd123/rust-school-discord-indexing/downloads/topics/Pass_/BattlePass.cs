...
{
    [Info("BattlePass", "By-Hydra", "0.0.1")]
        ...
        private void ShowUIMain(BasePlayer player, int page)
        {
            ...
            if (settings != null)
            {
                ...
                container.Add(new CuiLabel
                {
                    ...
                    Text =
                    {
                        Text = $"Exp Oranı: <color=white>{d.Score}/{settings.Exp}</color>", Font = "robotocondensed-bold.ttf", FontSize = 15, Align = TextAnchor.MiddleLeft,
                        Color = "0.93 0.77 0.58 1.00"
                    }
                }, Layer);
