...
/* 1.5.10
 * Fixed an issue with Harmony Unpatch all in Carbon by using AutoPatch.
 */

namespace Oxide.Plugins
{
    [Info("Skill Tree", "imthenewguy", "1.5.10")]
    ...
    class SkillTree : RustPlugin
    {
        ...
        object OnDispenserBonus(ResourceDispenser dispenser, BasePlayer player, Item item)
        {
            ...
            if (dispenser.gatherType == ResourceDispenser.GatherType.Tree)
            {
                ...
                {
                    RespawnTree(dispenser.baseEntity.PrefabName, dispenser.baseEntity.transform.position, dispenser.baseEntity.transform.rotation);
        ...
        void RespawnTree(string prefab, Vector3 pos, Quaternion rot)
        {
            NextTick(() =>
            {
                NextTick(() =>
