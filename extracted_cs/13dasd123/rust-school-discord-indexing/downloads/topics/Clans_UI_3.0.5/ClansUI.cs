                ...
                .WithChildren(members =>
                {
                    ImageContainer.Create(members, Anchor.CenterLeft, new Offset(0f, -187.5f, 635f, 187.5f))
                        ...
                        .WithChildren(memberView =>
                        {
                            ...
                            {
                                var kvp = clan.ClanMembers.ElementAt(i);
                                
                                Anchor anchor;
                                Offset offset;
                                m_MemberLayout.Evaluate(index, out anchor, out offset);
                    ...
                    ImageContainer.Create(members, Anchor.CenterRight, new Offset(-150f, -187.5f, 0f, 187.5f))
                        ...
                        .WithChildren(inviteView =>
                        {
                            ...
                            {
                                var kvp = clan.MemberInvites.ElementAt(i);
                                
                                Anchor anchor;
                                Offset offset;
                                m_InviteLayout.Evaluate(index, out anchor, out offset);
