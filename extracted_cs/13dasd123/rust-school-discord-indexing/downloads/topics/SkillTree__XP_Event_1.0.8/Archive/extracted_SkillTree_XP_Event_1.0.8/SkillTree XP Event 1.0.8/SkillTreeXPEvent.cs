...
/* Update 1.0.8
 * Fixed an issue with animal specific skinning tasks giving xp on hit, rather than when fully farmed.
 */

namespace Oxide.Plugins
{
	[Info("SkillTreeXPEvent", "imthenewguy", "1.0.8")]
	...
	class SkillTreeXPEvent : RustPlugin
	{
        ...
        public void SetupMultiplier(float multipler, int duration, Source source, ulong icon, int itemid)
        {
            ...
            {
                // Handle logic here for displaying info to players 31135
