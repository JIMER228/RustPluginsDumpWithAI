...
namespace Oxide.Plugins
{
    ...
    class Kits : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            ImageLibrary.Call("AddImage", $"https://i.ibb.co/gVPXm2G/1.png", $"fon");
            ...
            foreach(var kit in kitsList)
            {
                ImageLibrary.Call("AddImage", kit.img, kit.DisplayName);
            }
        ...
        private void InitilizeKitsUI(BasePlayer player, int page = 0)
        {
            ...
            var currentTime = GetCurrentTime();
            var kits = GetKitsForPlayer(player).Skip(10 * page).Take(10).ToList();
            int i = 0;
            var container = new CuiElementContainer();
            container.Add(new CuiPanel
            {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        ...
                        Color = "0.8277252 0.8277252 0.8277252 1",
                    },

                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0.4109375 0.5268519",
                        AnchorMax = "0.5817708 0.6744447",
                    },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        Text = "Здесь вы можете получить наборы",
                        Align = TextAnchor.MiddleCenter,
                    ...
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0.4026043 0.4938891",
                        AnchorMax = "0.5947917 0.6179631",
                    },
                }
            });
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    new CuiTextComponent
                    {
                        Text = "Чтобы закрыть меню наборов, щелкните по свободному месту!",
                        Align = TextAnchor.MiddleCenter,
                        Color = "0.8627451 0.8627451 0.8627451 1"
                    },
                    ...
                    new CuiRectTransformComponent
                    {
                        AnchorMin = "0.3276041 0.3227778",
                        AnchorMax = "0.6635416 0.4088888",
                    },
                }
            });
            var pos = 0.515f - (GetKitsForPlayer(player).Skip(10 * page).Take(10).Count() * 0.065f + (GetKitsForPlayer(player).Skip(10 * page).Take(10).Count() - 1) * 0.005f) / 2;
            if (kits.Count > 0) foreach (var kit in kits)
                {
                    ...
                    container.Add(new CuiPanel
                    {
                        ...
                        RectTransform = {
                            AnchorMin=$"{pos} 0.37", AnchorMax=$"{pos + 0.09f} 0.65"
                    ...
                    container.Add(new CuiPanel
                    {
                        ...
                        RectTransform = {
                            AnchorMin=$"0 0", AnchorMax=$"0.69 0.69"

                        }
                    }, $"ui.kits.main.{kit.Name}", $"ui.kits.{kit.Name}");
                    container.Add(new CuiElement
                    {
                        Name = $"ui.kits.{kit.Name}",
                        Parent = $"ui.kits.main.{kit.Name}",
                        Components =
                        {
                            ...
                            new CuiRectTransformComponent
                            {
                                AnchorMin=$"0 0.1", AnchorMax=$"0.6 0.58"
                            }
                        }
                    });
                    container.Add(new CuiElement
                    {
                        Name = $"ui.kits.{kit.Name}.img",
                        Parent = $"ui.kits.main.{kit.Name}",
                        Components =
                        {
                            new CuiRawImageComponent
                    ...
                    {
                        Button = {
                        Color="0.75 0.75 0.75 0.5", Command=$"kit.drawkitinfo {kit.Name} {page}", 
                    }
                        ,
                        RectTransform = {
        ...
        private void InitilizeCooldown(ref CuiElementContainer container, BasePlayer player, Kit kit, int page)
        {
            ...
            {
                Image = {
                    Color="0.75 0.75 0.75 0", /*Material= "assets/content/ui/ui.background.tile.psd", */
                }
                ,
                RectTransform = {
                    AnchorMin=$"0 0", AnchorMax=$"1 1"
            ...
            if (kit.Cooldown > 0 && playerData.Cooldown - 1 < GetCurrentTime() || kit.Cooldown == 0)
            {
                container.Add(new CuiPanel
                {
                    ...
                    ,
                    RectTransform = {
                        AnchorMin=$"0 0", AnchorMax=$"0.99 0.99"
                    }
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiTextComponent {
                            Color="1 1 1 1", Text=$"<b>{kit.DisplayName.ToUpper()}</b>", FontSize=16, Font="robotocondensed-regular.ttf", Align=TextAnchor.MiddleCenter,
                        }
                        , new CuiRectTransformComponent {
                            AnchorMin=$"0 -0.2", AnchorMax=$"1 0.8"
                        }
                        , new CuiOutlineComponent {
                            Color="0 0 0 0.3", Distance="-0.5 0.5"
                        }
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiTextComponent {
                            Color="0.85 0.85 0.85 1.00", Text=GetMsg("UI GIVE", player), FontSize=12, Font="robotocondensed-regular.ttf", Align=TextAnchor.MiddleCenter,
                        }
                        , new CuiRectTransformComponent {
        ...
        /*        var AnchorType = kit.Cooldown / (float)time.TotalSeconds - 0.03f;
                ...
                CuiHelper.DestroyUi(player, $"ui.kits.{kit.Name}");
                CuiHelper.DestroyUi(player, $"ui.kits.{kit.Name}.img");
                container.Add(new CuiElement
                {
                    Name = $"ui.kits.{kit.Name}",
                    Parent = $"ui.kits.main.{kit.Name}",
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiTextComponent {
                            Color="0.85 0.85 0.85 1.00", Text=TimeExtensions.FormatShortTime(time), FontSize=12, Font="robotocondensed-regular.ttf", Align=TextAnchor.MiddleCenter,
                        }
                        , new CuiRectTransformComponent {
                            AnchorMin=$"0 0", AnchorMax=$"1 0.3"
                        }
        ...
        private KitData GetPlayerData(string name, ulong playerid = 15786457)
        {
