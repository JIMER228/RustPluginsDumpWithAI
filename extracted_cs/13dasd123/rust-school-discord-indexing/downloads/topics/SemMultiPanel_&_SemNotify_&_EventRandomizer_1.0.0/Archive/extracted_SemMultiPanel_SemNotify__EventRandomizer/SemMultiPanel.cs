...
{
    [Info("SemMultiPanel", "FreePlugins", "1.0.0")]

    public class SemMultiPanel : RustPlugin
    {
        #region Vars
        [PluginReference] private Plugin ImageLibrary, EventRandomizer, NoEscape, SemNotify;
            ...
            public static Configuration DefaultConfig()
            {
                return new Configuration
                {
                    ...
                    MenuCmds =
                    {
                        ...
                        ["https://i.imgur.com/HYoXoOu1.png"] = "chat.say /friends1",
                        ["https://i.imgur.com/HYoXoOu2.png"] = "chat.say /friends2",
                        ["https://i.imgur.com/HYoXoOu.png"] = "chat.say /friends3",
        ...
        private void OnlineUi(BasePlayer player)
        {
            ...
            if (IsOpen)
            {
                container.Add(new CuiElement
                {
                    ...
                    Components =
                            {
                                new CuiTextComponent{Color = $"{HexToRustFormat("#E8E2D9E5")}", Text = $"{BasePlayer.activePlayerList.Count}/{ConVar.Server.maxplayers}", Align = TextAnchor.MiddleCenter, FontSize = 13, Font = "robotocondensed-bold.ttf", FadeIn = fadein},
        ...
        {
            if (SemNotify != null)
                SemNotify?.Call("SendNotify", player, type, message, show);
            else
