...
{
	[Info("ServerPanel Pop Ups", "https://discord.gg/dNGbxafuJn", "1.0.1")]
	public class ServerPanelPopUps : RustPlugin
	{
			...
			public List<PopUpEntry> PopUps = new()
			{
					...
					Content = new PopUpEntry.ContentUI
					{
						...
						ContentElements = new List<UiElement>
						{
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "4 -346", "394 -4"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-popups-banner-rules.png?raw=true",
								randomName: "PopUp.ServerRules.Banner"), // Banner
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "410 -54", "438 -26"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-icon-rules.png?raw=true",
						...
						ScrollView = new PopUpEntry.ScrollViewUI
						{
							...
							{
								UiElement.CreateLabel(
									InterfacePosition.CreatePosition("0 1", "0 1", "0 -350", "445 0"),
				...
				new()
				{
					...
					Content = new PopUpEntry.ContentUI
					{
						...
						{
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "4 -346", "394 -4"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-popups-banner-commands.png?raw=true",
								randomName: "PopUp.ServerCommands.Banner"), // Banner
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "410 -54", "438 -26"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-icon-commands.png?raw=true",
				...
				new()
				{
					...
					Content = new PopUpEntry.ContentUI
					{
						...
						{
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "4 -346", "394 -4"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-popups-banner-binds.png?raw=true",
								randomName: "PopUp.ServerBinds.Banner"), // Banner
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "410 -54", "438 -26"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-icon-binds.png?raw=true",
				...
				new()
				{
					...
					Content = new PopUpEntry.ContentUI
					{
						...
						{
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "4 -346", "394 -4"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-popups-banner-contacts.png?raw=true",
								randomName: "PopUp.ServerContacts.Banner"), // Banner
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "410 -54", "438 -26"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-icon-contacts.png?raw=true",
				...
				new()
				{
					...
					Content = new PopUpEntry.ContentUI
					{
						...
						{
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "4 -346", "394 -4"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-popups-banner-info.png?raw=true",
								randomName: "PopUp.ServerInfo.Banner"), // Banner
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "410 -54", "438 -26"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-icon-info.png?raw=true",
							...
							UiElement.CreateImage(InterfacePosition.CreatePosition("0 1", "0 1", "4 -346", "394 -175"),
								...
								randomName: "PopUp.ServerInfo.Hover"), // Hover
							UiElement.CreateImage(
								InterfacePosition.CreatePosition("0 1", "0 1", "169 -205", "229 -145"),
								"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-button-play.png?raw=true",
							...
							UiElement.CreateButton(
								...
								command:
								"serverpanelpopups_broadcastvideo https://github.com/TheMevent/PluginsStorage/raw/main/Images/ServerPanel/rust-official-trailer.mp4",
		...
		public class PopUpEntry
		{
			...
			{
				CloseButton.Show(player, container, Layer + ".Content", Layer,
			...
			public class BackgroundUI
			{
					...
					string cmdBG = "")
				{
					...
					Background.Get(ref container, player, ParentLayer, name);
			...
			public class ContentUI
			{
					...
					Action<string> callback = null)
				{
					...
					if (UseScrolling)
						ScrollView?.Get(player, container, name);
				...
				case "edit_popup":
				{
					...
					switch (arg.GetString(1))
					{
							...
							switch (arg.GetString(2))
							{
								case "add":
								{
									...
									switch (targetList)
									{
										...
										case "scroll":
										{
											editData.popUpEntry.Content.ScrollView.ScrollElements.Add(UiElement.CreatePanel(
												InterfacePosition.CreatePosition(0.5f, 0.5f, 0.5f, 0.5f, -50, -50, 50, 50),
												new IColor("#FFFFFF", 100)));
											break;
										}
								...
								case "move":
								{
									...
									var targetList = arg.GetString(3);
									var targetMode = arg.GetString(4);
									...
									switch (targetList)
									{
										...
										case "scroll":
										{
											switch (targetMode)
											{
												...
												case "down":
												{
													editData.popUpEntry.Content.ScrollView.ScrollElements.MoveDown(index);
													break;
												}
											}
						...
						case "field":
						{
							...
							{
								FieldElementUI(container, arg.GetString(0), parent, targetField, targetField.GetValue(editPageData.popUpEntry));
							});
							break;
						}
								...
								case "set":
								{
									...
									UpdateUI(player, container =>
									{
										if (editPageData.isTextEditing)
											ShowTextEditorLinesUI(ref container, editPageData);
										else
								...
								case "lang":
								{
									switch (arg.GetString(3))
									{
										case "select":
										{
											...
											UpdateUI(player, container =>
											{
												ShowTextEditorLangsUI(editPageData, container);
								...
								case "line":
								{
									...
									switch (textAction)
									{
										case "set":
										{
											...
											UpdateUI(player, container => ShowTextEditorLinesUI(ref container, editPageData));
											break;
										}
										...
										case "add":
										{
											...
											UpdateUI(player,
												container =>
												{
													...
													var totalHeight = text.Count * textLineHeight + (text.Count - 1) * UI_TextEditor_Lines_Margin_Y;

													totalHeight += 34 + 20;

													ShowTextEditorScrollLinesUI(ref container, editPageData, totalHeight);
				...
				case "edit_element":
				{
					...
					switch (arg.GetString(1))
					{
						case "start":
						{
							...
							var elementLayer = arg.GetString(3);
							var elementIndex = arg.GetInt(4);
							
							var editPageData = EditPopUpData.Get(player.userID);
							if (!editPageData.StartEditElement(elementIndex,elementLayer, Layer + ".Content", targetList))
								return;
						...
						case "save":
						{
							...
							UpdateUI(player, container =>
							{
								PageEditorFieldUI(container, editPageData.editingElementLayer, editPageData.elementIndex, editPageData.editingElement);
							});
						...
						case "field":
						{
								...
								UpdateUI(player, container =>
							{
								...
								FieldElementUI(container, arg.GetString(0), parent, targetField, targetField.GetValue(editPageData.editingElement));
							});
							break;
						}
								...
								case "set":
								{
									...
									switch (arg.GetString(5))
									{
										case "hex":
										{
											...
											if (targetField.GetValue(editPageData.editingElement) is not IColor targetValue) return;
		...
		private void ShowPageEditorPanel(BasePlayer player)
		{
			...
			}, Layer, EditingLayerPopUpEditor, EditingLayerPopUpEditor);
			...
			ShowCloseButtonUI(container, EditingLayerPopUpEditor, EditingLayerPopUpEditor + ".CloseButton",
				EditingLayerPopUpEditor,
				$"{CmdMainConsole} edit_popup save");
			...
			foreach (var property in targetFields)
			{
				...
				FieldElementUI(container, "edit_popup", targetFieldLayer, property, property.GetValue(editData.popUpEntry));
			...
			TitleEditorUI(container, EditingLayerPopUpEditor + ".Selection", ref offsetY, "CONTENT ELEMENTS", margin: 0f);
			...
			foreach (var cuiElement in editData.popUpEntry.Content.ContentElements)
			{
				...
				var targetLayer = container.Add(new CuiPanel
					{
				...
				PageEditorFieldUI(container, targetLayer,
					elementIndex, cuiElement, 
					cmdElementRemove: "edit_popup element remove content",
					cmdStartEdit: "edit_element start content",
					cmdMove: "edit_popup element move content");
			...
			foreach (var cuiElement in editData.popUpEntry.Content.ScrollView.ScrollElements)
			{
				...
				PageEditorFieldUI(container, targetLayer,
					elementIndex, cuiElement,
					cmdElementRemove: "edit_popup element remove scroll",
					cmdStartEdit: "edit_element start scroll",
					cmdMove: "edit_popup element move scroll");
			...
			CuiHelper.AddUi(player, container.ToJson().Replace("{PAGE_EDITOR_SCROLL_SIZE}", (Mathf.Abs(offsetY) + 100).ToString("N")));
		}
		...
		private void ShowElementEditorPanel(BasePlayer player)
		{
			...
			FieldElementUI(container, "edit_element", enabledLayer, enabledField, enabledField?.GetValue(targetElement));
			...
			TitleEditorUI(container, EditingLayerElementEditor + ".Selection", ref offsetY, "RECT TRANSFORM", margin: fieldMarginY);
			...
			if (targetElement is InterfacePosition interfacePos)
			{
				...
				foreach (var positionField in typeof(InterfacePosition).GetFields())
				{
					...
					}, EditingLayerElementEditor + ".Selection", targetFieldLayer + ".Background", targetFieldLayer + ".Background");

					FieldElementUI(container, "edit_element",targetFieldLayer, positionField, positionField.GetValue(interfacePos));
			...
			{
				TitleEditorUI(container, EditingLayerElementEditor + ".Selection", ref offsetY, "TEXT STYLE", margin: fieldMarginY);
			...
			{
				TitleEditorUI(container, EditingLayerElementEditor + ".Selection", ref offsetY, "PANEL STYLE", margin: fieldMarginY);
				...
				foreach (var panelField in targetFields)
				{
					...
					FieldElementUI(container,"edit_element", targetFieldLayer, panelField, panelField.GetValue(targetElement));
			...
			{
				TitleEditorUI(container, EditingLayerElementEditor + ".Selection", ref offsetY, "IMAGE STYLE", margin: fieldMarginY);
				...
				foreach (var textField in targetFields)
				{
					...
					FieldElementUI(container,"edit_element", targetFieldLayer, textField, textField.GetValue(targetElement));
			...
			string cmdMove = "edit_popup element move")
		{
			...
			container.Add(new CuiElement
			{
				...
				Components =
				{
					...
					{
						Color = "0 0 0 0",
						Command = $"{CmdMainConsole} {cmdElementRemove} {elementIndex}"
					},
					new CuiRectTransformComponent
					{
						AnchorMin = "0 0", AnchorMax = "1 1"
			...
			container.Add(new CuiElement
			{
				...
				Components =
				{
					...
					{
						Color = "0 0 0 0",
						Command = $"{CmdMainConsole} {cmdStartEdit} {parentLayer} {elementIndex}"
					},
					new CuiRectTransformComponent
					{
						AnchorMin = "0 0", AnchorMax = "1 1"
			...
			container.Add(new CuiElement
			{
				Parent = cuiLayer + ".Button.Move.Up",
				Components =
				{
					new CuiButtonComponent
					{
			...
			container.Add(new CuiElement
			{
				Name = cuiLayer + ".Button.Move.Down",
				Parent = cuiLayer,
				Components =
				{
					new CuiRawImageComponent
			...
			container.Add(new CuiElement
			{
				Parent = cuiLayer + ".Button.Move.Down",
				Components =
				{
					new CuiButtonComponent
					{
			...
			string cmdEdit = "")
		{
			...
			var Title = UiElement.CreateImage(
				...
				"https://github.com/TheMevent/PluginsStorage/blob/main/Images/ServerPanel/serverpanel-icon-edit-ui.png?raw=true");
		...
		private void PositionFieldElementUI(CuiElementContainer container, InterfacePosition interfacePos)
		{
			...
			}, EditingLayerElementEditor + ".Selection.RectTransform.Position", EditingLayerElementEditor + ".Selection.RectTransform.Position.Content", EditingLayerElementEditor + ".Selection.RectTransform.Position.Content");
			...
			if (fieldValue is bool boolValue)
			{
				...
				container.Add(new CuiButton()
				{
					...
					Button =
					{
						Color = HexToCuiColor("#4D4D4D", 50),
						Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat",
						Command = $"{CmdMainConsole} {parentCommand} field {targetField.Name} {targetFieldLayer} {!boolValue}",
					},
				}, targetFieldLayer);
			}
			else
			{
				...
				else if (targetField.FieldType.IsEnum)
				{
					...
					container.Add(new CuiButton()
					{
						...
						Button =
						{
							Command = $"{CmdMainConsole} {parentCommand} field {targetField.Name} {targetFieldLayer} prev",
							Color = HexToCuiColor("#4D4D4D", 50)
						}
					...
					container.Add(new CuiButton()
					{
						...
						Button =
						{
							Command = $"{CmdMainConsole} {parentCommand} field {targetField.Name} {targetFieldLayer} next",
							Color = HexToCuiColor("#4D4D4D", 50)
						}
					}, targetFieldLayer + ".Value");
					...
					container.Add(new CuiElement()
					{
						...
						Components =
						{
							new CuiInputFieldComponent()
							{
								...
								Font = "robotocondensed-bold.ttf",
								Align = TextAnchor.MiddleCenter,
								Command = $"{CmdMainConsole} {parentCommand} field {targetField.Name} {targetFieldLayer}",
								Color = HexToCuiColor("#E2DBD3", 90),
								Text = $"{fieldValueStr}",
								NeedsKeyboard = true
							},
		...
		private void ShowPositionSelectionPanel(BasePlayer player)
		{
			...
			if (editPageData.editingElement is not InterfacePosition interfacePos)
				return;
			...
			}, EditingLayerModalAnchorSelector, EditingLayerModalAnchorSelector + ".Main", EditingLayerModalAnchorSelector + ".Main");
				...
				for (float x = 0; x < scale; x += 1f)
				{
					...
					container.Add(new CuiButton
					{
						...
						Button =
						{
							...
							Command = $"{CmdMainConsole} edit_element color set {fieldName} {parentLayer} hex {ColorUtility.ToHtmlStringRGB(targetColor)}"
						}
					}, mainLayer);
		...
		private void ShowTextEditorPanel(BasePlayer player)
		{
			...
			var totalHeight = _langList.Count * UI_TextEditor_Lang_Height + (_langList.Count - 1) * UI_TextEditor_Lang_Margin_Y;
			...
			}, EditingLayerModalTextEditor + ".Main", EditingLayerModalTextEditor + ".Main.Select.Lang", EditingLayerModalTextEditor + ".Main.Select.Lang");
			...
			}, EditingLayerModalTextEditor + ".Main.Select.Lang", EditingLayerModalTextEditor + ".Main.Edit.Select.Lang.Panel", EditingLayerModalTextEditor + ".Main.Edit.Select.Lang.Panel");
			...
			var fontSize = Convert.ToInt32(editPageData.editingElement.GetType().GetField("FontSize")?.GetValue(editPageData.editingElement));
			Enum.TryParse<TextAnchor>(editPageData.editingElement.GetType().GetField("Align")?.GetValue(editPageData.editingElement)?.ToString(), out var align);
			...
			}, EditingLayerModalTextEditor + ".Main", EditingLayerModalTextEditor + ".Main.Edit.Text", EditingLayerModalTextEditor + ".Main.Edit.Text");
			...
			var targetFields = new List<FieldInfo>
			{
				...
				editPageData.editingElement.GetType().GetField("FontSize"),
				editPageData.editingElement.GetType().GetField("Align"),
				editPageData.editingElement.GetType().GetField("TextColor")
			};
			
			totalHeight = targetFields.Count * UI_TextEditor_TextStyle_Height + (targetFields.Count - 1) * UI_TextEditor_TextStyle_Margin_Y;
			...
			}, EditingLayerModalTextEditor + ".Main", EditingLayerModalTextEditor + ".Main.Text.Style", EditingLayerModalTextEditor + ".Main.Text.Style");
			...
			}, EditingLayerModalTextEditor + ".Main.Text.Style", EditingLayerModalTextEditor + ".Main.Edit.Text.Style.Panel", EditingLayerModalTextEditor + ".Main.Edit.Text.Style.Panel");
			...
			foreach (var targetField in targetFields)
			{
				...
				FieldElementUI(container, "edit_element", EditingLayerModalTextEditor + $".Main.Text.Style.Field.{targetField.Name}", targetField,
					targetField.GetValue(editPageData.editingElement));
		...
		private void ShowTextEditorScrollLinesUI(ref CuiElementContainer container, EditPopUpData editPageData, float totalHeight)
		{
			#region Scroll
			...
			}, EditingLayerModalTextEditor + ".Main.Edit.Text", EditingLayerModalTextEditor + ".Main.Edit.Text.Scroll.Panel", EditingLayerModalTextEditor + ".Main.Edit.Text.Scroll.Panel");
		...
		private void ShowTextEditorLangsUI(EditPopUpData editPageData, CuiElementContainer container)
		{
			var offsetY = 0f;
			foreach (var (flagPath, langKey, langName) in _langList)
			{
				...
				container.Add(new CuiPanel
					...
					}, EditingLayerModalTextEditor + ".Main.Select.Lang.Scroll.View", EditingLayerModalTextEditor + $".Main.Select.Lang.Item.{langKey}",
		...
		private void ShowTextEditorLinesUI(ref CuiElementContainer container, 
			EditPopUpData editPageData)
		{
			var text = editPageData.GetText();
			...
			for (var index = 0; index < text.Count; index++)
			{
				...
				container.Add(new CuiPanel
					{
						...
						{
							AnchorMin = "0 1", AnchorMax = "1 1", 
							OffsetMin = $"0 {offsetY - textLineHeight}",
							OffsetMax = $"-40 {offsetY}"
						}
					}, EditingLayerModalTextEditor + ".Main.Edit.Text.Scroll.View", EditingLayerModalTextEditor + $".Main.Edit.Text.Line.{index}", EditingLayerModalTextEditor + $".Main.Edit.Text.Line.{index}");
				...
				container.Add(new CuiElement
				{
					...
					Components = {
						...
						new CuiRectTransformComponent { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "12 -8", OffsetMax = "28 8" }
					}
				});
				...
				if (index == text.Count - 1)
					...
					offsetY = offsetY - textLineHeight - UI_TextEditor_Lines_Margin_Y;
			}
			...
			container.Add(new CuiPanel
				{
					Image = { Color = "0 0 0 0" },
					RectTransform ={ AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = $"0 {offsetY - 34}", OffsetMax = $"-40 {offsetY}" }
				}, EditingLayerModalTextEditor + ".Main.Edit.Text.Scroll.View", EditingLayerModalTextEditor + $".Main.Edit.Text.Line.{text.Count}", EditingLayerModalTextEditor + $".Main.Edit.Text.Line.{text.Count}");
			...
			container.Add(new CuiElement
			{
				...
				Components = {
					new CuiTextComponent { 
						...
						Text = "+ ADD NEW LINE", Font = "robotocondensed-bold.ttf", FontSize = 14, Align = TextAnchor.MiddleLeft, Color = "0.8117647 0.2627451 0.1764706 0.9019608"
					},
					new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "5 0", OffsetMax = "-5 0" }
				}
			});
		...
		private class EditPopUpData
		{
			...
			public string editingElementParent,
				editingElementLayer,
				editingElementName, editingTargetList;

			public int elementIndex;

			public bool StartEditElement(int elementID, string elementLayer, string parent, string targetList)
			{
				elementIndex = elementID;

				editingElementLayer = elementLayer;
			...
			{
				switch (editingTargetList)
				{
					case "content":
					{
						return popUpEntry.Content.ContentElements;
					}

					case "scroll":
					{
						return popUpEntry.Content.ScrollView.ScrollElements;
					}
			...
			{
				if (string.IsNullOrWhiteSpace(_targetLang) || _targetLang == "en") return editingElement.Text;
