...
{
    [Info("TPWipeSchedule", "/https://blackplugin.ru/", "11.0.1")]
    public class TPWipeSchedule : RustPlugin
    {
        ...
        private ConfigData GetDefaultConfig()
        {
            ...
            {
                Delay = 7200,
                ActiveImage = "https://gspics.org/images/2024/07/01/0zLFAj.png",
                ...
                {
                    {
                        1, new WipeClass
                        {
                            image = "https://i.ibb.co/CtXhFdS/0AVD15F.png",
                    ...
                    },
                    {
                        9, new WipeClass
                        {
                            image = "https://i.ibb.co/dDgGjYg/XLwFFCp.png",
                            type = Types.WIPE,
        ...
        {
            PrintWarning("\n-----------------------------\n" +
            "     Author - https://blackplugin.ru/\n" +
            "-----------------------------");
            PrintWarning("  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            PrintWarning($"     {Name} v{Version} loading");
            PrintWarning($"        Plugin loaded - OK");
            PrintWarning("  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            ImageLibrary.Call("AddImage", $"https://gspics.org/images/2024/07/01/0zF2eh.png", "ahDNpde");
