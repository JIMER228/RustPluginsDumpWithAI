...
{
    [Info("IQGradeRemove", "BlackPlugin.ru", "10.0.1")]
    ...
    public class IQGradeRemove : RustPlugin
    {
        ...
        Object OnStructureUpgrade(BaseCombatEntity entity, BasePlayer player, BuildingGrade.Enum grade)
        {
            ...
            if(entity.prefabID is 132854323 or 3285432) return null;
        ...
        private Boolean IsFriends(BasePlayer player, BasePlayer.EncryptedValue<UInt64> targetPlayerID) => IsFriends(player, targetPlayerID.Get());
        ...
        private void OnEntityBuilt(Planner plan, GameObject go)
        {
            ...
            if(entity.prefabID is 132854323 or 3285432) return;
            ...
            private void Building_AllObjectButton()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent
                        {
                            AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-17.33321 -17.3328544",
        ...
        /// <summary>
        /// - Исправления к обновлению игры (установите после обновления RUST)
        /// - Исправлена работа со старыми пулами
