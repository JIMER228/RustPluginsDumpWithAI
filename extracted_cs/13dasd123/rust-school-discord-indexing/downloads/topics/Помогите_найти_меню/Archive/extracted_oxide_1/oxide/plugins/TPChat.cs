...
{
    [Info("TPChat", "https://blackplugin.ru", "11.0.1")]
    [Description("Chat")]
    class TPChat : RustPlugin
    {
        ...
        private void DrawUI_IQChat_Mute_And_Ignore_Player_Panel(BasePlayer player, SelectedAction Action, Int32 Page = 0, String SearchName = null)
        {
            ...
            else
            {
                ...
                DrawUI_IQChat_Mute_And_Ignore_Player(player, Action, playerList.Skip(25 * Page).Take(25));
            }
        }
        ...
        private IEnumerable<T> GetPageOfPlayers<T>(IEnumerable<T> items, Int32 page) => items != null ? items.Skip(25 * page).Take(25) : Enumerable.Empty<T>();
        ...
        private void DrawUI_IQChat_Update_MuteChat_All(BasePlayer player)
        {
            ...
            InterfaceAdministratorChat = InterfaceAdministratorChat.Replace("%IMAGE%", !GeneralInfo.TurnMuteAllChat ? _imageUI.GetImage("ICON_CHAT_AND_VOIC_OFF") : _imageUI.GetImage("ICON_CHAT_AND_VOIC_ON"));

            CuiHelper.DestroyUi(player, "ModeratorMuteAllChat_Btn");
        ...
        private class InterfaceBuilder
        {
                        ...
                        private void BuildingVisualNick()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiTextComponent { Text = "%NICK_DISPLAY%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 1" },
                    new CuiRectTransformComponent { AnchorMin = "0.255 0.32", AnchorMax = "0.4 0.5", OffsetMax = "0 0" }
                }
                });
            ...
            private void BuildingStaticContext()
            {
                ...
                container.Add(new CuiElement
                {
                    Name = UI_Chat_Context,
                    Parent = ".Mains",
                    Components = 
                    {
                        new CuiRawImageComponent { Color = "1 1 1 1", Png = _imageUI.GetImage("MAIN") },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTING_ELEMENT%", Font = "robotocondensed-regular.ttf", FontSize = 8, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.27 0.65", AnchorMax = "0.5 0.71", OffsetMax = "0 0" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS%", Font = "robotocondensed-regular.ttf", FontSize = 8, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.435 0.66", AnchorMax = "0.48 0.7", OffsetMax = "0 0" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_PM%", Font = "robotocondensed-regular.ttf", FontSize = 8, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.425 0.74", AnchorMax = "0.425 0.74", OffsetMin = "11.075 -70.712", OffsetMax = "126.125 -57.088" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_ALERT%", Font = "robotocondensed-regular.ttf", FontSize = 8, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.425 0.74", AnchorMax = "0.425 0.74", OffsetMin = "11.075 -82.412", OffsetMax = "126.125 -68.788" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_ALERT_PM%", Font = "robotocondensed-regular.ttf", FontSize = 8, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.425 0.74", AnchorMax = "0.425 0.74", OffsetMin = "11.075 -94.412", OffsetMax = "126.125 -80.788" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%SETTINGS_SOUNDS%", Font = "robotocondensed-regular.ttf", FontSize = 8, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.425 0.74", AnchorMax = "0.425 0.74", OffsetMin = "11.075 -106.412", OffsetMax = "126.125 -92.788" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%MUTE_STATUS_PLAYER%", Font = "robotocondensed-regular.ttf", FontSize = 11, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.735 0.87", AnchorMax = "0.735 0.87", OffsetMin = "-143.174 -131.59", OffsetMax = "-120.611 -114.967" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%MUTE_STATUS_TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 7, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.735 0.87", AnchorMax = "0.735 0.87", OffsetMin = "-145.174 -141.429", OffsetMax = "-89.127 -132.508" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%IGNORED_STATUS_COUNT%", Font = "robotocondensed-regular.ttf", FontSize = 7, Align = TextAnchor.UpperLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.75 0.87", AnchorMax = "0.75 0.87", OffsetMin = "-66.98 -131.715", OffsetMax = "-11.09 -116.831" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%IGNORED_STATUS_TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 7, Align = TextAnchor.UpperLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.75 0.87", AnchorMax = "0.75 0.87", OffsetMin = "-66.98 -142.04", OffsetMax = "-19.967 -132.537" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiTextComponent { Text = "%NICK_DISPLAY_TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.255 0.353", AnchorMax = "0.5 0.5", OffsetMax = "0 0" }
                }
                });
                        ...
                        private void BuildingCheckBox()
            {
                CuiElementContainer container = new CuiElementContainer();
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0.297 0.74", AnchorMax = "0.297 0.74", OffsetMin = "%OFFSET_MIN%", OffsetMax = "%OFFSET_MAX%" }
                    }
                    });
            ...
            private void BuildingSlider()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "0.266 0.612", AnchorMax = "0.403 0.644" },
                    Image = { Color = "0 0 0 0" }
                }, UI_Chat_Context, NameSlider);

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.71 0.32", AnchorMax = "0.81 1" },
                    Button = { Command = "%COMMAND_LEFT_SLIDE%", Color = "0 0 0 0" },
                    Text = { Text = "" }
                }, NameSlider, "LEFT_SLIDER_BTN");

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.84 0.32", AnchorMax = "0.94 1" },
                    Button = { Command = "%COMMAND_RIGHT_SLIDE%", Color = "0 0 0 0" },
                    Text = { Text = "" }
                }, NameSlider, "RIGHT_SLIDER_BTN");
            ...
            private void BuildingSliderUpdateArgument()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = ParentSlider,
                    Components = {
                    new CuiTextComponent { Text = "Цвет никнейма", Font = "robotocondensed-bold.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "-0.05 0.45", AnchorMax = "0.7 1", OffsetMax = "0 0" }
                }
                });
                        ...
                        private void BuildingMuteAndIgnore()
            {
                ...
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0.414 0.198", AnchorMax = "0.757 0.566" },
                    Image = { Color = "0 0 0 0" }
                }, UI_Chat_Context, "MuteAndIgnoredPanel");
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.45 0.9", AnchorMax = "1 0.96", OffsetMax = "0 0" }
                }
                });
                ...
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0.02 0.88", AnchorMax = "0.43 0.97" },
                    Image = { Color = "0 0 0 0" }
                }, "MuteAndIgnoredPanel", "SearchPanel");
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                {
                    new CuiInputFieldComponent { Text = SearchName, FontSize = 12,Command = $"newui.cmd action.mute.ignore search.controller %ACTION_TYPE% {SearchName}", Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.4", CharsLimit = 15},
                ...
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0.86 0.025", AnchorMax = "0.984 0.118" },
                    Image = { Color = "0 0 0 0" }
                }, "MuteAndIgnoredPanel", "PanelPages");
            ...
            private void BuildingMuteAndIgnorePlayerPanel()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "0 0.15", AnchorMax = "1 0.85" },
                    Image = { Color = "0 0 0 0" }
            ...
            private void BuildingMuteAndIgnorePlayer()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "0.52 0.5", AnchorMax = "0.52 0.5", OffsetMin = "%OFFSET_MIN%", OffsetMax = "%OFFSET_MAX%" },
                    Image = { Color = "0 0 0 0" }
                }, "MuteIgnorePanelContent", "PANEL_PLAYER");
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "PANEL_PLAYER",
                    Components = {
                    new CuiTextComponent { Text = "%DISPLAY_NAME%", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.25 0", AnchorMax = "1 1", OffsetMax = "0 0" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiRawImageComponent { Png = "%IMAGE%" },
                    new CuiRectTransformComponent { AnchorMin = "0.05 0.2", AnchorMax = "0.2 0.8", OffsetMax = "0 0" }
                }
                });
            ...
            private void BuildingMuteAndIgnorePages()
            {
                ...
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0 0", AnchorMax = "0.41 0.95" },
                ...
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.6 0", AnchorMax = "1 0.95" },
            ...
            private void BuildingMuteAlert()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiRawImageComponent { Color = "1 1 1 1", Png = _imageUI.GetImage("BACK_MUTE") },
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-170.832 -170.669", OffsetMax = "170.832 170.669" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    Parent = "AlertMute",
                    Components = {
                    new CuiTextComponent { Text = "Блокировка игрока", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.03 0.92", AnchorMax = "0.8 1", OffsetMax = "0 0" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "AlertMute",
                    Components = {
                    new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.1 0.8", AnchorMax = "0.9 0.9", OffsetMax = "0 0" }
                }
                });

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.18 0.73", AnchorMax = "0.49 0.81" },
                    Button = { Command = "%COMMAND_TAKE_ACTION_MUTE_CHAT%", Color = "0 0 0 0" },
                    Text = { Text = "%BUTTON_TAKE_CHAT_ACTION%", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.4" }
                }, "AlertMute", "BUTTON_TAKE_CHAT");

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.51 0.73", AnchorMax = "0.82 0.81" },
                    Button = { Command = "%COMMAND_TAKE_ACTION_MUTE_VOICE%", Color = "0 0 0 0" },
                    Text = { Text = "%BUTTON_TAKE_VOICE_ACTION%", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.4" }
                }, "AlertMute", "BUTTON_TAKE_VOICE");
            ...
            private void BuildingMuteAlert_DropList_Title()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.1 0.65", AnchorMax = "0.9 0.7", OffsetMax = "0 0" }
                }
                });
            ...
            private void BuildingMuteAlert_DropList_Reason()
            {
                ...
                container.Add(new CuiButton
                {
                    ...
                    Text = { Text = "%REASON%", Align = TextAnchor.MiddleCenter, FontSize = 11, Color = "1 1 1 0.4" }
                }, "PanelMuteReason");
            ...
            private void BuildingIgnoreAlert()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "MUTE_AND_IGNORE_PANEL_ALERT",
                    Components = {
                    new CuiRawImageComponent { Color = "1 1 1 1", Png = _imageUI.GetImage("IGNORE_ALERT") },
                ...
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.93 0.83", AnchorMax = "1 1" },
                    Button = { Close = "MUTE_AND_IGNORE_PANEL_ALERT", Color = "0 0 0 0" },
                    Text = { Text = "" }
                }, "AlertIgnore");
                ...
                container.Add(new CuiElement
                {
                    Parent = "AlertIgnore",
                    Components = {
                    new CuiTextComponent { Text = "Настройка игнора игрока", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.03 0.85", AnchorMax = "0.8 1", OffsetMax = "0 0" } 
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                    new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.1 0.5", AnchorMax = "0.9 0.85", OffsetMax = "0 0" } 
                }
                });

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.18 0.31", AnchorMax = "0.49 0.5" },
                    Button = { Close = "MUTE_AND_IGNORE_PANEL_ALERT", Command = "%COMMAND%", Color = "0 0 0 0" },
                    Text = { Text = "%BUTTON_YES%", Align = TextAnchor.MiddleCenter, FontSize = 12, Color = "1 1 1 0.4" }
                }, "AlertIgnore");

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.51 0.31", AnchorMax = "0.82 0.5" },
                    Button = { Close = "MUTE_AND_IGNORE_PANEL_ALERT", Color = "0 0 0 0" },
                    Text = { Text = "%BUTTON_NO%", Align = TextAnchor.MiddleCenter, FontSize = 10, Color = "1 1 1 0.4" }
                }, "AlertIgnore");
            ...
            private void BuildingDropList()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "0.523 0.492", AnchorMax = "0.51 0.492", OffsetMin = "%OFFSET_MIN%", OffsetMax = "%OFFSET_MAX%" },
                    Image = { Color = "0 0 0 0" }
                }, UI_Chat_Context, "DropListIcon");
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "DropListIcon",
                    Components = {
                            new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-bold.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                            new CuiRectTransformComponent { AnchorMin = "0.05 0", AnchorMax = "1 1", OffsetMax = "0 0" }
                        }
                });
            ...
            private void BuildingOpenDropList()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = UI_Chat_Context,
                    Components = {
                    new CuiRawImageComponent { Color = "1 1 1 1", Png = _imageUI.GetImage("CHAT_AND_PREFIX")},
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-149.429 -17.38", OffsetMax = "155.093 109.1" }
                }
                });
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "OpenDropList",
                    Components = {
                    new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 11, Align = TextAnchor.UpperLeft, Color = "1 1 1 0.4" },
                ...
                container.Add(new CuiButton
                {
                    ...
                    Text = { Text = "" }
                }, "OpenDropList", "DropListClose_Button");
            ...
            private void BuildingElementDropList()
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Parent = "OpenDropList",
                    Components = {
                    new CuiRawImageComponent { FadeIn = 0.3f, Color = "1 1 1 1", Png = _imageUI.GetImage("DROPLIST_PLAYER") },
            ...
            private void BuildingModerationStatic()
            {
                ...
                {
                    CursorEnabled = true,
                    RectTransform = { AnchorMin = "0.247 0.194", AnchorMax = "0.402 0.385", OffsetMax = "0 0" },
                    Image = { Color = "0 0 0 0" }
                }, UI_Chat_Context, "ModerationLabel");

                container.Add(new CuiElement
                {
                    Name = "ModeratorMuteMenu",
                    Parent = "ModerationLabel",
                    Components = {
                    new CuiRawImageComponent { Color = "1 1 1 1", Png = _imageUI.GetImage("BACK_MODER")},
                ...
                container.Add(new CuiElement
                {
                    Parent = "ModeratorMuteMenu",
                    Components = {
                    new CuiTextComponent { Text = "%TITLE%", Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "1 1 1 0.4" },
                    new CuiRectTransformComponent { AnchorMin = "0.14 0.74", AnchorMax = "1 1", OffsetMax = "0 0" }
                }
                });
		   		 		  						  	   		  	 				  			 		  	   		  	   
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.03 0.525", AnchorMax = "0.97 0.7" },
                    Button = { Command = "%COMMAND_MUTE_MENU%", Color = "0 0 0 0" },
                    Text = { Text = "%TEXT_MUTE_MENU%", FontSize = 9, Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf", Color = "1 1 1 0.4" }
            ...
            private void BuildingMuteAllChat()
            {
                ...
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.03 0.29", AnchorMax = "0.97 0.475" },
                    Button = { Command = "%COMMAND_MUTE_ALLCHAT%", Color = "0 0 0 0" },
                    Text = { Text = "                %TEXT_MUTE_ALLCHAT%", FontSize = 9, Align = TextAnchor.MiddleLeft, Font = "robotocondensed-regular.ttf", Color = "1 1 1 0.4" }
                }, "ModeratorMuteMenu", "ModeratorMuteAllChat_Btn");

                container.Add(new CuiElement
                {
                    Parent = "ModeratorMuteAllChat_Btn",
                    Components = {
                        new CuiRawImageComponent { Png = "%IMAGE%" },
                        new CuiRectTransformComponent { AnchorMin = "0.05 0.3", AnchorMax = "0.15 0.7", OffsetMax = "0 0" }
                    }
                });
            ...
            private void BuildingMuteAllVoice()
            {
                ...
                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.03 0.05", AnchorMax = "0.97 0.235" },
                    Button = { Command = "%COMMAND_MUTE_ALLVOICE%", Color = "0 0 0 0" },
                    Text = { Text = "                %TEXT_MUTE_ALLVOICE%", FontSize = 9, Align = TextAnchor.MiddleLeft, Font = "robotocondensed-regular.ttf", Color = "1 1 1 0.4" }
                }, "ModeratorMuteMenu", "ModeratorMuteAllVoice_Btn");

                container.Add(new CuiElement
                {
                    Parent = "ModeratorMuteAllVoice_Btn",
                    Components = {
                        new CuiRawImageComponent { Png = "%IMAGE%" },
                        new CuiRectTransformComponent { AnchorMin = "0.05 0.3", AnchorMax = "0.15 0.7", OffsetMax = "0 0" }
                    }
        ...
        private void DrawUI_IQChat_Mute_And_Ignore_Player(BasePlayer player, SelectedAction Action, IEnumerable<BasePlayer> PlayerList, IEnumerable<FakePlayer> FakePlayerList = null)
        {
            ...
            if (IsReadyIQFakeActive() && FakePlayerList != null)
            {
                foreach (FakePlayer playerInList in FakePlayerList)
                {
                    ...
                    Interface = Interface.Replace("%OFFSET_MIN%", $"{-215.795 - (-150.17 * X)} {65.54 - (23.185 * Y)}");
                    Interface = Interface.Replace("%OFFSET_MAX%", $"{-85.345 - (-150.17 * X)} {83.03 - (23.185 * Y)}");
                    ...
                    Interface = Interface.Replace("%IMAGE%", Color == "1" ? _imageUI.GetImage("ICON_IGNORE_NO") : _imageUI.GetImage("ICON_IGNORE_YES"));
        ...
        private class ImageUI
        {
            ...
            {
                { "MAIN", new ImageData() },
                { "CHAT_AND_PREFIX", new ImageData() },
                { "DROPLIST_PLAYER", new ImageData() },
                { "ICON_YES", new ImageData() },
                { "ICON_NO", new ImageData() },
                { "ICON_IGNORE_YES", new ImageData() },
                { "ICON_IGNORE_NO", new ImageData() },
                { "IGNORE_ALERT", new ImageData() },
                { "BACK_MODER", new ImageData() },
                { "ICON_CHAT_AND_VOIC_OFF", new ImageData() },
                { "ICON_CHAT_AND_VOIC_ON", new ImageData() },
                { "BACK_MUTE", new ImageData() },
            };
        ...
        private void DrawUI_IQChat_OpenDropListArgument(BasePlayer player, TakeElementUser ElementType, Configuration.ControllerParameters.AdvancedFuncion Info, Int32 X, Int32 Y, Int32 Count)
        {
            ...
            Interface = Interface.Replace("%OFFSET_MIN%", $"{-140.329 - (-95 * X)} {9.243 + (Y * -35)}");
            Interface = Interface.Replace("%OFFSET_MAX%", $"{-52.271 - (-95 * X)} {35.568 + (Y * -35)}");
            Interface = Interface.Replace("%COUNT%", Count.ToString());
                ...
                private new void LoadDefaultMessages()
        {
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["IQCHAT_TITLE_IGNORE_TITLES"] = "DO YOU REALLY WANT TO IGNORE\n{0}?",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["IQCHAT_CONTEXT_NICK_DISPLAY_MESSAGE"] = "люблю TPChat",
                ...
                ["IQCHAT_CONTEXT_SLIDER_PREFIX_TITLE_DESCRIPTION"] = "Префикс", /// 
                ...
                ["IQCHAT_TITLE_IGNORE_TITLES"] = "ВЫ ДЕЙСТВИТЕЛЬНО ХОТИТЕ ИГНОРИРОВАТЬ\n{0}?",
                ["IQCHAT_TITLE_IGNORE_TITLES_UNLOCK"] = "ВЫ ХОТИТЕ СНЯТЬ ИГНОРИРОВАНИЕ С ИГРОКА\n{0}?",
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["IQCHAT_TITLE_IGNORE_TITLES"] = "¿REALMENTE QUIERES IGNORAR\n{0}?",
                ["IQCHAT_TITLE_IGNORE_TITLES_UNLOCK"] = "¿QUIERES QUITARLE AL JUGADOR LO DE IGNORAR?\n{0}?",
        ...
        private void DrawUI_IQChat_Mute_Alert_Reasons(BasePlayer player, BasePlayer Target, String Reason, Int32 Y, MuteType Type, UInt64 IDFake = 0)
        {
            ...
            Interface = Interface.Replace("%OFFSET_MIN%", $"-105 {165.42 - (Y * 34.6)}");
            Interface = Interface.Replace("%OFFSET_MAX%", $"105 {192.42 - (Y * 34.6)}");
                ...
                case TakeElementUser.Chat:
                    {
                        ...
                        Title = "Выберите цвет текста в чате";
                ...
                private void DrawUI_IQChat_Context(BasePlayer player)
        {
            ...
            if (ControllerParameter.VisualParametres.PrefixType == SelectedParametres.DropList || ControllerParameter.Prefixes.TurnMultiPrefixes)
                DrawUI_IQChat_DropList(player, "-318.788 54", "-130.788 79", GetLang("IQCHAT_CONTEXT_SLIDER_PREFIX_TITLE_DESCRIPTION", player.UserIDString), ControllerParameter.Prefixes.TurnMultiPrefixes ? TakeElementUser.MultiPrefix : TakeElementUser.Prefix);
            ...
            if (ControllerParameter.VisualParametres.ChatColorType == SelectedParametres.DropList)
                DrawUI_IQChat_DropList(player, "-318.787 24.5", "-130.787 46.5",GetLang("IQCHAT_CONTEXT_SLIDER_CHAT_MESSAGE_TITLE_DESCRIPTION", player.UserIDString),TakeElementUser.Chat);
            ...
            DrawUI_IQChat_Mute_And_Ignore(player, SelectedAction.Ignore);
        }
        ...
        void ChatCommandOpenedUI(BasePlayer player)
        {
            if (_interface == null)
            {
                PrintWarning(LanguageEn ? "We generate the interface, wait for a message about successful generation" : "Генерируем интерфейс, ожидайте сообщения об успешной генерации");
        ...
        private void DrawUI_IQChat_Update_Check_Box(BasePlayer player, ElementsSettingsType Type, String OffsetMin, String OffsetMax, Boolean StatusCheckBox)
        {
            ...
            Interface = Interface.Replace("%IMAGE%", !StatusCheckBox ? _imageUI.GetImage("ICON_YES") : _imageUI.GetImage("ICON_NO"));
            Interface = Interface.Replace("%OFFSET_MIN%", OffsetMin);
            Interface = Interface.Replace("%OFFSET_MAX%", OffsetMax);
        ...
        private void DrawUI_IQChat_Update_MuteVoice_All(BasePlayer player)
        {
            ...
            InterfaceAdministratorVoice = InterfaceAdministratorVoice.Replace("%IMAGE%", !GeneralInfo.TurnMuteAllVoice ? _imageUI.GetImage("ICON_CHAT_AND_VOIC_OFF") : _imageUI.GetImage("ICON_CHAT_AND_VOIC_ON"));

            CuiHelper.DestroyUi(player, "ModeratorMuteAllVoice_Btn");
