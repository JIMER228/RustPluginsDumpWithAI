...
{
    [Info("TPKits", "/https://blackplugin.ru/", "11.0.1")]
    class TPKits : RustPlugin
    {
        ...
        {
            PrintWarning("Благодарим за приобритение плагина на сайте blackplugin.ru. Если вы приобрели этот плагин на другом ресурсе знайте - это лишает вас гарантированных обновлений!");
            Config.Clear();
        ...
        private void OnServerInitialized()
        {
            ...
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/07/02/0zC8wQ.png", "fonKits");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/4Z6BDGs/W3kwUk2.png", "fonDescriptionKit");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/FqN6y8p/AojY4be.png", "canOpen");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/pfC9C8T/ggcEKlM.png", "fonItemsKit");
            ImageLibrary.Call("AddImage", $"https://i.ibb.co/nrKxb6X/8iuRY3u.png", $"mailbox_1812087291");
        ...
        private KitData GetPlayerData(string name, ulong playerid = 1)
        {
            if (!PlayersData.ContainsKey(playerid)) 
                PlayersData[playerid] = new Dictionary<string, KitData>();
            if (!PlayersData[playerid].ContainsKey(name)) 
                PlayersData[playerid][name] = new KitData();
