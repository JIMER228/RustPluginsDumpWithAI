...
{ 
    [Info("VKBot", "/https://blackplugin.ru/", "11.0.1")] 
    ...
    { 
        ...
        {			
            ...
            ImageLibrary.Call("AddImage", "https://gspics.org/images/2024/07/01/0zF5iN.png", "BackgroundImage"); 
        ...
        { 
            ...
            { 
                ...
                {"ОповещениеОПодарках", " получить награду, если вступили в нашу группу <color=#81BEF7>{0}</color>"}, 
