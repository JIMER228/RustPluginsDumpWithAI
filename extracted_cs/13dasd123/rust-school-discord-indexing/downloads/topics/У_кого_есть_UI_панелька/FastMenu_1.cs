...
namespace Oxide.Plugins
{
    ...
    public class FastMenu : RustPlugin
    {
        ...
        private void UI_DrawInterface123(BasePlayer player)
        {
            ...
            {
                Button = { Command = $"chat.say /hair", Color = "1 0.96 0.88 0.15" },
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "-264 -30", OffsetMax = "-204 30" },
                Text = { Text = "ПРИЦЕЛ", Align = TextAnchor.MiddleCenter, FontSize = 12 }
            }, Layer);
        ...
        private void UI_DrawInterface2(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                Button = { Command = $"chat.say /obmen", Color = "1 0.96 0.88 0.15" },
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "-264 -30", OffsetMax = "-204 30" },
                Text = { Text = "ОБМЕН", Align = TextAnchor.MiddleCenter, FontSize = 12 }
            }, Layer2);
