...
{ 
    ...
    class FHitMarker : RustPlugin
    {
		...
		private void OnServerInitialized()
        {
            ...
            {
                Puts("ImageLibrary plugin is not loaded!");
                return;
            }
            LoadImages();
        }
		void LoadImages()
        {
            ...
            {
                Puts($"Error loading images: {ex.Message}");
            }
        }
		Dictionary<string, string> Images = new Dictionary<string, string>()
		{
			{ "hitmarker.kill", "https://gspics.org/images/2025/04/10/IsESsZ.png" },
			{ "hitmarker.hit.normal", "https://gspics.org/images/2025/04/10/IsEaWT.png" },
			{ "hitmarker.hit.wound", "https://gspics.org/images/2025/04/10/IsEdOK.png" },
		};
