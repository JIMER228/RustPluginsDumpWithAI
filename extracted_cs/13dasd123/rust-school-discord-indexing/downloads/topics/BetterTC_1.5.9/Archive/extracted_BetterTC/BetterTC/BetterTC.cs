        ...
        private void ShowMenu(BasePlayer player, BuildingPrivlidge cup, int page = 0){
            ...
            foreach (var list_entry in BuildingItems){
                ...
                if (config.reskin){
                	...
                	UI.Button(ref container, upgrade_3, "0 0 0 0", "", 10, (list_entry.color && !unlock2) ? "0.82 0.50" : "0.82 0.66", (list_entry.color && !unlock2) ? "0.95 0.63" : "0.95 0.79", unlock2 ? $"SENDCMD ERROR" : $"SENDCMD RESKIN {ID} {list_entry.grade} {list_entry.skinid} {page} {list_entry.color}");

                    bool ups2 = (BuildingCupboard[cup].workwallpaper != null && BuildingCupboard[cup].id == ID);
                    UI.Panel(ref container, upgrade_3, ups2 ? "0.90 0.20 0.20 0.50" : "0.80 1.00 0.50 0.30", (list_entry.color && !unlock3) ? "0.82 0.34" : "0.82 0.50", (list_entry.color && !unlock3) ? "0.95 0.47" : "0.95 0.63");  
                    UI.Image2(ref container, upgrade_3, -1501434104, 0, (list_entry.color && !unlock3) ? "0.825 0.345" : "0.825 0.505", (list_entry.color && !unlock3) ? "0.945 0.465" : "0.945 0.625");
                    UI.Button(ref container, upgrade_3, "0 0 0 0", "", 10, (list_entry.color && !unlock3) ? "0.82 0.34" : "0.82 0.50", (list_entry.color && !unlock3) ? "0.95 0.47" : "0.95 0.63", unlock3 ? $"SENDCMD ERROR" : $"SENDCMD WALLPAPER {ID} {list_entry.grade} {list_entry.skinid} {page}");
                }
