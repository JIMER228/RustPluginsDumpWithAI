...
{
    [Info("TPShop", "Forum: https://topplugin.ru Ds: alone_sempai Vk: https://vk.com/rustnastroika", "2.0.4")]
    [Description("Кастомный внутреигровой магазин")]
    internal class TPShop : RustPlugin
    {
            ...
            if (product != null)
            {
                ...
                switch (_config.economicsCustomization.TypeEconomic)
                {
                    case EconomicsType.Economics:
                        if ((bool)Economics?.Call("Withdraw", (ulong)player.userID, (double)price))
                        {
                    ...
                    case EconomicsType.ServerRewards:
                        if (ServerRewards?.Call<object>("TakePoints", (ulong)player.userID, (int)price) != null)
                        {
                            GiveProduct(player, product, amount);
                            UpdateBalance(player, themetype);
                            NotificationUI(player, NotificationType.Success, GetLang("TPShop_UI_NOTIFICATION_SUCCESSFUL_PURCHASE", player.UserIDString, product.GetProductName(player.UserIDString)));
                    ...
                    case EconomicsType.IQEconomic:
                        IQEconomic?.Call("API_REMOVE_BALANCE", (ulong)player.userID, (int)price);
                        GiveProduct(player, product, amount);
                        UpdateBalance(player, themetype);
                        NotificationUI(player, NotificationType.Success, GetLang("TPShop_UI_NOTIFICATION_SUCCESSFUL_PURCHASE", player.UserIDString, product.GetProductName(player.UserIDString)));
                        break;
        ...
        private void UPDATEAMOUNTUI(BasePlayer player, int categoryIndex, int cat, int amount)
        {
            ...
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "8 10", OffsetMax = "-8 -50" },
                Button = { Command = $"UI_HandlerShop PRODUCT_BUY_CONFIRMATION {item.ID} {cat} {amount} 1", Color = "1 1 1 0" },
                Text = { Text = GetLang("TPShop_UI_BTN_BUY", player.UserIDString), FontSize = 12, Align = TextAnchor.MiddleCenter }
            ...
            //ПЕРЕКЛЮЧАТЕЛЬ + -
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = "1 1 1 0" },
                    RectTransform = { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-50 50", OffsetMax = "0 75" }
        ...
        {
            ["0"] = "https://i.ibb.co/gtpHpHP/MAIN-FON.png",
            ["1"] = "http://postimg.su/image/FUk3Ab2E/J5WoK4d.png",
            ["2"] = "http://postimg.su/image/qAHAcpqq/ZR7bbZm.png",
            ["3"] = "http://postimg.su/image/adJpzpzU/lariGpB.png",
            ["4"] = "http://postimg.su/image/hQ20B2Ba/jjEsmL5.png",
            ["5"] = "http://postimg.su/image/JDA7i2gy/jo3WN9H.png",
            ["6"] = "http://postimg.su/image/iEhAYQg6/odqNSDS.png",
            ["7"] = "http://postimg.su/image/az2a3t3E/xOWHmh0.png",
            ["8"] = "https://i.ibb.co/nmQfgZm/BACKGROUND-ITEM.png",
            ["9"] = "https://i.ibb.co/H4jZfYp/BACKGROUND-COUNT.png",
            ["10"] = "http://postimg.su/image/fESLZHFH/z88veYB.png",
            ["11"] = "http://postimg.su/image/Ep4mkxQk/yENDy73.png",
            ["12"] = "http://postimg.su/image/kCN9JmZc/khOBy3x.png",
            ["13"] = "http://postimg.su/image/NP6q7ZVf/e0y4aM5.png",
            ["14"] = "http://postimg.su/image/ILpEJg4e/d5YRaLB.png",
            ["15"] = "http://postimg.su/image/gPAtAMTD/eV9QUa0.png",
            ["16"] = "http://postimg.su/image/1Q8PifmQ/e0FCvGc.png",
            ["17"] = "https://i.ibb.co/zscj0bW/Tbv05TC.png",
            ["18"] = "https://i.ibb.co/qCWpfVd/BACKGROUND-CATEGORY.png",
            ["19"] = "https://i.ibb.co/xzGh2py/SELECTED-PRODUCT.png",
            ["20"] = "https://i.ibb.co/f2Y5sNS/33324.png",
        };
        ...
        private void UIMAIN(BasePlayer player, ThemeType themetype)
        {
            ...
            if (_config.discountStores.DiscountPerm.Count != 0)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = "1 1 1 0" },
                    RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-313 -143", OffsetMax = "-261.91 -123" }
        ...
        private void UIPRODUCT(BasePlayer player, ThemeType themetype, int page = 0, int categoryIndex = 0)
        {
            ...
            {
                {
                    new CuiPanel
                    {
                        CursorEnabled = false,
                        Image = { Color = "1 1 1 0" },
                        RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-206 -187", OffsetMax = "330 175" },
                    },
                    PanelProduct,
                    ProductsLayer
                }
            ...
            foreach (Configuration.CategoryShop.Product item in products.Where(x => !x.ItemsError).Page(page, 24))
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    RectTransform =
                    {
                        ...
                        OffsetMin = $"{12 + (i*87)} {-87 + (u*-87)}", 
                        OffsetMax = $"{87 + (i*87)} {-12 + (u*-87)}"
                    },
            ...
            if (products.Count > 24)
            {
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = "1 1 1 0" },
                    RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "632 -220", OffsetMax = "774 -195" }
            ...
            {
                {
                    new CuiPanel
                    {
                        CursorEnabled = false,//OffsetMin = "-313 -143", OffsetMax = "-261.91 -123"
                        Image = { Color = "1 1 1 0" },
                        RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-380 -143", OffsetMax = "-285 -124" }
                    },
                    PanelProduct,
                    "BALANCE_INFO"
                },
                ...
                },
                {
                    new CuiLabel
                    {
                        RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-61.563 -9.46", OffsetMax = "-0.372 10" },
            ...
            {
                {
                    new CuiPanel
                    {
                        CursorEnabled = false,
                        Image = { Color = "1 1 1 0" },
                        RectTransform = { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = "-320 -527", OffsetMax = "-210 -187" }
                    },
                    PanelProduct,
                    CategoryLayer
                }
                ...
                private float GetBalance(BasePlayer player)
        {
            switch (_config.economicsCustomization.TypeEconomic)
            {
                case EconomicsType.Economics:
                    if (!Economics)
                        return 0f;
                    return (float)Economics?.Call<double>("Balance", (ulong)player.userID);
                case EconomicsType.ServerRewards:
                    if (!ServerRewards)
                        return 0f;
                    return (int)ServerRewards?.Call("CheckPoints", (ulong)player.userID);
                case EconomicsType.IQEconomic:
                    if (!IQEconomic)
                        return 0f;
                    return (int)IQEconomic?.Call("API_GET_BALANCE", (ulong)player.userID);
                case EconomicsType.Item:
                ...
                case EconomicsType.TPEconomic:
                    if(!TPEconomic)
                        return 0f;
                    return (float)TPEconomic?.Call("API_GET_BALANCE", (ulong)player.userID);
                default:
                    return 0f;
            }
        }
