...
{ 
    [Info("TPBotbonus", "Sempai#3239", "5.0.0")] 
    ...
    { 
        ...
        { 
            ...
            { 
                [JsonProperty(PropertyName = "VK Token группы (для сообщений)")] public string VKToken = "Заполните эти поля, и выполните команду o.reload TPBotbonus"; 
                [JsonProperty(PropertyName = "VK Token приложения (для записей на стене и статуса)")] public string VKTokenApp = "Заполните эти поля, и выполните команду o.reload TPBotbonus"; 
                [JsonProperty(PropertyName = "VKID группы")] public string GroupID = "Заполните эти поля, и выполните команду o.reload TPBotbonus"; 
            } 
            ...
            { 
                ...
                [JsonProperty(PropertyName = "Ссылка на группу ВК")] public string VKGroupUrl = "vk.com/1234"; 
            ...
            { 
                ...
                [JsonProperty(PropertyName = "Текст поста о вайпе")] public string WPostMsg = "Заполните эти поля, и выполните команду o.reload TPBotbonus"; 
        ...
        {			
            ...
            ImageLibrary.Call("AddImage", "https://i.ibb.co/k8rXBrH/f7ec5a22d194f345.png", "BackgroundImage"); 
        ...
        { 
                ...
                { 
                    ...
                    { 
                        ...
                        Text = { Text = "   Ссылка на нашу группу вк\n         https://vk.com/grim_rust", Align = TextAnchor.MiddleLeft, Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 1 1 0.6"} 
                    }, MainLayer); 
