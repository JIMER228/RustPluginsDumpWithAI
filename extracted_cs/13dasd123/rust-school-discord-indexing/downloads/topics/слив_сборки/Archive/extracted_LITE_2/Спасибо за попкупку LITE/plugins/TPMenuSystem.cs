...
{
    [Info("TPMenuSystem", "http://topplugin.ru/Sempai#3239", "5.0.0")]
    class TPMenuSystem : RustPlugin
    {
        #region Вар
        [PluginReference] Plugin ImageLibrary, TPRulesSystem, TPSkillSystem, TPWipeBlock, TPKits, TPCases, TPStatsSystem, TPTeleportation, TPReportSystem, TPSkinMenu, TPBattlePass, GameStoresRUST, TPLotterySystem, SkinDrop, TPWipeSchedule, TPBotbonus, IQChat;
        ...
        class Configuration 
        {
            ...
            [JsonProperty("QRCode изображение вк в окне с информацией")] public string VKQR = "https://imgur.com/2MruV7D.png";
        ...
        Dictionary<string, string> imageMenu = new Dictionary<string, string>() {
            ...
            ["foninfo"] = "https://imgur.com/mogwxrE.png",
            ["commandinfo"] = "https://imgur.com/2ZPHP9q.png",
        };
        ...
        void UI(BasePlayer player, string name, string command = "") {
            ...
            if (name =="bot") {
                TPBotbonus?.Call("StartTPBotbonusMainGUI", player);
            }
            if (name =="chat") {
                IQChat?.Call("ChatCommandOpenedUI", player);
            }
            if (name == "command") {
                InfoUI(player);
