...
namespace Oxide.Plugins
{
    ...
    class NameRewards : CovalencePlugin
    {
        ...
        private string GetMsg(string key, ulong playerid = 3552256) =>
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["Not"] = "You don't have \"{0}\" in your nickname!\nIf you want to get free kits - add it to the nickanme and reconnect to the server!",
                ["NotMulti"] = "You don't have {0} or {1} in your nickname!\nIf you want to get free kits - add it to the nickanme and reconnect to the server!"
            }, this);
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["Granted"] = "У вас в нике есть текст \"{0}\"!\nНаслаждайтесь китом BONUS!",
                ["Not"] = "У вас в нике нет текста \"{0}\"!\nЕсли вы хотите получить кит BONUS - добавьте этот текст к нику и перезайдите на сервер!",
