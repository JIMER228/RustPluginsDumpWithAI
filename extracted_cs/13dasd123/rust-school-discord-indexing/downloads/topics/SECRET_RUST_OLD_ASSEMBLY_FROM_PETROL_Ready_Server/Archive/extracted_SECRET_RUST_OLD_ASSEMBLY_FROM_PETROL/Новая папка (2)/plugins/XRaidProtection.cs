...
{
    [Info("XRaidProtection", "TopPlugin.ru", "1.0.9")]
	...
	{	
        ...
        private void InitializeLang()
        {
            ...
            {
                ["UI_MESSAGE"] = "NIGHT RIDING PROTECTION ACTIVE: 50%. FROM 23:15 TO 08:00!",
                ["CHAT_MESSAGE"] = "NIGHT RIDING PROTECTION ACTIVE: 50%. FROM 23:15 TO 08:00!"
            }, this);

            lang.RegisterMessages(new Dictionary<string, string>
            {
                ["UI_MESSAGE"] = "АКТИВНА НОЧНАЯ ЗАЩИТА ОТ РЕЙДА: 100%. С 14:00 ДО 13:55!",
                ["CHAT_MESSAGE"] = "АКТИВНА НОЧНАЯ ЗАЩИТА ОТ РЕЙДА: 100%. С 14:00 ДО 13:50!"
            }, this, "ru");
        }
