...
namespace Oxide.Plugins
{
    ...
    class Obmen : RustPlugin
    {
        ...
        string[] FirstWord = { "ОБМЕНЯТЬ\n100К КАМНЯ НА 300К ДЕРЕВА", "ОБМЕНЯТЬ\n25К СКРАПА НА 50К ТНК", "ОБМЕНЯТЬ\n100к руды НА 100к металла", "ОБМЕНЯТЬ\n100К руды НА 100К СЕРЫ", "ОБМЕНЯТЬ\n1к руды НА мвк", "ОБМЕНЯТЬ\n100К СКРАПА НА 10К МВК", "ОБМЕНЯТЬ\n100К СКРАПА НА 10К МВК" };
        ...
        private Dictionary<string, string> images = new Dictionary<string, string>()
        {
            ...
            ["Img2"] = "https://media.discordapp.net/attachments/1009160550942507029/1024018076083171369/metal-node.png",
            ["Img3"] = "https://media.discordapp.net/attachments/1009160550942507029/1024018075760214086/sulfur-node.png",
            ["Img4"] = "https://media.discordapp.net/attachments/1009160550942507029/1024018076552937482/ubJ_3-exWhTn86BWmgWpVA.png",
            ...
            ["Image0"] = "https://media.discordapp.net/attachments/1009160550942507029/1021470541036667051/mph.png",
            ["Image1"] = "https://media.discordapp.net/attachments/1009160550942507029/1021468291409125436/49d8lLM0IaBKTXh01a-OCQ.png",
            ["Image2"] = "https://media.discordapp.net/attachments/1009160550942507029/1021472194435489832/metal.fragments.png",
            ["Image3"] = "https://media.discordapp.net/attachments/1009160550942507029/1021468617558200351/16636074851283418131741336056482.png",
            ["Image4"] = "https://www.rust-items.com/icons/95f7bc50d1458203a0924a572269bd1f.png",
        ...
        private void DrawInterface(BasePlayer player)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = "SECRET RUST", Align = TextAnchor.MiddleCenter, FontSize = 40 }
            }, Layer);
