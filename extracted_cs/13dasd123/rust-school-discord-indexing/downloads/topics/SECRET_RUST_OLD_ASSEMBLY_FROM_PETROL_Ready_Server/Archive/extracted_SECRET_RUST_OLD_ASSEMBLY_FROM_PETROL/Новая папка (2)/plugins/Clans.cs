...
namespace Oxide.Plugins
{
    ...
    public class Clans : RustPlugin
    {
        ...
        void OnEntitySpawned(BaseEntity entity)
        {
            ...
            {
                clan.turret++;
                player.ChatMessage($"Вам осталось турелей (на клан): <color=orange>{300 - clan.turret}</color>");
            }
        }
        ...
        void NewClanUI(BasePlayer player, bool leadermode = false)
        {
            ...
            {
                CursorEnabled = true,
                Image = { Color = "0.2 0.2 0.2 0.98", Sprite = "assets/content/ui/ui.background.tile.psd" },
...
'\n'
        ...
        void removescreen(ConsoleSystem.Arg ar)
        {
        ...
        string screengreyout = "oxide.grant";
