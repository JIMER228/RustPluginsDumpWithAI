...
{
    /*ПЛАГИН БЫЛ ПОФИКШЕН С ПОМОЩЬЮ ПРОГРАММЫ СКАЧАНОЙ С https://discord.gg/dNGbxafuJn */ /*ПЛАГИН БЫЛ ПОФИКШЕН С ПОМОЩЬЮ ПРОГРАММЫ СКАЧАНОЙ С https://discord.gg/dNGbxafuJn */ [Info("Friends", "https://discord.gg/dNGbxafuJn", "4.0.51")]
...
private object OnSamSiteTarget(SamSite entity, BaseCombatEntity target)
        ...
        private string API_KEY = "Friends-213213123123sadfvqasd";
        ...
        private void OnServerInitialized()
        {
           permission.RegisterPermission("friends.checkplayer", this);
            ...
            AddImage( $"https://gspics.org/images/2023/08/15/0oMdn8.png",$"button_friend");//картинка фона
            AddImage( $"https://cdn.icon-icons.com/icons2/4018/PNG/512/electricity_setting_setup_configuration_settings_electronics_icon_255677.png",$"setting_friend");//картинка настройки
            AddImage( $"https://cdn.icon-icons.com/icons2/692/PNG/512/seo-social-web-network-internet_189_icon-icons.com_61521.png",$"addfriend_friend");//добавить в друзья
            AddImage( $"https://cdn.icon-icons.com/icons2/2189/PNG/512/arrow_right_icon_133719.png",$"pageright_friend");//вправо стрелки
            AddImage( $"https://cdn.icon-icons.com/icons2/2189/PNG/512/arrow_left_icon_133718.png",$"pageleft_friend");//влево стрелки
            AddImage( $"https://gspics.org/images/2023/08/15/0oM5YJ.png",$"settingback_friend");//фон настроек
            AddImage( $"https://gspics.org/images/2023/08/15/0oMZXX.png",$"remove_friend");//выгнать кнопка
            AddImage( $"https://gspics.org/images/2023/08/15/0oMNn3.png",$"off_friend");// кнопка выкл
            AddImage( $"https://gspics.org/images/2023/08/15/0oMYpL.png",$"on_friend");// кнопка вкл
        ...
        private void RemoveBuild(BasePlayer player, ulong friendId)
        {
            foreach (BaseNetworkable entity in BaseNetworkable.serverEntities)
            {
                ...
                {
                    if(!bp.authorizedPlayers.ToList().Exists(p => p.userid == friendId)) continue;
                    var friend = bp.authorizedPlayers.ToList().Find(p => p.userid == friendId);
