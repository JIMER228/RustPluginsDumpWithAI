    ...
    class IQRates : RustPlugin
    {
        ...
        private class OvenController : FacepunchBehaviour
        {
            ...
            private void StartCooking()
            {
                ...
                _speed = (Single)(0.5f / Multiplace); // 0.534833 * M
        ...
        void OnQuarryGather(MiningQuarry quarry, Item item)
        {
            ...
            // PrintError(GetQuarryPlayer(quarry.net.ID + 27443483688).ToString() + "   " + Converted(Types.Quarry, item.info.shortname,
        ...
        /// <summary>
        /// Обновление 1.94.31
        /// - Исправлена работа с топливом в транспорте 
        /// - Исправлена компиляция плагина после обновления игры
        ...
        {
            AddQuarryPlayer(quarry.net.ID.Value, player.userID.Get());
        }
