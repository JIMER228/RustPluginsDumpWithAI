...
namespace Oxide.Plugins
{
    ...
    {        
        ...
        {
            ProtoBuf.PersistantPlayer playerInfo = SingletonComponent<ServerMgr>.Instance.persistance.GetPlayerInfo(player.userID.Get());
            ...
            SingletonComponent<ServerMgr>.Instance.persistance.SetPlayerInfo(player.userID.Get(), playerInfo);
