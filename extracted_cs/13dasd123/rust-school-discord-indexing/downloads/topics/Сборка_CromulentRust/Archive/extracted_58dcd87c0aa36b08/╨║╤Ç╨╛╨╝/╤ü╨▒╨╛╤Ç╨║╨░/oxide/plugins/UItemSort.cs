...
{
    [Info("ItemSort", "BadMandarin", "1.0.2")]
            ...
            {
                {
                    new CuiPanel
                    {
                        ...
                        {
                            Color = "1 0.52 0 0"
                            //Color = "0.968627453 0.921568632 0.882352948 0.2"
                        },
                    },
                    "Overlay", UI_Layer
                },
                ...
                },
                {
                    new CuiButton
                    {
                        ...
                        Button = { Color = _config.sortBttnColor, Command = "UI_Sort sortloot"}, // Color: red "1 0.2 0.3 0.6"
                        Text = { Text = "" }
                    }, $"{UI_Layer}", $"{UI_Layer}.3987"
                },
                {
                    new CuiElement
                    {
                ...
                },
                {
                    new CuiButton
                    {
                        ...
                        Button = { Color = _config.sortBttnColor, Command = "UI_Sort sortmain"}, // Color: red "1 0.2 0.3 0.6"
                        Text = { Text = "" }
                    }, $"{UI_LayerMain}"
                },
                {
