...
namespace Oxide.Plugins
{
    ...
    public class Trade : RustPlugin
    {
        ...
        object CanMoveItem(Item item, PlayerInventory playerLoot, ItemContainerId targetContainer, int num, int num2)
        {
            ...
            {
                if (item.contents != null && item.contents.IsLocked() && !isSkinBox(player.userID.Get()))
                {
