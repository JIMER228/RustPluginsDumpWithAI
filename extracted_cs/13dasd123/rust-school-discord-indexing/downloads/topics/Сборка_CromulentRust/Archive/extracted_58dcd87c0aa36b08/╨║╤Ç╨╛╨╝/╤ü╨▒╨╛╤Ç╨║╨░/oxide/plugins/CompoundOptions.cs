...
namespace Oxide.Plugins
{
    ...
    class CompoundOptions : RustPlugin
    {
        ...
        private const string PERM = "CompoundOptions.zoneoff";
        #endregion
        ...
        [ChatCommand("zoneoff")]
        private void zoneoff(BasePlayer player, string command, string[] args)
        {
            ...
            configData.General.disableCompoundTrigger = true;
        }
