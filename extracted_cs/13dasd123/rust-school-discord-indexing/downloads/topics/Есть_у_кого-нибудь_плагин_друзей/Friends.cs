...
private object OnSamSiteTarget(SamSite entity, BaseCombatEntity target)
        ...
        private void OnServerInitialized()
        {
           ...
           AddImage( $"https://i.postimg.cc/zfXbkwmG/0oMdn8.png",$"button_friend");//картинка фона
            AddImage( $"https://i.postimg.cc/q7btDt0X/electricity-setting-setup-configuration-settings-electronics-icon-255677.png",$"setting_friend");//картинка настройки
            AddImage( $"https://i.postimg.cc/76JLBmKw/seo-social-web-network-internet-189-icon-icons-com-61521.png",$"addfriend_friend");//добавить в друзья
            AddImage( $"https://i.postimg.cc/PJm5HNG7/arrow-right-icon-133719.png",$"pageright_friend");//вправо стрелки
            AddImage( $"https://i.postimg.cc/4Ng35vVR/arrow-left-icon-133718.png",$"pageleft_friend");//влево стрелки
            AddImage( $"https://i.postimg.cc/Jz7zw1pT/0oM5YJ.png",$"settingback_friend");//фон настроек
            AddImage( $"https://i.postimg.cc/N0HQgMWY/0oMZXX.png",$"remove_friend");//выгнать кнопка
            AddImage( $"https://i.postimg.cc/02yxzZLV/0oMNn3.png",$"off_friend");// кнопка выкл
            AddImage( $"https://i.postimg.cc/DfB33L8L/0oMYpL.png",$"on_friend");// кнопка вкл
