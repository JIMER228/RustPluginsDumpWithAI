...
{
    [Info("extendedindustrial", "bmgjet", "1.2.1")]
    ...
    class extendedindustrial : RustPlugin
    {
        ...
        private string permAutoRecycle = "extendedindustrial.autorecycle";//Grants chicken coop storage adapter
        //Cui Data
        ...
        private bool Attach(string pid, BaseEntity baseent, bool protect, bool checkonly)
        {
            ...
            else if (baseent is SamSite && HasPermission(pid, permSamSite)) { if (!checkonly) { SpawnPart(baseent, Quaternion.Euler(90, 90, 180), new Vector3(-.90f, .48f, 0f), protect); } return true; }
