...
{
	[Info("Wipe Block", "Puntofila.exe", "1.0.2")]
	internal class WipeBlock : RustPlugin
	{
		...
		private class Configuration
		{
			...
			public UserInterface UI = new UserInterface
			{
				...
				{
					"#8b00ff",
					"#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff",
					"#8b00ff",
					"#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff",
					"#8b00ff",
					"#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff", "#8b00ff",
		...
		private object CanMoveItem(Item item, PlayerInventory inventory, ulong targetContainer)
		{
		...
		private object OnReloadWeapon(BasePlayer player, BaseProjectile projectile)
		{
			...
			if (isBlocked)
			{
				var list = player.inventory.FindItemIDs(projectile.primaryMagazine.ammoType.itemid).ToList();
				if (list.Count == 0)
				{
		...
		private void MainUi(BasePlayer player, int type = 0, bool First = false)
		{
			...
			container.Add(new CuiButton
			{
				...
				Button =
				{
					Color = HexToCuiColor("#8b00ff", type == 0 ? 100 : 65),
			...
			container.Add(new CuiButton
			{
				...
				Button =
				{
					Color = HexToCuiColor("#8b00ff", type == 1 ? 100 : 65),
			...
			container.Add(new CuiButton
			{
				...
				Button =
				{
					Color = HexToCuiColor("#8b00ff", type == 2 ? 100 : 65),
