...
namespace Oxide.Plugins
{
    ...
    [Info("BotReSpawn", "Steenamaroo", "1.3.2", ResourceId = 0)]
    ...
    class BotReSpawn : RustPlugin
    {
        ...
        object CanPopulateLoot(ScientistNPC entity, NPCPlayerCorpse corpse) => corpse?.playerSteamID != null && !configData.Global.Allow_AlphaLoot && botInventories.ContainsKey(corpse.playerSteamID) ? true : (object)null;
        ...
        [HarmonyPatch("displayName", MethodType.Getter), AutoPatch]
        ...
        public class BotData : MonoBehaviour
        {
            ...
            public bool Hostile(BasePlayer player) => bs.NPCPlayers.ContainsKey(player.userID) ? true : player.userID != 0 && player.State.unHostileTimestamp > Network.TimeEx.currentTimestamp;
        ...
        private string[] RemoveGroupSpawn(string group)
        {
            ...
            List<global::HumanNPC> toDestroy = Pool.Get<List<global::HumanNPC>>();
            bool flag = false;
            ...
            toDestroy.Clear();
            Pool.FreeUnmanaged<global::HumanNPC>(ref toDestroy);
