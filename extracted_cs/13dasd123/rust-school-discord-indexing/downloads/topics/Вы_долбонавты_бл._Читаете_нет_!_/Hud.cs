...
namespace Oxide.Plugins
{
    ...
    internal class Hud : RustPlugin
    {
        ...
        private MySqlConnection dbConnection; // Declare dbConnection here
        ...
        private void ConnectToDatabase()
        {
            ...
            {
                string connectionString = "Server=mysql.shockbyte.fra1.shockbyte.host;Port=3306;Database=97398e8d05-artic;User=97398e8d05-artic-admin;Password=14ac33d1a7d044a9;";
                ...
                {
                    PrintError($"Failed to connect to database: {ex.Message}");
                }
            }
        }

        private void LoadHudConfigFromDatabase()
        {
            if (dbConnection.State == System.Data.ConnectionState.Open)
            {
                string query = "SELECT * FROM HudConfig WHERE ID = 1";
            ...
            {
                PrintError("Database connection is not open.");
            }
        }
