...
{
    [Info("FightZone", "Bomje-Frizen", "1.0.0")]
    public class FightZone : RustPlugin
    {
        ...
        void CreateFZ(bool AdminCreated)
        {
            ...
            IsActive = true;
            Server.Broadcast($"<color=red>[FARMILA ZONE]</color>\nИвент начался в квадрате {quad}!");
        ...
        public void timerUIq(BasePlayer player, double time)
        {
            ...
            UI.AddText(ref c, "infoqQ", "titleqQ", "1 1 1 0.9", $"До конца FARMILA ZONE [{FormatTimes(TimeSpan.FromSeconds(time))}]", TextAnchor.UpperLeft, 12, "0.5 0.5", "0.5 0.5", "-94.187 -4.775", "85.183 19.875");
        ...
        private void CreatePrivateMap(Vector3 pos)
        {
            ...
            vendingMarker.markerShopName = "FarmilaZone";
            vendingMarker.Spawn();
