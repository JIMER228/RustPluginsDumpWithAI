...
{
    [Info("Clans", "", "0.0.1", ResourceId = 14)]
    public class Clans : RustPlugin
    {
        ...
        void LoadVariables()
        {
            ...
            PointsOfKilledBradleyAPC = Convert.ToInt32(GetConfig("ТОП", "Очки: Сколько очков за танк", 1));
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string> {
                ...
                ,
                {
                 ...
                 {
                    "clanUItitle", "Клановая система <color=#0000FF>COMBAT RUST</color>"
                },
                  {
        ...
        void Init()
        {
            ...
            permission.RegisterPermission("Clans.Galaxyset", this);
            permission.RegisterPermission("Clans.71set", this);
            permission.RegisterPermission("Clans.Babyset", this);
            permission.RegisterPermission("Clans.adminset", this);
        ...
        //Custom code
        [PluginReference] private Plugin ImageLibrary, ClanTournament;
        ...
        void OnServerInitialized()
        {
            ...
            else
            {
                ...
                ImageLibrary?.Call("AddImage", "https://media.discordapp.net/attachments/1047951365516832880/1050467542373781594/Untitled-1.png", "logopng");
            }
            LoadData();
            if (enableClanRadar)
            {
            ...
            foreach (var player in BasePlayer.activePlayerList) ClanTopg(player);
        ...
        void OnEntitySpawned(BaseEntity entity)
        {
            ...
            if (clan == null)
            {
                player.ChatMessage("Вы не можете строить без клана! /clan create tag");
            ...
            if (entity.PrefabName.Contains("cupboard.tool"))
            {
                ...
                {
                    clan.cups++;
                    player.ChatMessage($"Лимит вашего клана на шкафы: <color=#18C2FF>{clan.cups}/{limcup}</color>");
                }
                if (clan.cups >= limcup)
                {
                    NextTick(() => entity.Kill());
                    player.ChatMessage($"Ваш клан достиг лимита по шкафам!");
        ...
        {
            var player = BasePlayer.FindByID((entity as BaseEntity).OwnerID);
            if (player == null)
            {
                return;
            }
        ...
        string ButtonListed = "[{\"name\":\"clans_player{id}\",\"parent\":\"clans_main7\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.001 {amin}\",\"anchormax\":\"0.998 {amax}\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{command}\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";
        ...
        private bool? CanEquipItem(PlayerInventory inventory, Item item, int targetPos)
        {
            ...
            if (clan != null)
            {
                if (clan.SkinList.ContainsKey(item.info.shortname))
                {
                    ...
                    {
                        item.GetHeldEntity().skinID = clan.SkinList[item.info.shortname];
        ...
        void OnDispenserGather(ResourceDispenser dispenser, BaseEntity entity, Item item)
        {
            ...
            if (clan != null && clan.members[player.UserIDString].GatherInfo.ContainsKey(item.info.shortname))
            {
                ...
                clan.members[player.UserIDString].FarmPlayer = clan.members[player.UserIDString].FarmPlayer + item.amount;
        ...
        void OnDispenserBonus(ResourceDispenser disp, BasePlayer player, Item item)
        {
            ...
            if (clan != null && clan.members[player.UserIDString].GatherInfo.ContainsKey(item.info.shortname))
            {
                ...
                clan.ClanPoints += 3;
                clan.members[player.UserIDString].PlayerPoints += 3;
            }
        ...
        void cmdClansGetSkinList(ConsoleSystem.Arg args)
        {
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = "<size=26>ВЫБЕРИТЕ НУЖНЫЙ СКИН ПРОСТО НАЖАВ НА НЕГО</size>", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter},
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" },
                    }
            });
        ...
        void ClanSetSkinn(BasePlayer player, string command, string[] args)
        {
            ...
            if (Set == "black")
            {
                clan.SkinList["metal.facemask"] = 2847192312;
                clan.SkinList["metal.plate.torso"] = 2847192740;
                clan.SkinList["roadsign.kilt"] = 2847194089;
                clan.SkinList["hoodie"] = 2847191782;
                clan.SkinList["pants"] = 2847191199;
                clan.SkinList["shoes.boots"] = 2847191875;
                clan.SkinList["coffeecan.helmet"] = 0;
                clan.SkinList["roadsign.jacket"] = 0;
                clan.SkinList["lmg.m249"] = 0;
                clan.SkinList["rifle.ak"] = 2847191472;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
                player.ChatMessage("Вы выбрали черный сэт!");
            }
            if (Set == "demon")
            {
                clan.SkinList["metal.facemask"] = 2396362535;
                clan.SkinList["metal.plate.torso"] = 1960028199;
                clan.SkinList["roadsign.kilt"] = 1960038887;
                clan.SkinList["hoodie"] = 839290032;
                clan.SkinList["pants"] = 839253668;
                clan.SkinList["shoes.boots"] = 1775247971;
                clan.SkinList["coffeecan.helmet"] = 0;
                clan.SkinList["roadsign.jacket"] = 0;
                clan.SkinList["lmg.m249"] = 0;
                clan.SkinList["rifle.ak"] = 1121475294;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "ahegao")
            {
                clan.SkinList["metal.facemask"] = 2853415680;
                clan.SkinList["metal.plate.torso"] = 2853416200;
                clan.SkinList["roadsign.kilt"] = 2853414987;
                clan.SkinList["hoodie"] = 2853407029;
                clan.SkinList["pants"] = 2853408785;
                clan.SkinList["shoes.boots"] = 2853415431;
                clan.SkinList["coffeecan.helmet"] = 2853414412;
                clan.SkinList["roadsign.jacket"] = 2853417272;
                clan.SkinList["lmg.m249"] = 0;
                clan.SkinList["rifle.ak"] = 2853423871;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "salat")
            {
                clan.SkinList["metal.facemask"] = 2676182710;
                clan.SkinList["metal.plate.torso"] = 2676181139;
                clan.SkinList["roadsign.kilt"] = 2676187164;
                clan.SkinList["hoodie"] = 2676195926;
                clan.SkinList["pants"] = 2676191858;
                clan.SkinList["shoes.boots"] = 2676194532;
                clan.SkinList["coffeecan.helmet"] = 0;
                clan.SkinList["roadsign.jacket"] = 0;
                clan.SkinList["lmg.m249"] = 0;
                clan.SkinList["rifle.ak"] = 0;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "red")
            {
                clan.SkinList["metal.facemask"] = 2807059503;
                clan.SkinList["metal.plate.torso"] = 2807059605;
                clan.SkinList["roadsign.kilt"] = 2807059947;
                clan.SkinList["hoodie"] = 2807056489;
                clan.SkinList["pants"] = 2807058599;
                clan.SkinList["shoes.boots"] = 2807059202;
                clan.SkinList["coffeecan.helmet"] = 0;
                clan.SkinList["roadsign.jacket"] = 0;
                clan.SkinList["lmg.m249"] = 0;
                clan.SkinList["rifle.ak"] = 2807058371;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "white")
            {
                clan.SkinList["metal.facemask"] = 2847678562;
                clan.SkinList["metal.plate.torso"] = 2847678924;
                clan.SkinList["roadsign.kilt"] = 2847681471;
                clan.SkinList["hoodie"] = 2847677385;
                clan.SkinList["pants"] = 2847677971;
                clan.SkinList["shoes.boots"] = 2847678240;
                clan.SkinList["coffeecan.helmet"] = 2847683501;
                clan.SkinList["roadsign.jacket"] = 2847683313;
                clan.SkinList["lmg.m249"] = 2847683922;
                clan.SkinList["rifle.ak"] = 2847682807;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "anonymous")
            {
                clan.SkinList["metal.facemask"] = 852867111;
                clan.SkinList["metal.plate.torso"] = 2847192740;
                clan.SkinList["roadsign.kilt"] = 2847194089;
                clan.SkinList["hoodie"] = 2847191782;
                clan.SkinList["pants"] = 2847191199;
            ...
            if (Set == "lw")
            {
                clan.SkinList["metal.facemask"] = 2859118269;
                clan.SkinList["metal.plate.torso"] = 2859119821;
                clan.SkinList["roadsign.kilt"] = 2859120302;
                clan.SkinList["hoodie"] = 2859115685;
                clan.SkinList["pants"] = 2859116801;
                clan.SkinList["shoes.boots"] = 2859117755;
                clan.SkinList["coffeecan.helmet"] = 2859125104;
                clan.SkinList["roadsign.jacket"] = 2859124743;
                clan.SkinList["lmg.m249"] = 2859124229;
                clan.SkinList["rifle.ak"] = 2859122868;
                clan.SkinList["rifle.l96"] = 0;
                clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "admin")
            {
                ...
                {
                    clan.SkinList["metal.facemask"] = 2589006659;
                    clan.SkinList["metal.plate.torso"] = 2589004697;
                    clan.SkinList["roadsign.kilt"] = 2589012267;
                    clan.SkinList["hoodie"] = 2497239256;
                    clan.SkinList["pants"] = 2585612675;
                    clan.SkinList["shoes.boots"] = 2589017818;
                    clan.SkinList["coffeecan.helmet"] = 0;
                    clan.SkinList["roadsign.jacket"] = 0;
                    clan.SkinList["lmg.m249"] = 0;
                    clan.SkinList["rifle.ak"] = 2445801655;
                    clan.SkinList["rifle.l96"] = 0;
                    clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "pig")
            {
                ...
                {
                    clan.SkinList["metal.facemask"] = 2828043768;
                    clan.SkinList["metal.plate.torso"] = 2828025086;
                    clan.SkinList["roadsign.kilt"] = 2828020257;
                    clan.SkinList["hoodie"] = 2847233656;
                    clan.SkinList["pants"] = 2817979991;
                    clan.SkinList["shoes.boots"] = 2818318586;
                    clan.SkinList["coffeecan.helmet"] = 0;
                    clan.SkinList["roadsign.jacket"] = 0;
                    clan.SkinList["lmg.m249"] = 0;
                    clan.SkinList["rifle.ak"] = 2807058371;
            ...
            if (Set == "Baby")
            {
                ...
                {
                    clan.SkinList["metal.facemask"] = 963790509;
                    clan.SkinList["metal.plate.torso"] = 963790862;
                    clan.SkinList["roadsign.kilt"] = 812154447;
                    clan.SkinList["hoodie"] = 812145060;
                    clan.SkinList["pants"] = 812150741;
                    clan.SkinList["shoes.boots"] = 861247986;
                    clan.SkinList["coffeecan.helmet"] = 812153394;
                    clan.SkinList["roadsign.jacket"] = 812156281;
                    clan.SkinList["lmg.m249"] = 0;
                    clan.SkinList["rifle.ak"] = 963791989;
                    clan.SkinList["rifle.l96"] = 0;
                    clan.SkinList["rifle.bolt"] = 0;
            ...
            if (Set == "71mc")
            {
                ...
                {
                    clan.SkinList["metal.facemask"] = 2823912906;
                    clan.SkinList["metal.plate.torso"] = 2823913978;
                    clan.SkinList["roadsign.kilt"] = 2823914389;
                    clan.SkinList["hoodie"] = 2823915389;
                    clan.SkinList["pants"] = 2823915058;
                    clan.SkinList["shoes.boots"] = 2823914748;
                    clan.SkinList["coffeecan.helmet"] = 0;
                    clan.SkinList["roadsign.jacket"] = 0;
                    clan.SkinList["lmg.m249"] = 2445799790;
                    clan.SkinList["rifle.ak"] = 2823918586;
                    clan.SkinList["rifle.l96"] = 2445788090;
                    clan.SkinList["rifle.bolt"] = 0;
        ...
        void cmdSetChangeOfClan(ConsoleSystem.Arg args)
        {
            ...
            for (int i = 0; i < clan.Change.Count; i++)
            {
                ...
                elements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent { Text = $"Установлено:\n{clan.Change.ToList()[i].Value.Need.ToString("N3", CultureInfo.GetCultureInfo("ru-RU")).Replace(",000", "")}".ToUpper(), Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter},
                ...
                elements.Add(new CuiElement()
                {
                    ...
                    Components =
                    {
                        new CuiInputFieldComponent {Align = TextAnchor.MiddleCenter,CharsLimit = 7,FontSize = 15,
                            Command = $"clan_Change {clan.Change.ToList()[i].Key} ",Font = "robotocondensed-regular.ttf",Text = "", Color = "1 0.9294118 0.8666667 1"},
                        new CuiRectTransformComponent {AnchorMin = "0 0", AnchorMax = "1 1"}
                    }
                });
                ...
                elements.Add(new CuiButton
                {
                    ...
                    Text = { Text = "OK", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
            ...
            elements.Add(new CuiButton
            {
                ...
                Text = { Text = "ЗАВЕРШИТЬ", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
        ...
        void cmdSetAvatarOfClan(ConsoleSystem.Arg args)
        {
            ...
            elements.Add(new CuiElement
            {
                ...
                Components =
                    {
                        new CuiTextComponent { Text = "<size=24>СКОПИРУЙТЕ СЮДА ССЫЛКУ И НАЖМИТЕ СОХРАНИТЬ</size>", Color = "1 0.9294118 0.8666667 0.05", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter},
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" },
                    }
            });
            ...
            {
                Button = { Color = "0.13 0.44 0.48 0.7", Command = $"clanui.page 0" },
                Text = { Text = "ЗАКРЫТЬ", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
            ...
            {
                Button = { Color = "0.25 0.25 0.23 0.9", Command = "" },
                Text = { Text = "СОХРАНИТЬ", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
        ...
        private BasePlayer GetLastBradleyAPCAttacker(uint heliNetId)
        {
            ulong player;
            LastBradleyAPCHit.TryGetValue(heliNetId, out player);
            return BasePlayer.FindByID(player);
        }
        ...
        string ButtonListedClan = "[{\"name\":\"clans_player{id}\",\"parent\":\"Clanstop_main8\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 {amin}\",\"anchormax\":\"0.995 {amax}\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{command}\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";

        string TOP = "[{\"name\":\"Clanstop_main2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.6980392\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main3\",\"parent\":\"Clanstop_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.345 0.345 0.345 0\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.31 0.28\",\"anchormax\":\"0.69 0.72\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main4\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.369 0.369 0.369 0.90\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.004 -0.02\",\"anchormax\":\"0.9955 0.097\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main5\",\"parent\":\"Clanstop_main4\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":18,\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main24\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.369 0.369 0.369 0.90\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.004 -0.28\",\"anchormax\":\"0.9935 -0.03\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main25\",\"parent\":\"Clanstop_main24\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"  Очки даются:\n  Убийство +100, добыча руды +7, разрушение бочки +2, сбитие вертолета +1500, уничтожение танка +750\n  Очки отнимаются:\n  Смерть и самоубийство -25\n  Награды выдаются после вайпа на сервере!\",\"fontSize\":10,\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main6\",\"parent\":\"Clanstop_main5\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"Clanstop_main2\",\"color\":\"0.439 0.439 0.439 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.805175 0.18\",\"anchormax\":\"0.9906773 0.93\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main7\",\"parent\":\"Clanstop_main6\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ЗАКРЫТЬ</b>\",\"fontSize\":12,\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main8\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.369 0.369 0.369 0.90\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.1\",\"anchormax\":\"0.9953553 0.98\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main9\",\"parent\":\"Clanstop_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.384 0.384 0.384 0.80\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.9809524\",\"anchormax\":\"0.9953553 1.0310777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"#\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"-0.015 0\",\"anchormax\":\"0.09 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main11\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"КЛАН\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.095 0\",\"anchormax\":\"0.4983538 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКИ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.21 0\",\"anchormax\":\"0.37 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main121\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ФАРМ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.65 0\",\"anchormax\":\"0.75 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main122\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"К/Д\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.51 0\",\"anchormax\":\"0.61 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main125\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"РЕЙД\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4 0\",\"anchormax\":\"0.5 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main124\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"    \",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 0 \"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5 0\",\"anchormax\":\"0.6 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main123\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ШКАФ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.35 0\",\"anchormax\":\"0.55 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main12\",\"parent\":\"Clanstop_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИГРОКОВ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.75 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]}]";

        string InfoTOP = "[{\"name\":\"Clanstop_info2\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.6980392\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info3\",\"parent\":\"Clanstop_info2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.1647059\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.286 0.25\",\"anchormax\":\"0.68 0.8\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info4\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.333 0.333 0.333 0.95\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 -0.06935965\",\"anchormax\":\"0.9953553 0.01\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info5\",\"parent\":\"Clanstop_info4\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b></b>\",\"fontSize\":14,\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info6\",\"parent\":\"Clanstop_info5\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"Clanstop_info2\",\"color\":\"0.392 0.392 0.392 0.90\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.825175 0.1\",\"anchormax\":\"0.9786773 0.95\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info7\",\"parent\":\"Clanstop_info6\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ЗАКРЫТЬ</b>\",\"fontSize\":14,\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info8\",\"parent\":\"Clanstop_info5\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{return}\",\"color\":\"0.392 0.392 0.392 0.90\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.64332103 0.1\",\"anchormax\":\"0.8174549 0.95\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info9\",\"parent\":\"Clanstop_info8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>НАЗАД</b>\",\"fontSize\":14,\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info10\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.333 0.333 0.333 0.95\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.009\",\"anchormax\":\"0.9953553 0.5081203\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info11\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.333 0.333 0.333 0.95\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.9173692\",\"anchormax\":\"1 1.000001\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ИМЯ ИГРОКА</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0.3428636 1\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>СТАТУС</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.2449865 0\",\"anchormax\":\"0.6094171 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ОЧКИ</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4576665 0\",\"anchormax\":\"0.7555799 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ФАРМ\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6073302 0\",\"anchormax\":\"0.9371242 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_main10\",\"parent\":\"Clanstop_info11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>КД</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.7841259 0\",\"anchormax\":\"1.045 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info12\",\"parent\":\"Clanstop_info10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.333 0.333 0.333 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.01011801\",\"anchormax\":\"1 0.9123102\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info13\",\"parent\":\"Clanstop_info3\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.333 0.333 0.333 0.95\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548413 0.51\",\"anchormax\":\"0.9953553 0.9310777\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info14\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.333 0.333 0.333 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6318366 0.1428573\",\"anchormax\":\"0.9670526 0.8928576\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info15\",\"parent\":\"Clanstop_info14\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>Лидер Клана: {lname}\n\nКоличество очков: {Points}</b>\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"-2.58 0\",\"anchormax\":\"1 1.3\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info16\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.16 0.1428573\",\"anchormax\":\"0.95 0.8928576\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info17\",\"parent\":\"Clanstop_info16\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\" Лидер Клана: {lname}\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 0.65\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info17\",\"parent\":\"Clanstop_info16\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\" Игроков в клане: {ccount}\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 -0.03\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info17\",\"parent\":\"Clanstop_info16\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\" Количество захватов {ccup}\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 -0.65\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info17\",\"parent\":\"Clanstop_info16\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\" Количество рейдов {craid}\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 -0.35\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info17\",\"parent\":\"Clanstop_info16\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\" Количество очков: {Points}\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.15 0.3\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"Clanstop_info444\",\"parent\":\"Clanstop_info17\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 -0.280035965\",\"anchormax\":\"0.8253553 -0.11\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info444\",\"parent\":\"Clanstop_info17\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 -0.06\",\"anchormax\":\"0.8253553 0.12\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info444\",\"parent\":\"Clanstop_info17\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.17\",\"anchormax\":\"0.8253553 0.35\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info444\",\"parent\":\"Clanstop_info17\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.4\",\"anchormax\":\"0.8253553 0.58\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info444\",\"parent\":\"Clanstop_info17\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.65\",\"anchormax\":\"0.8253553 0.84\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"Clanstop_info18\",\"parent\":\"Clanstop_info13\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.03318176 0.07857105\",\"anchormax\":\"0.1382089 0.9357135\",\"offsetmax\":\"0 0\"}]}]";

        string InfoTOPButton = "[{\"name\":\"clans_player{id}\",\"parent\":\"Clanstop_info12\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.001 {amin}\",\"anchormax\":\"0.998 {amax}\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\"},{\"type\":\"UnityEngine.UI.Outline\",\"color\":\"0 0 0 0.2784314\",\"distance\":\"1 -1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"CuiElement\",\"parent\":\"clans_player{id}\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"command\":\"{command}\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";


        [ConsoleCommand("clanstop_infobysteamid")]
        void cmdClansTopKeyBySteamId(ConsoleSystem.Arg arg)
        {
            var player = arg.Player();
            var clan = findClanByUser(arg.Args[0]);
            if (clan != null)
            {
        ...
        string TOPs = "[{\"name\":\"Message\",\"parent\":\"Hud\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5 0\",\"anchormax\":\"0.5 0\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";
        ...
        void ClanTopgs(BasePlayer player)
        {
            int page = 0;
            ...
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(3 * page).Take(ClanMembers.ToList().Count >= 3 ? 3 : ClanMembers.ToList().Count))
            {
                ...
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0.1675 0", AnchorMax = "1 0", OffsetMax = "0 18" },
                    Image = { Color = color }
                ...
                {
                    CursorEnabled = false,
                    RectTransform = { AnchorMin = "0 0", AnchorMax = "0.1675 0", OffsetMax = "0 18" },
                    Image = { Color = "1 1 1 0.2" }
                }, "clans_player" + key.Key, "cla" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{i}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
                }, "cla" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.tag.ToUpper(), Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
                }, "cl" + key.Key);
        ...
        string ButtonListeds = "[{\"name\":\"clans_player{id}\",\"parent\":\"Message\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"{color}\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0 0\",\"offsetmin\":\"{amin} 0\",\"offsetmax\":\"{amax} 0\"}]}]";

        [ChatCommand("tops")]
        void ClanTopg(BasePlayer player)
        {
            timer.Every(3f, () =>
            {
                CuiHelper.DestroyUi(player, "Message");
        ...
        void ClanTOPInfo(BasePlayer player, Clan clan, int page)
        {
            ...
            CuiHelper.AddUi(player, InfoTOP.Replace("{clanname}", "" + clan.tag.ToUpper())
                 .Replace("{ccount}", clan.members.Count.ToString())
                  .Replace("{ccup}", clan.Cupcount.ToString())
                  .Replace("{craid}", clan.KilledTCAll.ToString())
            ...
            else
            {
                elements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0.05318176 0.22857105", AnchorMax = "0.2482089 0.8157135" }
                    }
                });
            }
            ...
            foreach (KeyValuePair<string, PlayerStats> key in ClanMembers.Skip(11 * page).Take(ClanMembers.ToList().Count >= 10 ? 10 : ClanMembers.ToList().Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{i * (page + 1)}", Color = "1 0.9294118 0.8666667 0", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.05 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = covalence.Players.FindPlayerById(key.Key) != null ? covalence.Players.FindPlayerById(key.Key).Name : "Имя не указано", Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.3428636 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = GetPlayerStatus(key.Key, clan), Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.2449865 0", AnchorMax = $"0.6094171 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.PlayerPoints.ToString(), Color = "1 0.9294118 0.8666667 1", FontSize = 12, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.4576665 0", AnchorMax = $"0.7555799 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.FarmPlayer.ToString(), Color = "1 0.9294118 0.8666667 1", FontSize = 12, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.6073302 0", AnchorMax = $"0.9371242 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{key.Value.Killed}/{key.Value.Death}", Color = "1 0.9294118 0.8666667 1", FontSize = 12, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.7841259 0", AnchorMax = $"1.05 1" },
                }, "clans_player" + key.Key);
                i++;
            ...
            elements.Add(new CuiButton
            {
                ...
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.455 0", AnchorMax = $"0.555 0.048" },
            }, "Clanstop_info12", "clans_page");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.298 0.298 0.298 0.85", Command = page > 0 ? $"clanstop_info {clan.tag} {page - 1}" : "" },
                Text = { Text = "<", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"-4.4 -3", AnchorMax = $"-3.83 -0.2" },
            }, "clans_page");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.420 0.420 0.420 0.4" },
                Text = { Text = $"{page + 1}", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 13, Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"-3.79 -3", AnchorMax = $"-3.23 -0.2" },
            }, "clans_page");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.298 0.298 0.298 0.85", Command = ClanMembers.Skip(11 * (page + 1)).Count() > 0 ? $"clanstop_info {page + 1}" : "" },
                Text = { Text = ">", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"-3.2 -3", AnchorMax = $"-2.58 -0.2" },
            }, "clans_page");
            CuiHelper.AddUi(player, elements);
        ...
        void ClanTOP(BasePlayer player, int page)
        {
            ...
            foreach (KeyValuePair<string, Clan> key in ClanMembers.Skip(13 * page).Take(ClanMembers.ToList().Count >= 13 ? 13 : ClanMembers.ToList().Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{i * (page + 1)}", Color = "1 0.9294118 0.8666667 1", FontSize = 12, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.001 0", AnchorMax = $"0.07 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.tag.ToUpper(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.105 0", AnchorMax = $"0.9983538 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.ClanPoints.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.23 0", AnchorMax = $"0.35 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.Farm.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.65 0", AnchorMax = $"0.75 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.KilledTCAll.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 0", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.5 0", AnchorMax = $"0.6 1" },
                }, "clans_player" + key.Key);
                ...
                if ((bool)ClanTournament?.Call<bool>("CheckTournament", ulong.Parse(key.Value.owner)) == true)
                {
                    elements.Add(new CuiLabel
                    {
                        Text = { Text = "+", Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "0 0.5 0 1", Align = TextAnchor.MiddleCenter },
                        RectTransform = { AnchorMin = $"0.35 0", AnchorMax = $"0.55 1" },
                    }, "clans_player" + key.Key);
                }
                else
                {
                    elements.Add(new CuiLabel
                    {
                        Text = { Text = "-", Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0 0 1", Align = TextAnchor.MiddleCenter },
                        RectTransform = { AnchorMin = $"0.35 0", AnchorMax = $"0.55 1" },
                    }, "clans_player" + key.Key);
                }
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = key.Value.Cupcount.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 0", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.5 0", AnchorMax = $"0.6 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{clan.Killedc}/{clan.Deathc + clan.Suicidec}", Font = "robotocondensed-regular.ttf", FontSize = 12, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.51 0", AnchorMax = $"0.61 1" },
                }, "clans_player" + key.Key);
                ...
                elements.Add(new CuiLabel
                {
                    ...
                    RectTransform = { AnchorMin = $"0.75 0", AnchorMax = $"1 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiButton
                {
                    Button = { Color = "0.25 0.25 0.23 0", Command = $"clanstop_info {key.Value.tag}" },
                    Text = { Text = "", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
                }, "clans_player" + key.Key);
                i++;
                Amin = Amin - 0.073;
            ...
            elements.Add(new CuiButton
            {
                Button = { Color = "0.25 0.25 0.23 0" },
                Text = { Text = "" },
                RectTransform = { AnchorMin = $"0.455 0.005", AnchorMax = $"0.555 0.05" },
            }, "Clanstop_main8", "clans_page");
            elements.Add(new CuiButton
            {
                Button = { Color = "0.11 0.07 0.09 0.7", Command = page > 0 ? $"clanstop_main {page - 1}" : "" },
                Text = { Text = "<", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"-4.43 -2.4", AnchorMax = $"-3.8 -0.3" },
            }, "clans_page");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.3294118 0.3294118 0.3294118 1" },
                Text = { Text = $"{page + 1}", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 13, Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"-3.785 -2.4", AnchorMax = $"-3.15 -0.3" },
            }, "clans_page");

            elements.Add(new CuiButton
            {
                Button = { Color = "0.11 0.07 0.09 0.7", Command = clans.Keys.Skip(13 * (page + 1)).Count() > 0 ? $"clanstop_main {page + 1}" : "" },
                Text = { Text = ">", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                RectTransform = { AnchorMin = $"-3.14 -2.4", AnchorMax = $"-2.5 -0.3" },
            }, "clans_page");

            elements.Add(new CuiButton
            {
                RectTransform = { AnchorMin = $"0.40 0.2", AnchorMax = $"0.62 0.9", OffsetMax = "0 0" },
                Button = { Color = "0.290 0.824 0.012 0.70", Command = $"clanstop_infobysteamid {player.UserIDString}" },
                Text = { Text = $"МОЙ КЛАН", Color = "1 1 1 1", Align = TextAnchor.MiddleCenter, FontSize = 14, Font = "robotocondensed-regular.ttf" }
            }, "Clanstop_main5");

            CuiHelper.AddUi(player, elements);
        }

        void ClanUI(BasePlayer player, int page = 0, bool changeSkin = true, bool changeResource = false)
        {
            if (!IsReady())
            {
            ...
            string Main = "[{\"name\":\"clans_main1\",\"parent\":\"Overlay\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"material\":\"assets/content/ui/uibackgroundblur-ingamemenu.mat\",\"color\":\"0 0 0 0.7\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main2\",\"parent\":\"clans_main1\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0 0 0 0.1647059\"},{\"type\":\"NeedsCursor\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.17 0.1546297\",\"anchormax\":\"0.83 0.8935185\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main3\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.943609\",\"anchormax\":\"0.9953553 0.9955974\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main4\",\"parent\":\"clans_main3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>{title}</b>\",\"fontSize\":18,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main5\",\"parent\":\"clans_main4\",\"components\":[{\"type\":\"UnityEngine.UI.Button\",\"close\":\"clans_main1\",\"color\":\"0.5254902 0.282353 0.2313726 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.935175 0\",\"anchormax\":\"0.9986773 0.94\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main6\",\"parent\":\"clans_main5\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>X</b>\",\"fontSize\":18,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main10\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.6918138\",\"anchormax\":\"0.6431664 0.9398496\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanLogo\",\"parent\":\"clans_main10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"1 1 1 0\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.05315594 0.02741549\",\"anchormax\":\"0.2838709 0.9721818\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanInfo\",\"parent\":\"clans_main10\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.2745098 0.2745098 0.2745098 0.3948693\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.3418818 0.02741549\",\"anchormax\":\"0.9542304 0.9754673\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName\",\"parent\":\"ClanInfo\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0.3843137\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.7517123\",\"anchormax\":\"1 0.9931507\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName1\",\"parent\":\"ClanName\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"НАЗВАНИЕ КЛАНА: \",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.556291 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>{Title}</b>\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName2\",\"parent\":\"ClanInfo\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0.3843137\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.5034246\",\"anchormax\":\"1 0.744863\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName3\",\"parent\":\"ClanName2\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ГЛАВА КЛАНА:\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.4698553 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName2\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{LeaderName}\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName3\",\"parent\":\"ClanInfo\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0.3843137\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.255137\",\"anchormax\":\"1 0.4965754\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName4\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИГРОКОВ В КЛАНЕ:\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8705882 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.5718051 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{O/P}\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName3\",\"parent\":\"ClanInfo\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.11 0.07 0.09 0.3843137\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.006849289\",\"anchormax\":\"1 0.2482877\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"ClanName4\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"МЕСТО В ТОПЕ:\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8705882 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.0221675 0\",\"anchormax\":\"0.6493754 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clanTitle\",\"parent\":\"ClanName3\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"{per}\",\"fontSize\":16,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleRight\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5141813 0\",\"anchormax\":\"0.9929016 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main11\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6467149 0.6918139\",\"anchormax\":\"0.9980168 0.9398496\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main112\",\"parent\":\"clans_main11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>СПИСОК ЗАДАЧ</b>\",\"fontSize\":15,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.7554934\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main113\",\"parent\":\"clans_main11\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>{attach}</b>\",\"fontSize\":15,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1 0.02572244\",\"anchormax\":\"1 0.7554934\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_main9\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548518 0.4335839\",\"anchormax\":\"0.9971297 0.6859453\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main91\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>КЛАНОВАЯ ОДЕЖДА</b>\",\"fontSize\":15,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.8\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]},{\"name\":\"clans_item0\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.06081926 0.04293609\",\"anchormax\":\"0.1799577 0.7877806\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item1\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.1871024 0.04293609\",\"anchormax\":\"0.3062414 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item2\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.3133879 0.04293609\",\"anchormax\":\"0.4325227 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item3\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4396606 0.04293609\",\"anchormax\":\"0.558799 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item4\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.5659431 0.04293609\",\"anchormax\":\"0.6850816 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item5\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6922278 0.04293609\",\"anchormax\":\"0.8113656 0.7877806\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_item6\",\"parent\":\"clans_main9\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.4039216 0.3921569 0.3686275 0.5568628\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.81852 0.04293605\",\"anchormax\":\"0.9376571 0.7877805\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main7\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.003548417 0.006466299\",\"anchormax\":\"0.6431664 0.4285714\"}]},{\"name\":\"clans_main71\",\"parent\":\"clans_main7\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.911024\",\"anchormax\":\"1 0.9998377\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main722\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"*\",\"fontSize\":15,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0\",\"anchormax\":\"0.06366677 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main723\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ИМЯ ИГРОКА\",\"fontSize\":12,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.06366677 0\",\"anchormax\":\"0.4043106 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main724\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"АКТИВНОСТЬ\",\"fontSize\":13,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.4056678 0\",\"anchormax\":\"0.6526684 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main725\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"ОЧКИ\",\"fontSize\":13,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6526684 0\",\"anchormax\":\"0.75 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main726\",\"parent\":\"clans_main71\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\" \",\"fontSize\":13,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleLeft\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.75 0\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main8\",\"parent\":\"clans_main2\",\"components\":[{\"type\":\"UnityEngine.UI.Image\",\"color\":\"0.20 0.20 0.20 0.70\"},{\"type\":\"RectTransform\",\"anchormin\":\"0.6467149 0.006466303\",\"anchormax\":\"0.9980168 0.4285714\",\"offsetmin\":\"0 0\",\"offsetmax\":\"0 0\"}]},{\"name\":\"clans_main81\",\"parent\":\"clans_main8\",\"components\":[{\"type\":\"UnityEngine.UI.Text\",\"text\":\"<b>ДОБЫЧА РЕСУРСОВ</b>\",\"fontSize\":15,\"font\":\"robotocondensed-regular.ttf\",\"align\":\"MiddleCenter\",\"color\":\"1 0.9294118 0.8666667 1\"},{\"type\":\"RectTransform\",\"anchormin\":\"0 0.8873403\",\"anchormax\":\"1 1\",\"offsetmin\":\"0 0\",\"offsetmax\":\"1 1\"}]}]";
            var Messages = "";
            ...
            foreach (var key in clan.members.OrderBy(pair => BasePlayer.FindByID(ulong.Parse(pair.Key)) == null).Skip(8 * page).Take(clan.members.Count >= 8 ? 8 : clan.members.Count))
            {
                ...
                elements.Add(new CuiLabel
                {
                    Text = { Text = "●", Color = playerKey != null ? "0.00 1.00 0.00 1.00" : "1.00 0.00 0.00 1.00", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0 0", AnchorMax = $"0.06366677 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = covalence.Players.FindPlayerById(key.Key) != null ? covalence.Players.FindPlayerById(key.Key).Name : "Имя не указано", Font = "robotocondensed-regular.ttf", FontSize = 14, Color = "1 0.9294118 0.8666667 1", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.06366677 0", AnchorMax = $"0.4043106 1" },
                }, "clans_player" + key.Key);
                elements.Add(new CuiLabel
                {
                    Text = { Text = playerKey != null ? FormatShortTime(TimeSpan.FromSeconds(playerKey.TimeAlive())) : "0", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.4056678 0", AnchorMax = $"0.6526684 1" },
                }, "clans_player" + key.Key);

                elements.Add(new CuiLabel
                {
                    Text = { Text = $"{key.Value.PlayerPoints}", Color = "1 0.9294118 0.8666667 1", FontSize = 14, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleLeft },
                    RectTransform = { AnchorMin = $"0.6656684 0", AnchorMax = $"0.824169 1" },
                }, "clans_player" + key.Key);
                Amin = Amin - 0.1;
                Amax = Amax - 0.1;
                if (clan.owner == player.UserIDString)
                {
                    if (key.Key != player.UserIDString)
                    {
                        elements.Add(new CuiButton
                        {
                            ...
                            Text = { Text = "ВЫГНАТЬ", Align = TextAnchor.MiddleCenter, FontSize = 10, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
                        ...
                        elements.Add(new CuiButton
                        {
                            ...
                            Text = { Text = clan.moderators.Contains(key.Key) ? "УБРАТЬ МОДЕРАТОРА" : "НАЗНАЧИТЬ МОДЕРАТОРОМ", Align = TextAnchor.MiddleCenter, FontSize = 10, Font = "robotocondensed-regular.ttf", Color = "1 0.9294118 0.8666667 1" },
            ...
            /*            elements.Add(new CuiButton
                        ...
                        elements.Add(new CuiButton
                        {
                            Button = { Color = "0.11 0.07 0.09 0.7", Command = page > 0 ? $"clanui.page {page - 1}" : "" },
                            Text = { Text = "<", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                        ...
                        elements.Add(new CuiButton
                        {
                            Button = { Color = "0.11 0.07 0.09 0.7", Command = clan.members.Skip(8 * (page + 1)).Count() > 0 ? $"clanui.page {page + 1}" : "" },
                            Text = { Text = ">", Color = "1 0.9294118 0.8666667 1", FontSize = 15, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
            ...
            for (int i = 0; i < clan.SkinList.Count; i++)
            {
                ...
                if (changeSkin)
                    elements.Add(new CuiButton
                    {
                        ...
                        Text = { Text = "", Color = "1 0.9294118 0.8666667 0", FontSize = 14, Align = TextAnchor.MiddleCenter },
                        RectTransform = { AnchorMin = $"0 0", AnchorMax = $"1 1" },
                    }, "clans_item" + i);
            }
            ...
            if (clan.owner == player.UserIDString)
            {
                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 1", Command = changeSkin ? $"clanui.page {page}" : $"clanui.page {page} false" },
                    Text = { Text = changeSkin ? "СОХРАНИТЬ" : "НАСТРОИТЬ", Color = "1 0.9294118 0.8666667 1", Font = "robotocondensed-regular.ttf", FontSize = 14, Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.9 0", AnchorMax = $"0.997 0.95" },
                }, "clans_main91");

                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 1", Command = $"clan_setChange" },
                    Text = { Text = "НАСТРОИТЬ", Color = "1 0.9294118 0.8666667 1", FontSize = 13, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
                    RectTransform = { AnchorMin = $"0.75 0.2", AnchorMax = $"0.993 0.93" },
                }, "clans_main112");

                elements.Add(new CuiButton
                {
                    Button = { Color = "0.13 0.44 0.48 0", Command = $"clan_setAvatar" },
                    Text = { Text = "ИЗМЕНИТЬ", Color = "1 0.9294118 0.8666667 0", FontSize = 12, Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter },
            ...
            if (changeSkin)
            {
                ...
                elements.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent { Text = "<size=26>ПАНЕЛЬ УПРАВЛЕНИЯ СКИНАМИ</size>", Color = "1 0.9294118 0.8666667 0", Font = "robotocondensed-regular.ttf", Align = TextAnchor.MiddleCenter},
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" },
                    }
                });
                ...
                elements.Add(new CuiButton
                {
                    Button = { Color = "0.11 0.07 0.09 0", Command = "", Material = "assets/content/ui/uibackgroundblur-ingamemenu.mat" },
...
"disband", "forever"
        ...
        void clansetgetcheck(ConsoleSystem.Arg ar)
        {
