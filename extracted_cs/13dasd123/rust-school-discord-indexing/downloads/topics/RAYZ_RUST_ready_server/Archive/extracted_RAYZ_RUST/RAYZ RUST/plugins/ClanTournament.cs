...
{
    [Info("ClanTournament", "Molik", "0.0.1")]
    public class ClanTournament : RustPlugin
    {
        ...
        {
            var lefTime = SaveRestore.SaveCreatedTime.ToUniversalTime().Subtract(epoch).TotalSeconds + 108000 - CurrentTime();
        ...
        private void OnLootEntity(BasePlayer player, BaseEntity entity)
        {
            ...
            if (entity as BuildingPrivlidge)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    RectTransform =
                        {AnchorMin = "0.08181816 0.3208335", AnchorMax = "0.9454545 0.7166667"},
                    Image = { Color = "0 0 0 0" }
                }, "Overlay", CupLayer);
