...
{
    [Info("IQChat", "x0z", "2.3.46")]
    [Description("The most pleasant chat for your server from the IQ branch")]
    class IQChat : RustPlugin
    {
        /// <summary>
        /// Update 2.2.x
        /// - Fixed the possibility of using markup tags in /pm and /r
        /// - The path was changed for the data file, the new path is IQSystem/IQChat (The plugin itself will transfer all the data and inform you about it to the console, after the message about the successful transfer and checking the new ones files - you can delete old files)
        /// - Changed and improved the method of searching for "bad words" in the chat. Added ignoring the case of words
        /// - Changed the check for issuing automatic muta for "bad words"
        /// - "Link protection" has been added to the formatting of nicknames - they will be deleted
        /// - The method of searching for "banned nicknames" has been changed and improved. Added ignoring the case of words
        /// - Added the "Protection from noobs" functionality, players who are connected for the first time will not be able to write to the chat /pm/r N time, configured in the configuration
        /// - When the "Protection from noobs" is enabled, old players will be transferred to the protection
        /// Update 2.3.x
        /// - Correction of CAPS formatting
        ...
        private class Configuration
        {
            ...
            {
                [JsonProperty("Function switches")]
                public Turned Turneds = new Turned();
                [JsonProperty("Setting standard values")]
                public SetupDefault SetupDefaults = new SetupDefault();

                internal class SetupDefault
                {
                    [JsonProperty("This prefix will be set if the player first logged on to the server or if the rights to the prefix that he had previously expired")]
                    public String PrefixDefault = "<color=#CC99FF>[PLAYER]</color>";
                    [JsonProperty("This nickname color will be set if the player logged into the server for the first time or if the rights to the nickname color that he had previously ended")]
                    public String NickDefault = "#33CCCC";
                    [JsonProperty("This chat color will be set if the player logged into the server for the first time or if the rights to the chat color that he had previously expired")]
                    public String MessageDefault = "#0099FF";
                }
                internal class Turned
                {
                    [JsonProperty("Set the prefix automatically to the player when he got the rights to it")]
                    public Boolean TurnAutoSetupPrefix;
                    [JsonProperty("Set the nickname color automatically to the player when he got the rights to it")]
                    public Boolean TurnAutoSetupColorNick;
                    [JsonProperty("Set the chat color automatically to the player when he got the rights to it")]
                    public Boolean TurnAutoSetupColorChat;
                    [JsonProperty("Reset the prefix automatically when the player's rights to it expire")]
                    public Boolean TurnAutoDropPrefix;
                    [JsonProperty("Reset the nickname color automatically when the player's rights to it expire")]
                    public Boolean TurnAutoDropColorNick;
                    [JsonProperty("Reset the chat color automatically when the player's rights to it expire")]
            ...
            [JsonProperty("Setting parameters for the player")]
            public ControllerParameters ControllerParameter = new ControllerParameters();
            internal class ControllerParameters
            {
                [JsonProperty("Setting up the display of parameters for player selection")]
                public VisualSettingParametres VisualParametres = new VisualSettingParametres();
                [JsonProperty("List and customize colors for a nickname")]
                public List<AdvancedFuncion> NickColorList = new List<AdvancedFuncion>();
                [JsonProperty("List and customize colors for chat messages")]
                public List<AdvancedFuncion> MessageColorList = new List<AdvancedFuncion>();
                [JsonProperty("List and configure prefixes in the chat")]
                public PrefixSetting Prefixes = new PrefixSetting();
                internal class PrefixSetting
                {
                    [JsonProperty("Enable support for multiple prefixes at once (true - you can set multiple prefixes/false - you can set only 1 to choose from)")]
                    public Boolean TurnMultiPrefixes;
                    [JsonProperty("The maximum number of prefixes that can be set at a time (This parameter only works if multiple prefixes are enabled)")]
                    public Int32 MaximumMultiPrefixCount;
                    [JsonProperty("List of prefixes and their settings")]
                ...
                {
                    [JsonProperty("The type of prefix selection display for the player is (0 - drop-down list, 1 - slider (Note that if you have multi-prefix enabled, a drop-down list will be set))")]
                    public SelectedParametres PrefixType;
                    [JsonProperty("The type of display of the nickname color selection for the player - (0 - drop-down list, 1 - slider)")]
                    public SelectedParametres NickColorType;
                    [JsonProperty("The type of display of the message color selection for the player - (0 - drop-down list, 1 - slider)")]
                    public SelectedParametres ChatColorType;
                    [JsonProperty("IQRankSystem: Display type of rank selection for a player - (0 - drop - down list, 1 - slider)")]
            ...
            [JsonProperty("Setting up mute in the plugin")]
            public ControllerMute ControllerMutes = new ControllerMute();
            internal class ControllerMute
            {
                [JsonProperty("Setting up an automatic mute")]
                public AutoMute AutoMuteSettings = new AutoMute();
                internal class AutoMute
                {
                    [JsonProperty("Enable automatic mute for forbidden words (true - yes/false - no)")]
                    public Boolean UseAutoMute;
                    [JsonProperty("The reason for the automatic mute")]
                    public Muted AutoMuted;
                }
                [JsonProperty("Additional setting for logging about mute in discord")]
                public LoggedFuncion LoggedMute = new LoggedFuncion();
                internal class LoggedFuncion
                {
                    [JsonProperty("Support for logging the last N messages (Logging in the mute discord must be enabled)")]
                    public Boolean UseHistoryMessage;
                    [JsonProperty("How many recent player messages to send in logging")]
                    public Int32 CountHistoryMessage;
                }

                [JsonProperty("Reasons to block the chat")]
                public List<Muted> MuteChatReasons = new List<Muted>();
                [JsonProperty("Reasons for Voice Blocking")]
                public List<Muted> MuteVoiceReasons = new List<Muted>();
                internal class Muted
                {
                    [JsonProperty("Reason for blocking")]
                    public String Reason;
                    [JsonProperty("Blocking time (in seconds)")]
            ...
            [JsonProperty("Configuring Message Processing")]
            public ControllerMessage ControllerMessages = new ControllerMessage();
            internal class ControllerMessage
            {
                [JsonProperty("Basic configuration of chat messages from the plugin")]
                public GeneralSettings GeneralSetting = new GeneralSettings();
                [JsonProperty("Setting up the functionality switching in the chat")]
                public TurnedFuncional TurnedFunc = new TurnedFuncional();
                [JsonProperty("Configuring the formatting of player messages")]
                public FormattingMessage Formatting = new FormattingMessage();

                internal class GeneralSettings
                {
                    [JsonProperty("Setting up the chat notification format")]
                    public BroadcastSettings BroadcastFormat = new BroadcastSettings();
                    [JsonProperty("Setting up the chat mention format, via @")]
                    public AlertSettings AlertFormat = new AlertSettings();
                    [JsonProperty("Additional configuration")]
                    public OtherSettings OtherSetting = new OtherSettings();

                    internal class BroadcastSettings
                    {
                        [JsonProperty("Name of the notification in the chat")]
                        public String BroadcastTitle;
                        [JsonProperty("The color of the notification message in the chat")]
                        public String BroadcastColor;
                        [JsonProperty("Steam64ID for the avatar in the chat")]
                        public String Steam64IDAvatar;
                    }
                    internal class AlertSettings
                    {
                        [JsonProperty("The color of the message mentioning the player in the chat")]
                        public String AlertPlayerColor;
                        [JsonProperty("Sound when receiving and sending mentions via @")]
                        public String SoundAlertPlayer;
                    }
                    internal class OtherSettings
                    {
                        [JsonProperty("The time after which the message from the UI from the administrator will be deleted")]
                        public Int32 TimeDeleteAlertUI;

                        [JsonProperty("The size of the message from the player in the chat")]
                        public Int32 SizeMessage = 14;
                        [JsonProperty("The size of the player's nickname in the chat")]
                        public Int32 SizeNick = 14;
                        [JsonProperty("The size of the player's prefix in the chat (will be used if <size=N></size> is not set in the prefix itself)")]
                        public Int32 SizePrefix = 14;
                    }
                }
                internal class TurnedFuncional
                {
                    [JsonProperty("Setting up Spam protection")]
                    public AntiSpam AntiSpamSetting = new AntiSpam();
                    [JsonProperty("Setting up a temporary chat lock for beginners (who have just logged on to the server)")]
                    public AntiNoob AntiNoobSetting = new AntiNoob();
                    [JsonProperty("Setting up Private messages")]
                    public PM PMSetting = new PM();

                    internal class AntiNoob
                    {
                        [JsonProperty("Protection from a beginner in PM/R")]
                        public Settings AntiNoobPM = new Settings();
                        [JsonProperty("Protection from a newcomer in global and command chat")]
                        public Settings AntiNoobChat = new Settings();
                        internal class Settings
                        {
                            [JsonProperty("Enable protection?")]
                            public Boolean AntiNoobActivate = false;
                            [JsonProperty("Chat blocking time for a beginner")]
                            public Int32 TimeBlocked = 1200;
                        }
                    }
                    internal class AntiSpam
                    {
                        [JsonProperty("Enable spam protection (Antispam)")]
                        public Boolean AntiSpamActivate;
                        [JsonProperty("The time after which the player can send a message (anti-SPAM)")]
                        public Int32 FloodTime;
                        [JsonProperty("Additional Anti-Spam Settings")]
                        public AntiSpamDuples AntiSpamDuplesSetting = new AntiSpamDuples();
                        internal class AntiSpamDuples
                        {
                            [JsonProperty("Enable additional spam protection (Anti-duplicates, repeating messages)")]
                            public Boolean AntiSpamDuplesActivate = true;
                            [JsonProperty("How many duplicate messages does a player need to make in order to be confused by the system")]
                            public Int32 TryDuples = 3;
                            [JsonProperty("Setting up automatic mute for duplicates")]
                            public ControllerMute.Muted MuteSetting = new ControllerMute.Muted
                            {
                                Reason = "Blocking for duplicate messages (SPAM)",
                                SecondMute = 300,
                            };
                        }
                    }
                    internal class PM
                    {
                        [JsonProperty("Enable private messages")]
                        public Boolean PMActivate;
                        [JsonProperty("Sound when receiving a private message")]
                        public String SoundPM;
                    }
                    [JsonProperty("Enable ignore BOS to players (/ignore nick or via the interface)")]
                    public Boolean IgnoreUsePM;
                    [JsonProperty("Hide the issue of items to the Admin from the chat")]
                    public Boolean HideAdminGave;
                    [JsonProperty("Transfer mute to the team chat(In the case of mute, the player will not be able to write even to the team chat)")]
                    public Boolean MuteTeamChat;
                }
                internal class FormattingMessage
                {
                    [JsonProperty("Enable message formatting [Will control caps, message format] (true - yes/false - no)")]
                    public Boolean FormatMessage;
                    [JsonProperty("Use a list of forbidden words (true - yes/false - no)")]
                    public Boolean UseBadWords;
                    [JsonProperty("The word that will replace the forbidden word")]
                    public String ReplaceBadWord;
                    [JsonProperty("List of forbidden words")]
                    public List<String> BadWords = new List<String>();

                    [JsonProperty("Configuring the Nickname Controller")]
                    public NickController ControllerNickname = new NickController();
                    internal class NickController
                    {
                        [JsonProperty("Enable formatting of player nicknames (message formatting must be enabled)")]
                        public Boolean UseNickController = true;
                        [JsonProperty("The word that will replace the forbidden word (You can leave it empty and will just delete it)")]
                        public String ReplaceBadNick = "****";
                        [JsonProperty("List of banned nicknames")]
            ...
            [JsonProperty("Setting up chat alerts")]
            ...
            internal class ControllerAlert
            {
                ...
                [JsonProperty("Setting up player session status alerts")]
                public PlayerSession PlayerSessionSetting;
                [JsonProperty("Setting up administrator session status alerts")]
                public AdminSession AdminSessionSetting;
                [JsonProperty("Setting up personal notifications to the player when connecting")]
                public PersonalAlert PersonalAlertSetting;
                internal class Alert
                {
                    [JsonProperty("Enable automatic chat messages (true - yes/false - no)")]
                    public Boolean AlertMessage;
                    [JsonProperty("Type of automatic messages : true - sequential/false - random")]
                    public Boolean AlertMessageType;

                    [JsonProperty("List of automatic chat messages")]
                    public List<String> MessageList;
                    [JsonProperty("The interval for sending messages to the chat (Broadcaster) (in seconds)")]
                    public Int32 MessageListTimer;
                }
                internal class PlayerSession
                {
                    [JsonProperty("When a player is notified of entry/exit, display his avatar opposite the nickname (true - yes/false - no)")]
                    public Boolean ConnectedAvatarUse;

                    [JsonProperty("Notify the chat about the player's entry (true - yes/false - no)")]
                    public Boolean ConnectedAlert;
                    [JsonProperty("Enable random notifications about the entry of a player from the list (true - yes/false - no)")]
                    public Boolean ConnectionAlertRandom;
                    [JsonProperty("Display the country of the visiting player (true - yes/false - no")]
                    public Boolean ConnectedWorld;

                    [JsonProperty("Notify about the player's exit to the chat (selected from the list) (true - yes/false - no)")]
                    public Boolean DisconnectedAlert;
                    [JsonProperty("Enable random player exit notifications (true - yes/false - no)")]
                    public Boolean DisconnectedAlertRandom;
                    [JsonProperty("Display the reason for the player's exit (true - yes/false - no)")]
                    public Boolean DisconnectedReason;

                    [JsonProperty("Random notifications about player entry ({0} - player's nickname, {1} - country (if country display is enabled)")]
                    public List<String> RandomConnectionAlert = new List<String>();
                    [JsonProperty("Random notifications about the player's exit ({0} - the player's nickname, {1} - the reason for the exit (if the reason is enabled)")]
                    public List<String> RandomDisconnectedAlert = new List<String>();
                }
                internal class AdminSession
                {
                    [JsonProperty("Notify the admin of the server's login to the chat (true - yes/false - no)")]
                    public Boolean ConnectedAlertAdmin;
                    [JsonProperty("Notify the admin of the server's exit to the chat (true - yes/false - no)")]
                    public Boolean DisconnectedAlertAdmin;
                }
                internal class PersonalAlert
                {
                    [JsonProperty("Enable a random message to a visiting player (true - yes/false - no)")]
                    public Boolean UseWelcomeMessage;
                    [JsonProperty("List of messages to the player at the entrance")]
            ...
            #region Rust Plus
            [JsonProperty("Setting up Rust+")]
            public RustPlus RustPlusSettings;
            internal class RustPlus
            {
                [JsonProperty("Use Rust+")]
                public Boolean UseRustPlus;
                [JsonProperty("Name for Rust+ notification")]
                public String DisplayNameAlert;
            }
            #endregion

            #region Reference Setting
            [JsonProperty("Configuring support plugins")]
            public ReferenceSettings ReferenceSetting = new ReferenceSettings();
            internal class ReferenceSettings
            {
                [JsonProperty("Setting up IQFakeActive")]
                public IQFakeActive IQFakeActiveSettings = new IQFakeActive();
                [JsonProperty("Setting up IQRankSystem")]
                public IQRankSystem IQRankSystems = new IQRankSystem();
                internal class IQRankSystem
                {
                    [JsonProperty("The format for displaying the rank in the chat ({0} is the rank of the user, do not delete this value)")]
                    public String FormatRank = "[{0}]";
                    [JsonProperty("The format for displaying the time with Inksystem in the chat ({0} is the user's time, do not delete this value)")]
                    public String FormatRankTime = "[{0}]";
                    [JsonProperty("Use rank support")]
                    public Boolean UseRankSystem;
                    [JsonProperty("Display the players their time played next to the rank")]
                    public Boolean UseTimeStandart;
                }
                internal class IQFakeActive
                {
                    [JsonProperty("Use IQFakeActive support")]
            ...
            [JsonProperty("Setting up an answering machine")]
            public AnswerMessage AnswerMessages = new AnswerMessage();

            internal class AnswerMessage
            {
                [JsonProperty("Turn on the answering machine?(true - yes/false - no)")]
                public bool UseAnswer;
                [JsonProperty("Message Setup [Keyword] = Answer")]
            ...
            internal class OtherSettings
            {
                [JsonProperty("Configuring Message logging")]
                public LoggedChat LogsChat = new LoggedChat();
                [JsonProperty("Setting up logging of personal messages of players")]
                public General LogsPMChat = new General();
                [JsonProperty("Setting up logging of chat/voice locks/unblocks")]
                public General LogsMuted = new General();
                [JsonProperty("Setting up logging of chat commands from players")]
                public General LogsChatCommands = new General();
                internal class LoggedChat
                {
                    [JsonProperty("Setting up General Chat logging")]
                    public General GlobalChatSettings = new General();
                    [JsonProperty("Setting up tim chat logging")]
                    public General TeamChatSettings = new General();
                }
                internal class General
                {
                    [JsonProperty("Enable logging (true - yes/false - no)")]
                    public Boolean UseLogged = false;
                    [JsonProperty("Webhooks of the logging channel")]
            ...
            List<Fields> fields = new List<Fields>
                        {
                            new Fields("Ник", player.displayName, true),
                            new Fields("Steam64ID", player.UserIDString, true),
                            new Fields("Канал", Channel == Chat.ChatChannel.Global ? "Глобальный чат" : Channel == Chat.ChatChannel.Cards ? "Покерный чат" : "Командный чат", true),
