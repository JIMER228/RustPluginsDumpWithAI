...
{
    [Info("Hit Markers", "https://discord.gg/TrJ7jnS233", "1.2.0")]
    public class HitMarkers : RustPlugin
    {
        #region Fields
        ...
        private class Configuration
        {
            ...
            [JsonProperty(PropertyName = "Разрешение (например: hitmarkers.use)")]
        ...
        private class BtnConf
        {
            ...
            [JsonProperty(PropertyName = "Разрешение (например: hitmarkers.text)")]
        ...
        private class FontConf
        {
            ...
            [JsonProperty(PropertyName = "Разрешение (например: hitmarkers.font)")]
            public string Permission;
        }
        ...
        private void MainUi(BasePlayer player, bool first = false)
        {
            ...
            foreach (var fontConf in _config.Fonts)
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    Image =
                    {
                        Color = selected ? "0.98 0.87 0.53 0.8" : "0.98 0.87 0.53 0.4"
                    }
                ...
                container.Add(new CuiLabel
                {
                    ...
                    Text =
                    {
                        ...
                        FontSize = 14,
                        Color = selected ? HexToCuiColor("#000000") : "0.98 0.87 0.53 0.9"
                    }
