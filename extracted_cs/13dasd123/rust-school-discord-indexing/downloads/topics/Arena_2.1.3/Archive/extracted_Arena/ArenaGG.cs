...
{
    [Info("Arena GunGame", "k1lly0u", "2.0.5"), Description("GunGame event mode for EventManager")]
        ...
        private void FindValidWeapons()
        {
            ...
            foreach (ItemDefinition itemDefinition in ItemManager.itemList)
            {
                if (itemDefinition.category == ItemCategory.Weapon || itemDefinition.category == ItemCategory.Tool)
                {
                    ...
                    if (attackEntity != null && (attackEntity is BaseMelee || attackEntity is BaseProjectile || attackEntity is FlameThrower))
