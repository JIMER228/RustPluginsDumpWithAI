...
{
    [Info ( "QuarryLevels", "Death (edit by Raul-Sorin Sorban)", "2.0.0" )]
    class QuarryLevels : RustPlugin
    {
        ...
        object OnQuarryConsumeFuel ( MiningQuarry quarry, Item item )
        {
            ...
            var expectedItem = fuel.inventory.FindItemsByItemName ( quarry.ShortPrefabName.Contains ( "pumpjack" ) ? options.FuelSettings.PumpjackItem : options.FuelSettings.QuarryItem );
        ...
        bool HasFuel ( MiningQuarry quarry )
        {
            ...
            var item = fuel.inventory.FindItemsByItemName ( quarry.ShortPrefabName.Contains ( "pumpjack" ) ?
                options.FuelSettings.PumpjackItem : options.FuelSettings.QuarryItem );
