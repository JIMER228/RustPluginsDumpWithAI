...
namespace Oxide.Plugins
{
    ...
    class Trade : RustPlugin
    {
        ...
        void LoadMessages()
        {
            ...
            {
                {"Inventory: You", "<color=orange>[TRADE]</color> <color=#808080>Вам не хватает места в инвентаре.</color>"},
                {"Inventory: Them", "<color=orange>[TRADE]</color> <color=#808080>Игроку с которым вы обмениваетесь не хватает места.</color>"},
                {"Inventory: Generic", "<color=orange>[TRADE]</color> <color=#808080>Недостаточно места для обмена.</color>"},

                {"Player: Not Found", "<color=orange>[TRADE]</color> <color=#808080>Игрок с таким именем не найден.</color>"},
                {"Player: Unknown", "<color=orange>[TRADE]</color> <color=#808080>не найден</color>"},
                {"Player: Yourself", "<color=orange>[TRADE]</color> <color=#808080>Вы не можете обмениваться с самим собой.</color>"},

                {"Status: Completing", "<color=orange>[TRADE]</color> <color=#808080>Завершение торговли..</color>"},
                {"Status: No Pending", "<color=orange>[TRADE]</color> <color=#808080>У вас нет запросов на обмен.</color>"},
                {"Status: Pending", "They already have a pending trade request"},
                {"Status: Received", "<color=orange>[TRADE]</color> <color=#808080>Вы получили запрос на обмен от игрока</color> '{0}'.\nПринять обмен <color=orange>/trade accept</color>"},
                {"Status: They Interrupted", "<color=orange>[TRADE]</color> <color=#808080>Игрок переместился или закрыл обмен!</color>"},
                {"Status: You Interrupted", "<color=orange>[TRADE]</color> <color=#808080>Вы переместились или закрыли обмен!</color>"},

                {"Trade: Sent", "<color=orange>[TRADE]</color> <color=#808080>Запрос на обмен отправлен.</color>"},
                {"Trade: They Declined", "<color=orange>[TRADE]</color> <color=#808080>Игрок отклонил ваш запрос на обмен.</color>"},
                {"Trade: You Declined", "<color=orange>[TRADE]</color> <color=#808080>Вы отклонили запрос на обмен.</color>"},
                {"Trade: They Accepted", "<color=#808080>Игрок</color> {0} <color=#808080>принял запрос.</color>"},
                {"Trade: You Accepted", " Вы подтвердили обмен."},
                {"Trade: Pending", "<color=orange>[TRADE]</color> Обмен обрабатывается."},

                {"Denied: Permission", "<color=orange>[TRADE]</color> <color=#808080>У вас нет на это разрешения.</color>"},
                {"Denied: Privilege", "<color=orange>[TRADE]</color> <color=#808080>Вы не можете совершить запрос на обмен где строительство запрещено.</color>"},
                {"Denied: Swimming", "<color=orange>[TRADE]</color> <color=#808080>Вы не можете совершить запрос на обмен в воде.</color>"},
                {"Denied: Falling", "<color=orange>[TRADE]</color> <color=#808080>Вы не можете совершить запрос на обмен в воздухе.</color>"},
                {"Denied: Wounded", "<color=orange>[TRADE]</color> <color=#808080>Вы не можете совершить запрос на обмен, пока раненые.</color>"},
                {"Denied: Generic", "<color=orange>[TRADE]</color> <color=#808080>Вы не можете совершить запрос на обмен прямо сейчас.</color>"},
                {"Denied: They Busy", "<color=orange>[TRADE]</color> <color=#808080>Этот игрок занят.</color>"},
                {"Denied: They Ignored You", "<color=orange>[TRADE]</color> Игрок проигнорировал тебя."},
                {"Denied: Distance", "<color=orange>[TRADE]</color> Игрок слишком далеко."},

                {"Item: BP", "BP"},

                {"Syntax: Trade Accept", "<color=orange>[TRADE]</color> <color=#808080>Неверный синтаксис.</color> /trade accept"},
                {"Syntax: Trade", "<color=orange>[TRADE]</color> <color=#808080>Неверный синтаксис.</color> /trade \"Player Name\""},

                {"Cooldown: Seconds", "<color=orange>[TRADE]</color><color=#808080>Вы делаете это слишком часто, попробуйте еще раз через {0} секунд(ы).</color>"},
                {"Cooldown: Minutes", "<color=orange>[TRADE]</color><color=#808080>Вы делаете это слишком часто, попробуйте еще раз через {0} минут(ы).</color>"},
            }, this);
        }
