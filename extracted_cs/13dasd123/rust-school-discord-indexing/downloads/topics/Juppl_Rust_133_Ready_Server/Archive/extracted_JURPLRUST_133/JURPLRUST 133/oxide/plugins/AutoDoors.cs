...
namespace Oxide.Plugins
{
    ...
    class AutoDoors : CovalencePlugin
    {
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            Config["DefaultDelay"] = defaultDelay = GetConfig("DefaultDelay", 10);
            Config["MaximumDelay"] = maximumDelay = GetConfig("MaximumDelay", 30);
            Config["MinimumDelay"] = minimumDelay = GetConfig("MinimumDelay", 10);
        ...
        void LoadDefaultMessages()
        {
            ...
            {
                ["DelayDisabled"] = "Автоматическое закрытие дверей теперь отключено",
                ["DelaySet"] = "Задержка закрытия двери установлена ​​на {0}с.",
                ["NotAllowed"] = "Вам не разрешено использовать команду '{0}'",
                ["Usage"] = "/{0} отключить автоматические двери\n /{0} # (число от 5 до 30)"
            }, this);
        }
