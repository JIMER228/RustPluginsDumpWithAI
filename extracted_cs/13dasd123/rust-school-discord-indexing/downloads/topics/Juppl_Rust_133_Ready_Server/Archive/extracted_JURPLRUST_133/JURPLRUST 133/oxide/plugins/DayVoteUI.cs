...
namespace Oxide.Plugins
{
    ...
    class DayVoteUI : RustPlugin
    {
        ...
        {
            var MainCont = UI.CreateElementContainer(Main, UI.Color(configData.Colors.UIBackgroundColor, configData.Colors.UIBackgroundAlpha), "0.350 0.96", "0.650 0.99");
        ...
        protected override void LoadDefaultConfig()
        {
            var config = new ConfigData
            {
                ...
                Colors = new Colors
                {
                    MainColor = "#0091ff",
                    MSGColor = "#ffffff",
                    ProgressBarColor = "#0091ff",
                    UIBackgroundAlpha = 0.5f,
        ...
        Dictionary<string, string> Messages = new Dictionary<string, string>
        {
            ...
            {"invalidSyntax", "{msg}Неправильно!</color> {main}/vote open</color>{msg} || </color> {main}/vote close</color>" },
            ...
            {"commandSyn", "{msg}Введите </color>{main}/vote</color>{msg} что бы пропустить ночь!</color>"},
