    ...
    class IQReportSystem : RustPlugin
    {
                ...
                else
                {
                    ...
                    if (config.RCCSetting.RCCUse)
                    {
                        ...
                        try
                        {
                            ...
                            webrequest.EnqueueGet(API, (code, response) => { }, this);
                        }
                        catch { }
                    }
                }
                ...
                case "give":
                    {
                        ...
                        if (!BasePlayer.FindByID(Convert.ToUInt64(arg.Args[1])) && !BasePlayer.FindSleeping(Convert.ToUInt64(arg.Args[1])))
                        {
                            PrintWarning("Укажите корректный Steam64ID");
                            return;
                        }
        ...
        void UI_Interface(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                 {
                    new CuiRawImageComponent { Png = ImageAvatar,Color = HexToRustFormat("#FFFFFFFF"), Sprite = "assets/content/textures/generic/fulltransparent.tga" },
            ...
            if (permission.UserHasPermission(player.UserIDString, PermissionModeration))
            {
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0 0.507467", AnchorMax = "1 0.5374059" },
                ...
                CuiHelper.DestroyUi(player, "BTN_REPORTS");

                container.Add(new CuiButton
                {
                    RectTransform = { AnchorMin = "0.05 0.4212967", AnchorMax = "0.95 0.47963" },
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0.02362165 0", AnchorMax = "0.2455902 1" }
                    }
                });
                ...
                CuiHelper.DestroyUi(player, "STATS_MODERATION");
        ...
        void UI_Player_Loaded(BasePlayer player, bool Moderation = false, int Page = 0, string TargetName = "")
        {
            ...
            foreach (BasePlayer p in playerList)
            {
                ...
                CuiHelper.DestroyUi(player, $"PLAYER_{i}");
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                 {
                    new CuiRawImageComponent { Png = ImageAvatar,Color = HexToRustFormat("#FFFFFFAA"), Sprite = "assets/content/textures/generic/fulltransparent.tga" },
                ...
                CuiHelper.DestroyUi(player, $"BTN_ACTION_{i}");
        ...
        void UI_SendReport(BasePlayer player, BasePlayer Suspect)
        {
            ...
            CuiHelper.DestroyUi(player, "PANEL_MAIN_REPORT");
            ...
            CuiHelper.DestroyUi(player, $"BTN_CLOSE");
            ...
            CuiHelper.DestroyUi(player, "PANEL_MAIN_REPORT_REASON");
            ...
            {
                CuiHelper.DestroyUi(player, $"REASON_{i}");
        ...
        void UI_ModerReport(BasePlayer player, BasePlayer Suspect)
        {
            ...
            CuiHelper.DestroyUi(player, "REPORT_HISTORY_PANEL");
            ...
            CuiHelper.DestroyUi(player, $"BTN_GO_CHECK");
        ...
        void UI_RaitingSend(BasePlayer player, BasePlayer Moderator)
        {
            ...
            {
                CuiHelper.DestroyUi(player, $"STAR_{i}");
        ...
        private void Init()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["METODS_SEND_REPORT_VK"] = "[ 133 DEVBLOG | MODDED ]\nНа игрока {0}({1}) отправили жалобу!\nЖалоба - {2}\nОтправил жалобу : {3}({4})",
                ...
                ["STATUS_CHANGED_VK"] = "[ 133 DEVBLOG | MODDED ]У игрока {0} изменился статус на : {1}\nОжидайте игрока на сервере в течении 10 минут!\nЕсли игрок не зайдет после 10 минут - выдавайте бан за Отказ",
                ...
                ["UI_NEW_MODERATION_TITLE_PANEL"] = "<size=17>ПАНЕЛЬ ПРОВЕРЯЮЩЕГО</size>",
        ...
        string IsSteam(string id)
        {
            if (MultiFighting != null)
            {
                ...
                var obj = MultiFighting.CallHook("IsSteam", player.net.connection);
                if (obj is bool)
                {
                    if ((bool)obj)
                    {
