...
namespace Oxide.Plugins
{
    ...
    class BuildingUpgrade : RustPlugin
    {
        ...
        private bool OxideCanAffordUpgrade(BuildingBlock block, BuildingGrade.Enum iGrade, BasePlayer player)
        {
            bool flag;
            object[] objArray = new object[] { player, iGrade };
        ...
        {
            {BuildingGrade.Enum.Wood, "<color=#ff0000>Дерева</color>"},
            {BuildingGrade.Enum.Stone, "<color=#ff0000>Камня</color>"},
            {BuildingGrade.Enum.Metal, "<color=#ff0000>Метала</color>"},
            {BuildingGrade.Enum.TopTier, "<color=#ff0000>Армора</color>"}
        };
		...
		private string NoticeFont = "robotocondensed-bold.ttf";
		...
		private string FontName = "robotocondensed-bold.ttf";
	    ...
	    private void UpgradeConfig()
        {
			...
			NoticeFont = GetConfig("robotocondensed-bold.ttf", "Настройки GUI Оповещения", "Названия шрифта");
			
			PanelAnchorMin = GetConfig("0.343 0.113", "Настройки GUI Panel", "Минимальный отступ");
			PanelAnchorMax = GetConfig("0.64 0.143", "Настройки GUI Panel", "Максимальный отступ");
			...
			TextAnchorMin = GetConfig("0.343 0.113", "Настройки GUI Text", "Минимальный отступ в gui панели");
			TextAnchorMax = GetConfig("0.64 0.143", "Настройки GUI Text", "Максимальный отступ в gui панели");
			FontName = GetConfig("robotocondensed-bold.ttf", "Настройки GUI Text", "Названия шрифта");
        ...
        void Grade(BuildingBlock block, BasePlayer player)
        {
            ...
            if (OxideCanAffordUpgrade(block, grade, player))
            {
                var ret = Interface.Call("CanUpgrade", player) as string;
                if (ret != null)
                {
        ...
        Dictionary<string, string> Messages = new Dictionary<string, string>()
        {
			...
			{"UpgradeON", "<color=ffcc00><size=14>Вы включили <color=#EC402C>Upgrade!</color></size></color>"},
		    ...
		    {"UpgradeMSG", "Режим улучшения строения до {0}"},
        };
