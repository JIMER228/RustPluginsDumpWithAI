...
{
    [Info("Logo", "empty", "1.0.0")]
    public class Logo : RustPlugin
    {
		#region Settings [Настройка]
		
		string LogoName = "JURPL RUST • MAX 5";
        ...
        void DrawInterface(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                Parent = "LogoPanel",
                Components = {
                    new CuiTextComponent() { Color = HexToRustFormat("#FFFFFF"), Text = LogoName, FontSize = 20, Align = TextAnchor.UpperLeft, Font = "robotocondensed-bold.ttf" },
            ...
            container.Add(new CuiElement
            {
                Parent = "LogoPanel",
                Components = {
                    new CuiTextComponent() { Color = HexToRustFormat("#FFFFFF"), Text = $"Barren | Онлайн {BasePlayer.activePlayerList.Count}", FontSize = 15, Align = TextAnchor.UpperLeft, Font = "robotocondensed-bold.ttf" },
