...
namespace Oxide.Plugins
{
    ...
    class TimedItemsBlocker : RustPlugin
    {
        ...
        private void LoadConfigValues()
        {
            ...
            {
                ["Satchel Charge"] = 12,
                ["Timed Explosive Charge"] = 24,
                ["Custom SMG"] = 7,
                ["Assault Rifle"] = 24,
                ["Bolt Action Rifle"] = 20,
                ["Revolver"] = 1,
                ["Thompson"] = 9,
                ["Semi-Automatic Rifle"] = 12,
                ["Semi-Automatic Pistol"] = 6,
                ["Pump Shotgun"] = 4,
                ["M249"] = 24,
                ["Rocket Launcher"] = 24,
                ["Flame Thrower"] = 6,
