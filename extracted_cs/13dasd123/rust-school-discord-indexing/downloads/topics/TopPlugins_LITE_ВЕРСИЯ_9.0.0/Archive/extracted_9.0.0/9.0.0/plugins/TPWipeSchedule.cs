...
{
    [Info("TPWipeSchedule", "ds:alone_sempai / https://topplugin.ru/", "9.0.0")]
    public class TPWipeSchedule : RustPlugin
    {
        ...
        private ConfigData GetDefaultConfig()
        {
            ...
            {
                Delay = 7200,
                ActiveImage = "https://i.ibb.co/VxQVJvz/roSADIV.png",
        ...
        private void OnServerInitialized()
        {
            ...
            PrintWarning("  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            ImageLibrary.Call("AddImage", $"https://i.ibb.co/vxbszW2/ahDNpde.png", "ahDNpde");
