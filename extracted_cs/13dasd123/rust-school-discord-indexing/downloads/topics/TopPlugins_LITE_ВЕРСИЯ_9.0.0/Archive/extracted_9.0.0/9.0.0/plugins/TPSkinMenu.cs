...
{ 
    [Info("TPSkinMenu", "ds:alone_sempai / https://topplugin.ru/", "9.0.0")]
    class TPSkinMenu : RustPlugin
    {
	    ...
	    private void OnServerInitialized()
		{
			...
			ImageLibrary.Call("AddImage", "https://i.ibb.co/4pX1rGn/HZAn2Et.png", "HZAn2Et");
			ImageLibrary.Call("AddImage", "https://i.ibb.co/4VShb4f/76unpVI.png", "76unpVI");
			ImageLibrary.Call("AddImage", "https://i.ibb.co/kcsLhyZ/QJ1ZV1G.png", "QJ1ZV1G");
		}
