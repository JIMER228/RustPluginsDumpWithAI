...
{
    [Info("TPStatsSystem", "ds:alone_sempai / https://topplugin.ru/", "9.0.0")]
    public class TPStatsSystem : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            ImageLibrary.Call("AddImage", $"https://i.ibb.co/gy2Nc6C/2.png", "P72zCAu");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/0f7jDKX/yEONWCm.png", "Skip");
            ImageLibrary.Call("AddImage", "https://i.ibb.co/Gd9xtLx/uF1fOzF.png", "SkipBack");
        ...
        private void GetRandomTopPlayer()
        {
            ...
            switch (random)
            {
                case 0:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Больше всего убийств:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Kill}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 1:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Больше всего смертей:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Death}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 2:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Больше всего фарма:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.TotalFarm()}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 3:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Добыто МВК:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Gather["hq.metal.ore"]}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 4:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Добыто Металла:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Gather["metal.ore"]}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 5:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Добыто Серы:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Gather["sulfur.ore"]}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 6:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Добыто бочек и залутно ящиков:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Gather["loot-barrel"]}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 7:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Проведено больше всего время на сервере:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{FormatShortTime(TimeSpan.FromSeconds(key.Value.PlayTimeInServer * 60))}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
                ...
                case 8:
                {
                    ...
                    {
                        int i = 1;
                        ServerBroadcast(player, "<size=13><color=#FFDD2FFF>Больше всего очков:</color></size>", 0);
                        foreach (var key in playerList)
                        {
                            ServerBroadcast(player, $"<size=10>{i}.{key.Value.Name} - <color=#FFDD2FFF>{key.Value.Point}</color></size>", key.Key);
                            i++;
                        }
                    }
                    break;
