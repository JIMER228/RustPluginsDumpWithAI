...
{
    [Info("TPMenuSystem", "ds:alone_sempai / https://topplugin.ru/", "9.0.0")]
    class TPMenuSystem : RustPlugin
    {
        #region Вар
        [PluginReference] Plugin TPShop, TPMiningFarm, TPBaraxolka, TPEconomic, ImageLibrary, TPRulesSystem, TPWipeBlock, TPKits, TPCases, TPStatsSystem, TPTeleportation, TPReportSystem, TPSkinMenu, TPBattlePass, GameStoresRUST, TPLotterySystem, SkinDrop, TPWipeSchedule, VKBot, TPChat, TPSkillSystem;
        ...
        Dictionary<string, string> imageMenu = new Dictionary<string, string>() {
            ...
            ["foninfo"] = "https://i.ibb.co/P4Hsjhy/mogwxrE.png",
        ...
        private void UpdateUIBalance(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components =
                {
                    ...
                    {
                        Text = $"{(float) TPEconomic.Call("API_GET_BALANCE", player.userID)}",
                        FontSize = 11,
