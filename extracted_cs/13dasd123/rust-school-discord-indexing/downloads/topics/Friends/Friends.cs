...
[Info("Friends", "https://rust-plug.ru/", "4.2.4")]
public class Friends : RustPlugin
{
    ...
    private void OnServerInitialized()
    {
        ...
        NextFrame(() =>
        {
            // Исправленный код для работы с BaseNetworkable.serverEntities
            foreach (var entity in BaseNetworkable.serverEntities)
            {
                ...
                {
                    var cb = entity as BuildingPrivlidge;
                ...
                if (entity.ShortPrefabName.Contains("lock.code"))
                {
                    var cd = entity as CodeLock;
