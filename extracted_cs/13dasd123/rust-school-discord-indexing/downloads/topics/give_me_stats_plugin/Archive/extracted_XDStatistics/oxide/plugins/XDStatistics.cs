...
{
    [Info("XDStatistics", "DezLife", "3.2.4")]
    ...
    class XDStatistics : RustPlugin
    {
        ...
        private class PlayerInfo : SplitDatafile<PlayerInfo>
        {
            ...
            internal class PvpStatsBuilder 
            {
        ...
        private List<int> _alowedSeedId = new(){ 1548091822, 1771755747, 1112162468, 1367190888,-1962971928, -2086926071, 44433072, 34515127, -567909622, 1272194103, 854447607,1660145984, 1783512007, -858312878 };
