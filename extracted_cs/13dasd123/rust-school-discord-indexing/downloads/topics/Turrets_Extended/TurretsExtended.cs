...
namespace Oxide.Plugins
{
    ...
    public class TurretsExtended : RustPlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            ...
            {
                ["NoAuth"] = "You don't have building privilege or you're not authorised to the turret!",
                ["NoAuthChat"] = "<color=#ce422b>You don't have building privilege or you're not authorised to the turret!</color>"
            }, this);
        }
