...
{
	[Info("ServerPanel Pop Ups", "Mevent", "1.0.19")]
	public class ServerPanelPopUps : RustPlugin
	{
			...
			string cmdMove = "edit_popup element move")
		{
			...
			AddButton(cmdElementRemove, "ServerPanel_Editor_Btn_Remove", "-106 -8", "-90 8");
			AddButton(cmdElementClone, "ServerPanel_Editor_Btn_Clone", "-81 -8", "-65 8");
			AddButton(cmdStartEdit, "ServerPanel_Editor_Btn_Edit", "-56 -8", "-40 8");
            AddButton(cmdMove + " up", "ServerPanel_Editor_Btn_Up", "-28.5 1.5", "-20 8");
			AddButton(cmdMove + " down", "ServerPanel_Editor_Btn_Down", "-28.5 -8", "-20 -1.5");
			...
			UiElement cuiElement, bool needUpdate = false)
		{
			...
			var element = new CuiElement()
			{
				...
				Components =
				{
					...
					{
						AnchorMin = "0 0", AnchorMax = "1 1",
						OffsetMin = "20 0", OffsetMax = "-105 0"
					}
				}
			};
		...
		{
			var width = (line.Length + 1) * fontSize * 0.35f;
