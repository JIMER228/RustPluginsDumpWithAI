...
namespace Oxide.Plugins
{
    ...
    class JetPack : RustPlugin
    {
        ...
        class JetpackComponent : FacepunchBehaviour
        {
            ...
            List<BaseEntity> fireEntities = new List<BaseEntity>();
            ...
            {
                BuildManager.SpawnChildEntity(movableDroppedItem, "assets/prefabs/weapons/rocketlauncher/rocket_launcher.entity.prefab", new Vector3(-0.160f, -0.221f, 0.186f), new Vector3(6.413f, 0.312f, 38.265f));
                BuildManager.SpawnChildEntity(movableDroppedItem, "assets/prefabs/weapons/rocketlauncher/rocket_launcher.entity.prefab", new Vector3(0.292f, -0.221f, 0.186f), new Vector3(6.413f, 0.312f, 38.265f));
            }
            ...
            void ControlFuelConsumtion()
            {
                ...
                if (timeScienceLastConsumtion >= 2)
                {
                    ...
                    targetConsumtionAmount += ins._config.fuel.fuelPerTick;
            ...
            {
                if (fireEntities.Count > 0 || !haveFuel)
                    return;

                //CreateFireGun("assets/prefabs/weapons/military flamethrower/militaryflamethrower.entity.prefab", new Vector3(0.118f, 0.206f, 0f), new Vector3(355.290f, 270.032f, 89.903f));
                //CreateFireGun("assets/prefabs/weapons/military flamethrower/militaryflamethrower.entity.prefab", new Vector3(-0.129f, 0.208f, 0.061f), new Vector3(355.290f, 90.032f, 89.903f));
                CreateFireGun("assets/prefabs/npc/patrol helicopter/rocket_heli.prefab", new Vector3(0.228f, -0.96f, 0.047f), new Vector3(270, 0, 0));
                CreateFireGun("assets/prefabs/npc/patrol helicopter/rocket_heli.prefab", new Vector3(-0.228f, -0.96f, 0.047f), new Vector3(270, 0, 0));
            }

            void CreateFireGun(string prefabName, Vector3 localPosition, Vector3 localRotation)
            {
                BaseEntity entity = BuildManager.SpawnChildEntity(movableDroppedItem, prefabName, localPosition, localRotation);
                entity.SetFlag(BaseEntity.Flags.Reserved8, true);
                fireEntities.Add(entity);
            }

            void KillFireEntities()
            {
                if (fireEntities.Count == 0)
                    return;

                foreach (BaseEntity entity in fireEntities)
                    if (entity.IsExists())
                        entity.Kill();
        ...
        static class BuildManager
        {
            ...
            internal static BaseEntity SpawnScaledDecorEntity(string prefabName, Vector3 position, Quaternion rotation, float scale, Vector3 sphereOffset, ulong skinId = 0)
            {
                ...
                BaseEntity scaledEntity = SpawnChildEntity(sphereEntity, prefabName, new Vector3(0, 0, 0) / scale, Vector3.zero, skinId, true);
                ...
                DestroyEntityConponent<TorpedoServerProjectile>(scaledEntity);
            ...
            {
                BaseEntity entity = CreateDecorEntity(prefabName, position, rotation, skinId, false);
                DestroyUnnessesaryComponents(entity);
            ...
            internal static BaseEntity SpawnDecorCargo(Vector3 position, Quaternion rotation)
            {
                ...
                SpawnChildEntity(customCargoShip, "assets/bundled/prefabs/static/door.hinged.cargo_ship_side.prefab", new Vector3(11.90f, 3.50f, 2.25f), new Vector3(0.00f, 180.00f, 0.00f), 0, true);
                SpawnChildEntity(customCargoShip, "assets/bundled/prefabs/static/door.hinged.cargo_ship_side.prefab", new Vector3(11.90f, 3.50f, 18.75f), new Vector3(0.00f, 180.00f, 0.00f), 0, true);
                SpawnChildEntity(customCargoShip, "assets/bundled/prefabs/static/door.hinged.cargo_ship_side.prefab", new Vector3(-11.90f, 3.50f, 18.75f), new Vector3(0.00f, 0.00f, 0.00f), 0, true);
                SpawnChildEntity(customCargoShip, "assets/bundled/prefabs/static/door.hinged.cargo_ship_side.prefab", new Vector3(-11.90f, 3.50f, 2.25f), new Vector3(0.00f, 0.00f, 0.00f), 0, true);
