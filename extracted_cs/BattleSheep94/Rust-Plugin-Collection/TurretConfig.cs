...
namespace Oxide.Plugins
{
    ...
    class TurretConfig : RustPlugin
    {
        ...
        {
            if (hitInfo.Initiator != null && (hitInfo.Initiator.prefabID == autoTurretPrefabId || hitInfo.Initiator.prefabID == flameTurretPrefabId)) {
                float modifier = FromPermission (hitInfo.Initiator.OwnerID.ToString (), bulletModifiers, defaultBulletModifier);
