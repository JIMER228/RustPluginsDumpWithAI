...
namespace Oxide.Plugins {
    ...
    [Info("True Welcomer", "ItzNxthaniel", "1.2.1")]
    ...
    public class TrueWelcomer : RustPlugin {
        ...
        protected override void LoadDefaultConfig() {
            _config = new Configuration {
                ...
                PrivateWelcomeMessages = false,
                PrivateJoinMessages = false,
        ...
        private class Configuration {
            ...
            [JsonProperty("Private Welcome Messages - Welcomes the user privately.")]
            internal bool PrivateWelcomeMessages;
            
            [JsonProperty("Private Join Messages - Welcome backs the user privately.")]
            internal bool PrivateJoinMessages;
        ...
        private void OnPlayerSleepEnded(BasePlayer player) {
            ...
            if (isOnline) {
                ...
                if (string.IsNullOrEmpty(keyToUse)) return;
                if (keyToUse == "OnWelcome" && _config.PrivateWelcomeMessages || keyToUse == "OnJoin" && _config.PrivateJoinMessages) {
                    player.ChatMessage(GetMessage(keyToUse, player.UserIDString));
                    return;
                }
