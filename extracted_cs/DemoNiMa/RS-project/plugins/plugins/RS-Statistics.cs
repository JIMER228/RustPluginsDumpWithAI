    ...
    class XDStatistics : RustPlugin
    {
        ...
        private void DialogConfirmationDropStat(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent {AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "13.64 -104.38", OffsetMax = "160.12 -45.24" }
                }
            });
        ...
        private void TopTen(BasePlayer player)
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "1 1 1 0" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-640 -360.00", OffsetMax = "640 266.93" }
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-599.3 -237.22", OffsetMax = "589.33 271.44" }
            }, UI_TOP_TEN_USER, "TOP_10_TABLE");
            
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-203.17 70.35", OffsetMax = "203.17 107.46" },
            ...
            if (_config.settings.pveServerMode)
            {
                                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "9.2 -20.65", OffsetMax = "176.34 -3.54" },
                ...
                container.Add(new CuiElement
                {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "9.57 -441.75", OffsetMax = "177.21 -26.86" }
                }
                });
                ...
                foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in animalKiller)
                {
                    ...
                    container.Add(new CuiPanel
                    {
                        ...
                        RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-83.82 {177.27 - (y * 42.86)}", OffsetMax = $"83.82 {207.44 - (y * 42.86)}" }
                    ...
                    container.Add(new CuiElement
                    {
                        ...
                        Components =
                        {
                            ...
                            new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-64.82 -6.72", OffsetMax = "7.52 6.72" }
                        }
                    });

                    container.Add(new CuiLabel
                    {
                        RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "7.52 -6.72", OffsetMax = "76.93 6.72" },
            ...
            else
            {
                ...
                foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in killer)
                {
                    ...
                    y++;
                        ...
                        container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "209.12 -20.65", OffsetMax = "376.27 -3.54" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiRawImageComponent { Color = "1 1 1 0.3", Png =  _imageUI.GetImage("20") },
                    new CuiRectTransformComponent { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "210.28 -441.75", OffsetMax = "377.91 -26.86" }
                }
            });
            ...
            foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in killerNpc)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = processedItem.Color },
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-83.82 {177.27 - (i * 42.86)}", OffsetMax = $"83.82 {207.44 - (i * 42.86)}" }
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "409.22 -20.65", OffsetMax = "576.37 -3.54" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiRawImageComponent { Color = "1 1 1 0.3", Png =  _imageUI.GetImage("20") },
                    new CuiRectTransformComponent { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "409.23 -441.75", OffsetMax = "576.86 -26.86" }
                }
            });
            ...
            foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in time)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = processedItem.Color },
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-83.82 {177.27 - (c * 42.86)}", OffsetMax = $"83.82 {207.44 - (c * 42.86)}" }
                ...
                c++;
                        ...
                        container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-580.57 -20.65", OffsetMax = "-413.42 -3.54" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiRawImageComponent { Color = "1 1 1 0.3", Png =  _imageUI.GetImage("20") },
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-580.09 -441.75", OffsetMax = "-412.46 -26.86" }
                }
            });
            ...
            foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in farm)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = processedItem.Color },
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-83.82 {177.27 - (f * 42.86)}", OffsetMax = $"83.82 {207.44 - (f * 42.86)}" }
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-381.15 -20.65", OffsetMax = "-214.00 -3.54" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiRawImageComponent { Color = "1 1 1 0.3", Png =  _imageUI.GetImage("20") },
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-380.67 -441.75", OffsetMax = "-213.04 -26.86"  }
                }
            });
            ...
            foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in exp)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = processedItem.Color },
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-83.82 {177.27 - (z * 42.86)}", OffsetMax = $"83.82 {207.44 - (z * 42.86)}" }
                ...
                z++;
                        ...
                        container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-180.87 -20.65", OffsetMax = "-13.72 -3.54" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiRawImageComponent { Color = "1 1 1 0.3",  Png = _imageUI.GetImage("20") },
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-180.41 -441.75", OffsetMax = "-12.78 -26.86"}
                }
            });
            ...
            foreach ((ulong playerId, PlayerInfo playerInfo, int value, float score) item in score)
            {
                ...
                container.Add(new CuiPanel
                {
                    CursorEnabled = false,
                    Image = { Color = processedItem.Color },
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"-83.82 {177.27 - (s * 42.86)}", OffsetMax = $"83.82 {207.44 - (s * 42.86)}" }
        ...
        private void OnPlayerDisconnected(BasePlayer player)
        {
            ...
            if (_lootersListCarte.ContainsKey(player))
                _lootersListCarte.Remove(player);
        }
        ...
        private void ButtonDropStat(BasePlayer player, PlayerInfo info)
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "13.75 -29.55", OffsetMax = "160.23 -15.72" }
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-120.55 -6.91", OffsetMax = "21.75 8.20" },
                Text = { Text = "STAT_UI_RESET_STAT".GetAdaptedMessage(player.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" }
        ...
        {
            if (entity == null || player == null || !player.IsPlayer())
                return;
            
            ulong netId = entity.net.ID.Value;

            if (!_lootersListCarte.TryGetValue(player, out HashSet<ulong> playerLoots))
            {
                playerLoots = new HashSet<ulong>();
                _lootersListCarte[player] = playerLoots;
            }

            if (!playerLoots.Add(netId))
                return; 
        ...
        private void ButtonHideStat(BasePlayer player, PlayerInfo info)
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "13.86 -8.61", OffsetMax = "160.34 6.22" }
            }, UI_USER_STAT_INFO, "BUTTON_HIDE_STAT");
		   		 		  						  	   		  	 	 		  		 			  		 			  	  	
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-120.77 -7.42", OffsetMax = "21.52 9.81" },
                Text = { Text = "STAT_UI_HIDE_STAT".GetAdaptedMessage(player.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" }
            ...
            if (!info.HidedStatistics)
            {
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        ...
                        new CuiRectTransformComponent { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "1.38 -6.40", OffsetMax = "14.38 6.59" }
                    }
                });
            }
            else
        ...
        private void OnCollectiblePickedup(CollectibleEntity collectible, BasePlayer player, Item item)
        {
            ...
            {
                case ItemCategory.Food when !item.info.shortname.Contains("seed"):
        ...
        {
            if (container == null || container.entityOwner == null || !container.entityOwner.ShortPrefabName.Contains("barrel"))
                return;
        ...
        private void CategoryStatUser(BasePlayer player, ulong target = 0, int cat = 0)
        {
            ...
            {
                CursorEnabled = false,
                Image = { Color = "0.58 0.57 0.61 0.43" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"151.69 {181.04 - ((list.Count - 1) * 50.72)}", OffsetMax = $"153.21 225.49" }
            }, UI_USER_STAT_INFO, "STAT_LINE");

            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0.58 0.57 0.61 1" },
                RectTransform = { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = $"-0.76 {-23.34 - ((list.Count - 1) * 30.72)}", OffsetMax = "0.76 0.17" }
                        ...
                        container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = "-146.98 -71.4", OffsetMax = "146.38 -53.16" }
            }, UI_USER_STAT_INFO, "MENU_USER_STAT");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "0.31 -9.12", OffsetMax = "84.70 9.12" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = cat == 0 ? "0.29 0.68 0.12 0.64" : "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-42.34 0", OffsetMax = "42.19 1.87" }
            }, "Panel_5655", "Panel_8052");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-61.98 -9.12", OffsetMax = "31.23 9.12" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = cat == 1 ? "0.29 0.68 0.12 0.64" : "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-46.60 0", OffsetMax = "46.60 1.87" }
            }, "Panel_56551", "Panel_8052");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-115.45 -9.12", OffsetMax = "0.00 9.12" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = cat == 2 ? "0.29 0.68 0.12 0.64" : "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 0", AnchorMax = "0.5 0", OffsetMin = "-57.73 0", OffsetMax = "57.73 1.87" }
                        ...
                        container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-146.99 -124.12", OffsetMax = "146.38 226.03" }
            ...
            foreach (KeyValuePair<string, int> item in list)
            {
                ...
                {
                    FadeOut = 0.30f,
                    RectTransform = { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = $"-146.11 {-44.97 - (y * 50.72)}", OffsetMax = $"146.69 {-0.76 - (y * 50.72)}" },
                    Image = { Color = "0.96 0.92 0.88 0.03",  Material = "assets/content/ui/namefontmaterial.mat", FadeIn = fade },
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "26.03 -10.53", OffsetMax = "126.03 12.57" },
                    Text = { Text = name, Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleRight, Color = "0.85 0.84 0.88 1", FadeIn = fade }
                ...
                if (item.Key == "all")
                {
                    ...
                    container.Add(new CuiLabel
                    {
                        RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-128 -10.53", OffsetMax = "50 12.57" },
                ...
                else
                {
                    ...
                    container.Add(new CuiLabel
                    {
                        RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-73.17 -10.53", OffsetMax = "50 12.57" },
                        Text = { Text = itemName, Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" , FadeIn = fade}
                    }, "STAT_USER_LINE");
                }
                y++;
            }
                ...
                private void MainMenuStat(BasePlayer player)
        {
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-115.35 -36.79", OffsetMax = "-105.24 -27.94" }
                }
            });
        ...
        private void OnGrowableGathered(GrowableEntity plant, Item item, BasePlayer player)
        {
            ...
            if (item.info.category == ItemCategory.Food && !item.info.shortname.Contains("seed"))
            {
                PlayerInfo playerStat = PlayerInfo.GetOrCreate(player.userID);
                playerStat.AddOrUpdateCrop(item.info.shortname, item.amount, _config.settingsScore.PlantScore);
            }
                ...
                private void SearchPageUser(BasePlayer player, string target = "")
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "1 1 1 0" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-378.45 -264.83", OffsetMax = "381.99 266.93" }
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    ...
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-119.86 -9.31", OffsetMax = "129.03 9.59" }
                }
            });
            ...
            foreach (KeyValuePair<ulong, PlayerInfo> players in PlayerInfo._players.Where(z => z.Value.Name.ToLower().Contains(targetLower) && !_config.settings.ignoreList.Contains(z.Key)))
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiImageComponent() {Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat"},
                        new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = $"{-164.97 + (x * 112.58)} {84.13 - (y * 26.28)}", OffsetMax = $"{-62.80 + (x * 112.58)} {105.62 - (y * 26.28)}" }
                    }
                });
                ...
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-26.83 -10.74", OffsetMax = "48.36 10.74" },
        ...
        private void OtherStatUser(BasePlayer player, ulong target = 0, int statType = 0)
        {
            ...
            if (statType == 0)
            {
                                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat"},
                        new CuiRectTransformComponent { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-210.14 181.39", OffsetMax = "-13.97 227.42" }
                }
                });
                
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "48.35 -7.01", OffsetMax = "176.50 8.41" },
                                ...
                                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat"},
                        new CuiRectTransformComponent { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-210.14 129.17", OffsetMax = "-13.97 175.20" }
                    }
                });
                                ...
                                container.Add(new CuiElement
                {
                    ...
                    Components = {
                        new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat"},
                    new CuiRectTransformComponent { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-210.14 76.95", OffsetMax = "-13.97 122.98" }
                }
                });
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = "STAT_UI_BTN_MORE".GetAdaptedMessage(player.UserIDString), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleCenter, Color = "0.85 0.84 0.88 1" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "186.97 -254.68", OffsetMax = "383.15 -233.6" }
                ...
                private void UserStat(BasePlayer player, ulong target = 0)
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-400.25 -331.55", OffsetMax = "393.97 274.44" }
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "14.90 -69.43", OffsetMax = "227.49 -53.16" },
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "15.47 -179.88", OffsetMax = "87.32 -161.71" },
            ...
            if (target == 0 && (_config.settings.availabilityUse && (permission.UserHasPermission(player.UserIDString, PermAvailability) ||  _config.settings.dropStatUse && permission.UserHasPermission(player.UserIDString, PermReset))))
            {
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "15.47 -290.08", OffsetMax = "87.32 -271.91" },
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "14.8 -151.28", OffsetMax = "227.38 -134.31" },
                Text = { Text = "STAT_UI_PLACE_TOP".GetAdaptedMessage(player.UserIDString, GetTopScore(target == 0 ? player.userID : target)), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" }
            }, UI_USER_STAT_INFO, "TOP_IN_USER");

            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "0 1", OffsetMin = "14.69 -201.18", OffsetMax = "227.27 -184.21" },
                Text = { Text = "STAT_UI_ACTIVITY_TODAY".GetAdaptedMessage(player.UserIDString, TimeHelper.FormatTime(TimeSpan.FromMinutes(statInfo.playedTime.PlayedToday), 5, lang.GetLanguage(player.UserIDString))), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" }
            }, UI_USER_STAT_INFO, "TODAY_ACTIVE_USER");

            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-382.31 79.21", OffsetMax = "-169.73 96.18" },
                Text = { Text = "STAT_UI_ACTIVITY_TOTAL".GetAdaptedMessage(player.UserIDString, TimeHelper.FormatTime(TimeSpan.FromMinutes(statInfo.playedTime.PlayedForWipe), 5, lang.GetLanguage(player.UserIDString))), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" }
            }, UI_USER_STAT_INFO, "ALLTIME_ACTIVE_USER");

            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-382.31 56.91", OffsetMax = "-169.73 73.88" },
                Text = { Text = "STAT_UI_SCORE".GetAdaptedMessage(player.UserIDString, statInfo.ScoreFormatted()), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleLeft, Color = "0.85 0.84 0.88 1" }
            }, UI_USER_STAT_INFO, "SCORE_USER");

            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-209.5 -67.82", OffsetMax = "-130.04 -53.66" },
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-209.50 36.61", OffsetMax = "-13.97 50.78" },
                        ...
                        container.Add(new CuiElement
            {
                ...
                Parent = UI_USER_STAT_INFO,
                Components = {
                    new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat", ImageType = Image.Type.Tiled},
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-209.38 -123.24", OffsetMax = "-14.46 -78.4" }
                }
            });

            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "19 -7.01", OffsetMax = "97 8.41" },
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-98 -7.01", OffsetMax = "-16.84 8.41" },
                Text = { Text = kills.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleRight, Color = "0.85 0.84 0.88 1" }
                        ...
                        container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat", ImageType = Image.Type.Tiled},
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-209.38 -173.69", OffsetMax = "-14.46 -128.84" }
                }
            });
            ...
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-98 -7.01", OffsetMax = "-16.84 8.41" },
                Text = { Text = statInfo.PlayerPvpStats.Deaths.ToString(), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleRight, Color = "0.85 0.84 0.88 1" }
                        ...
                        container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat", ImageType = Image.Type.Tiled},
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-209.39 -224.72", OffsetMax = "-14.47 -179.87" }
                }
            });
            container.Add(new CuiLabel
            {
            ...
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-98 -7.01", OffsetMax = "-16.84 8.41" },
                Text = { Text = statInfo.PlayerPvpStats.CalculateKDR(kills), Font = "robotocondensed-regular.ttf", FontSize = 10, Align = TextAnchor.MiddleRight, Color = "0.85 0.84 0.88 1" }
                        ...
                        container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiImageComponent() { Color = "0.96 0.92 0.88 0.03", Material = "assets/content/ui/namefontmaterial.mat", ImageType = Image.Type.Tiled},
                    new CuiRectTransformComponent { AnchorMin = "1 1", AnchorMax = "1 1", OffsetMin = "-210.15 -324.60", OffsetMax = "-13.97 -278.56" }
                }
            });
            ...
            if (weaponTop.Key != null)
            {
                container.Add(new CuiLabel
                {
                    RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "46.32 -16.5", OffsetMax = "176.50 16.5" },
            ...
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-209.49 -63.38", OffsetMax = "-79.66 -49.21" },
        ...
        private void MenuButton(BasePlayer player, int page = 0)
        {
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "1 1 1 0" },
                RectTransform = { AnchorMin = "0.5 1", AnchorMax = "0.5 1", OffsetMin = "-132.23 -75.53", OffsetMax = "122.19 -48.56" }
            }, UI_INTERFACE, UI_MENU_BUTTON);
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0 0.5", AnchorMax = "0 0.5", OffsetMin = "-0.00 -13.48", OffsetMax = "88.11 13.48" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = page == 0 ? "0.29 0.68 0.12 0.64" : "1 1 1 0.3" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-44.05 -13.48", OffsetMax = "44.05 -11.64" }
            }, "BUTTON_MY_STAT", "Panel_8193");

            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-39.10 -13.48", OffsetMax = "65.74 13.48" },
            ...
            {
                CursorEnabled = false,
                Image = { Color = page == 1 ? "0.29 0.68 0.12 0.64" : "1 1 1 0.3" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-52.42 -13.48", OffsetMax = "52.42 -11.64" }
            ...
            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = "0 0 0 0" },
                RectTransform = { AnchorMin = "1 0.5", AnchorMax = "1 0.5", OffsetMin = "-61.47 -13.48", OffsetMax = "0.21 13.48" }
            }, UI_MENU_BUTTON, "BUTTON_PAGE_SEARCH");

            container.Add(new CuiPanel
            {
                CursorEnabled = false,
                Image = { Color = page == 2 ? "0.29 0.68 0.12 0.64" : "1 1 1 0.3" },
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-30.84 -13.48", OffsetMax = "30.84 -11.64" }
            }, "BUTTON_PAGE_SEARCH");
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "-30.84 -8.36", OffsetMax = "12.86 8.36" },
            ...
            container.Add(new CuiElement
            {
                ...
                Components = {
                    new CuiImageComponent { Color = "1 1 1 1", Sprite = "assets/icons/examine.png" },
                    new CuiRectTransformComponent { AnchorMin = "0.5 0.5", AnchorMax = "0.5 0.5", OffsetMin = "12.86 -6.5", OffsetMax = "25.86 6.5" }
                }
            });
            container.Add(new CuiButton
            {
        ...
        private  Dictionary<BasePlayer, HashSet<ulong>> _lootersListCarte = new();
        ...
        private class Configuration
        {
            public class SettingsInterface
            {
                ...
                public string BackgroundColor = "0.23 0.22 0.18 0.90";
                [JsonProperty(RU ? "Цвет спрайта и материала" : "The color of the sprite and the material")]
                public string BackgroundColorSpriteAndMaterial = "0.14 0.13 0.10 1";
                [JsonProperty("Sprite")]
        ...
        private List<int> _alowedSeedId = new(){ 1548091822, 1771755747, 1112162468, 1367190888,-1962971928, -2086926071, 44433072, 34513516, -567909622, 1272194103, 854447607,1660145984, 1783512007, -858312878 };
                ...
                private void Unload()
        {
            ...
            PlayerInfo._players = new Dictionary<ulong, PlayerInfo>();
            Instance = null;
        }
