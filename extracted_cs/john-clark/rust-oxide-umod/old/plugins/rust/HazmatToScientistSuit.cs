...
{
	[Info("Hazmat To Scientist Suit", "BuzZ[PHOQUE]", "0.0.6")]
...
*=======================================================================================================================*/
	...
	public class HazmatToScientistSuit : RustPlugin
	{
        ...
        private void LoadVariables()
        {
            ...
            SteamIDIcon = Convert.ToUInt64(GetConfig("Chat Settings", "SteamIDIcon", 76561198859224394));        // SteamID FOR PLUGIN ICON - STEAM PROFILE CREATED FOR THIS PLUGIN / 76561198857725741 /
