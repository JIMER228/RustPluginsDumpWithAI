...
{
    [Info("Autokick", "Exel80", "1.2.1", ResourceId = 2138)]
    ...
    class Autokick : CovalencePlugin
    {
        ...
        private void Loaded()
        {
            ...
            {
                ["Toggle"] = "Autokick is now [#yellow]{0}[/#]",
                ["KickHelp"] = "When Autokick is [#yellow]{0}[/#], use [#yellow]{1}[/#] to kick all online players. (Except whitelisted players)",
        ...
        #region Commands
        [ConsoleCommand("autokick")]
        void cmdConsoleAutokick(ConsoleSystem.Arg arg)
        {
            switch (arg.Args[0])
            {
                case "on":
                    {
                        ...
                        // Print Toggle
                        Puts(Lang("Toggle", null, "ACTIVATED!") + "\n" + Lang("KickHelp", null, "enabled", "autokick kick"));
                    }
                    break;
                case "kick":
                    {
                        ...
                        if (!config.akEnable)
                        {
                            Puts(Lang("ToggleHint", null, "true", "autokick kick"));
                            return;
                        }
                ...
                case "off":
                    {
                        ...
                        // Print Toggle
                        Puts(Lang("Toggle", null, "DE-ACTIVATED!"));
                    }
                    break;
            }
