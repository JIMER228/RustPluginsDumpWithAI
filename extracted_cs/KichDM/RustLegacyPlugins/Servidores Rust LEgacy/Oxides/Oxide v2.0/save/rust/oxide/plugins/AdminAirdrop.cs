...
namespace Oxide.Plugins
{
    ...
    class AdminAirdrop : RustLegacyPlugin
    {
        ...
        static string calledAirdrop = "airdrop chamado...";
        static string cancelledAirdrop = "{0} Airdrops cancelled...";
        static string destroyedCrates = "{0} Supply crates destroyed...";
        static string massAirdrop = "Chamando {0} airdrops ...";
        static string airdropPos = "Airdrop chamado @ {0}";
        static string airdropPlayer = "Airdrop chamado @ {0} - {1}'s position";
        ...
        void Init()
        {
            ...
            CheckCfg<string>("Messages: Chamado 1 airdrop", ref calledAirdrop);
            ...
            CheckCfg<string>("Messages: Airdrop na posicao", ref airdropPos);
