...

{
...

    {
...

        {
            ...
            if (receiver.activeItem == null || receiver.activeItem.datablock.name != "Pick Axe" || receiver.activeItem.datablock.name != "Uber Hatchet")
