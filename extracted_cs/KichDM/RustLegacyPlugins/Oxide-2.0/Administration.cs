...
namespace Oxide.Plugins
{
    ...
    class Administration : RustLegacyPlugin
    {
        ...
        void SetupChatCommands()
        {
            ...
            if (commandClose)
                cmd.AddChatCommand("gameclose", this, "cmdClose");

            if (commandMute)
                cmd.AddChatCommand("mutejhgjffhgj", this, "cmdMute");
            ...
            if (commandAirdrop)
                cmd.AddChatCommand("Teleregalo", this, "cmdAirdrop");

            if (commandPopup)
                cmd.AddChatCommand("m", this, "cmdPopup");
