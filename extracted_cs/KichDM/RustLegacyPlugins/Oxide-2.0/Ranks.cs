...
namespace Oxide.Plugins{
	...
	class Ranks : RustLegacyPlugin{
		...
		static int percentageTakeXpDeaths	= 25;
		static int percentageTakeXpSuicides	= 15;
		...
		static int giveXpMutantBear			= 10;
		static int giveXpMutantWolf			= 9;
		static int giveXpBear				= 8;
		static int giveXpWolf				= 7;
		static int giveXpStag				= 6;
		static int giveXpChicken			= 4;
		static int giveXpRabbit				= 4;
		static int giveXpBoar				= 5;
		...
		static Dictionary<string,int> GetXpBodyParts(){
			...
			dict.Add("torso", 10);
			dict.Add("hip", 10);
			dict.Add("left calve", 8);
			dict.Add("right calve", 8);
			dict.Add("right shoulder", 8);
			dict.Add("left shoulder", 8);
			dict.Add("right bicep", 10);
			dict.Add("left bicep", 10);
			dict.Add("right foot", 6);
			dict.Add("left foot", 6);
			dict.Add("right wrist", 6);
			dict.Add("left wrist", 6);
			dict.Add("right ankle", 6);
			dict.Add("left ankle", 6);
			return dict;
		}
		...
		static Dictionary<string,int> GetRanksNamesLevels(){
			var dict = new Dictionary<string, int>();
			dict.Add("Recluta", giveRankLevels);
			dict.Add("Soldado", giveRankLevels * 2);
			dict.Add("Cabo", giveRankLevels * 3);
			dict.Add("Sargento", giveRankLevels * 4);
			dict.Add("Teniente", giveRankLevels * 5);
			dict.Add("Capitan", giveRankLevels * 6);
			dict.Add("Mayor", giveRankLevels * 7);
			dict.Add("General", giveRankLevels * 8);
			dict.Add("Héroe de guerra", giveRankLevels * 9);
			dict.Add("Supernova", giveRankLevels * 10);
			return dict;
		}
