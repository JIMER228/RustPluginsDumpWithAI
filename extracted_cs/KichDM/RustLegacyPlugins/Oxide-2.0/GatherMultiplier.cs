...
{
    [Info("GatherMultiplier", "PionixZ", "1.0.5", ResourceId = 974)]
    class GatherMultiplier : RustLegacyPlugin
    {
        ...
        static int GathermetalOreMultiplier = 2;
        static int GathersulfurOreMultiplier = 2;
        static int GatherstonesMultiplier = 2;
        static int GatherwoodpileMultiplier = 3;
