...
namespace Oxide.Plugins
{
    ...
    class AntiCheat : RustLegacyPlugin
    {
        ...
        public static string playerHackDetectionBroadcast = "[color red][[[[color white] {0} [color #F92A82]intento usar hacks en el servidor y fue baneado[color red]]]]";
        public static string noAccess = "[color red]No tienes permisos para usar este comando.";
        public static string noPlayerFound = "[color red]Jugador no encontrado.";
        public static string checkingPlayer = "{0} [color #F92A82]esta siendo checkeado.";
        public static string checkingAllPlayers = "AntiCheat[color cyan] - [color #F92A82]checkeando a todos los jugadores.";
        public static string DataReset = "AntiCheat[color cyan] - [color #F92A82]Datos reseteados, todos los jugadores serán checkeados de nuevo.";
        ...
        void Init()
        {
            ...
            CheckCfg<float>("OverKill: Reset Timer ", ref overkillResetTimer);
            CheckCfg<float>("OverKill: Detections before punish", ref overkillDetectionForPunish);
