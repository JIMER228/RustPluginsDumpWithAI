...
namespace Oxide.Plugins
{
    ...
    class AdminAirdrop : RustLegacyPlugin
    {
        ...
        static string calledAirdrop = "[color orange]Calledo [color cyan]Dropsss!!!...";
        static string cancelledAirdrop = "{0} [color red]Airdrops cancelados...";
        static string destroyedCrates = "{0} [color red]Supply crates destruidas...";
        static string massAirdrop = "[color orange]Llamando [color yellow]{0} [color cyan]Airdrops ...";
        static string airdropPos = "[color orange]Airdrop called @[color cyan] {0}";
        static string airdropPlayer = "[color orange]Airdrop called @[color cyan] {0} - [color yellow]{1}'s position";
