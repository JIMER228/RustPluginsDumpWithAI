	...
	class MiniEvents : RustLegacyPlugin
	{
		...
		void LoadDefaultMessages()
		{
			var message = new Dictionary<string, string>
			{
				...
				{"AutoStartGameMath", "Автоматический евент по математике, пример: [color red]{0} [color clear] равно [color lime]{1} [color clear]минуты до окончания."},
				{"AutoStartGameMath1", "Время [color red]закончилось [color clear] по математическому вопросу!"},
				{"EventLottery", "Начался лотерейный розыгрыш [color red] {0} [color clear] минуты, чтоб принять участие напишите - [color lime]/enter"},
				{"EventLottery1", "Начался лотерейный розыгрыш чисел, укажите свой номер, окончание через [color red] {0} [color clear] минуты, чтобы принять участие напишите - [color lime]/enter [color cyan](Номер)"},
				{"EventLottery2", "Мало людей для начала лотереи, всего [color red]{0}  [color clear]игроков!"},
				{"EventLottery3", "[color red]{0} [color clear]выиграл в лотерее."},
				{"EventLottery4", "[color red]{0} [color clear]выиграл в лотерее чисел, число [color lime]{1}[color clear]."},
				{"EventLottery5", "Никто не угадал номер в лотерее, правильный номер - [color red]{0}[color clear]."},
				{"PrizeInInventory", "Ваш приз в инвентаре!"},
				...
				{"EventsConfig3", "Минимальное количество игроков для старта лотереи - {0}."},
				...
				{"EventsConfig11", "Максимальное число в лотерее {0}."},
				{"EventsSystems", "{0} [color red]disabled [color clear]auto events."},
				{"EventsSystems1", "{0} [color lime]activated [color clear]auto events."},
				{"EventsSystems2", "Лотерея для игроков теперь {0}."},
				{"EventsSystems3", "Евент теперь {0}, новое начало через {1}."},
				{"EventsSystems4", "Math event now is {0}, event lottery now is {1}."},
				{"EventsSystems5", "Random Events is {0}."},
				{"NoHaveAcess", "У вас нету доступа к данной команде."},
				{"EnterLottery", "Участие в лотерее [color red]закрыто[color clear]!"},
				{"EnterLottery1", "Вы уже  [color red]участвуете [color clear]в лотереи!"},
				{"EnterLottery2", "[color red]{0} [color clear]присоединился к лотерее игроков, принять участие [color lime]/enter [color clear]игроков участвует [color red]{1}[color clear]."},
				{"EnterLottery3", "Используйте /enter [color red](Number) [color clear]=> Участвовать в лотерее."},
				{"EnterLottery4", "Вы должны выбрать номер из лотереи от [color lime]0 [color clear]до [color red]{0} [color clear]максимум."},
				{"EnterLottery5", "[color red]{0} [color clear]принял участие в лотереи [color lime]{1} [color clear]/enter (Number) чтобы принять участие [color red]{2}[color clear]."}
			}; 
