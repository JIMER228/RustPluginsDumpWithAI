...
{
    [Info("OutsideSafeZoneFix", "Shady", "0.0.2")]
    class OutsideSafeZoneFix : RustPlugin
    {
        /*
        ...
        private void OnPlayerAttack(BasePlayer player, HitInfo info)
        {
            ...
            if (victim != null && !victim.IsNpc && victim.InSafeZone() && !player.InSafeZone() && !player.IsNpc) CancelDamage(info);
        }
