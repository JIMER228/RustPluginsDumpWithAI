...
{
    [Info("Water Drink Foundation Fix", "Shady", "0.0.1")]
    internal class WaterDrinkFoundationFix : RustPlugin
    {
        /*
        ...
        private void OnPlayerInput(BasePlayer player, InputState input)
        {
            ...
            if (input.WasJustPressed(BUTTON.USE) && GetLookAtEntity(player, 5f) != null)
                player.metabolism.MarkConsumption(); //just consumed, so won't be able to actually drink!
        }
