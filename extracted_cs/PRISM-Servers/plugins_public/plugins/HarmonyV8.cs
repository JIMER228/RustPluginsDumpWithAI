...
{
    [Info("Harmony V8 Engine", "Shady", "0.0.1")]
    class HarmonyV8 : RustPlugin
    {
        /*
        ...
        private void DoHarmonyPatches(Harmony instance, Type type)
        {
            ...
            try { c = PatchAllHarmonyAttributes(type.Assembly, type, instance); }
            finally
            {
        ...
        private int PatchAllHarmonyAttributes(Assembly executingAssembly, Type type, Harmony harmony, BindingFlags? flags = null)
        {
            var patched = 0;
