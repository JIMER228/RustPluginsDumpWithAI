...
{
    [Info("CanDropItem Patch", "Shady", "0.0.1", ResourceId = 0)]
    internal class CanDropItemPatch : RustPlugin
    {
        /*
        ...
        {
            private static bool Prefix(Item __instance, Vector3 vPos, Vector3 vVelocity, Quaternion rotation= default(Quaternion))
            {

                var canAdd = Interface.Oxide.CallHook("OnItemDrop", __instance);
                return canAdd == null;
