...
{
    [Info("RestartPopup", "Shady", "0.0.1")]
    class RestartPopup : RustPlugin
    {
        /*
        ...
        void OnServerCommand(ConsoleSystem.Arg arg)
        {
            ...
            ShowPopupAll("<color=#ff216b><size=27>SERVER RESTART IN " + restartTime.ToString("N0") + " SECONDS!</size></color>");
        }
