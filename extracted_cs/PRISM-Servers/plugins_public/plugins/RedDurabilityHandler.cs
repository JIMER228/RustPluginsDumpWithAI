...
{
    [Info("Project Red | Durability Handler", "Shady", "0.0.2")]
    class RedDurabilityHandler : RustPlugin
    {
        /*
         ...
         * 
         */
        //THIS IS COMPLETELY FUCKED AND DOES NOT HANDLE DURABILITY. IT'S A COPY OF METABOLISM HANDLER. WTF WAS I DOING?
        ...
        private void OnMeleeAttack(BasePlayer player, HitInfo info)
        {
          ...
          //  PrintWarning("OnMeleeAttack for DurabilityHandler cal/hydration on attack: " + metabolism.calories.value + ", " + metabolism.hydration.value + ", cal frac: " + metabolism.calories.Fraction());
            ...
            if (calFrac <= 0.25 && UnityEngine.Random.Range(0, 101) <= (5 / (1 + calFrac)) * repeatDelay || waterFrac <= 0.33 && UnityEngine.Random.Range(0, 101) <= (10 / (1 + waterFrac)) * repeatDelay)
            {
                ...
                ShowPopup(player, "You inaccurately swing your weapon and deal less damage!", 3.25f);
        ...
        private void OnDispenserGather(ResourceDispenser dispenser, BasePlayer player, Item item)
        {
         ...
         //   PrintWarning("OnDispenserGather");
            ...
            {
                PrintWarning("last inaccurate hit does not match current ent!!!!");
                return;
            }
