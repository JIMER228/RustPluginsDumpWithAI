...
{
    [Info("Arena Statistics", "k1lly0u", "0.2.0"), Description("Manages and provides API for statistics gathered from Arena")]
    public class ArenaStatistics : RustPlugin
    {
        #region Fields
        ...
        private void Loaded()
        {
            statisticsData = Interface.Oxide.DataFileSystem.GetFile("Arena/statistics_data");
