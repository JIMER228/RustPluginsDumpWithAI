...
{
    [Info("Bank System", "rustmods.ru fix kreker", "1.2.2")]
    public class BankSystem : RustPlugin
    {
        ...
        {
            [JsonProperty(PropertyName = "Работать с Notify?")]
            ...
            [JsonProperty(PropertyName = "Авто-создание карты")]
            public readonly bool CardAutoCreation = false;

            [JsonProperty(PropertyName = "Использовать срок действия карты?")]
            public readonly bool UseCardExpiry = true;

            [JsonProperty(PropertyName = "Срок действия карты (в днях)")]
            public readonly int CardExpiryDate = 7;

            [JsonProperty(PropertyName = "Настройка БАНКОМАТА")]
            ...
            [JsonProperty(PropertyName = "Настройка отслеживания")]
            ...
            [JsonProperty(PropertyName = "Настройка вайпа данных")]
            ...
            [JsonProperty(PropertyName = "Настройка NPC")]
            ...
            [JsonProperty(PropertyName = "Настройка выпадения",
            ...
            [JsonProperty(PropertyName = "Цвета")] public readonly Colors Colors = new Colors
            {
                Color1 = "#0E0E10",
                Color2 = "#161617",
                Color3 = "#4B68FF",
        ...
        {
            [JsonProperty(PropertyName = "Включить")]
            public bool Enabled;

            [JsonProperty(PropertyName = "Префаб")]
            public string PrefabName;

            [JsonProperty(PropertyName = "Шанс")] public int DropChance;

            [JsonProperty(PropertyName = "Мин. количество")]
            public int MinAmount;

            [JsonProperty(PropertyName = "Макс. количество")]
            public int MaxAmount;
        }

        private class EconomySettings
        {
            [JsonProperty(PropertyName = "Использовать собственную систему экономики?")]
            public bool Self;
        ...
        {
            [JsonProperty(PropertyName = "Очищать данные игроков?")]
            public bool Players;

            [JsonProperty(PropertyName = "Очищать логи?")]
            public bool Logs;

            [JsonProperty(PropertyName = "Очищать данные банкоматов?")]
            public bool ATMs;
        }

        private class SpawnSettings
        {
            [JsonProperty(PropertyName = "Монументы", ObjectCreationHandling = ObjectCreationHandling.Replace)]
        ...
        private class ATMPosition
        {
            ...
            [JsonProperty(PropertyName = "Позиция")]
            public Vector3 Position;

            [JsonProperty(PropertyName = "Поворот")]
            public float Rotation;

            [JsonProperty(PropertyName = "Комиссия с пополнения")]
            public float DepositFee;

            [JsonProperty(PropertyName = "Комиссия со снятия")]
            public float WithdrawFee;
        }

        private class TrackingSettings
        {
            [JsonProperty(PropertyName = "Таблица стоимости (shortname - cost)",
                ObjectCreationHandling = ObjectCreationHandling.Replace)]
        ...
        {
            [JsonProperty(PropertyName = "Минимальный депозит (количество)")]
            public float MinDeposit;

            [JsonProperty(PropertyName = "Минимальное снятие (количество)")]
            public float MinWithdrawal;

            [JsonProperty(PropertyName = "Минимальная комиссия с пополнения")]
            public float MinDepositFee;

            [JsonProperty(PropertyName = "Максимальная комиссия с пополнения")]
            public float MaxDepositFee;

            [JsonProperty(PropertyName = "Комиссия по умолчанию с пополнения")]
            public float DefaultDepositFee;

            [JsonProperty(PropertyName = "Шаг комиссии с пополнения")]
            public float StepDepositFee;

            [JsonProperty(PropertyName = "Минимальная комиссия со снятия")]
            public float MinWithdrawalFee;

            [JsonProperty(PropertyName = "Максимальная комиссия со снятия")]
            public float MaxWithdrawalFee;

            [JsonProperty(PropertyName = "Комиссия по умолчанию со снятия")]
            public float DefaultWithdrawalFee;

            [JsonProperty(PropertyName = "Шаг комиссии со снятия")]
            public float StepWithdrawalFee;

            [JsonProperty(PropertyName = "Процент поломки по умолчанию за каждую операцию")]
            public float DefaultBreakPercent;

            [JsonProperty(PropertyName = "Процент поломки за каждую операцию",
                ObjectCreationHandling = ObjectCreationHandling.Replace)]
            public Dictionary<string, float> BreakPercent;

            [JsonProperty(PropertyName = "Настройка ремонта")]
            ...
            [JsonProperty(PropertyName = "Настройка спавна")]
            public SpawnSettings Spawn;

            [JsonProperty(PropertyName = "Имя магазина ({id} {owner})")]
        ...
        {
            [JsonProperty(PropertyName = "Предметы (за 1%)", ObjectCreationHandling = ObjectCreationHandling.Replace)]
        ...
        private class RepairItemConf
        {
            ...
            [JsonProperty(PropertyName = "Количество (за 1%)")]
            public float Amount;

            [JsonProperty(PropertyName = "Skin")] public ulong Skin;

            [JsonProperty(PropertyName = "Название (пусто - по умолчанию)")]
            public string Title;
        ...
        private void OnLootEntity(BasePlayer player, LootContainer container)
        {
            ...
            if (_lootedContainers.ContainsKey(netID.Value)) return;

            _lootedContainers.Add(netID.Value, player.userID);
