...
{
    [Info("Player Trade", "emu", "0.0.9", ResourceId = 1242)]
    class PlayerTrade : RustPlugin
    {
        ...
        class Trader : MonoBehaviour
        {
            ...
            {
                tradeAccepted = false;
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PlayerAccepted");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "OtherAccepted");
            }
            ...
            public void AcceptTrade()
            {
                ...
                tradeAccepted = true;
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "AddUI", Trader.playerAcceptIndicatorGUI);
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = other.GetPlayer().net.connection }, null, "AddUI", Trader.otherAcceptIndicatorGUI);
            ...
            private void UpdateOfferGUI()
            {
                ...
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PlayerOfferList");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = other.net.connection }, null, "DestroyUI", "OtherOfferList");

                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "AddUI", PlayerGUIMessage);
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = other.net.connection }, null, "AddUI", OtherGUIMessage);
            }
            ...
            public void CreateTradeGUI()
            {
                ...
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "AddUI", baseTradeGUI);
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "AddUI", partnerIndicatorGUIMessage);
            }

            public void DestroyTradeGUI()
            {
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "TradePanel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PlayerPanel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "OtherPanel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "InfoPanel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "InfoLabel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PlayerAccepted");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "OtherAccepted");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PlayerOfferLabel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "OtherOfferLabel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PlayerOfferList");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "OtherOfferList");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PartnerLabelPanel");
                CommunityEntity.ServerInstance.ClientRPCEx(new Network.SendInfo() { connection = player.net.connection }, null, "DestroyUI", "PartnerLabel");
            }
