 ...
 * TODO Add option to add a permission check to each item | Fix cooldowns.
 * 
 *******************************************************/

namespace Oxide.Plugins
{
    [Info("GUI Shop", "Default", "1.5.9")]
    ...
    public class GUIShop : RustPlugin
    {
        ...
        public const string Use = "guishop.use";
        ...
        [PluginReference]
        Plugin Economics, Kits, ImageCache, NoEscape;
        ...
        private void LoadData()
        {
            ...
            buyed = Interface.Oxide.DataFileSystem.ReadObject<Dictionary<string, ulong>>(nameof(GUIShop) + "Purchases");
            selled = Interface.Oxide.DataFileSystem.ReadObject<Dictionary<string, ulong>>(nameof(GUIShop) + "Sales");
        }
        ...
        private void SaveData()
        {
            ...
            if (buyed != null)
                Interface.Oxide.DataFileSystem.WriteObject(nameof(GUIShop) + "Purchases", buyed);
            if (selled != null)
                Interface.Oxide.DataFileSystem.WriteObject(nameof(GUIShop) + "Sales", selled);
        }
        ...
        #region Config
        //////////////////////////////////////////////////////////////////////////////////////
        // Default Shops for Tutorial purpose ////////////////////////////////////////////////
        //////////////////////////////////////////////////////////////////////////////////////
        private static Dictionary<string, object> DefaultShops()
        {
            var shops = new Dictionary<string, object>
            {
                ...
                },
                {
                    ...
                    {
                        {"description", "You currently have {0} coins to spend in the weapons shop"},
                        {"name", "Weapons"},
                        {"buy", new List<object> {"Assault Rifle", "Bolt Action Rifle"}},
                        {"sell", new List<object> {"Assault Rifle", "Bolt Action Rifle"}}
                    }
                ...
                },
                {
                    ...
                    {
                        {"description", "You currently have {0} coins to spend in the tools shop"},
                        {"name", "Tools"},
                        {"buy", new List<object> {"Assault Rifle", "Bolt Action Rifle"}},
                        {"sell", new List<object> {"Assault Rifle", "Bolt Action Rifle"}}
                    }
                ...
                },
                {
                    ...
                    {
                        {"description", "You currently have {0} coins to spend in the items market"},
                        {"name", "Item"},
                ...
                },
                {
                    ...
                    {
                        {"description", "You currently have {0} coins to spend in the components shop"},
                        {"name", "Item"},
                        {"buy", new List<object> {"Apple", "BlueBerries", "Assault Rifle", "Bolt Action Rifle"}},
                        {"sell", new List<object> {"Apple", "BlueBerries", "Assault Rifle", "Bolt Action Rifle"}}
                    }
        ...
        private static CuiElementContainer CreateShopOverlay(string shopname)
        {
            return new CuiElementContainer
            {
                ...
                },
                {
                    new CuiLabel
                    {
                        Text = {Text = shopname, FontSize = 30, Align = TextAnchor.MiddleCenter},//TODO asdasd
        ...
        private CuiElementContainer CreateShopItemIcon(string name, float ymax, float ymin, ItemData data)
        {
            ...
            //TODO Implement better customization.
