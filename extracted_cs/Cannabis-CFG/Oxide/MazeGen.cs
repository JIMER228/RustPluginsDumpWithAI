...
namespace Oxide.Plugins
{
    ...
    internal class MazeGen : RustPlugin
    {
        ...
        TODO
        Finish implementation of loot and NPC's in maze. NPC's aren't currently possible.
        ...
        */
        ...
        private void dmaze(BasePlayer player, string command, string[] args)
        {
        ...
        [ChatCommand("maze")]
        private void GenerateMaze(BasePlayer player, string command, string[] args)
        {
            MakeRoof = true;
        ...
        private List<Block> LastVisited = new List<Block>();
