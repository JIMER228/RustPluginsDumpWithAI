...
{
    [Info("Payback", "1928Tommygun", "1.9.4")]
    ...
    class Payback : RustPlugin
    {
        ...
        void DoPaybackPrintout(BasePlayer player, string[] args)
        {
            ...
            if (Payback2 == null)
            {
                output += "\n\n " + UI2.ColorText("Payback2 not detected :", "red") + UI2.ColorText(" There's even more Payback available at https://payback.fragmod.com !", "white");
            }
        ...
        void Initialize()
        {
            ...
            timer.Once(0.5f, () => {
                if (Payback2 == null)
                {
                    Puts($"\nPayback2 is not loaded! Check out the sequel to this plugin, there's a lot more Payback to be had at https://payback.fragmod.com !\n");
                }
            });
