 ...
 *      The following Software License Agreement constitutes a legally binding agreement between You, (the "Buyer") and (the "Vendor").
 *      This Software License Agreement by (the "Vendor") grants the right to use AdminToggle (the "Software") respecting the license limitations and restrictions below.
 ...
 *
 *  GRANT OF LICENCE
 *      This agreement (the "License") by (the "Vendor") grants the Licensee exclusive, non-transferable, personal-use of the license (the "License") to use this AdminToggle (the "Software").
 *
 *  LICENSE DISCLAIMERS, LIMITATIONS AND RESTRICTIONS
 *      AdminToggle (the "Software") is provided "AS IS" from (the "Vendor") without any warranties of any kind.
 *      AdminToggle (the "Software") may not be modified, changed, adapted, reverse-engineered, de-compiled, Reproduced, Distributed, Resold, Published or shared without the authority of the (the "Vendor")
...
/*VERSION 3.1.19
 * Revert HttpClient issue
 */
/*VERSION 3.1.18
 * Fixed FPF
 */
/*VERSION 3.1.17
 * Fixed HttpClient issue ()
 */
/*VERSION 3.1.16
 * Fixed FPF
...
{
    [Info("AdminToggle", "rustmods.ru", "3.1.19")]
