...
{
    [Info("MachiningTools", "rustmods.ru", "1.3.3", ResourceId = 89)]
    ...
    class MachiningTools : RustPlugin
    {
        ...
        {
            PrintWarning("Благодарим за приобретение плагина на сайте RustMods.ru. Если вы приобрели этот плагин на другом ресурсе знайте - это лишает вас гарантированных обновлений!");
