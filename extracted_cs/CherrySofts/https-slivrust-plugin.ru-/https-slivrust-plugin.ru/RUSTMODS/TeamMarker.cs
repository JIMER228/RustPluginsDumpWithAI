...
{
    [Info("TeamMarker", "rustmods.ru", "1.0.4")]
...
if (activeItem != null)
{
    // Dürbün ve jackhammer için engelleme
    string[] blockedItems = { "tool.binoculars", "jackhammer" };
    if (Array.Exists(blockedItems, item => item == activeItem.info.shortname))
    {
        return;
    }
}
