...
namespace Oxide.Plugins
{
    ...
    [Description("Auto Event Special Cargo")]
    public class XDChinookEvent : RustPlugin
    {
        ///Optimized the method of searching for positions.
        ///Fixed the problem with the same NPC nicknames
        ///
