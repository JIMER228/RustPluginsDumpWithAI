...
{
    [Info("Wipe Block", "https://rust-plug.ru/", "1.0.3")]
    class WipeBlock : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            AddImage("https://i.postimg.cc/HLqmBRhn/Group-11-1.png", $"{Name}.GreenFon");
        ...
        private void AvailableItem(BasePlayer player, int page = 0)
        {
            ...
            for (Int32 i = 0, x = 0, y = 0; i < 20; i++)
            {
                ...
                container.Add(new CuiElement
                {
                    ...
                    Components =
                    {
                        new CuiRawImageComponent { Png = GetImage($"{Name}.GreenFon"), Color = "1 1 1 1" },
                        new CuiRectTransformComponent { AnchorMin = "0 0", AnchorMax = "1 1" }
                    }
                });
