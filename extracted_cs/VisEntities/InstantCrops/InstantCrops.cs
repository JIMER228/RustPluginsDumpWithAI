...
{
    [Info("Instant Crops", "VisEntities", "1.1.2")]
    ...
    public class InstantCrops : RustPlugin
    {
        ...
        private void OnEntityBuilt(Planner planner, GameObject gameObject)
        {
            ...
            NextTick(() =>
            {
                ...
                bool makeRipe =
                    (planterBox != null && seedConfig.ImmediateRipenessInPlanter) ||
                    (planterBox == null && seedConfig.ImmediateRipenessInGround);
                ...
                growableEntity.stageAge = growableEntity.currentStage.lifeLengthSeconds;

                growableEntity.yieldPool = 0f;
                growableEntity.Yield = growableEntity.currentStage.yield;
