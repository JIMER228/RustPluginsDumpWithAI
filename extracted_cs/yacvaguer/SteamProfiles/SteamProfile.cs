...
namespace Oxide.Plugins
{
    ...
    public class SteamProfile : RustPlugin
    {
        ...
        private void OnServerInitialized()
        {
            ...
            _profiles = Interface.Oxide.DataFileSystem.ReadObject<List<Profile>>(_filename) ?? new List<Profile>();
        ...
        {
            Profile existingProfile = _profiles.Find(p => p.steamID == player.UserIDString);
        ...
        {
            _profiles = Interface.Oxide.DataFileSystem.ReadObject<List<Profile>>("SteamProfiles");
            log.Debug($"Loaded {_profiles.Count} profiles");
            return _profiles;
        }
