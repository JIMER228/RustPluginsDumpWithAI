...
{
    [Info("Cannibal", "BuzZ[PHOQUE]", "0.0.4")]
    ...
    *   0.0.4   20190214    fixed issue on serverstart
    *
    ...
    *   
    *
-Possible to add a % chance whereby swimming in water or drinking from fresh water river have a % chance to turn player into cannibal?

-Add a Radiation aura around cannibals and any other players near the cannibals would be irradiated?

-Turns player into cannibal when they reach 30 radiation? 

-Cures cannibalism when cannibals reach 0 radiation 

-increase combat damage multiplier for survival weapons (melee, bows,etc.)

-decreate combat damage multiplier for fire weapons (ak47,lr300,etc. )

-Reward points / economics for turning others into cannibals

- Auto sprint for cannibals
    *=======================================================================================================================*/
    ...
    public class Cannibal : RustPlugin
    {
        ...
        void OnItemUse(Item item, int amountToUse) {
            ...
            if (storedData.Cannibalz.ContainsKey(Eater.userID) == false) { return; }
        ...
        private void CannibalHUD(BasePlayer player) {
            ...
            ONCannibalHUD = CuiElement.Add(new CuiPanel {
                Image = { Color = "0.8 0.0 0.0 0.5" },
                RectTransform = { AnchorMin = $"0.95 0.80", AnchorMax = $"1.0 0.85" },
                CursorEnabled = false
            }, new CuiElement().Parent = "Overlay", ONCannibalHUD);

            CuiElement.Add(new CuiLabel {
                Text = { Text = $"CANNIBAL\nMODE", FontSize = 8, Align = TextAnchor.MiddleCenter, Color = "0.0 0.0 0.0 1" },
                RectTransform = { AnchorMin = "0.10 0.10", AnchorMax = "0.90 0.79" }
            }, ONCannibalHUD);
