...
{
    //* 1.0.2 Added CanTeleport hook and removed some redundant code
    ...
    [Info("GrTeleport", "carny666", "1.0.2", ResourceId = 2665)]
    class GrTeleport : RustPlugin
    {
        ...
        void Init()
        {
            ...
            PrintToChat($"{Name} {Version} Initialized @ {DateTime.Now:hh:mm:ss}...");
