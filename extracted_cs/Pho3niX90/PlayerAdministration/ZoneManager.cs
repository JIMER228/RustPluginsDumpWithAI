...
{
    [Info("Zone Manager", "Reneb / Nogrod / k1lly0u", "3.0.11")]
    ...
    public class ZoneManager : RustPlugin
    {
        ...
        private object OnGrowableGather(GrowableEntity growable, Item item, BasePlayer player) => OnGatherInternal(player);
