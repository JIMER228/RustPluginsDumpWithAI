...
{
    [Info("Player Challenges", "k1lly0u", "2.0.47")]
    ...
    class PlayerChallenges : RustPlugin
    {
        ...
        private void CreateMenuContents(BasePlayer player, int page = 0)
        {
            ...
            UI.Label(ref container, UIMain, $"<color={configData.Colors.TextColor1}>Kingdom Stats</color>", 22, "0.05 0.93", "0.6 0.99", TextAnchor.MiddleLeft);
