...
{
    [Info("Shrinking Radiation Zone", "k1lly0u", "0.1.3")]
    ...
    class ShrinkingRadZone : RustPlugin
    {
        ...
        class ShrinkZone : MonoBehaviour
        {
            ...
            public void CreateZones(string zoneId, Vector3 position, float initialRadius, float timeToTake)
            {
                ...
                Rigidbody innerRB = innerSphere.gameObject.AddComponent<Rigidbody>();
            ...
            private void RemoveFromTrigger(BasePlayer player)
            {
                player.LeaveTrigger(radTrigger);
            }

            private void AddToTrigger(BasePlayer player)
            {
        ...
        private void Unload()
        {
            ...
            if (shrinkZones != null)
            {
                ...
                {
                    UnityEngine.Object.Destroy(shrinkZones[i].gameObject);
                }
            }
        }
        #endregion
        ...
        public void RemoveRadzone(string id)
        {
            ...
            {
                UnityEngine.Object.DestroyImmediate(activeZones[id].gameObject);
        ...
        {           
            ...
            ShrinkZone zone = new GameObject().gameObject.AddComponent<ShrinkZone>();
