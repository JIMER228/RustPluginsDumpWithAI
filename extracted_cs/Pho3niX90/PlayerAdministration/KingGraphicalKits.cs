...
namespace Oxide.Plugins {
    [Info("Kits GUI Normal Servers", "Pho3niX90", "0.0.2")]
    [Description("")]
    public class KingGraphicalKits : RustPlugin {
        #region Vars
        ...
        private void BuildKitsUI(CuiElementContainer container, KitUI[] kits, string userID) {
            ...
            foreach (var kit in kits) {
                ...
                GenerateContents(kit, 9, 10, 18, 18, container, panelName, 
                    "0.05 0.7", 
                    "0.05 0.7", 6);
        ...
        private void BuildContentsUI(BasePlayer player, string kitName) {
            ...
            GenerateContents(kit, 14, 75, config.ContentsizeX, config.ContentsizeY, container, elemInfo);
        ...
        private Dictionary<object, string> langMessages = new Dictionary<object, string>
        {
            ...
            {Message.TextBottom, "<size=15><color=#ff0000>Click on a free place to exit!\n</color></size>"},
            {Message.None, "None"},
