...
{
    [Info("NoFuelRequirements", "k1lly0u", "1.3.8", ResourceId = 1179)]
    class NoFuelRequirements : RustPlugin
    {
        ...
        #region Config  
        enum ConsumeType { Campfire, CandleHat, CeilingLight, ChineseLantern, Firepit, Fireplace, Furnace, Lanterns, LargeFurnace, MinersHat, OilRefinery, Quarry, TunaLight, Searchlight, FogMachine, SnowMachine, CursedCauldren, None }
        ...
        private void UpdateConfigValues()
        {
            ...
            {
                configData.AffectedTypes.Add(ConsumeType.SnowMachine, true);
                configData.AffectedTypes.Add(ConsumeType.FogMachine, true);
                configData.AffectedTypes.Add(ConsumeType.CursedCauldren, true);
            }

            if (configData.Version < new VersionNumber(1, 3, 8))
                configData.AffectedTypes.Add(ConsumeType.ChineseLantern, true);
