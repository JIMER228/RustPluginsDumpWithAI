...
{
    [Info("SoFriends | Система друзей", "LAGZYA", "0.0.2")]
    public class SoFriends : RustPlugin
    {
        ...
        private void FriendCmd(BasePlayer player, string command, string[] arg)
        {
            ...
            switch (arg[0])
            {
                case "add":
                    ...
                    {
                        if (!playerAccept.ContainsKey(target.userID) ||
                            !playerAccept.ContainsValue(player.userID)) return;
                        if (target != null)
                        {
                    ...
                    switch (arg[1])
                    {
                        ...
                        case "damage":
                            ...
                            if (arg[2] == "1")
                            {
                                ...
                                SendReply(player,
                                    $"{PlugName}{lang.GetMessage("DAMAGEON", this, player.UserIDString)}");
                            }
                            else
                            {
                                foreach (var friends in player1.friendList)
                                ...
                                SendReply(player,
                                    $"{PlugName}{lang.GetMessage("DAMAGEOFF", this, player.UserIDString)}");
                            }
        ...
        private CuiElement ButtonList = new CuiElement()
        {
            ...
            Components =
            {
                ...
                {
                    Color = "0.40 0.40 0.40 0", Command = "chat.say /fmenu",
                    Sprite = "assets/content/ui/ui.background.tile.psd",
                    Material = "assets/content/ui/uibackgroundblur.mat"
                },
                new CuiOutlineComponent() { Color = "0.64 0.00 0.00 1.00", Distance = "1 1" },
        ...
        private CuiElement AddFriends = new CuiElement()
        {
            ...
            Components =
            {
                new CuiButtonComponent()
                {
                    Color = "0.40 0.40 0.40 0", Command = "friendui addfriend",
                    Sprite = "assets/content/ui/ui.background.tile.psd",
                    Material = "assets/content/ui/uibackgroundblur.mat"
                },
                new CuiOutlineComponent() { Color = "0.64 0.00 0.00 1.00", Distance = "1 1" },
        ...
        private CuiButton CloseKrest = new CuiButton()
        {
            ...
            Button =
            {
                Color = "0.64 0.00 0.00 0.80", Close = Layer, Sprite = "assets/icons/vote_down.png",
            },
        ...
        private CuiButton ClosePanel = new CuiButton()
        {
            ...
            Button =
            {
                Color = "0.64 0.00 0.00 0.80", Close = Layer, Sprite = "assets/icons/circle_open.png",
            },
            Text = { Text = "", Align = TextAnchor.MiddleCenter, Font = "robotocondensed-regular.ttf" }
        };
        ...
        private CuiButton DenyButton = new CuiButton()
        {
            ...
            Button = { Color = HexToRustFormat("#656565CC"), Command = "friend deny" },
        ...
        private CuiButton AcceptButton = new CuiButton()
        {
            ...
            Button = { Color = HexToRustFormat("#a40000CC"), Command = "friend accept" },
        ...
        CuiElement page0 = new CuiElement()
        {
            ...
            Components =
            {
                ...
                new CuiRectTransformComponent() { AnchorMin = "0.292861 0.2438576", AnchorMax = "0.3850963 0.2970295" }
            }
        };
        ...
        CuiElement page1 = new CuiElement()
        {
            ...
            Components =
            {
                ...
                new CuiOutlineComponent() { Color = "0.40 0.40 0.40 1.00", Distance = "1.5 1.5" },
        ...
        CuiElement page2 = new CuiElement()
        {
            ...
            Components =
            {
                ...
                new CuiOutlineComponent() { Color = "0.40 0.40 0.40 1.00", Distance = "1.5 1.5" },
                new CuiRectTransformComponent()
                    { AnchorMin = "0.7118673 0.05172569", AnchorMax = "0.9830517 0.9137955" }
            }
        };
        ...
        CuiElement page3 = new CuiElement()
        {
            ...
            Components =
            {
                new CuiImageComponent()
                {
                    Color = "0.40 0.40 0.40 0.87",
                    Material = "assets/content/ui/uibackgroundblur.mat"
                },
                new CuiOutlineComponent() { Color = "0.40 0.40 0.40 1.00", Distance = "1.5 1.5" },
                new CuiRectTransformComponent()
                    { AnchorMin = "0.3672329 0.05172569", AnchorMax = "0.6384174 0.9137955" }
            }
        };
        ...
        private void AddFriendList(BasePlayer player, int page)
        {
            ...
            foreach (var players in BasePlayer.activePlayerList.Where(p => p.userID != player.userID)
                         ...
                         .Select((i, t) => new { A = i, B = t - (page - 1) * 12 }).Skip((page - 1) * 12).Take(12))
            {
                cont.Add(new CuiElement()
                {
                    ...
                    Components =
                    {
                        ...
                        new CuiOutlineComponent() { Distance = "1 1", Color = HexToRustFormat("#A40000FF") },
                        new CuiRectTransformComponent
                        {
                            AnchorMin =
                                $"{0.2944241 + players.B * 0.53 - Math.Floor((double)players.B / 2) * 2 * 0.53} {0.6123946 - Math.Floor((double)players.B / 2) * 0.13}",
                            AnchorMax =
                                $"{0.4533611 + players.B * 0.53 - Math.Floor((double)players.B / 2) * 2 * 0.53} {0.6508984 - Math.Floor((double)players.B / 2) * 0.13}"
                        }
                    }
                });
                cont.Add(new CuiButton
                {
                    ...
                    Button =
                    {
                        Color = "0 0 0 0", Command = $"friend add {players.A.userID}"
                    },
        ...
        private void SettingInit(BasePlayer player, ulong steamdIdTarget)
        {
            ...
            cont.Add(new CuiButton()
            {
                ...
                Button =
                {
                    Color = "0 0.00 0.00 0", Command = $"friend remove {steamdIdTarget}",
                },
                Text =
                {
                         ...
                         .Skip((page - 1) * 6).Take(6))
            {
                ...
                if (friend == null)
                {
                    cont.Add(new CuiElement()
                    {
                        ...
                        {
                            new CuiImageComponent()
                                { Sprite = "assets/icons/circle_closed_toedge.png", Color = "1 0 0 1" },
                            new CuiRectTransformComponent()
                ...
                else
                {
                    cont.Add(new CuiElement()
                    {
                        ...
                        {
                            new CuiImageComponent()
                                { Sprite = "assets/icons/circle_closed_toedge.png", Color = "0 1 0 1" },
                            new CuiRectTransformComponent()
                                { AnchorMin = "0.06557404 0.3333297", AnchorMax = "0.1016398 0.6190448" }
                        }
                    });
                ...
                cont.Add(new CuiElement()
                {
                    ...
                    Components =
                    {
                        new CuiTextComponent()
                        {
                            Text = $"{friends.A.Value.name}", Align = TextAnchor.MiddleLeft,
                            Font = "robotocondensed-regular.ttf",
                        },
                        new CuiRectTransformComponent()
