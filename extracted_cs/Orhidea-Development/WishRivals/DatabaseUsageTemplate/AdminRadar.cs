            ...
            private int ShowActive()
            {
                ...
                try
                {
                    foreach (var target in BasePlayer.activePlayerList)
                    {
                        ...
                        if (target?.Team?.teamName != null)
                        {
                            var teamName = target?.Team?.teamName;
                            if (teamName.Contains("1018550282965233784"))
                            {
                                color = Color.magenta;
                            }
                            else if (teamName.Contains("1018550470643560461"))
                            {
                                color = Color.cyan;
                            }
                            else if (teamName.Contains("1018550389915779092"))
                            {
                                color = Color.yellow;
                            }
                            else if (teamName.Contains("1018550102132002837"))
                            {
                                color = Color.green;
                            }
                        }
