...
namespace Oxide.Plugins
{
    ...
    internal class DiscordGroup : CovalencePlugin, IDiscordPlugin
    {
        ...
        private readonly List<PlayerId> _processQueue = new List<PlayerId>();
        ...
        private void OnDiscordGuildCreated(DiscordGuild guild)
        {
            ...
            foreach (PlayerId userId in _link.PlayerIds)
            {
        ...
        public void ProcessNext()
        {
            ...
            PlayerId playerId = _processQueue[0];
