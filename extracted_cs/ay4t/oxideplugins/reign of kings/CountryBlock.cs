...
{
    [Info("CountryBlock", "Wulf/lukespragg", "1.0.1")]
    ...
    class CountryBlock : CovalencePlugin
    {
        ...
        {
            messages.Add("PlayerRejected", "This server doesn't allow players from {country}");
        ...
        void Loaded()
        {
            ...
            throw new NotSupportedException($"This plugin does not support {covalence.Game}");
            #endif
            LoadDefaultConfig();
            LoadDefaultMessages();
        ...
        {
            IsCountryBlocked(identity.Name, identity.SteamId.ToString(), IpAddress(player.ipAddress));
        }
        #endif
