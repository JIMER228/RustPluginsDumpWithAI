...
{
    [Info("IPLogger", "redBDGR", "1.0.0")]
    [Description("Easily log all players IPs for easy comparison")]
    ...
    class IPLogger : CovalencePlugin
    {
        ...
        void Init()
        {
            IPInfo = Interface.Oxide.DataFileSystem.GetFile("IPLogger");
            LoadData();
        }
