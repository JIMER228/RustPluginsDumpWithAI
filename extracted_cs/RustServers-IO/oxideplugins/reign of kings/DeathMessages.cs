...
{
    [Info("Death Messages", "PaiN", 0.5, ResourceId = 1042)] 
    ...
    { 
		...
		{
			if(e.Entity == null || e.KillingDamage.DamageSource == null || e == null || e.Entity.IsPlayer == false || e.KillingDamage.DamageSource.Owner.IsServer || e.Entity.Owner.IsServer || e.KillingDamage.DamageSource.Owner == null) return;
