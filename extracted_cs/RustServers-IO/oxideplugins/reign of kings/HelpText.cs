...
{
    [Info("Help Text", "Mughisi", "1.0.3", ResourceId = 1055)]
    public class HelpText : ReignOfKingsPlugin
    {
        ...
        { 
            var RoKCommands = new List<CodeHatch.Engine.Core.Commands.CommandAttribute>();
            ...
            {
                CodeHatch.Engine.Core.Commands.CommandAttribute RoKCommandAttr;
            ...
            CodeHatch.Engine.Core.Commands.CommandAttribute helpArgumentCommand;
