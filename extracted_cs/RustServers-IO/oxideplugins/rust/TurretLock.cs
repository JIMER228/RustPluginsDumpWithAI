...
{
    [Info("TurretLock", "redBDGR", "1.0.2", ResourceId = 2703)]
    [Description("Give players the ability to lock their turrets")]
    ...
    class TurretLock : RustPlugin
    {
        ...
        private void LockTurretCMD(BasePlayer player, string command, string[] args)
        {
            ...
            if (turretEntity.ShortPrefabName == "autoturret_deployed")
            {
