...
{
    [Info("Free Driving Vehicles", "MON@H", "1.1.5")]
    ...
    public class FreeDrivingVehicles : RustPlugin
    {
        ...
        private const string PermissionTugboat = "freedrivingvehicles.tugboat"; // new
        private const string PermissionWorkcart = "freedrivingvehicles.workcart";
        private const string PermissionLocomotive = "freedrivingvehicles.locomotive"; // new
        ...
        private const string PermissionAttackHelicopter = "freedrivingvehicles.attackhelicopter"; // new
        private const string PermissionChinook = "freedrivingvehicles.chinook"; // new
        ...
        private void Init()
        {
            ...
            permission.RegisterPermission(PermissionTugboat, this);
            permission.RegisterPermission(PermissionWorkcart, this);
            permission.RegisterPermission(PermissionLocomotive, this);
            permission.RegisterPermission(PermissionModularCar, this);
            permission.RegisterPermission(PermissionMiniCopter, this);
            permission.RegisterPermission(PermissionAttackHelicopter, this);
            permission.RegisterPermission(PermissionScrapCopter, this);
            permission.RegisterPermission(PermissionChinook, this);
        ...
        private void CreateCache()
        {
            ...
            _prefabPermissions[StringPool.Get("assets/content/vehicles/attackhelicopter/attackhelicopter.entity.prefab")] = PermissionAttackHelicopter; // new
            _prefabPermissions[StringPool.Get("assets/prefabs/npc/ch47/ch47.entity.prefab")] = PermissionChinook; // new
            ...
            _prefabPermissions[StringPool.Get("assets/content/vehicles/snowmobiles/tomahasnowmobile.prefab")] = PermissionSnowmobile; // new
            ...
            _prefabPermissions[StringPool.Get("assets/content/vehicles/boats/tugboat/tugboat.prefab")] = PermissionTugboat; // new
            _prefabPermissions[StringPool.Get("assets/content/vehicles/workcart/workcart.entity.prefab")] = PermissionWorkcart;
            _prefabPermissions[StringPool.Get("assets/content/vehicles/trains/workcart/workcart_aboveground.entity.prefab")] = PermissionWorkcart; // new
            _prefabPermissions[StringPool.Get("assets/content/vehicles/trains/workcart/workcart_aboveground2.entity.prefab")] = PermissionWorkcart; // new
            _prefabPermissions[StringPool.Get("assets/content/vehicles/trains/locomotive/locomotive.entity.prefab")] = PermissionLocomotive; // new
        }
