...
namespace Oxide.Plugins
{
    ...
    public class BGrade : RustPlugin
    {
        ...
        // Auto Upgrade default value for users joining
        private bool AutoGradeOnJoin;
        private int AutoGradeOnJoinValue;
        ...
        private void InitConfig()
        {
            ...
            AutoGradeOnJoin = GetConfig(false, "BGrade on Join", "Enabled");
            AutoGradeOnJoinValue = GetConfig(4, "BGrade on Join", "Grade Level");
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["Notice.Connected"] = "Please disable this if you don't want to build at this tier.",
        ...
        private void OnPlayerConnected(BasePlayer player)
        {
            ...
            List<string> chatMsgs = Facepunch.Pool.GetList<string>();
            ...
            Facepunch.Pool.FreeList(ref chatMsgs);
        }
