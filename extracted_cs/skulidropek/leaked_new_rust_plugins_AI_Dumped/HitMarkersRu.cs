...
namespace Oxide.Plugins
{
    ...
    public class HitMarkersRu : RustPlugin
    {
        ...
        private void MainUi(BasePlayer player, bool first = false)
        {
            ...
            foreach (var fontConf in _config.Fonts)
            {
                ...
                container.Add(new CuiPanel
                {
                    ...
                    Image =
                    {
                        Color = selected ? HexToCuiColor("#ff7b4b") : HexToCuiColor("#161617")
                    }
                ...
                container.Add(new CuiLabel
                {
                    ...
                    Text =
                    {
                        ...
                        FontSize = 14,
                        Color = selected ? HexToCuiColor("#FFFFFF") : HexToCuiColor("#ff7b4b")
                    }
        ...
        {
            return RelationshipManager.Instance.FindTeam(player)?.members?.Contains(friend) == true;
        }
