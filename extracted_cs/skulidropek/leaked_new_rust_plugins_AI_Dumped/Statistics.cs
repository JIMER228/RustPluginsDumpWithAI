...
{
	[Info("Statistics", "https://discord.gg/TrJ7jnS233", "1.1.5")]
	public class Statistics : RustPlugin
	{
		...
		private const string Layer = "UI.Statistics", UsePermission = "statistics.use", HidePermission = "statistics.hide";
		...
		private class Configuration
		{
			...
			[JsonProperty(PropertyName = "Work with PlayTimeRewards?")]
			public bool UsePlayTimeRewards = true;

			[JsonProperty(PropertyName = "Work with PlaytimeTracker?")]
			public bool UsePlaytimeTracker = true;

			[JsonProperty(PropertyName = "Enable a Profile?")]
			...
			[JsonProperty(PropertyName = "Enable a Leaderboard?")]
			...
			[JsonProperty(PropertyName = "NPCs Score Table (UserID - score)",
				ObjectCreationHandling = ObjectCreationHandling.Replace)]
			...
			[JsonProperty(PropertyName = "Count suicide as kill")]
			...
			[JsonProperty(PropertyName = "Count bot kills in kills?")]
			...
			[JsonProperty(PropertyName = "Enable the ability to see another player's profile?")]
			public bool SeeProfile = true;

			[JsonProperty(PropertyName = "Permission to view the other player's profile (ex: statistics.profile)")]
			public string PermissionSeeProfile = string.Empty;

			[JsonProperty(PropertyName = "Enable the collection of statistics only for players with permission?")]
			public bool UseCollectionPerm = false;

			[JsonProperty(PropertyName = "Permission to collect statistics (ex: statistics.collect)")]
