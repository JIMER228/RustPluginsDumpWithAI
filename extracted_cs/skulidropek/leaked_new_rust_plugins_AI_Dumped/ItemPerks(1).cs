...
/* 1.0.17
 * Added a couple of config options to disable chat messages.
 * Patched pooling
 * Updated for October patch
 */

namespace Oxide.Plugins
{
    [Info("Item Perks", "imthenewguy", "1.0.17")]
    ...
    class ItemPerks : RustPlugin
    {
        ...
        void OnPlayerDeath(BasePlayer player, HitInfo info)
        {
            ...
            {
                if (player is global::HumanNPC) LootedCorpses.Add(player.userID, new LootedCorpse(player as global::HumanNPC));
                return;
            }
