...
namespace Oxide.Plugins
{
    ...
    internal class BetterChatMute : CovalencePlugin
    {
        ...
        private string API_GetMuteDetails(IPlayer target, IPlayer player)
        {
            ...
            else
            {
                ...
                if (muteInfo.Timed)
                    text += $"Mute expires in: {muteInfo.ExpireDate} ({muteInfo.Reason})";
                else
                    text += $"Muted permanently({muteInfo.Reason})";
            }
