...
{
    public class IsThreeModuleCarUnitTests
    {
        ...
        [Fact]
        public void IsThreeModuleCar_WhenPrefabIsThreeModuleCar_ReturnsTrue()
        {
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCarSpawnedPrefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar01Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar02Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar03Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar04Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar05Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar06Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar07Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(TwoModuleCar08Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCarSpawnedPrefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar01Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar02Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar03Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar04Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar05Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar06Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar07Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar08Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar09Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar10Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar11Prefab));
            Assert.Equal(true, ModuleCarLicensePlate.IsThreeModuleCarWrapper(ThreeModuleCar12Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCarSpawnedPrefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar01Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar02Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar03Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar04Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar05Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar06Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar07Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar08Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar09Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar10Prefab));
            Assert.Equal(false, ModuleCarLicensePlate.IsThreeModuleCarWrapper(FourModuleCar11Prefab));
        }
    }
};
