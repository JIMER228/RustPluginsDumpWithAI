...
{
    [Info("Where is my ride", "st-little", "0.2.0")]
    ...
    public class WhereIsMyRide : RustPlugin
    {
        ...
        private void Init()
        {
            ...
            cmd.AddChatCommand(_configuration.CommandName, this, nameof(WhereCommand));
        ...
        {
            string rideGridCoord = MapHelper.PositionToString(ride.transform.position);
